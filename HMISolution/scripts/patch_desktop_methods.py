...
# 1. Add _serverUrl field after _window field
if '_serverUrl' not in content:
    ...
    print("1. SKIP _serverUrl field (already exists)")

# 2. Add methods before FindEditorExe
if 'OnWindowClosing' not in content:
    ...
    print("2. SKIP methods (already exist)")
