...
namespace UFUAServerInfo
{
    ...
    public class UFUAServerInfo
    {
        ...
        public static NodeId GetWriteTagSynchNodeId()
        {
            Opc.Ua.NamespaceTable n = new Opc.Ua.NamespaceTable();
            UInt16 ns = (UInt16)(n.Count + 2 - 1);
            return new NodeId(BrowserNames.WriteVarValues, ns);
        }

        public static NodeId GetTagRootNodeId()
        {
            Opc.Ua.NamespaceTable n = new Opc.Ua.NamespaceTable();
            UInt16 ns = (UInt16)(n.Count + 2 - 1);
            return new NodeId(Guids.RootTagsGuid, ns);
        }
        public static int GetMinWriteTimeout()
        {
            return Properties.Settings.Default.MinWriteTimeout;
        }
        #endregion
    ...
    public static partial class BrowserNames
    {
        ...
        #region Read/Write
        public const string WriteVarValues = "WriteVarValues";        
        #endregion

        #region Access Rights
        /// <summary>
        /// The BrowseName for the UserReadAccessMask component.
        /// </summary>
        public const string UserReadAccessMask = "UserReadAccessMask";
        /// <summary>
        /// The BrowseName for the UserAccessLevel component.
        /// </summary>
        ...
        /// <summary>
        /// The BrowseName for the ActiveSessionsWebHMI component.
        /// </summary>
        public const string ActiveSessionsWebHMIName = "ActiveSessionsWebHMI";

        /// <summary>
        /// The BrowseName for the ActiveSessionsWebClient component.
        /// </summary>
        public const string ActiveSessionsWebClientName = "ActiveSessionsWebClient";

        /// <summary>
        /// The BrowseName for the ActiveSessionsWebApps component.
        /// </summary>
        public const string ActiveSessionsWebAppsName = "ActiveSessionsWebApps";
        #endregion
        ...
        /// <summary>
        /// The Description for the ActiveSessionsWebHMI component.
        /// </summary>
        public const string ActiveSessionsWebHMIDesc = "Active WebHMI sessions count";

        /// <summary>
        /// The Description for the ActiveSessionsWebClient component.
        /// </summary>
        public const string ActiveSessionsWebClientDesc = "Active WebClient HTML5 sessions count";

        /// <summary>
        /// The Description for the ActiveSessionsWebApps component.
        /// </summary>
        public const string ActiveSessionsWebAppsDesc = "Active WebApps sessions count";
        #endregion
