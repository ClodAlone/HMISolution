...
{
    [DataContract(Name = "HeightAnimation")]
    public class HeightAnimation : AnimationManager
    {
#region Properties
        ...
        {
            Control.HeightAnimation(CommonTarget, AnimationTime, Repeatable, Autoreverse, AnimationEquation, null, AdaptPosition);
            base.Demo();
        }
#endif
        public override void Execute()
        {
            if (Control == null)
                return;
            Control.HeightAnimation(dTargetValue, AnimationTime, Repeatable, Autoreverse, AnimationEquation, null, AdaptPosition);
        }

        public override void Stop()
        {
            if (Control != null)
                Control.HeightAnimation(0, -1, Repeatable, Autoreverse, AnimationEquation, null, AdaptPosition);
            base.Stop();
        }
#endif
        public override String Name
        {
            get
            {
                return Properties.Resources.HeightName;
            }
        }
