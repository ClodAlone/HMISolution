...
namespace IpDriverCodeBase
{
    ...
    [Persistent("TcpChannelSettings_1")]
    public class TcpChannelSettings : ChannelSettings
    {
       #region Constructors
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public void CopyProperties(TcpChannelSettings ch)
        {
        ...
        protected override String PerformValidation(String propertyName)
        {
            ...
            {
                if (TcpChannelSettingsHostName.Length == 0)
            ...
            else if (propertyName == "TcpChannelSettingsBackupHostName")
            {
                ...
                if ((TcpChannelSettingsBackupHostName.Length > 0) && (!Regex.IsMatch(TcpChannelSettingsBackupHostName, ValidIpAddressRegex) && !Regex.IsMatch(TcpChannelSettingsBackupHostName, ValidHostnameRegex)))
                    return Properties.Resources.InvalidHostName;
            }
