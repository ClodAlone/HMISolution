    ...
    public class DemoModeTests
    {
        ...
        public void TestModuleAvailableInDemoMode()
        {
            ...
            for (int ii = 0; ii < modulesAvailableInDemoMode.Length; ii++)
            {
                ...
                var expectedModuleValue = modulesValueInDemoMode.ContainsKey(module) ? long.Parse(modulesValueInDemoMode[module]) : demoMaxIntValue;
                var value = MSZ.MSZView.GetModule(module);
                Assert.AreEqual(expectedModuleValue, value, "The Module '{0}' should be available in demo mode", WPFUtilities.CryptString.CryptString.DecryptString(module));
            }
        }
        #endregion
        ...
        public void TestKeyChangeEvent()
        {
            ...
            using (ManualResetEvent wait = new ManualResetEvent(false))
            {
                ...
                MSZ.MSZView.Read();
                var signaled = wait.WaitOne(10000);
