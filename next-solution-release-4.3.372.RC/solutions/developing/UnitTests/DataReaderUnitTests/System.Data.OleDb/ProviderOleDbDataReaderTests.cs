...
namespace DataReaderUnitTests
{
    ...
    public class ProviderOleDbDataReaderTests
    {
        ...
        {
            if (!FactoryHelper.IsProviderAviable(DataProvider.OleDBDataProvider.Name))
                return;

            DataReader.SchemaInfo.DbSchemaInfo schemaInfo = null;
            try
            {
                schemaInfo = DataReader.SchemaInfo.DbSchemaInfoFactory.CreateSchemaInfo(DataProvider.OleDBDataProvider.Name,
