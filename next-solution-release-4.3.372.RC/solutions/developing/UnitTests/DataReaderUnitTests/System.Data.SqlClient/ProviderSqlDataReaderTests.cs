...
namespace DataReaderUnitTests
{
    ...
    public class ProviderSqlDataReaderTests
    {
        ...
        {
            if (!FactoryHelper.IsProviderAviable(DataProvider.SqlDataProvider.Name))
                return;

            DataReader.SchemaInfo.DbSchemaInfo schemaInfo = null;
            try
            {
                schemaInfo = DataReader.SchemaInfo.DbSchemaInfoFactory.CreateSchemaInfo(DataProvider.SqlDataProvider.Name,
