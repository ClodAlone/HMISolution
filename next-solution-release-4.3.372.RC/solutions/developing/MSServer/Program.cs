...
#if !DEBUG
#if !NET_CORE
        readonly static Mindscape.Raygun4Net.RaygunClient _raygunClient = new Mindscape.Raygun4Net.RaygunClient("ZSCPs7wEYwrHnEUQVLQ6NQ");
#else
        readonly static Mindscape.Raygun4Net.RaygunClient _raygunClient = new Mindscape.Raygun4Net.RaygunClient("NFua9VtkNfkqJDd3JDI2A");
#endif
