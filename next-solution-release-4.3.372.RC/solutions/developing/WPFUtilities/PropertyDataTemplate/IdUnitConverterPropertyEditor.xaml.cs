...
namespace WPFUtilities.PropertyDataTemplate
{
    ...
    public partial class IdUnitConverterPropertyEditor : UserControl
    {
        ...
        public static readonly DependencyProperty BindingPathProperty = DependencyProperty.Register("BindingPath", typeof(string), typeof(IdUnitConverterPropertyEditor), new UIPropertyMetadata(null, new PropertyChangedCallback(OnBindingPathChanged), new CoerceValueCallback(OnCoerceBindingPath)));
