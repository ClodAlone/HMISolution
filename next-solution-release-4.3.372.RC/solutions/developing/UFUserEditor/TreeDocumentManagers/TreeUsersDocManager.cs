...
{
    class TreeUsersDocManager : IDocumentManager
    {
        #region Declarations
        readonly UFUserDocument userDocument;
        readonly UFUserEditorManagerComponent userManagerComponent;
        readonly UFUserModel.UFUser User;
        #endregion

        public TreeUsersDocManager(UFUserEditorManagerComponent c, UFUserDocument doc, UFUserModel.UFUser user)
        {
        ...
        {
            get { return UFUserEditorManagerComponent.GetBitmapImage("UFUSRUserSmall"); }
        }
        ...
        {
            get { return UFUserEditorManagerComponent.GetBitmapImage("UFUSRUser"); }
        }
        ...
        public Object BrowsableContent
        {
            get
            {
                return null; // userDocument.GetNestedObject(User);
            }
        }
    }
}
