    ...
    public partial class RecipeService : ServiceBase
    {
        ...
        public virtual void StartService(string[] args)
        {
            ...
            using (var Mutex = new Mutex(false, appName))
            {
                ...
                {
                    Logger.WriteToEventLog(Properties.Resources.LoggerSource,
                        ex.Message, System.Diagnostics.EventLogEntryType.Warning, LoggerDestination.RecipeService);
                }
                ...
                try
                {
                                                    ...
                                                    Properties.Resources.InitializedServer))
                    {
                        ...
                        while (true)
                        {
                            ...
                            try
                            {
                                serverCSM = new RecipeServiceCSM(projectDocument.ConfigurationId.ToString(), this);
                        ...
                        projectDocument.CreateProjectFolders();
                        recipeManager.BalloonEvent += recipeManager_BalloonEvent;
                    }
                    ...
                    {
                        projectDocument.StartupServiceRecipes(recipeManager);
                    }
                }
                finally
                {
        ...
        #region Methods
        public bool IsReady(Uri uri, RecipeCommandType commandType)
        {
            return recipeManager.IsReady(uri, (int)commandType, projectDocument);
        }
        public void Execute(Uri uri, ExecutionMode mode, RecipeServiceCMS.ExecutionArgs args)
        {
        ...
        void recipeManager_BalloonEvent(object sender, UFRecipeEditor.ComponentService.BalloonEventArgs e)
        {
            if (e != null)
            {
