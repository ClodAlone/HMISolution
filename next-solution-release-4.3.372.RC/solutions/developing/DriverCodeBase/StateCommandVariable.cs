...
namespace DriverCodeBase
{
    ...
    {       
        ...
        public StateCommandVariable(string name, string id)
        {
            ...
            varValue = new DataValue(new Variant((UInt32)0));
        ...
        public bool SetStateCommandVariableBit(bool bitValue, UInt16 bitIndex, CommunicationDriver commDriver)
        {
            ...
            //stateCommandVariableObj.SetValue(null);
            DataValue newDataValue = new DataValue(new Variant(varValue));
        ...
        /// <param name="bitIndex" type="UInt16">     The index of the bit. </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public bool GetStateCommandVariableValue(ref uint varValue, UInt16 bitIndex)
        {
