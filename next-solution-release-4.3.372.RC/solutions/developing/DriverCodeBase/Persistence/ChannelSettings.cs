...
namespace DriverCodeBase
{
    ...
    public abstract class ChannelSettings : XPObject, IDataErrorInfo
    {
        ...
        public void DefaultSettings()
        {
            ...
            _WaitTime = 0;
            _Timeout = 5000;
            _ScheduleTimeJobsList = 500;
            _PollingTimeNotInUse = 0;
            _PollingTimeInError = 0;
            _KeepOpened = true;
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>
        /// Allows to set the schedule time (ms) of the jobs list for the execution thread channel.
        /// </summary>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        private int _ScheduleTimeJobsList;
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Gets or sets a list of schedule time jobs. </summary>
        ///
        ...
        public int ScheduleTimeJobsList
        {
            ...
            set
            {
                SetPropertyValue("ScheduleTimeJobsList", ref _ScheduleTimeJobsList, value);
            }
        }
        ...
        protected virtual String PerformValidation(String propertyName)
        {
            ...
            switch(propertyName)
            {
                ...
                case "Timeout":
                    ...
                    break;
                case "ScheduleTimeJobsList":
                    if (ScheduleTimeJobsList > int.MaxValue || ScheduleTimeJobsList < 0)
                        return string.Format(Properties.Resources.ScheduleTimeJobsListOutOfRange, int.MaxValue);
                    break;
