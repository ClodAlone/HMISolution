...
namespace DriverCodeBaseEx
{
    ...
    public class DynTagSettings : IDataErrorInfo, INotifyPropertyChanged
    {
        ...
        /// <summary>   Method Id </summary>
        private static readonly String MethodTypeParameter = "Method";

        /// <summary>   struct's members string size </summary>
        private static readonly String StructStringFieldLengthsParameter = "SSFL";

        /// <summary>   struct's atomic enabled </summary>
        private static readonly String StructAtomicEnableParameter = "SAE";
        ...
        public virtual void Parse(String dynamicSettings)
        {
            ...
            TagLinkType = (int)(helper.GetPartByName(DeviceLinkParameter, (int)LinkType.InputOutput));
            ...
            MethodID = helper.GetPartByName(MethodTypeParameter, -1);

            StructStringFieldLengths = helper.GetPartByName(StructStringFieldLengthsParameter);

            StructAtomicEnable = helper.GetPartByName(StructAtomicEnableParameter, false);
        }
        ...
        public virtual bool TryParse(String dynamicSettings)
        {
            ...
            if (helper.GetDriverName() == null)
                return false;
            if (helper.GetDriverName().ToLower() != DriverName.ToLower())
                return false;
        ...
        {
            var dynamicstring = new StringBuilder(DriverName);
            ...
            // optional parameter
            if (StructAtomicEnable)
            {
                dynamicstring.Append(DynamicStringParser.CharSep);
                dynamicstring.AppendFormat("{0}{1}{2}", StructAtomicEnableParameter, DynamicStringParser.CharAssign, StructAtomicEnable);
            }
        ...
        {
            return GetNextDynSetting(prevtagdefinition, thistagdefinition, 0);
        }

        public virtual string GetNextDynSetting(TagDefinition prevtagdefinition, TagDefinition thistagdefinition, int stringSize)
        {
            return string.Empty;
        }
        ...
        {
            return GetFirstDynSetting(tag, thistagdefinition, 0);
        }

        public virtual string GetFirstDynSetting(Tag tag, TagDefinition thistagdefinition, int stringSize)
        {
        ...
        {
            return new List<string>() {StationParameter, DeviceLinkParameter, 
        ...
        /// <summary>
        /// Gets or sets the the Conditional variable of job.
        /// 
        /// Use only for dynamic-link edit !!!
        /// 
        /// </summary>
        public UFUAModel.TagEntityReference ConditionalVariableTag
        {
            get
            {
                Opc.Ua.NodeId nodeId;
                if (!NodeIdHelper.TryParse(_ConditionalVariableId, out nodeId))
                    nodeId = Opc.Ua.NodeId.Null;
                return new UFUAModel.TagEntityReference(Guid.Empty, _ConditionalVariableName, _ConditionalVariableId);
            }
            set
            {
                if (value == null)
                {
                    _ConditionalVariableName = null;
                    _ConditionalVariableId = null;
                }
                else
                {
                    _ConditionalVariableName = value.ToString();
                    _ConditionalVariableId = value.NodeId.ToString();
                }
            }
        }

        /// <summary>   Name of the Offset variable. </summary>
        private string _OffsetVariableName;
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Offset Variable Name. </summary>
        ///
        /// <value> The name of the Offset value. </value>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        [Category("General")]
        [Description("Offset Variable Name")]
        public virtual string OffsetVariableName
        {
        ...
        /// <summary>   Node ID of the Offset variable. </summary>
        private string _OffsetVariableId;
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Offset Variable Node Id. </summary>
        ///
        /// <value> The Node Id of the Offset value. </value>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        [Category("General")]
        [Description("Offset Variable Node Id")]
        public virtual string OffsetVariableId
        {
        ...
        /// <summary>
        /// Gets or sets the the OffsetVariable variable of job.
        /// 
        /// Use only for dynamic-link edit !!!
        /// 
        /// </summary>
        public UFUAModel.TagEntityReference OffsetVariableTag
        {
            get
            {
                Opc.Ua.NodeId nodeId;
                if (!NodeIdHelper.TryParse(_OffsetVariableId, out nodeId))
                    nodeId = Opc.Ua.NodeId.Null;
                return new UFUAModel.TagEntityReference(Guid.Empty, _OffsetVariableName, _OffsetVariableId);
            }
            set
            {
                if (value == null)
                {
                    _OffsetVariableName = null;
                    _OffsetVariableId = null;
                }
                else
                {
                    _OffsetVariableName = value.ToString();
                    _OffsetVariableId = value.NodeId.ToString();
                }
            }
        }
        ...
        private bool _StructAtomicEnable;
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>  Enables aggregation of structure members to be swapped together </summary>
        ///
        /// <value> The dynamic jobs. </value>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public bool StructAtomicEnable
        {
            get
            {
                return _StructAtomicEnable;
            }
            set
            {
                _StructAtomicEnable = value;
            }
        }
        ...
        protected virtual String PerformValidation(String propertyName)
        {
            ...
            if (!IsMethodSupported && IsMethod)
                return DriverCodeBaseEx.Properties.Resources.MethodNotSupported;
                ...
                case "TagLinkType":
                    {
                        ...
                        if (lt != LinkType.ExceptionOutput && lt != LinkType.Input &&
                           lt != LinkType.InputOutput && lt != LinkType.UnconditionalOutput)
                            return Properties.Resources.JobTypeInvalid;
                        if (OutputAtStartup && lt == LinkType.Input)
                            return (DriverCodeBaseEx.Properties.Resources.OutputAtStartupNotSupported);
                        if (VarType >= UFUAModel.DataType.Boolean)
                        {
                            if (ProtocolDataSizeValidation(VarType) == DriverCodeBaseEx.Properties.Resources.JobTypeInvalid)
                                return (DriverCodeBaseEx.Properties.Resources.JobTypeInvalid);
                        }
                    }
                    break;
