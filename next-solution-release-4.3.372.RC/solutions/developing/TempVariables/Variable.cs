...
{
    public class Variable : XPObject, IDataErrorInfo, INotifyPropertyVisibilityChanged
    {
        #region Ctor
        ...
        protected String PerformValidation(String propertyName, String prototypeName = null)
        {
            if (propertyName == "Name")
            {
                ...
                else if ((from tag in new XPQuery<TempVariablesManager.Variable>(Session, true)/*.AsParallel()*/
