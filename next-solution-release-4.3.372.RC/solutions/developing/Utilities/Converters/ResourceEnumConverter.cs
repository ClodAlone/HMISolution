...
namespace Utilities.Converters
{
    ...
    // https://www.codeproject.com/Articles/19953/Localizing-NET-Enums
    // /// <summary>
    ...
    {
        static IDictionary<String, String> _stringTable;
        public static IDictionary<String, String> StringTable
        {
            get
            {
                return _stringTable;
        ...
        private string GetValueText(CultureInfo culture, object value)
        {
            ...
            if (StringTable != null && StringTable.ContainsKey(resourceName))
                return StringTable[resourceName];
        ...
        public override object ConvertFrom(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            if (value is string)
            {
                object result = (_isFlagEnum) ?
                    GetFlagValue(System.Globalization.CultureInfo.CurrentUICulture, (string)value) : GetValue(System.Globalization.CultureInfo.CurrentUICulture, (string)value);
                if (result == null)
                {
                    result = base.ConvertFrom(context, System.Globalization.CultureInfo.CurrentUICulture, value);
                }
                return result;
            }
            else
        ...
        public override object ConvertTo(System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                object result = (_isFlagEnum) ?
                    GetFlagValueText(System.Globalization.CultureInfo.CurrentUICulture, value) : GetValueText(System.Globalization.CultureInfo.CurrentUICulture, value);
                return result;
            }
            else
            {
        ...
        //
        // Summary:
        //     Gets a collection of standard values for the data type this validator is designed
        //     for.
        //
        // Parameters:
        //   context:
        ...
        //     set of valid values, or null if the data type does not support a standard set
        //     of values.
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            {
                DisplayAttribute orderAttr = (DisplayAttribute)EnumType.GetField(n)
