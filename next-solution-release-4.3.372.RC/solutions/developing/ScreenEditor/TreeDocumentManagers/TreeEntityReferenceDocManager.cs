...
{
    class TreeEntityReferenceDocManager : IDocumentManager
    {
        #region Declarations
        readonly ScreenDocument screenDocument;
        readonly ScreenManagerComponent screenManagerComponent;
        readonly OPCUAEntityReference Reference;
        #endregion

        public TreeEntityReferenceDocManager(ScreenManagerComponent c, ScreenDocument doc, 
                                             OPCUAEntityReference r)
        {
        ...
        public void Edit(Uri uri, IDocument parent)
        {
            ...
            Dispatcher.CurrentDispatcher.BeginInvoke((Action)(() => Reference.Edit()), DispatcherPriority.ApplicationIdle);
        }
        ...
        {
            get { return ScreenManagerComponent.GetBitmapImage("SMReferencesSmall"); }
        }
        ...
        {
            get { return ScreenManagerComponent.GetBitmapImage("SMReferences"); }
        }
        ...
        public string TypeScheme
        {
            get 
            {
                return Properties.Resources.TreeEntityReference.Replace(" ", ""); 
            }
        }
