...
namespace ScreenManager
{
    ...
    public static class UIGeneralCommands
    {
        ...
        private static GeneralCommand _DynamicStringInspector = new GeneralCommand(
            Properties.UICommandResource.DynamicStringInspectorName,
            Properties.UICommandResource.DynamicStringInspectorText,
            Properties.UICommandResource.DynamicStringInspectorGestures,
            Properties.UICommandResource.DynamicStringInspectorGesturesDisplayText,
            Properties.UICommandResource.DynamicStringInspectorTooltip,
            Properties.UICommandResource.DynamicStringInspectorDescription,
            typeof(UIGeneralCommands));

        public static GeneralCommand DynamicStringInspector
        {
            get { return _DynamicStringInspector; }
        }
