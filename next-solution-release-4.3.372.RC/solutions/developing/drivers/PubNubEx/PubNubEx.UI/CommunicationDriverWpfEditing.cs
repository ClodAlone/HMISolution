...
namespace PubNub.UI
{
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditing3
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            bool result = DriverCodeBaseEx.CommunicationDriver.CopyFile<PubNubDriverSettings>(sourceconn, targetconn, drivername);
            result &= DriverCodeBaseEx.CommunicationDriver.CopyFile<PubNubChangeTag>(sourceconn, targetconn, drivername, DriverCodeBaseEx.Helpers.DriverInfo.GetChangeDynTagsExtension());
            return result;
        }
        ...
        {
            PubNub.PubNubDynTagSettings dynTag = new PubNub.PubNubDynTagSettings();
        ...
        {
            PubNubDynTagSettings dynTag = new PubNubDynTagSettings();
        ...
        {
            var genSet = generalSettings as PubNubDriverSettings;
            if (genSet == null)
                return null;

            if (channelEditor == null)
                channelEditor = new ChannelDetails();
            var ch = new PubNubChannelSettings(genSet.Session);
        ...
        public UserControl NewStationSettingsEditor(object generalSettings)
        {
            ...
            var st = new PubNubStationSettings(genSet.Session);
        ...
        public bool DisableDriver(string connectionString, bool bProtected, Guid protectionCode)
        {
            ...
            {
                string drivername = DriverCodeBaseEx.Helpers.DriverInfo.GetDriverName(this).Replace(".UI", "");
                configurationEditor.Init<PubNubDriverSettings>(connectionString, drivername, bProtected, protectionCode);
