...
namespace CoDeSys
{
    ...
    public class CoDeSysChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            DeviceName = ((CoDeSysChannelSettings)ch).DeviceName;
            DeviceAddress = ((CoDeSysChannelSettings)ch).DeviceAddress;
            PlcVersion = ((CoDeSysChannelSettings)ch).PlcVersion;
            PlcPort = ((CoDeSysChannelSettings)ch).PlcPort;
            CyclicListUdateRate = ((CoDeSysChannelSettings)ch).CyclicListUdateRate;
            Motorola = ((CoDeSysChannelSettings)ch).Motorola;
            BufferSize = ((CoDeSysChannelSettings)ch).BufferSize;
            //LogIn = ch.LogIn;
            Protocol = ((CoDeSysChannelSettings)ch).Protocol;
            UseDirectReading = ((CoDeSysChannelSettings)ch).UseDirectReading;
            MaxDynamicAggregation = ((CoDeSysChannelSettings)ch).MaxDynamicAggregation;
            ConnectionType = ((CoDeSysChannelSettings)ch).ConnectionType;
            UserPLC = ((CoDeSysChannelSettings)ch).UserPLC;
            PasswordPLC = ((CoDeSysChannelSettings)ch).PasswordPLC;
            PasswordGateWay = ((CoDeSysChannelSettings)ch).PasswordGateWay;
        }
        /////////////////////////////
        ...
        protected override void OnChanged(string propertyName, object oldValue, object newValue)
        {
            ...
            {
                case "DeviceName":
                    RaisePropertyChangedEvent("DeviceAddress");
                    break;
