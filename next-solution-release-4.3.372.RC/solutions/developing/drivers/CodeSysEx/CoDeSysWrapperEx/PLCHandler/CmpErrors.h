...
#define ERR_CLIENT_IN_RO_MODE  	0x004A /* Client is in readonly mode and has no rights for this service. */
#define ERR_LICENSE_EXCEEDED	0x004B /* License is not sufficient */
#define ERR_ASYNC_EXCEPTION		0x004C /* Exception occured during execution of async service task */
#define ERR_NO_SIGNATURE		0x004D /* Object contains no siganture */
#define ERR_PASSWORD_POLICY		0x004E /* Password does not fulfill the password policy requirements */
...
/* Device server errors
  (range: 0x0170 - 0x017F)
*/
#define ERR_DEVS_LOGINFAILED	0x0170 /* User login failed */
#define ERR_DEVS_SESSIONTIMEOUT	0x0171 /* Inactive session closed due to timeout */
#define ERR_DEVS_CHANNELCLOSED	0x0172 /* Channel has been closed */
...
#define ERR_BTAG_TAGDATASIZE			0x0408 /* Unexpected length of the tag data */
...
#define ERR_CERT_UNABLE_TO_GET_ISSUER_CRL				0x738
 ...
 * (range: 0x800 - 0x8FF)
 */
#define ERR_DMS_SERVICE_NOT_RUNNING						0x801		/* The corresponding device management service is not running and cannot be started! */
...
#define MONITORING_ERR_FAILED				   0x15  /* Generic monitoring error  										     */
