...
/* Defines for safe datatypes */
#define RTS_IEC_SAFEBOOL_C(x)	(RTS_IEC_BOOL_C(x))
#define RTS_IEC_SAFEBYTE_C(x)	(RTS_IEC_BYTE_C(x))
#define RTS_IEC_SAFESINT_C(x)	(RTS_IEC_SINT_C(x))
#define RTS_IEC_SAFEUSINT_C(x)	(RTS_IEC_USINT_C(x))
#define RTS_IEC_SAFEWORD_C(x)	(RTS_IEC_WORD_C(x))
#define RTS_IEC_SAFEINT_C(x)	(RTS_IEC_INT_C(x))
#define RTS_IEC_SAFEUINT_C(x)	(RTS_IEC_UINT_C(x))
#define RTS_IEC_SAFEDWORD_C(x)	(RTS_IEC_DWORD_C(x))
#define RTS_IEC_SAFEDINT_C(x)	(RTS_IEC_DINT_C(x))
#define RTS_IEC_SAFEUDINT_C(x)	(RTS_IEC_UDINT_C(x))
#define RTS_IEC_SAFELWORD_C(x)	(RTS_IEC_LWORD_C(x))
#define RTS_IEC_SAFELINT_C(x)	(RTS_IEC_LINT_C(x))
#define RTS_IEC_SAFEULINT_C(x)	(RTS_IEC_ULINT_C(x))
#define RTS_IEC_SAFEREAL_C(x)	(RTS_IEC_REAL_C(x))
#define RTS_IEC_SAFELREAL_C(x)	(RTS_IEC_LREAL_C(x))
