 ...
 * <category>Static defines</category>
 * <description>
 *	Specifies the maximum comm cycle interval [ms]. 
 * </description>
 */
#ifndef CM_COMM_CYCLE_INTERVAL_MAXIMUM
	#define CM_COMM_CYCLE_INTERVAL_MAXIMUM		10000
#endif
...
typedef void (CDECL CDECL_EXT* PFCMADDCOMPONENT_IEC) (cmaddcomponent_struct *p);
	...
	#define EXTREF_ITF_cmaddcomponent {(RTS_VOID_FCTPTR)cmaddcomponent, "cmaddcomponent", RTSITF_GET_SIGNATURE(0, 0x3FB931A6), 0x03051100}
...
typedef void (CDECL CDECL_EXT* PFCMADDCOMPONENT2_IEC) (cmaddcomponent2_struct *p);
	...
	#define EXTREF_ITF_cmaddcomponent2 {(RTS_VOID_FCTPTR)cmaddcomponent2, "cmaddcomponent2", 0x1057D488, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmaddcomponent2
	#define EXT_cmaddcomponent2
	#define GET_cmaddcomponent2(fl)  CAL_CMGETAPI( "cmaddcomponent2" ) 
...
typedef void (CDECL CDECL_EXT* PFCMEXITCOMPONENT_IEC) (cmexitcomponent_struct *p);
	...
	#define EXTREF_ITF_cmexitcomponent {(RTS_VOID_FCTPTR)cmexitcomponent, "cmexitcomponent", RTSITF_GET_SIGNATURE(0, 0x0DDC8E7F), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmexitcomponent
	#define EXT_cmexitcomponent
	#define GET_cmexitcomponent(fl)  CAL_CMGETAPI( "cmexitcomponent" ) 
...
typedef void (CDECL CDECL_EXT* PFCMGETCOMPONENTBYNAME_IEC) (cmgetcomponentbyname_struct *p);
	...
	#define EXTREF_ITF_cmgetcomponentbyname {(RTS_VOID_FCTPTR)cmgetcomponentbyname, "cmgetcomponentbyname", RTSITF_GET_SIGNATURE(0, 0x1C90B550), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmgetcomponentbyname
	#define EXT_cmgetcomponentbyname
	#define GET_cmgetcomponentbyname(fl)  CAL_CMGETAPI( "cmgetcomponentbyname" ) 
...
typedef void (CDECL CDECL_EXT* PFCMGETCOREVERSION_IEC) (cmgetcoreversion_struct *p);
	...
	#define EXTREF_ITF_cmgetcoreversion {(RTS_VOID_FCTPTR)cmgetcoreversion, "cmgetcoreversion", 0x83B57980, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmgetcoreversion
	#define EXT_cmgetcoreversion
	#define GET_cmgetcoreversion(fl)  CAL_CMGETAPI( "cmgetcoreversion" ) 
...
typedef void (CDECL CDECL_EXT* PFCMINITCOMPONENT_IEC) (cminitcomponent_struct *p);
	...
	#define EXTREF_ITF_cminitcomponent {(RTS_VOID_FCTPTR)cminitcomponent, "cminitcomponent", RTSITF_GET_SIGNATURE(0, 0xAD863340), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cminitcomponent
	#define EXT_cminitcomponent
	#define GET_cminitcomponent(fl)  CAL_CMGETAPI( "cminitcomponent" ) 
...
typedef void (CDECL CDECL_EXT* PFCMREGISTERGETUSERLICENSEVALUE_IEC) (cmregistergetuserlicensevalue_struct *p);
	...
	#define EXTREF_ITF_cmregistergetuserlicensevalue {(RTS_VOID_FCTPTR)cmregistergetuserlicensevalue, "cmregistergetuserlicensevalue", RTSITF_GET_SIGNATURE(0, 0x84364FC6), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmregistergetuserlicensevalue
	#define EXT_cmregistergetuserlicensevalue
	#define GET_cmregistergetuserlicensevalue(fl)  CAL_CMGETAPI( "cmregistergetuserlicensevalue" ) 
...
typedef void (CDECL CDECL_EXT* PFCMREGISTERLICENSEFUNCTIONS_IEC) (cmregisterlicensefunctions_struct *p);
	...
	#define EXTREF_ITF_cmregisterlicensefunctions {(RTS_VOID_FCTPTR)cmregisterlicensefunctions, "cmregisterlicensefunctions", RTSITF_GET_SIGNATURE(0, 0xC18CCC88), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmregisterlicensefunctions
	#define EXT_cmregisterlicensefunctions
	#define GET_cmregisterlicensefunctions(fl)  CAL_CMGETAPI( "cmregisterlicensefunctions" ) 
...
typedef void (CDECL CDECL_EXT* PFCMREMOVECOMPONENT_IEC) (cmremovecomponent_struct *p);
	...
	#define EXTREF_ITF_cmremovecomponent {(RTS_VOID_FCTPTR)cmremovecomponent, "cmremovecomponent", RTSITF_GET_SIGNATURE(0, 0xB53B03F4), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmremovecomponent
	#define EXT_cmremovecomponent
	#define GET_cmremovecomponent(fl)  CAL_CMGETAPI( "cmremovecomponent" ) 
...
typedef void (CDECL CDECL_EXT* PFCMSHUTDOWN_IEC) (cmshutdown_struct *p);
	...
	#define EXTREF_ITF_cmshutdown {(RTS_VOID_FCTPTR)cmshutdown, "cmshutdown", RTSITF_GET_SIGNATURE(0, 0x28C83A52), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmshutdown
	#define EXT_cmshutdown
	#define GET_cmshutdown(fl)  CAL_CMGETAPI( "cmshutdown" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUNREGISTERGETUSERLICENSEVALUE_IEC) (cmunregistergetuserlicensevalue_struct *p);
	...
	#define EXTREF_ITF_cmunregistergetuserlicensevalue {(RTS_VOID_FCTPTR)cmunregistergetuserlicensevalue, "cmunregistergetuserlicensevalue", RTSITF_GET_SIGNATURE(0, 0xE400F55F), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmunregistergetuserlicensevalue
	#define EXT_cmunregistergetuserlicensevalue
	#define GET_cmunregistergetuserlicensevalue(fl)  CAL_CMGETAPI( "cmunregistergetuserlicensevalue" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUNREGISTERLICENSEFUNCTIONS_IEC) (cmunregisterlicensefunctions_struct *p);
	...
	#define EXTREF_ITF_cmunregisterlicensefunctions {(RTS_VOID_FCTPTR)cmunregisterlicensefunctions, "cmunregisterlicensefunctions", RTSITF_GET_SIGNATURE(0, 0x7144A275), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmunregisterlicensefunctions
	#define EXT_cmunregisterlicensefunctions
	#define GET_cmunregisterlicensefunctions(fl)  CAL_CMGETAPI( "cmunregisterlicensefunctions" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUTLCWSTRCPY_IEC) (cmutlcwstrcpy_struct *p);
	...
	#define EXTREF_ITF_cmutlcwstrcpy {(RTS_VOID_FCTPTR)cmutlcwstrcpy, "cmutlcwstrcpy", RTSITF_GET_SIGNATURE(0x09DB4923, 0xCCB6DDB5), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmutlcwstrcpy
	#define EXT_cmutlcwstrcpy
	#define GET_cmutlcwstrcpy(fl)  CAL_CMGETAPI( "cmutlcwstrcpy" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUTLSAFESTRCPY_IEC) (cmutlsafestrcpy_struct *p);
	...
	#define EXTREF_ITF_cmutlsafestrcpy {(RTS_VOID_FCTPTR)cmutlsafestrcpy, "cmutlsafestrcpy", RTSITF_GET_SIGNATURE(0, 0x794C4461), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmutlsafestrcpy
	#define EXT_cmutlsafestrcpy
	#define GET_cmutlsafestrcpy(fl)  CAL_CMGETAPI( "cmutlsafestrcpy" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUTLSTRICMP_IEC) (cmutlstricmp_struct *p);
	...
	#define EXTREF_ITF_cmutlstricmp {(RTS_VOID_FCTPTR)cmutlstricmp, "cmutlstricmp", RTSITF_GET_SIGNATURE(0, 0xF3161529), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmutlstricmp
	#define EXT_cmutlstricmp
	#define GET_cmutlstricmp(fl)  CAL_CMGETAPI( "cmutlstricmp" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUTLUTF8TOW_IEC) (cmutlutf8tow_struct *p);
	...
	#define EXTREF_ITF_cmutlutf8tow {(RTS_VOID_FCTPTR)cmutlutf8tow, "cmutlutf8tow", RTSITF_GET_SIGNATURE(0xB78A45E0, 0x76EB6470), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmutlutf8tow
	#define EXT_cmutlutf8tow
	#define GET_cmutlutf8tow(fl)  CAL_CMGETAPI( "cmutlutf8tow" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUTLWSTRCPY_IEC) (cmutlwstrcpy_struct *p);
	...
	#define EXTREF_ITF_cmutlwstrcpy {(RTS_VOID_FCTPTR)cmutlwstrcpy, "cmutlwstrcpy", RTSITF_GET_SIGNATURE(0, 0x92BF32B1), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmutlwstrcpy
	#define EXT_cmutlwstrcpy
	#define GET_cmutlwstrcpy(fl)  CAL_CMGETAPI( "cmutlwstrcpy" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUTLWTOUTF8_IEC) (cmutlwtoutf8_struct *p);
	...
	#define EXTREF_ITF_cmutlwtoutf8 {(RTS_VOID_FCTPTR)cmutlwtoutf8, "cmutlwtoutf8", RTSITF_GET_SIGNATURE(0xAE6E95C8, 0x61F1F05D), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmutlwtoutf8
	#define EXT_cmutlwtoutf8
	#define GET_cmutlwtoutf8(fl)  CAL_CMGETAPI( "cmutlwtoutf8" ) 
...
typedef void (CDECL CDECL_EXT* PFCMLOADCOMPONENT_IEC) (cmloadcomponent_struct *p);
	...
	#define EXTREF_ITF_cmloadcomponent {(RTS_VOID_FCTPTR)cmloadcomponent, "cmloadcomponent", 0, 0}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmloadcomponent
	#define EXT_cmloadcomponent
	#define GET_cmloadcomponent(fl)  CAL_CMGETAPI( "cmloadcomponent" ) 
...
typedef void (CDECL CDECL_EXT* PFCMUNLOADCOMPONENT_IEC) (cmunloadcomponent_struct *p);
	...
	#define EXTREF_ITF_cmunloadcomponent {(RTS_VOID_FCTPTR)cmunloadcomponent, "cmunloadcomponent", 0, 0}
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_cmunloadcomponent
	#define EXT_cmunloadcomponent
	#define GET_cmunloadcomponent(fl)  CAL_CMGETAPI( "cmunloadcomponent" ) 
...
/**
 * <description> 
 *   Checks if any of the following runtime licenses is available:
 *   - Product specific licenses
 *   - General performance licenses
 * </description>
 * <param name="bCheckProductSpecific" type="IN">TRUE: all product specific licenses are checked. 
 *   If no local license (dongle, softcontainer) can be found, also network licenses are checked.</param>
 * <param name="bCheckGeneral" type="IN">TRUE: all general performance licenses are checked</param>
 * <result>Error code</result>
 * <errorcode name="RTS_RESULT" type="ERR_OK">At least one license is available.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_FAILED">No requested license is available.</errorcode>
 */
RTS_RESULT CDECL CMRuntimeLicenseIsAvailable(RTS_BOOL bCheckProductSpecific, RTS_BOOL bCheckGeneral);
typedef RTS_RESULT (CDECL * PFCMRUNTIMELICENSEISAVAILABLE) (RTS_BOOL bCheckProductSpecific, RTS_BOOL bCheckGeneral);
#if defined(CM_NOTIMPLEMENTED) || defined(CMRUNTIMELICENSEISAVAILABLE_NOTIMPLEMENTED)
	#define USE_CMRuntimeLicenseIsAvailable
	#define EXT_CMRuntimeLicenseIsAvailable
	#define GET_CMRuntimeLicenseIsAvailable(fl)  ERR_NOTIMPLEMENTED
	#define CAL_CMRuntimeLicenseIsAvailable(p0,p1)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_CMRuntimeLicenseIsAvailable  FALSE
	#define EXP_CMRuntimeLicenseIsAvailable  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_CMRuntimeLicenseIsAvailable
	#define EXT_CMRuntimeLicenseIsAvailable
	#define GET_CMRuntimeLicenseIsAvailable(fl)  CAL_CMGETAPI( "CMRuntimeLicenseIsAvailable" ) 
	#define CAL_CMRuntimeLicenseIsAvailable  CMRuntimeLicenseIsAvailable
	#define CHK_CMRuntimeLicenseIsAvailable  TRUE
	#define EXP_CMRuntimeLicenseIsAvailable  CAL_CMEXPAPI( "CMRuntimeLicenseIsAvailable" ) 
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_CMRuntimeLicenseIsAvailable
	#define EXT_CMRuntimeLicenseIsAvailable
	#define GET_CMRuntimeLicenseIsAvailable(fl)  CAL_CMGETAPI( "CMRuntimeLicenseIsAvailable" ) 
	#define CAL_CMRuntimeLicenseIsAvailable  CMRuntimeLicenseIsAvailable
	#define CHK_CMRuntimeLicenseIsAvailable  TRUE
	#define EXP_CMRuntimeLicenseIsAvailable  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"CMRuntimeLicenseIsAvailable", (RTS_UINTPTR)CMRuntimeLicenseIsAvailable, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CMCMRuntimeLicenseIsAvailable
	#define EXT_CMCMRuntimeLicenseIsAvailable
	#define GET_CMCMRuntimeLicenseIsAvailable  ERR_OK
	#define CAL_CMCMRuntimeLicenseIsAvailable pICM->ICMRuntimeLicenseIsAvailable
	#define CHK_CMCMRuntimeLicenseIsAvailable (pICM != NULL)
	#define EXP_CMCMRuntimeLicenseIsAvailable  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_CMRuntimeLicenseIsAvailable
	#define EXT_CMRuntimeLicenseIsAvailable
	#define GET_CMRuntimeLicenseIsAvailable(fl)  CAL_CMGETAPI( "CMRuntimeLicenseIsAvailable" ) 
	#define CAL_CMRuntimeLicenseIsAvailable pICM->ICMRuntimeLicenseIsAvailable
	#define CHK_CMRuntimeLicenseIsAvailable (pICM != NULL)
	#define EXP_CMRuntimeLicenseIsAvailable  CAL_CMEXPAPI( "CMRuntimeLicenseIsAvailable" ) 
#else /* DYNAMIC_LINK */
	#define USE_CMRuntimeLicenseIsAvailable  PFCMRUNTIMELICENSEISAVAILABLE pfCMRuntimeLicenseIsAvailable;
	#define EXT_CMRuntimeLicenseIsAvailable  extern PFCMRUNTIMELICENSEISAVAILABLE pfCMRuntimeLicenseIsAvailable;
	#define GET_CMRuntimeLicenseIsAvailable(fl)  s_pfCMGetAPI2( "CMRuntimeLicenseIsAvailable", (RTS_VOID_FCTPTR *)&pfCMRuntimeLicenseIsAvailable, (fl), 0, 0)
	#define CAL_CMRuntimeLicenseIsAvailable  pfCMRuntimeLicenseIsAvailable
	#define CHK_CMRuntimeLicenseIsAvailable  (pfCMRuntimeLicenseIsAvailable != NULL)
	#define EXP_CMRuntimeLicenseIsAvailable  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"CMRuntimeLicenseIsAvailable", (RTS_UINTPTR)CMRuntimeLicenseIsAvailable, 0, 0) 
#endif
...
/**
 * <description> 
 *   Retrieves the feature map for a given license ID if license is available.
 * </description>
 * <param name="ulLicenseID" type="IN">License ID</param>
 * <param name="pResult" type="OUT">Pointer to error code</param>
 * <result>Feature map</result>
 * <errorcode name="RTS_RESULT pResult" type="ERR_OK">Feature map successfully retrieved</errorcode>
 * <errorcode name="RTS_RESULT pResult" type="ERR_FAILED">License not available</errorcode>
 */
RTS_UI32 CDECL CMRuntimeLicenseGetFeaturemap(RTS_UI32 ulLicenseID, RTS_RESULT *pResult);
typedef RTS_UI32 (CDECL * PFCMRUNTIMELICENSEGETFEATUREMAP) (RTS_UI32 ulLicenseID, RTS_RESULT *pResult);
#if defined(CM_NOTIMPLEMENTED) || defined(CMRUNTIMELICENSEGETFEATUREMAP_NOTIMPLEMENTED)
	#define USE_CMRuntimeLicenseGetFeaturemap
	#define EXT_CMRuntimeLicenseGetFeaturemap
	#define GET_CMRuntimeLicenseGetFeaturemap(fl)  ERR_NOTIMPLEMENTED
	#define CAL_CMRuntimeLicenseGetFeaturemap(p0,p1)  (RTS_UI32)ERR_NOTIMPLEMENTED
	#define CHK_CMRuntimeLicenseGetFeaturemap  FALSE
	#define EXP_CMRuntimeLicenseGetFeaturemap  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_CMRuntimeLicenseGetFeaturemap
	#define EXT_CMRuntimeLicenseGetFeaturemap
	#define GET_CMRuntimeLicenseGetFeaturemap(fl)  CAL_CMGETAPI( "CMRuntimeLicenseGetFeaturemap" ) 
	#define CAL_CMRuntimeLicenseGetFeaturemap  CMRuntimeLicenseGetFeaturemap
	#define CHK_CMRuntimeLicenseGetFeaturemap  TRUE
	#define EXP_CMRuntimeLicenseGetFeaturemap  CAL_CMEXPAPI( "CMRuntimeLicenseGetFeaturemap" ) 
#elif defined(MIXED_LINK) && !defined(CM_EXTERNAL)
	#define USE_CMRuntimeLicenseGetFeaturemap
	#define EXT_CMRuntimeLicenseGetFeaturemap
	#define GET_CMRuntimeLicenseGetFeaturemap(fl)  CAL_CMGETAPI( "CMRuntimeLicenseGetFeaturemap" ) 
	#define CAL_CMRuntimeLicenseGetFeaturemap  CMRuntimeLicenseGetFeaturemap
	#define CHK_CMRuntimeLicenseGetFeaturemap  TRUE
	#define EXP_CMRuntimeLicenseGetFeaturemap  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"CMRuntimeLicenseGetFeaturemap", (RTS_UINTPTR)CMRuntimeLicenseGetFeaturemap, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CMCMRuntimeLicenseGetFeaturemap
	#define EXT_CMCMRuntimeLicenseGetFeaturemap
	#define GET_CMCMRuntimeLicenseGetFeaturemap  ERR_OK
	#define CAL_CMCMRuntimeLicenseGetFeaturemap pICM->ICMRuntimeLicenseGetFeaturemap
	#define CHK_CMCMRuntimeLicenseGetFeaturemap (pICM != NULL)
	#define EXP_CMCMRuntimeLicenseGetFeaturemap  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_CMRuntimeLicenseGetFeaturemap
	#define EXT_CMRuntimeLicenseGetFeaturemap
	#define GET_CMRuntimeLicenseGetFeaturemap(fl)  CAL_CMGETAPI( "CMRuntimeLicenseGetFeaturemap" ) 
	#define CAL_CMRuntimeLicenseGetFeaturemap pICM->ICMRuntimeLicenseGetFeaturemap
	#define CHK_CMRuntimeLicenseGetFeaturemap (pICM != NULL)
	#define EXP_CMRuntimeLicenseGetFeaturemap  CAL_CMEXPAPI( "CMRuntimeLicenseGetFeaturemap" ) 
#else /* DYNAMIC_LINK */
	#define USE_CMRuntimeLicenseGetFeaturemap  PFCMRUNTIMELICENSEGETFEATUREMAP pfCMRuntimeLicenseGetFeaturemap;
	#define EXT_CMRuntimeLicenseGetFeaturemap  extern PFCMRUNTIMELICENSEGETFEATUREMAP pfCMRuntimeLicenseGetFeaturemap;
	#define GET_CMRuntimeLicenseGetFeaturemap(fl)  s_pfCMGetAPI2( "CMRuntimeLicenseGetFeaturemap", (RTS_VOID_FCTPTR *)&pfCMRuntimeLicenseGetFeaturemap, (fl), 0, 0)
	#define CAL_CMRuntimeLicenseGetFeaturemap  pfCMRuntimeLicenseGetFeaturemap
	#define CHK_CMRuntimeLicenseGetFeaturemap  (pfCMRuntimeLicenseGetFeaturemap != NULL)
	#define EXP_CMRuntimeLicenseGetFeaturemap  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"CMRuntimeLicenseGetFeaturemap", (RTS_UINTPTR)CMRuntimeLicenseGetFeaturemap, 0, 0) 
#endif
...
typedef struct
{
	...
	PFCMINIT ICMInit;
 	...
 	PFCMRUNTIMELICENSEISAVAILABLE ICMRuntimeLicenseIsAvailable;
 	PFCMRUNTIMELICENSEGETFEATUREMAP ICMRuntimeLicenseGetFeaturemap;
 } ICM_C;
...
class ICM : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL ICMRuntimeLicenseIsAvailable(RTS_BOOL bCheckProductSpecific, RTS_BOOL bCheckGeneral) =0;
		virtual RTS_UI32 CDECL ICMRuntimeLicenseGetFeaturemap(RTS_UI32 ulLicenseID, RTS_RESULT *pResult) =0;
};
	#ifndef ITF_CM
