...
/**
 * <category>Static defines</category>
 * <description>Object for the rights management to restrict access to settings</description>
 */
#define USERDB_OBJECT_SETTINGS		                        "Device.Settings"

/**
 * <category>Static defines</category>
 * <description>Object for the rights management to restrict access to security settings</description>
 */
#define USERDB_OBJECT_SECURITYSETTINGS		                "Device.Settings.SecuritySettings"
 ...
 *	<request>
 *		<complextag id="TAGNEST_SETTINGS" name="Setting" cardinality="1..n" description="Tag containting on setting to write">
 *			<tag id="TAG_SETTG_CATEGORY" name="Setting Category" cardinality="0..1" type="RTS_CSTRING::UTF-8" description="The category of the setting"/>
 *			<complextag id="TAGNEST_SETTING_INFO" name="Setting info" cardinality="1" description="Information to identify the setting">
 *				<tag id="TAG_SETTG_COMPONENT" name="Section" cardinality="1" type="RTS_CSTRING::UTF-8" description="The section name within the CODESYSControl.cfg" />
 *				<tag id="TAG_SETTG_KEY" name="Key" cardinality="1" type="RTS_CSTRING::UTF-8" description="The key of the setting within the section" />
 *			</complextag>
 *			<complextag id="TAGNEST_SETTG_SETTING_SELECTABLE" name="Selectable Value" cardinality="0..1" alternate="true" description="Value to set if the setting acts like a enumration. Only sent selectable settings.">
 *				<tag id="TAG_SETTG_SELECTED" name="" cardinality="1" type="RTS_CSTRING::UTF-8" description="The value to set the setting to."/>
 *			</complextag>
 *			<complextag id="TAGNEST_SETTG_SETTING_EDITABLE" name="Editable value" cardinality="0..1" alternate="true" 
 *			 description="Value to set if the setting can contain any value. Only sent editable settings. The datatype depends on the datatype of the setting. This can be retrieved by the flags of the editable setting. ">
 *				<tag id="TAG_SETTG_SETTING_VALUE_INT" name="Number VAlue" cardinality="0..1" type="RTS_I32" alternate="true"description="The integer value to set."/>
 *				<tag id="TAG_SETTG_SETTING_VALUE_STRING" name="String Value" cardinality="0..1" type="RTS_CSTRING::UTF-8" alternate="true" description="The string to set."/>
 *			</complextag>
 *		</complextag>
 *	</request>
 *	<response>
 *		<tag id="TAG_SETTG_RESULT" name="" cardinality="1..n" type="RTS_I16" description="Result code of each write operation"/>
 *	</response>
 * </service>
 */
...
typedef void (CDECL CDECL_EXT* PFSETTGBEGINUPDATE_IEC) (settgbeginupdate_struct *p);
	...
	#define EXTREF_ITF_settgbeginupdate {(RTS_VOID_FCTPTR)settgbeginupdate, "settgbeginupdate", 0x8767D13E, 0x03051100}
...
typedef void (CDECL CDECL_EXT* PFSETTGENDUPDATE_IEC) (settgendupdate_struct *p);
	...
	#define EXTREF_ITF_settgendupdate {(RTS_VOID_FCTPTR)settgendupdate, "settgendupdate", 0x460858D3, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settgendupdate
	#define EXT_settgendupdate
	#define GET_settgendupdate(fl)  CAL_CMGETAPI( "settgendupdate" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGGETINTVALUE_IEC) (settggetintvalue_struct *p);
	...
	#define EXTREF_ITF_settggetintvalue {(RTS_VOID_FCTPTR)settggetintvalue, "settggetintvalue", RTSITF_GET_SIGNATURE(0, 0x0065176D), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settggetintvalue
	#define EXT_settggetintvalue
	#define GET_settggetintvalue(fl)  CAL_CMGETAPI( "settggetintvalue" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGGETSTRINGVALUE_IEC) (settggetstringvalue_struct *p);
	...
	#define EXTREF_ITF_settggetstringvalue {(RTS_VOID_FCTPTR)settggetstringvalue, "settggetstringvalue", RTSITF_GET_SIGNATURE(0, 0x366FF6F7), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settggetstringvalue
	#define EXT_settggetstringvalue
	#define GET_settggetstringvalue(fl)  CAL_CMGETAPI( "settggetstringvalue" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGGETWSTRINGVALUE_IEC) (settggetwstringvalue_struct *p);
	...
	#define EXTREF_ITF_settggetwstringvalue {(RTS_VOID_FCTPTR)settggetwstringvalue, "settggetwstringvalue", RTSITF_GET_SIGNATURE(0, 0x17E6DC47), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settggetwstringvalue
	#define EXT_settggetwstringvalue
	#define GET_settggetwstringvalue(fl)  CAL_CMGETAPI( "settggetwstringvalue" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGREMOVEKEY_IEC) (settgremovekey_struct *p);
	...
	#define EXTREF_ITF_settgremovekey {(RTS_VOID_FCTPTR)settgremovekey, "settgremovekey", RTSITF_GET_SIGNATURE(0, 0xBA5C250F), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settgremovekey
	#define EXT_settgremovekey
	#define GET_settgremovekey(fl)  CAL_CMGETAPI( "settgremovekey" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGSETINTVALUE_IEC) (settgsetintvalue_struct *p);
	...
	#define EXTREF_ITF_settgsetintvalue {(RTS_VOID_FCTPTR)settgsetintvalue, "settgsetintvalue", RTSITF_GET_SIGNATURE(0, 0xBC5E022C), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settgsetintvalue
	#define EXT_settgsetintvalue
	#define GET_settgsetintvalue(fl)  CAL_CMGETAPI( "settgsetintvalue" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGSETSTRINGVALUE_IEC) (settgsetstringvalue_struct *p);
	...
	#define EXTREF_ITF_settgsetstringvalue {(RTS_VOID_FCTPTR)settgsetstringvalue, "settgsetstringvalue", RTSITF_GET_SIGNATURE(0, 0x63FA6ABA), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settgsetstringvalue
	#define EXT_settgsetstringvalue
	#define GET_settgsetstringvalue(fl)  CAL_CMGETAPI( "settgsetstringvalue" ) 
...
typedef void (CDECL CDECL_EXT* PFSETTGSETWSTRINGVALUE_IEC) (settgsetwstringvalue_struct *p);
	...
	#define EXTREF_ITF_settgsetwstringvalue {(RTS_VOID_FCTPTR)settgsetwstringvalue, "settgsetwstringvalue", RTSITF_GET_SIGNATURE(0, 0x61870FE4), 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSETTINGS_EXTERNAL)
	#define USE_settgsetwstringvalue
	#define EXT_settgsetwstringvalue
	#define GET_settgsetwstringvalue(fl)  CAL_CMGETAPI( "settgsetwstringvalue" ) 
 ...
 * <param name="bCached" type="IN">Flag, if value should be read cached or direct from file (CMPSETTINGS_CACHED, CMPSETTINGS_NOT_CACHED)</param>
 * <result>error code</result>
 * <errorcode name="RTS_RESULT" type="ERR_OK">WSTRING setting successfully read.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_PARAMETER">Invalid parameter given</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BUFFERSIZE">Buffer size is not sufficient to carry out the complete setting or default value; only a part is returned.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_FAILED">Key not found</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_FAILED">Invalid character in WSTRING value.</errorcode>
 */
RTS_RESULT CDECL SettgGetWStringValue(const char *pszComponent, const char *pszKey, RTS_WCHAR *pwszValue, RTS_I32 *piLen, const RTS_WCHAR *pwszDefault, int bCached);
typedef RTS_RESULT (CDECL * PFSETTGGETWSTRINGVALUE) (const char *pszComponent, const char *pszKey, RTS_WCHAR *pwszValue, RTS_I32 *piLen, const RTS_WCHAR *pwszDefault, int bCached);
#if defined(CMPSETTINGS_NOTIMPLEMENTED) || defined(SETTGGETWSTRINGVALUE_NOTIMPLEMENTED)
	#define USE_SettgGetWStringValue
	#define EXT_SettgGetWStringValue
	#define GET_SettgGetWStringValue(fl)  ERR_NOTIMPLEMENTED
 ...
 * <result>error code</result>
 * <errorcode name="RTS_RESULT" type="ERR_OK">WSTRING setting successfully written.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_NOTINITIALIZED">Internal IniPool of CmpSettings has not been initialized.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_NOMEMORY">Not enough dynamic memory available.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_FAILED">Internal error at conversion of WString to char array.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_INVALID_ENCODING">Invalid UFT-16 character in pwszValue.</errorcode>
 * <errorcode name="RTS_RESULT" type="[UNDOCUMENTED]">Return value of internal function SettgBeSetStringValue().</errorcode>
 */
RTS_RESULT CDECL SettgSetWStringValue(const char *pszComponent, const char *pszKey, const RTS_WCHAR *pwszValue, RTS_I32 iLen);
typedef RTS_RESULT (CDECL * PFSETTGSETWSTRINGVALUE) (const char *pszComponent, const char *pszKey, const RTS_WCHAR *pwszValue, RTS_I32 iLen);
#if defined(CMPSETTINGS_NOTIMPLEMENTED) || defined(SETTGSETWSTRINGVALUE_NOTIMPLEMENTED)
	#define USE_SettgSetWStringValue
	#define EXT_SettgSetWStringValue
	#define GET_SettgSetWStringValue(fl)  ERR_NOTIMPLEMENTED
...
class ICmpSettings : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL ISettgGetWStringValue(const char *pszComponent, const char *pszKey, RTS_WCHAR *pwszValue, RTS_I32 *piLen, const RTS_WCHAR *pwszDefault, int bCached) =0;
		virtual RTS_RESULT CDECL ISettgSetWStringValue(const char *pszComponent, const char *pszKey, const RTS_WCHAR *pwszValue, RTS_I32 iLen) =0;
