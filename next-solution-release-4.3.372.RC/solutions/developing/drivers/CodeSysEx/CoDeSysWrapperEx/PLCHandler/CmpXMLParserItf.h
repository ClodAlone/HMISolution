...
typedef void (CDECL CDECL_EXT* PFCREATEXMLPARSER2_IEC) (createxmlparser2_struct *p);
	...
	#define EXTREF_ITF_createxmlparser2 {(RTS_VOID_FCTPTR)createxmlparser2, "createxmlparser2", 0xAC05CC34, 0x03051100}
...
typedef void (CDECL CDECL_EXT* PFFREEXMLPARSER_IEC) (freexmlparser_struct *p);
	...
	#define EXTREF_ITF_freexmlparser {(RTS_VOID_FCTPTR)freexmlparser, "freexmlparser", 0xF9BB08C3, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPXMLPARSER_EXTERNAL)
	#define USE_freexmlparser
	#define EXT_freexmlparser
	#define GET_freexmlparser(fl)  CAL_CMGETAPI( "freexmlparser" ) 
...
typedef void (CDECL CDECL_EXT* PFPARSEXML2_IEC) (parsexml2_struct *p);
	...
	#define EXTREF_ITF_parsexml2 {(RTS_VOID_FCTPTR)parsexml2, "parsexml2", 0xC0F3799A, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPXMLPARSER_EXTERNAL)
	#define USE_parsexml2
	#define EXT_parsexml2
	#define GET_parsexml2(fl)  CAL_CMGETAPI( "parsexml2" ) 
 ...
 */
typedef void (CDECL *PF_XML_StartElementHandler)(void *pUserData, RTS_CWCHAR *pcwName, RTS_CWCHAR **ppAttributes);
 ...
 * <param name="pcwName" type="IN">Pointer to name of the tag</param>
 */
typedef void (CDECL *PF_XML_EndElementHandler)(void *pUserData, RTS_CWCHAR *pcwName);
 ...
 */
typedef void (CDECL *PF_XML_CharacterDataHandler)(void *pUserData, RTS_CWCHAR *pcwValue, int nValueLen);
