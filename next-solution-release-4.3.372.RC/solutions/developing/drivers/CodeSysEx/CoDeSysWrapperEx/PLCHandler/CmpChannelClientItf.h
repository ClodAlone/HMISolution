...
/**
 * <description>Function to unregister a handler interface</description>
 * <param name="wChannelHandle" type="IN">Channel handle that was retrieved by NetClientOpenChannel</param>
 * <param name="pIChannelClientApp" type="IN">Interface pointer</param>
 * <result>error code</result>
 */
...
/* -- Functions exported to the CmpChannelMgr only -- */

/* <description>
 *   Get the buffer for the specified channel id. Called by the CmpChannelMgr. 
 *
 *   NOTE:
 ...
 *   The CmpChannelMgr must use appropriate semaphores to ensure exclusive access.
 * </description>
...
/**
 * <description>
 *   Release a channel buffer returned by NetServerGetChannel. Called by the CmpChannelMgr.
 *   This buffer may not be used after calling this function. Use NetServerGetChannel to 
 *   acquire access to this channel again.
 * </description>
 *
...
/**
 * <description>
 *   Called by the CmpChannelMgr each time a meta-response arrives. 
 * </description>
...
/**
 * <description>
 *   Calls the pfChannelHandler once for each active server channel. Called by the CmpChannelMgr. 
 * </description>
...
/**
 * <description>
 *   Called by the CmpChannelMgr whenever a complete L7 message arrived on a client channel 
 * </description>
...
/**
 * <description>
 *   Called by the CmpChannelMgr when a unrecoverable error occurs for pChBuffer.
