...
namespace HilscherCifXmultiProtocol
{
    ...
    class HilscherCifXmultiProtocolChannel : Channel
    {
        ...
        {
            if (hJob.Type == LinkType.Input ||
               (hJob.Type == LinkType.InputOutput && hJob.GetTagListOnWritingCount() == 0))
            {
                ReadData(hJob);
            }
            else
        ...
        protected void ReadData(HilscherCifXmultiProtocolCommJob hJob)
        {
            ...
            if (hJob.Type == LinkType.InputOutput)
            {
        ...
        protected void WriteData(HilscherCifXmultiProtocolCommJob hJob)
        {
            ...
            listToWrite.AddRange(hJob.GetTagListOnWriting());
            ...
            hJob.UpdateTagsListOnWritingAndTagsListToWrite(listOnWriting);
            listToWrite.Clear();
