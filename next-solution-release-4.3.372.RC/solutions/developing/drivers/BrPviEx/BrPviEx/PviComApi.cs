...
namespace BrPvi
{
    ...
    class PviComApi
    {
        ...
        [DllImport("PviCom64.dll", CallingConvention = CallingConvention.Winapi, EntryPoint = "PviXDeleteRequest")]
        public static extern unsafe int _PviXDeleteRequest64Bit(uint hPVI, string pObjectName, void* hResMsg, uint ResMsgNo, IntPtr ResParam);
        [DllImport("PviCom.dll", CallingConvention = CallingConvention.Winapi, EntryPoint = "PviXDeleteRequest")]
        public static extern unsafe int _PviXDeleteRequest32Bit(uint hPVI, string pObjectName, void* hResMsg, uint ResMsgNo, IntPtr ResParam);       
        #endregion
    }
}
