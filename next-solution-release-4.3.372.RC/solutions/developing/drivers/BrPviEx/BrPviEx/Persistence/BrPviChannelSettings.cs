...
namespace BrPvi
{
    ...
    public class BrPviChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            BrPviServerAddress = ((BrPviChannelSettings)ch).BrPviServerAddress;
            BrPviServerPort = ((BrPviChannelSettings)ch).BrPviServerPort;
            BrPviServerCommunicationTimeout = ((BrPviChannelSettings)ch).BrPviServerCommunicationTimeout;
            BrPviRetryTime = ((BrPviChannelSettings)ch).BrPviRetryTime;
            //BrPviMaxNumberOfAggregatedRequests = ch.BrPviMaxNumberOfAggregatedRequests;
            BrPviVersion = ((BrPviChannelSettings)ch).BrPviVersion;
            BrPviMaxNumberSubscriptions = ((BrPviChannelSettings)ch).BrPviMaxNumberSubscriptions;
        }
