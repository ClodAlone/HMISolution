...
namespace BrPvi
{
    ...
    public class BrPviStationSettings : StationSettings
    {
            ...
            : base(session)
        {
            ...
            session.UpdateSchema(typeof(BrPviStationSettings));
        }
        ...
        public override void CopyProperties(StationSettings st)
        {
            ...
            _BrPviRoutingPath = ((BrPviStationSettings)st).BrPviRoutingPath;
            _BrPviResponseTimeout = ((BrPviStationSettings)st).BrPviResponseTimeout;
            _BrPviInterfaceType = ((BrPviStationSettings)st)._BrPviInterfaceType;
            _BrPviSourceStationPort = ((BrPviStationSettings)st).BrPviSourceStationPort;
            _BrPviSourceStationID = ((BrPviStationSettings)st).BrPviSourceStationID;
            _BrPviDestinationStationIPAddress = ((BrPviStationSettings)st).BrPviDestinationStationIPAddress;
            _BrPviDestinationStationPort = ((BrPviStationSettings)st)._BrPviDestinationStationPort;
            _BrPviDestinationStationID = ((BrPviStationSettings)st).BrPviDestinationStationID;
            _BrPviSerialPort = ((BrPviStationSettings)st).BrPviSerialPort;
            _BrPviSerialBaudrate = ((BrPviStationSettings)st).BrPviSerialBaudrate;
            _BrPviSerialParity = ((BrPviStationSettings)st).BrPviSerialParity;
            _BrPviSerialFlowControl = ((BrPviStationSettings)st).BrPviSerialFlowControl;
            _BrPviRemoveDisabledItemAfterSecs = ((BrPviStationSettings)st).BrPviRemoveDisabledItemAfterSecs;
        }
        ...
        public void DefaultSettings()
        {
            ...
            _BrPviInterfaceType = BrPviProcol.InterfaceTypes.Ethernet;
        ...
        public uint BrPviRemoveDisabledItemAfterSecs
        {
            get
            {
                return _BrPviRemoveDisabledItemAfterSecs;
            }
            set
            {
                SetPropertyValue("BrPviRemoveDisabledItemAfterSecs", ref _BrPviRemoveDisabledItemAfterSecs, value);
            }
        }
        #endregion
