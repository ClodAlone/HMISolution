...
namespace MQTTClient
{
    ...
    public class MQTTClientProtocol
    {
        ...
        public static bool ParseData(string receivedValue, ref MQTTClientCommJob job, ref List<object> items)
        {
            ...
            bool returnValue = job.SetJobValue(receivedValue, ref changed);
#if DEBUG
