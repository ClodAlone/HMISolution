...
namespace MTConnect.UI
{
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditing3
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            return DriverCodeBaseEx.CommunicationDriver.CopyFile<MTConnectDriverSettings>(sourceconn, targetconn, drivername);
        }
        ...
        {
            MTConnect.MTConnectDynTagSettings dynTag = new MTConnect.MTConnectDynTagSettings();
        ...
        {
            MTConnectDynTagSettings dynTag = new MTConnectDynTagSettings();
        ...
        {
            var genSet = generalSettings as MTConnectDriverSettings;
            if (genSet == null)
                return null;

            if (channelEditor == null)
                channelEditor = new ChannelDetails();
            var ch = new MTConnectChannelSettings(genSet.Session);
        ...
        public UserControl NewStationSettingsEditor(object generalSettings)
        {
            ...
            var st = new MTConnectStationSettings(genSet.Session);
        ...
        public bool DisableDriver(string connectionString, bool bProtected, Guid protectionCode)
        {
            ...
            {
                string drivername = DriverCodeBaseEx.Helpers.DriverInfo.GetDriverName(this).Replace(".UI", "");
                configurationEditor.Init<MTConnectDriverSettings>(connectionString, drivername, bProtected, protectionCode);
