...
namespace IEC60870_5_104
{
    ...
    public class iecInfoObj : infObj
    {
        ...
        public iecInfoObj(IEC60870_5_104CommJob job)
        {
    ...
    public static class APDUFactory
    {
        ...
        public static APDU confirmedWriteJob(IEC60870_5_104CommJob job)
        {
    ...
    public static class APDUValidator
    {
        ...
        {
            return (receiveItem.Apdu.Asdu != null && receiveItem.Apdu.Asdu.UnitId.Cause == CausesOfTrasmission.activation_confirmation);
        }
        ...
        public static bool IsASDUSpontaneousInputTypes(ref APDU pdu)
        {
            return (pdu.Asdu == null ||
                    (
        ...
        public static List<iecInfoObj> GetASDUSpontaneousInputTypes(ref APDU pdu)
        {
            if (ASDUInputTypes(ref pdu, out List<iecInfoObj> infoObjList))
                return infoObjList;
            else
                return null;
        }
