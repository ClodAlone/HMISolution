...
namespace IEC60870_5_104
{
    ...
    public class IEC60870_5_104CommJob : CommJob
    {
            ...
            : base(station, settings)
        {
            ...
            _FileChecksum = 0;
            _SectionChecksum = 0;
            if (ObservedVariable.IsTagsSet(_CotVariableName, _CotVariableId))
            {
                jobCotVariable = new ObservedVariable(_CotVariableName, _CotVariableId);
            ...
            if (ObservedVariable.IsTagsSet(_QualityVariableName, _QualityVariableId))
            {
                jobQualityVariable = new ObservedVariable(_QualityVariableName, _QualityVariableId);
            ...
            if (ObservedVariable.IsTagsSet(_FileNameVariableName, _FileNameVariableId))
            {
                jobFileNameVariable = new ObservedVariable(_FileNameVariableName, _FileNameVariableId);
        ...
        public override List<NodeId> GetObservingNodes()
        {
            ...
            {
                nodeIDs.Add(jobFileNameVariable.GetNodeId());
            }
        ...
        public bool setQualityVariable(byte quality)
        {
            ...
            Station.GetCommDriver().OnTagChanged(jobQualityVariable.GetNodeId(), jobQualityVariable.varValue);
        ...
        public bool setCotVariable(CausesOfTrasmission Cot)
        {
            ...
            Station.GetCommDriver().OnTagChanged(jobCotVariable.GetNodeId(), jobCotVariable.varValue);
        ...
        public override void ManageUpdatedValueForTheConditionalVariable(NodeId node, DataValue value)
        {
            base.ManageUpdatedValueForTheConditionalVariable(node, value);
            ...
            if (IsSelectBeforeOperateJob())
            {
                ...
                if (bitCount == 1)
                {
                    ...
                    ((IEC60870_5_104Channel)this.Station.GetChannel()).SetRequestSchedule();
                }
                else if (bitCount > 1)
                {
        ...
        public override bool IsReadRWReady()
        {
            lock (lockListObject)
            {
                ...
                TagsListOnWriting.Count != 0 /*&& (ProtocolDataSizeBig() || IOReadForRW())*/);
            }
        }
        ...
        public override uint SamplingInterval
        {
            get
            {
                if (ReadRequest() && ASDUType != ASDUSelectableTypes.ReadDirectoryContents)
