...
namespace IEC60870_5_104
{
    ...
    public class IEC60870_5_104StationSettings : StationSettings
    {
        ...
        public override void CopyProperties(StationSettings st)
        {
            ...
            _CommonAddress = ((IEC60870_5_104StationSettings)st).CommonAddress;
            _MaxOutAPDU = ((IEC60870_5_104StationSettings)st).MaxOutAPDU;
            _MaxInAPDU = ((IEC60870_5_104StationSettings)st).MaxInAPDU;
            _MissingAckTimeout = ((IEC60870_5_104StationSettings)st).MissingAckTimeout;
            _NoInMsgTimeout = ((IEC60870_5_104StationSettings)st).NoInMsgTimeout;
            _NoActivityTimeout = ((IEC60870_5_104StationSettings)st).NoActivityTimeout;
            _EnablePeriodicReset = ((IEC60870_5_104StationSettings)st).EnablePeriodicReset;
            _FileTransferDirectory = ((IEC60870_5_104StationSettings)st).FileTransferDirectory;
        }
