        ...
        protected override string PerformValidation(string propertyName)
        {
            ...
            if (propertyName == "ASDUType")
            {
                ...
                if (IEC60870_5_104Protocol.InvalidAreaTypeOutput(_ASDUType, (LinkType)TagLinkType))
                    return string.Format(Properties.Resources.AreaTypeRequireOutput, DriverCodeBaseEx.Properties.Resources.LinkType_UnconditionalOutput, DriverCodeBaseEx.Properties.Resources.LinkType_ExceptionOutput);
