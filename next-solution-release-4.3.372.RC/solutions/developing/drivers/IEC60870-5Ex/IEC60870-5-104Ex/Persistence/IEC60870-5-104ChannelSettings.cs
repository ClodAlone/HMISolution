...
namespace IEC60870_5_104
{
    ...
    public class IEC60870_5_104ChannelSettings : TcpChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            OriginatorAddress = ((IEC60870_5_104ChannelSettings)ch).OriginatorAddress;
            InitializationTimeOut = ((IEC60870_5_104ChannelSettings)ch).InitializationTimeOut;
            RepeatInitialInterrogation = ((IEC60870_5_104ChannelSettings)ch).RepeatInitialInterrogation;
            EnableInitialClockSynchronization = ((IEC60870_5_104ChannelSettings)ch).EnableInitialClockSynchronization;
        }
