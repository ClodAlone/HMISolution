...
namespace BACnet
{
    ...
    public class BACnetStationSettings : StationSettings
    {
        ...
        public override void CopyProperties(StationSettings st)
        {
            ...
            _ForceInitialPolling = ((BACnetStationSettings)st).ForceInitialPolling;
            _COVInterval = ((BACnetStationSettings)st).COVInterval;
            _TimeSync = ((BACnetStationSettings)st).TimeSync;
            _BBMDRegister = ((BACnetStationSettings)st).BBMDRegister;
            _BBMDAddress = ((BACnetStationSettings)st).BBMDAddress;
            _BBMDLifetime = ((BACnetStationSettings)st).BBMDLifetime;
            _DeviceHostName = ((BACnetStationSettings)st).DeviceHostName;
            _DeviceHostPort = ((BACnetStationSettings)st).DeviceHostPort;
            _DeviceInstance = ((BACnetStationSettings)st).DeviceInstance;
            _WhoIsDisabled = ((BACnetStationSettings)st).WhoIsDisabled;
        }
