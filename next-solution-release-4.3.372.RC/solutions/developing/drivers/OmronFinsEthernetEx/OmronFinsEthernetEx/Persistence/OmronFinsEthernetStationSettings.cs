...
namespace OmronFinsEthernet
{
    ...
    public class OmronFinsEthernetStationSettings : StationSettings
    {
        ...
        public override void CopyProperties(StationSettings st)
        {
            ...
            _DestinationNetworkAddress = ((OmronFinsEthernetStationSettings)st).DestinationNetworkAddress;
            _DestinationNode = ((OmronFinsEthernetStationSettings)st).DestinationNode;
            _DestinationUnit = ((OmronFinsEthernetStationSettings)st).DestinationUnit;
        }
