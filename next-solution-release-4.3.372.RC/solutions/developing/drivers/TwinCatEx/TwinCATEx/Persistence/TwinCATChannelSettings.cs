...
namespace TwinCAT
{
    ...
    public class TwinCATChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            TwinCATAdsAmsNetId = ((TwinCATChannelSettings)ch).TwinCATAdsAmsNetId;
            TwinCATAdsAmsPortNum = ((TwinCATChannelSettings)ch).TwinCATAdsAmsPortNum;
            TwinCATCommunicationTimeout = ((TwinCATChannelSettings)ch).TwinCATCommunicationTimeout;
            TwinCATMaxNumberOfAggregatedRequests = ((TwinCATChannelSettings)ch).TwinCATMaxNumberOfAggregatedRequests;
            TwinCATVersion = ((TwinCATChannelSettings)ch).TwinCATVersion;
        }
