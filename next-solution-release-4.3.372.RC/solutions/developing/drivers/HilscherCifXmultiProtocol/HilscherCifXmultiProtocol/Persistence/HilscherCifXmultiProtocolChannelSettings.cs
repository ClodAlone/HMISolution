...
namespace HilscherCifXmultiProtocol
{
    ...
    public class HilscherCifXmultiProtocolChannelSettings : ChannelSettings
    {
            ...
            : base(session)
        {
            ...
            session.UpdateSchema(typeof(HilscherCifXmultiProtocolChannelSettings));
        }
        ...
        public void CopyProperties(HilscherCifXmultiProtocolChannelSettings ch)
        {
            base.CopyProperties(ch);
            _BoardNumber = ch.BoardNumber;
            _ChannelNumber = ch.ChannelNumber;
            _ForceOutputDataAtStartup = ch.ForceOutputDataAtStartup;
        }
