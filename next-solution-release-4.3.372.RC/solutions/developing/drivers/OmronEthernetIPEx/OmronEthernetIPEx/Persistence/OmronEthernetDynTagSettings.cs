    ...
    public sealed class OmronEthernetIPDynTagSettings : DynTagSettings
    {
        ...
        string GetNodeDynSetting(TagDefinition thistagdefinition)
        {
            ...
            if (TagFormat == TagFormats.STRING)
            {
                ...
                StructStringLength structStringFieldLengthsMapper = new StructStringLength(OmronEthernetIPProtocol.MAX_STRING_LENGTH);
        ...
        private Dictionary<string, OmronEthernetIPStationSettings> _stationSettingList;
        public Dictionary<string, OmronEthernetIPStationSettings> stationSettingList
        {
        ...
        protected override String PerformValidation(String propertyName)
        {
            ...
            switch (propertyName) {
                case "ABAddress":
                    ...
                    break;
                case "TagFormat":
                    if ((TagFormat == TagFormats.STRING) && (VarType == UFUAModel.DataType.String))
                    {
                        if (ArrayDimension > 1)
                        {
                            return Properties.Resources.ErrorStringArraysAreNotSupported;
                        }
                    }
                    break;
                ...
                case "StructStringFieldLengths":
                    ...
                    {
                        StructStringLength oSSL = new StructStringLength(OmronEthernetIPProtocol.MAX_STRING_LENGTH);
