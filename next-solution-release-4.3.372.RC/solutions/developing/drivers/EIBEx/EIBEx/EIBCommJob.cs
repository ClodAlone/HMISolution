...
namespace EIB
{
    ...
    public class EIBCommJob : CommJob
    {
        ...
        public bool WriteIsForced()
        {
            ...
            if (jobConditionalVariable.GetStateCommandVariableBit(ref forceWriteBit, (ushort)EIBConditionalVariableBits.BitForceWrite) == false)
            {
                return (false);
            }
        ...
        public bool PollingIsForced()
        {
            ...
            if (jobConditionalVariable.GetStateCommandVariableBit(ref forceReadBit, (ushort)EIBConditionalVariableBits.BitForceRead) == false)
            {
                return (false);
            }
        ...
        //    //Check up if Conditional variable was inizialized
        //    if ((jobConditionalVariable.SetValue(varValue == null) || (jobConditionalVariable.varValue.Value == null))
        //    {
        //        return (false);
        //    }
        ...
        public void AutoResetNewDataFlag()
        {
                ...
                (AutoResetNewDataTime > 0))
            {
                ...
                {
                    jobConditionalVariable.SetStateCommandVariableBit(false, (ushort)EIBConditionalVariableBits.BitNewData, Station.GetCommDriver());
                }
            }
        }
        ...
        {
            return jobConditionalVariable.SetStateCommandVariableBit(bitValue, bitIndex, Station.GetCommDriver());
        }
