...
namespace PhoenixContactPLCI
{
    ...
    public class PhoenixContactPLCIChannelSettings : ChannelSettings
    {
            ...
            : base(session)
        {
            ...
            session.UpdateSchema(typeof(PhoenixContactPLCIChannelSettings));
        }
        ...
        public void CopyProperties(PhoenixContactPLCIChannelSettings ch)
        {
            base.CopyProperties(ch);

            _ServerAddress = ch.ServerAddress;
            _ServerPort = ch.ServerPort;
            _SubscribeVariables = false;
        }
        /////////////////////////////
