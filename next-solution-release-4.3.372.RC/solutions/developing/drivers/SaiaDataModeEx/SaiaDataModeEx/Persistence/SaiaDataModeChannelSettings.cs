...
namespace SaiaDataMode
{
    ...
    public class SaiaDataModeChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            ChannelType = ((SaiaDataModeChannelSettings)ch).ChannelType;

            UdpChannelSettingsHostName = ((SaiaDataModeChannelSettings)ch).UdpChannelSettingsHostName;
            UdpChannelSettingsHostPort = ((SaiaDataModeChannelSettings)ch).UdpChannelSettingsHostPort;
            UdpChannelSettingsReadTimeout = ((SaiaDataModeChannelSettings)ch).UdpChannelSettingsReadTimeout;
            UdpChannelSettingsWriteTimeout = ((SaiaDataModeChannelSettings)ch).UdpChannelSettingsWriteTimeout;

            CommPortName = ((SaiaDataModeChannelSettings)ch).CommPortName;
            CommPortNameLinux = ((SaiaDataModeChannelSettings)ch).CommPortNameLinux;
            CommPortBaudRate = ((SaiaDataModeChannelSettings)ch).CommPortBaudRate;
            CommPortDataBits = ((SaiaDataModeChannelSettings)ch).CommPortDataBits;
            CommPortParity = ((SaiaDataModeChannelSettings)ch).CommPortParity;
            CommPortStopBits = ((SaiaDataModeChannelSettings)ch).CommPortStopBits;
            CommPortHandshake = ((SaiaDataModeChannelSettings)ch).CommPortHandshake;
            CommPortRtsEnable = ((SaiaDataModeChannelSettings)ch).CommPortRtsEnable;
            CommPortDtrEnable = ((SaiaDataModeChannelSettings)ch).CommPortDtrEnable;
            CommPortReadTimeout = ((SaiaDataModeChannelSettings)ch).CommPortReadTimeout;
            CommPortWriteTimeout = ((SaiaDataModeChannelSettings)ch).CommPortWriteTimeout;
        }
    ...
    public class SaiaDataModeUdpChannelSettings : UdpChannelSettings
    {
        ...
        public void CopyProperties(ChannelSettings ch)
        {
            base.CopyProperties(ch);
            KeepOpened = true;
            UdpChannelSettingsHostName = ((SaiaDataModeChannelSettings)ch).UdpChannelSettingsHostName;
