...
#include "CmpPLCHandlerItf.h"
	...
	RTS_RESULT CDECL ExitComponents(void);
#endif
...
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)plchandlervarlistread, "plchandlervarlistread", 0x5FFAB125, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlervarlistleave, "plchandlervarlistleave", 0x6150164D, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlervarlistenter, "plchandlervarlistenter", 0x7F252097, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlervarlistenable, "plchandlervarlistenable", 0x5EDC0FD8, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlervarlistdisable, "plchandlervarlistdisable", 0xA9F0A7EB, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlervarlistdelete, "plchandlervarlistdelete", 0xAD8E5D4F, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlervarlistdefine, "plchandlervarlistdefine", 0x81C780F4, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlersyncwritevars, "plchandlersyncwritevars", 0xDACACBAF, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlersyncwritevarlisttoplc, "plchandlersyncwritevarlisttoplc", 0xA486E098, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)plchandlersyncsendservice, "plchandlersyncsendservice", 0x303EF9A4, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlersyncreadvarsrelease, "plchandlersyncreadvarsrelease", 0xD4834060, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlersyncreadvars, "plchandlersyncreadvars", 0x7F4F3550, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlersyncreadvarlistfromplc, "plchandlersyncreadvarlistfromplc", 0xD0C1A01F, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)plchandlersyncreadvarlist, "plchandlersyncreadvarlist", 0x22BA041E, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlersyncdeletevarlist, "plchandlersyncdeletevarlist", 0xA82CAF19, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)plchandlersyncdefinevarlist, "plchandlersyncdefinevarlist", 0x9C816C52, 0x03050D00 },\
          { (RTS_VOID_FCTPTR)plchandlerlogginginit, "plchandlerlogginginit", 0xFB1F6D11, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlergetstate, "plchandlergetstate", 0x3882F552, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlergetdeviceinfo, "plchandlergetdeviceinfo", 0x9D8B2632, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlerdisconnect, "plchandlerdisconnect", 0xBEC54443, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlerdeleteinstance, "plchandlerdeleteinstance", 0x62C4DDDA, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlercreateinstance, "plchandlercreateinstance", 0xF3B6D6E9, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlerconnect, "plchandlerconnect", 0xA16ECE49, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlerconfigurebystring, "plchandlerconfigurebystring", 0x9A5EB7EA, 0x03050900 },\
          { (RTS_VOID_FCTPTR)plchandlerchecksymbolvalidity, "plchandlerchecksymbolvalidity", 0x35B50EAA, 0x03050900 },\
