...
class CPLCComGateway3 : public CPLCComBase3Selector
{
	public:
		...
		CPLCComGateway3(PlcConfig *pConfig, PlcDeviceDesc *pDevice, PFVERIFYCERTCALLBACK pfVerifyCallback, void* pVerifyUserData, RTS_HANDLE hLogger = RTS_INVALID_HANDLE);
