...
namespace MQTTClient
{
    ...
    public class MQTTClientChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            _MQTTServerHostName = ((MQTTClientChannelSettings)ch).MQTTServerHostName;
            _MQTTServerHostPort = ((MQTTClientChannelSettings)ch).MQTTServerHostPort;
            _MQTTClientIdentifier = ((MQTTClientChannelSettings)ch).MQTTClientIdentifier;
            _MQTTClientUsername = ((MQTTClientChannelSettings)ch).MQTTClientUsername;
            _MQTTClientPassword = ((MQTTClientChannelSettings)ch).MQTTClientPassword;
            _MQTTClientUseSecureConnection = ((MQTTClientChannelSettings)ch).MQTTClientUseSecureConnection;
            _MQTTClientProtocolForSecureConnection = ((MQTTClientChannelSettings)ch).MQTTClientProtocolForSecureConnection;
            _MQTTClientCACertificateFile = ((MQTTClientChannelSettings)ch).MQTTClientCACertificateFile;
            _MQTTClientClientCertificateFile = ((MQTTClientChannelSettings)ch)._MQTTClientClientCertificateFile;
            _MQTTClientCleanSession = ((MQTTClientChannelSettings)ch).MQTTClientCleanSession;
            _MQTTClientKeepAliveTime = ((MQTTClientChannelSettings)ch).MQTTClientKeepAliveTime;
            _MQTTClientMaxNumberOfPendingRequests = ((MQTTClientChannelSettings)ch).MQTTClientMaxNumberOfPendingRequests;
