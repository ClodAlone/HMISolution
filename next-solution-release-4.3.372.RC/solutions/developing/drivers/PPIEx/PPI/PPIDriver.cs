...
namespace PPI
{
    ...
    {
        //Station test information collection string
        ...
        public PPIDriver(string strSettingPath)
            : base()
        {            
        }
        ...
        public override bool TestComm(ChannelSettings ch, StationSettings st, BuiltInType tagDataType, string dynamicSettings, out string error)
        {
            ...
            var conf = ch as PPIChannelSettings;
        ...
        /// <summary>
        /// Method used to collect information from the test connected to the station.
        /// </summary>
