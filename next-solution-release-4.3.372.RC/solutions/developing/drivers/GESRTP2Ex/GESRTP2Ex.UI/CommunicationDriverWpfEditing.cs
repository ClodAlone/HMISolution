...
namespace GESRTP2.UI
{
    ...
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditing3
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            bool result = DriverCodeBaseEx.CommunicationDriver.CopyFile<GESRTP2DriverSettings>(sourceconn, targetconn, drivername);
            result &= DriverCodeBaseEx.CommunicationDriver.CopyFile<GESRTP2ChangeTag>(sourceconn, targetconn, drivername, DriverCodeBaseEx.Helpers.DriverInfo.GetChangeDynTagsExtension());
            return result;
        }
        ...
        public bool DisableDriver(string connectionString, bool bProtected, Guid protectionCode)
        {
            ...
            {
                string drivername = DriverCodeBaseEx.Helpers.DriverInfo.GetDriverName(this).Replace(".UI", "");
                configurationEditor.Init<GESRTP2DriverSettings>(connectionString, drivername, bProtected, protectionCode);
