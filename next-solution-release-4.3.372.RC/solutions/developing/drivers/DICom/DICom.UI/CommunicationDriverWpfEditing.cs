...
namespace DICom.UI
{
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditing2
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            bool result = DriverCodeBase.CommunicationDriver.CopyFile<DIComDriverSettings>(sourceconn, targetconn, drivername);
            result &= DriverCodeBase.CommunicationDriver.CopyFile<DIComChangeTag>(sourceconn, targetconn, drivername, DriverCodeBase.Helpers.DriverInfo.GetChangeDynTagsExtension());
            return result;
        }
        ...
        {
            DIComDynTagSettings dynTag = new DIComDynTagSettings();
        ...
        {
            var genSet = generalSettings as DIComDriverSettings;
            if (genSet == null)
                return null;

            if (channelEditor == null)
                channelEditor = new ChannelDetails();
            var ch = new DIComChannelSettings(genSet.Session);
        ...
        public UserControl NewStationSettingsEditor(object generalSettings)
        {
            ...
            var st = new DIComStationSettings(genSet.Session);
