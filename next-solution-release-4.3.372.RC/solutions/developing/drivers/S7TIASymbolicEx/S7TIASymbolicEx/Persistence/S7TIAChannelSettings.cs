...
namespace S7TIASymbolic
{
    ...
    public class S7TIAChannelSettings : ChannelSettings
    {
        #region Constructors

        public S7TIAChannelSettings(Session session)
            : base(session)
        {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            TcpChannelSettingsHostName = ((S7TIAChannelSettings)ch).TcpChannelSettingsHostName;
            TcpChannelSettingsHostPort = ((S7TIAChannelSettings)ch).TcpChannelSettingsHostPort;
        }
