...
namespace Databoom.UI
{
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditing3
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            return DriverCodeBaseEx.CommunicationDriver.CopyFile<DataboomDriverSettings>(sourceconn, targetconn, drivername);
        }
        ...
        {
            Databoom.DataboomDynTagSettings dynTag = new Databoom.DataboomDynTagSettings();
        ...
        {
            DataboomDynTagSettings dynTag = new DataboomDynTagSettings();
        ...
        {
            var genSet = generalSettings as DataboomDriverSettings;
            if (genSet == null)
                return null;

            if (channelEditor == null)
                channelEditor = new ChannelDetails();
            var ch = new DataboomChannelSettings(genSet.Session);
        ...
        public UserControl NewStationSettingsEditor(object generalSettings)
        {
            ...
            var st = new DataboomStationSettings(genSet.Session);
        ...
        public bool DisableDriver(string connectionString, bool bProtected, Guid protectionCode)
        {
            ...
            {
                string drivername = DriverCodeBaseEx.Helpers.DriverInfo.GetDriverName(this).Replace(".UI", "");
                configurationEditor.Init<DataboomDriverSettings>(connectionString, drivername, bProtected, protectionCode);
