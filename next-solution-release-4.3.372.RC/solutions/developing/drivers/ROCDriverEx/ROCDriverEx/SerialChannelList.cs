...
namespace ROCDriver
{
    /// <summary> Serial communication channel for communication drivers with dynamic aggregation. </summary>
    public abstract class SerialChannelList : ChannelList, IDisposable
    {
        #region Data Members
        ...
        ///                                                         operation. </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public SerialChannelList(CommunicationDriver commdriver, SerialChannelSettings settings)
            : base(commdriver, settings)
        {
            ...
            {
                CommDriver.OnSystemEvent(null, string.Format(SerialDriverCodeBaseEx.Properties.Resources.SerialPortCreationError, Name, ex.Message), Opc.Ua.EventSeverity.High);
            }
        }
