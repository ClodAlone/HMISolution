...
namespace SQLDriver
{
    ...
    public class SQLDriverChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            Provider = ((SQLDriverChannelSettings)ch).Provider;
            ConnectionString = ((SQLDriverChannelSettings)ch).ConnectionString;
            BackupProvider = ((SQLDriverChannelSettings)ch).BackupProvider;
            BackupConnectionString = ((SQLDriverChannelSettings)ch).BackupConnectionString;
            ChannelSwitchHostTimeout = ((SQLDriverChannelSettings)ch).ChannelSwitchHostTimeout;
            PublishingInterval = ((SQLDriverChannelSettings)ch).PublishingInterval;
        }
        /////////////////////////////
