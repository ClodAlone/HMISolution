...
{
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditingSql, ICommunicationDriverWpfEditing3
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            return DriverCodeBaseEx.CommunicationDriver.CopyFile<SQLDriverDriverSettings>(sourceconn, targetconn, drivername);
        }
        ...
        {
            SQLDriver.SQLDriverDynTagSettings dynTag = new SQLDriver.SQLDriverDynTagSettings();
        ...
        {
            SQLDriverDynTagSettings dynTag = new SQLDriverDynTagSettings();
        ...
        public UserControl NewChannelSettingsEditor(object generalSettings, String connectionString)
        {
            var genSet = generalSettings as SQLDriverDriverSettings;
            if (genSet == null)
                return null;

            if (channelEditor == null)
                channelEditor = new ChannelDetails();
            var ch = new SQLDriverChannelSettings(genSet.Session);
            ch.DriverSettings = genSet;
            ch.DefaultSettings();
            channelEditor.DataContext = ch;
            channelEditor.ConnectionString = connectionString;
        ...
        public UserControl NewStationSettingsEditor(object generalSettings)
        {
            ...
            var st = new SQLDriverStationSettings(genSet.Session);
        ...
        public bool DisableDriver(string connectionString, bool bProtected, Guid protectionCode)
        {
            ...
            {
                string drivername = DriverCodeBaseEx.Helpers.DriverInfo.GetDriverName(this).Replace(".UI", "");
                configurationEditor.Init<SQLDriverDriverSettings>(connectionString, drivername, bProtected, protectionCode);
