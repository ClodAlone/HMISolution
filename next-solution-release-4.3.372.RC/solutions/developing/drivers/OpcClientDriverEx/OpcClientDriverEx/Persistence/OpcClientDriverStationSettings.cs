...
namespace OpcClientDriver
{
    ...
    public class OpcClientDriverStationSettings : StationSettings
    {
        ...
        public override void CopyProperties(StationSettings st)
        {
            ...
            _RemoveDisabledItemAfterSecs = ((OpcClientDriverStationSettings)st).RemoveDisabledItemAfterSecs;
            _MaxCleanCount = ((OpcClientDriverStationSettings)st).MaxCleanCount;
            _UseAlwaysSecureConnections = ((OpcClientDriverStationSettings)st).UseAlwaysSecureConnections;
            _FastSamplingInterval = ((OpcClientDriverStationSettings)st).FastSamplingInterval;
            _SlowSamplingInterval = ((OpcClientDriverStationSettings)st).SlowSamplingInterval;
            _DisableWhenNotUsed = ((OpcClientDriverStationSettings)st).DisableWhenNotUsed;
            _PublishingInterval = ((OpcClientDriverStationSettings)st).PublishingInterval;
            _ConnectionTimeout = ((OpcClientDriverStationSettings)st).ConnectionTimeout;
            _User = ((OpcClientDriverStationSettings)st).User;
            _Password = ((OpcClientDriverStationSettings)st).Password;
            _UseServerDiscovery = ((OpcClientDriverStationSettings)st).UseServerDiscovery;
            _UseLocalTimestamp = ((OpcClientDriverStationSettings)st).UseLocalTimestamp;
        }
