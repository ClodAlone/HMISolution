...
namespace BrPvi
{
    public class BrPviDriver : CommunicationDriver
    {
        ...
        public override void GetDriverErrorInfo(int errorcode, out uint quality, out string error)
        {
            ...
            switch ((BrPviErrorCodes)errorcode)
            {
                case BrPviErrorCodes.ErrorCodeCreateFailure:
                    error = LastPviCreateError;
                    break;

                case BrPviErrorCodes.ErrorCodeEventError:
                    error = LastPviEventError;
                    break;

                case BrPviErrorCodes.ErrorCodeConnectionBroken:
                    error = LastPviEventError;
                    break;

                case BrPviErrorCodes.ErrorCodeIdentificationError:
                    error = LastPviEventError;
