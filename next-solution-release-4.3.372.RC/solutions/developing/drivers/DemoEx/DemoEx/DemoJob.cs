    ...
    {        
        ...
        private void CheckJobValid()
        {
            ...
            if (TagsList.Count == 1)
            {
                ...
                else if (!DemoProtocol.AreParametersInRange((uint)TagsList[0].TagNode.DataType.Identifier, (int)_DemoType, _MinValue, _MaxValue, _DeltaValue, _FactorSinCos))
                {
                    IsValid = false;
