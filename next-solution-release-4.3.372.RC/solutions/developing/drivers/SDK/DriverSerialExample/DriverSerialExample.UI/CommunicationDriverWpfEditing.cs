...
{
    /// <summary>   DriverSerialExample.UI ICommunicationDriverWpfEditing interface. </summary>
    public class CommunicationDriverWpfEditing : ICommunicationDriverWpfEditing2, IDisposable
    {
        ...
        public bool CopyFile(string sourceconn, string targetconn)
        {
            ...
            bool result = DriverCodeBase.CommunicationDriver.CopyFile<DriverSerialExampleDriverSettings>(sourceconn, targetconn, drivername);
            result &= DriverCodeBase.CommunicationDriver.CopyFile<DriverSerialExampleChangeTag>(sourceconn, targetconn, drivername, DriverCodeBase.Helpers.DriverInfo.GetChangeDynTagsExtension());
            return result;
        }        
        ...
        {
            DriverSerialExample.DriverSerialExampleDynTagSettings dynTag = new DriverSerialExample.DriverSerialExampleDynTagSettings();
        ...
        {
            DriverSerialExampleDynTagSettings dynTag = new DriverSerialExampleDynTagSettings();
        ...
        {
            var genSet = generalSettings as DriverSerialExampleDriverSettings;
            if (genSet == null)
                return null;

            if (channelEditor == null)
                channelEditor = new ChannelDetails();
            var ch = new DriverSerialExampleChannelSettings(genSet.Session);
        ...
        public UserControl NewStationSettingsEditor(object generalSettings)
        {
            ...
            var st = new DriverSerialExampleStationSettings(genSet.Session);
