...
namespace DriverSerialExample
{
    public class DriverSerialExampleCommJob : CommJob
    {
            ...
            : base(station, defTag)
        {
            ...
            _FileNumber = defTag.DriverSerialExampleDynSettings.FileNumber;
            _BroadCast = defTag.DriverSerialExampleDynSettings.BroadCast;
        ...
        {
            return DriverSerialExampleProtocol.GetMaxJobSize(FunctionCode, Type);
        }
        ...
        /*
        private DriverSerialExampleCommJobSettings _JobSettings;
        public DriverSerialExampleCommJobSettings JobSettings
        {
            get 
            {
                if ((Settings as DriverSerialExampleCommJobSettings) != null)
                    _JobSettings = (DriverSerialExampleCommJobSettings)Settings;
