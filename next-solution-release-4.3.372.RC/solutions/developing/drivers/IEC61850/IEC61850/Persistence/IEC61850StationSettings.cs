...
namespace IEC61850
{
    ...
    public class IEC61850StationSettings : StationSettings
    {
        ...
        //steve 080711
        public void CopyProperties(IEC61850StationSettings st)
        {
            base.CopyProperties(st);
            _TransportSelector = st.TransportSelector;
            _SessionSelector = st.SessionSelector;
            _PresentationSelector = st.PresentationSelector;
            _ApplicationID = st.ApplicationID;
            _AEQualifier = st.AEQualifier;
            _AuthenticationEnabled = st.AuthenticationEnabled;
            _AuthenticationPassword = st.AuthenticationPassword;
        }
        //////////////////
