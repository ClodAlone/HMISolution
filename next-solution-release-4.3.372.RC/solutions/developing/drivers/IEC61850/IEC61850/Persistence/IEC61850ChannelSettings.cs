...
namespace IEC61850
{
    ...
    public class IEC61850ChannelSettings : TcpChannelSettings
    {
        ...
        //steve 080711
        public void CopyProperties(IEC61850ChannelSettings ch)
        {
            base.CopyProperties(ch);
            _ClientSessionSelector = ch.ClientSessionSelector;
            _ClientPresentationSelector = ch.ClientPresentationSelector;
            _ClientApplicationID = ch.ClientApplicationID;
            _ClientAEQualifier = ch.ClientAEQualifier;
            _ReportAutomaticActivation = ch.ReportAutomaticActivation;
            _TimeZone = ch.TimeZone;
        }
        /////////////////////////////
