...
namespace Simotion
{
    ...
    public class SimotionChannelSettings : ChannelSettings
    {
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            TcpChannelSettingsHostName = ((SimotionChannelSettings)ch).TcpChannelSettingsHostName;
            TcpChannelSettingsHostPort = ((SimotionChannelSettings)ch).TcpChannelSettingsHostPort;
        }
