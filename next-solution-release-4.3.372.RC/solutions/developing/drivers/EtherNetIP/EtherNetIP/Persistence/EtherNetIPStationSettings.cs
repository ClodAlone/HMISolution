...
namespace EtherNetIP
{
    ...
    public class EtherNetIPStationSettings : StationSettings
    {
            ...
            : base(session)
        {
            ...
            session.UpdateSchema(typeof(EtherNetIPStationSettings));
        }
        ...
        public void CopyProperties(EtherNetIPStationSettings st)
        {
            base.CopyProperties(st);
            PlcType = st.PlcType;
            CPUSlot = st.CPUSlot;
            Logix5550NonBlockPhAdd = st.Logix5550NonBlockPhAdd;
            ReadStructuresMode = st.ReadStructuresMode;
            PLCStatusPollingTime = st.PLCStatusPollingTime;
        }
