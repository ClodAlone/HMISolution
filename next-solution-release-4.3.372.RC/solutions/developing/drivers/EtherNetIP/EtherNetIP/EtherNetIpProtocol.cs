...
namespace EtherNetIP
{
   ...
   // Constructor:
    ...
    public class EtherNetIpProtocol
    {
        ...
        public static void UnRegisterSession(ref byte[] pdu, ref ushortUnion pduPointer, EtherNetIPChannel c)
        {
            ...
            if (c.SessionRegisterOk())
            {
                ...
                if (c.EtherNetIpDeviceWrite(ref pdu, ref pduPointer))
                {
                    ...
                    {
                        ushortUnion lenData = new ushortUnion(pdu, EDATA_LEN_OFFS);
                        // The length of the remaining part of the message should be always 0
                        if (0 != lenData.USHORT)
                        {
                            c.DeviceRead(pdu, lenData.USHORT);
                        }
        ...
        public static bool Logix5550ForwardOpen(EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer, EtherNetIPChannel c)
        {
            if (c.SessionRegisterOk())
            {
                            ...
                            if (lenData.USHORT >= 20)
                            {
                                ...
                                if (c.DeviceRead(pduData, (uint)lenData.USHORT)) //error timeout RX
                                {
                                    ...
                                    if (c.AnalyzeReplyHeader(ref pdu, ecSendRRData.USHORT, c.SessionHandle.UINT) ==
                                        (EtherNetIpErrorCodes)DriverCodeBase.Enumerators.DriverErrorCodes.ErrorNoError)
                                    {
                ...
                foreach (String szProgramName in s.m_listPrograms)
                {
                    if (s.m_mapProgramsInstances.TryGetValue(szProgramName, out nProgramInstance))
                    {
                        if (!Logix5000V21GetTagInstances(s, ref pdu, ref pduPointer, c, ref nErrorCode, szProgramName, nProgramInstance))
                        {
                            ...
                            String szWarningMsg = string.Format(EtherNetIP.Properties.Resources.WARNRUNPROGRAMVARINST,
                                                        ...
                                                        ref Dictionary<ushort, PlcTemplateInfo> pDestMap)
        {
            ...
            foreach (ushort Key in keyList)
            {
                ...
                {
                    String szWarningMsg = string.Format(EtherNetIP.Properties.Resources.WARNRUNTEMPLATEINFO,
                                                        ...
                                                        ref ushort nReadDataBytes)
        {
            ...
            while (nReadDataBytes < nTemplateSize)
            {
                ...
                if (!c.EtherNetIpDeviceWrite(ref pdu, ref pduPointer))
                {
                    UnRegisterSession(ref pdu, ref pduPointer, c);
                    c.DeviceClose();
                    return false;
                }
        ...
        public static bool Logix5000V21SetProgramsTrueInstances(EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer, EtherNetIPChannel c)
        {
            ...
            foreach (string szProgramName in s.m_listPrograms)
            {
                ...
                if (!Logix5000V21GetProgramAddress2(s, ref pdu, ref pduPointer, c, s.m_mapProgramsInstances[szProgramName], ref nAddress, ref wStatus))
                {
                    ...
                    String szWarningMsg = string.Format(EtherNetIP.Properties.Resources.WARNRUNPROGRAMTRUEINST,
        ...
        public static bool Logix5000V21GetProgramsAddresses(EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer, EtherNetIPChannel c)
        {
            ...
            foreach (ushort nInstance in s.m_listProgramsTrueIstances)
            {
                ...
                if (!Logix5000V21GetProgramAddress(s, ref pdu, ref pduPointer, c, new ushortUnion(nInstance), ref nAddress, ref nErrorCode))
                {
                    ...
                    String szWarningMsg = string.Format(EtherNetIP.Properties.Resources.WARNRUNGETPROGRAMADD,
        ...
        public static ushort Logix5550PrepareRequest(ref List<EtherNetIPCommJob> list, EtherNetIPChannel c, ref EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer)
        {
        ...
        public static ushort Logix5550PrepareUnconnectedRequest(EtherNetIPCommJob job, EtherNetIPChannel c, EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer)
        {
            ushort StartCh = pduPointer.USHORT;
            PrepareEncapsulationHeader(ecSendRRData, c, ref pdu, ref pduPointer);

            // Complete the request message
            Logix5550PrepareUnconnectedCPF(job, s, ref pdu, ref pduPointer);
            return ((ushort)(pduPointer.USHORT - StartCh));
        }

        public static ushort Logix5550PrepareUnconnectedCPF(EtherNetIPCommJob job, EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer)
        {
            ushort StartCh = pduPointer.USHORT;
            ...
            //Common Packet Format (CPF)
            //Transport PDU
            ushortUnion PDULen = new ushortUnion(Logix5550PrepareUnconnectedTPDU(job, s, ref pdu, ref pduPointer));
        ...
        public static ushort Logix5550PrepareUnconnectedTPDU(EtherNetIPCommJob job, EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer)
        {
            if (s.PlcType == PlcTypes.Micro800_series)
            {
        ...
        public static void getWriteListLimitate(List<EtherNetIPCommJob> nextlist, ref List<EtherNetIPCommJob> nextlistLimitate, ref List<EtherNetIPCommJob> queueEmptyJobs)
        {
                ...
                foreach (Tag tag in j.TagsList)
                    {
                        ...
                        if (writeSize > LOGIX5550_CONNECTION_SIZE)
                        {
                            if (tag.Size / j.ElemSize <= 1)
                                return;
                            int tmp = (j.adjSizeWrite(tag) + LOGIX5550_CONNECTION_SIZE + 1 - writeSize - j.ElemSize) / j.ElemSize;
        ...
        public static ushort Logix5550TagsPrepareMultiWriteReq(ref List<EtherNetIPCommJob> listJobs, ref EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer)
        {
            ushort StartCh = pduPointer.USHORT;
            ...
            try
            {
                ...
                s.lastProcessedTags.USHORT = (ushort)(listJobs.Count + listJobs.Count(j => j.TagFormat == TagFormats.STRING));
        ...
        public static ushort Logix5550TagsPrepareMultiWriteReqMicro800(
            ref List<EtherNetIPCommJob> List, ref EtherNetIPStation s,
            ref byte[] pdu, ref ushortUnion pduPointer)
        {
            ushort StartCh = pduPointer.USHORT;
            ushort WriteLenght;

            EtherNetIPCommJob j = List[0];
            Tag tag;
        ...
        public static void getReadListLimitate(List<EtherNetIPCommJob> nextlist, ref List<EtherNetIPCommJob> nextlistLimitate)
        {
            ushort readSize = (ushort)CIP_MULTIPLE_READ_HEADER_SIZE;

            //ushort responseSize = LOGIX5550_RESPONSE_SIZE_HEADER;
            ushort responseSize = (ushort)(nextlist[0].BuildInfoMaps ? LOGIX5550_HEADER_SIZE_OF_OPTIMIZED_RESPONSE : LOGIX5550_RESPONSE_SIZE_HEADER);
            System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate Step 1 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
            foreach (EtherNetIPCommJob j in nextlist)
            {
                ushort TagIndex = 0;
                ...
                foreach (Tag tag in j.TagsList)
                {
                    if (TagIndex >= j.ReadTagStart)
                    {
                        ...
                        if (readSize > LOGIX5550_CONNECTION_SIZE)
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate return 1 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
                            return;
                        }
                        System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate Step 2 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
                        responseSize += 8;
                        responseSize += (ushort)(j.adjSize(tag) - j.PartialArrayStart * j.ElemSize);
                        System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate Step 3 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
                        if (responseSize > LOGIX5550_CONNECTION_SIZE)
                        {
                            if (j.ReadTagEnd != j.ReadTagStart)
                            {
                                nextlistLimitate.Add(j);
                                System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate return 2 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
                                return;
                            }
                            if (tag.Size / j.ElemSize <= 1)
                            {
                                System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate return 3 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
                                return;
                            }
                            ...
                            System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate return 4 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
                            return;
                        }
                        j.ReadTagEnd++;
                    }
                ...
                j.ReadTagEnd = 0;
                j.PartialArrayEnd = 0;
                System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate step 4 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
            }
            System.Diagnostics.Debug.WriteLine(String.Format("DBG REQ LENGTH - {0} - getReadListLimitate return 5 - readSize = {1} - responseSize = {2} - Num. of Selected Jobs = {3}", DateTime.UtcNow.ToString("HH:mm:ss.fff"), readSize, responseSize, nextlistLimitate.Count));
        }

        private static ushort numTagsListToRead(List<EtherNetIPCommJob> List)
        {
            ushort i = 0;
        ...
        public static ushort PrepareEncapsulateRequest(ref List<PrepareHeader> prepareHeaderList, ref List<EtherNetIPCommJob> ListJob, ref EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer)
        {
            ushort StartCh = pduPointer.USHORT;
        ...
        public static bool Logix5000V21ReadAttributes(EtherNetIPStation s, ref byte[] pdu, ref ushortUnion pduPointer, EtherNetIPChannel c, out ushort attribute1, out ushort attribute2, out uint attribute3, out uint attribute4, out uint attribute10)
        {
            ...
            if (c.DeviceRead(pdu, EtherNetIpProtocol.ENCAPSULATION_HEADER_SIZE)) { //error timeout RX
                ...
                if (lenData.USHORT >= 20)
                {
                    ...
                    {
                        pduData.CopyTo(pdu, EtherNetIpProtocol.ENCAPSULATION_HEADER_SIZE);
                        if (c.AnalyzeReplyHeader(ref pdu, ecSendUnitData.USHORT, c.SessionHandle.UINT) == (EtherNetIpErrorCodes)DriverCodeBase.Enumerators.DriverErrorCodes.ErrorNoError)
                        {
                            // Check the reply service code
                            ushortUnion DataLen = new ushortUnion(pdu, EDATA_LEN_OFFS);
