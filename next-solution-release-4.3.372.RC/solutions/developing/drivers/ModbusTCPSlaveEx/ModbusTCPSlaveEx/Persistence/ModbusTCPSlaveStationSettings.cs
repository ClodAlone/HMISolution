...
namespace ModbusTCPSlave
{
    ...
    public class ModbusTCPSlaveStationSettings : StationSettings
    {
        ...
        public override void CopyProperties(StationSettings st)
        {
            ...
            StationID = ((ModbusTCPSlaveStationSettings)st).StationID;
            DeviceHostName = ((ModbusTCPSlaveStationSettings)st).DeviceHostName;
            DeviceBackupHostName = ((ModbusTCPSlaveStationSettings)st).DeviceBackupHostName;
        }
        //////////////////
