...
namespace IEC61850
{
    ...
    {
        #region Constructor
        public IEC61850Report(string reportLogicalDeviceName, string mmsReportID, ReportTypes reportType, IEC61850Channel channel, Station station)
        {
            ...
            if (nDataLength > (nDataOffset + 1))
            {
                ...
                switch (dataBuffer[nDataOffset++])
                {
                    ...
                    case 0xa7:
                        ...
                        nLengthSize = 0;
                        nLength = IEC61850Protocol.BerDecodeLength(dataBuffer, nDataOffset, nDataLength - nDataOffset, out nLengthSize);
...
//#endif
                ...
                switch (dataType)
                {
                    ...
                    case 0x8c:
                        if (nDataLength >= (nDataOffset + 2))
                        {
                            ...
                            uint nLengthSize = 0;                            
                            uint nLength = IEC61850Protocol.BerDecodeLength(dataBuffer, nDataOffset, nDataLength - nDataOffset, out nLengthSize);
                        ...
                        if (nDataLength >= (nDataOffset + 2))
                        {
                            ...
                            if ((nLength != 0) || (dataType == 0x89) || (dataType == 0x8a) || (dataType == 0x90))
                            {
                                ...
                                if (nDataLength >= (nDataOffset + nLength))
                                {
                                    ...
                                    if (dataType == 0x8c)
                                    {
                                        IEC61850Protocol.ConvertBinaryTimeToDateTime(vt, ref structDt);
                                    }
                                    else if (dataType == 0x91)
                                    {
                                        IEC61850Protocol.ConvertUTCTimeToDateTime(vt, ref structDt);
                                    }
        ...
        bool ParseBinaryTime(byte[] dataBuffer, ref uint nDataOffset, ref DateTime dtValue)
        {
            ...
            dtValue = IEC61850Protocol.ConvertBinaryTimeToDateTime(nLength, timeBuffer);
