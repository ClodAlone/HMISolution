        ...
        protected override String PerformValidation(String propertyName)
        {
            ...
            if (propertyName == "ASDUType")
            {
                ...
                if (IEC60870_5_104Protocol.InvalidAreaTypeOutput(_ASDUType, (LinkType)TagLinkType))
                    return string.Format(Properties.Resources.AreaTypeRequireOutput,  DriverCodeBase.Properties.Resources.LinkType_UnconditionalOutput, DriverCodeBase.Properties.Resources.LinkType_ExceptionOutput);
