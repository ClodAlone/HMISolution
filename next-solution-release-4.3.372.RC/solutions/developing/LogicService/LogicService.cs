...
namespace LogicService
{
    ...
    {
        #region Declarations
        protected LogicServiceCSM serverCSM;
                ...
                try
                {
                                                    ...
                                                    Properties.Resources.InitializedServer))
                    {
                        ...
                        while (true)
                        {
                            try
                            {
                                serverCSM = new LogicServiceCSM(projectDocument.ConfigurationId.ToString(), this);
                        ...
                        uriRisolver.RegisterDocumentManager(ufProjectManagerComponent, ufProjectManagerComponent.TypeScheme);
                    ...
                    {
                        projectDocument.StartupServiceLogics(LogicManager);
                    }
                }
                finally
                {
