...
namespace DeployServer
{
    public class Startup
    {
                                ...
                                IHostApplicationLifetime applicationLifetime)
        {
            ...
            if (int.TryParse(Configuration["DeployServerSettings:MaxProcessAutorestarts"], out int maxProcessAutorestarts))
                ProcessInfo.MaxProcessAutorestarts = maxProcessAutorestarts;
            if (int.TryParse(Configuration["DeployServerSettings:ProcessAutorestartCounterLifetimeMinutes"], out int processAutorestartCounterLifetimeMinutes))
                try
                {
                    ProcessInfo.ProcessAutorestartCounterLifetimeTimespan = TimeSpan.FromMinutes(processAutorestartCounterLifetimeMinutes);
                }
                catch { }
