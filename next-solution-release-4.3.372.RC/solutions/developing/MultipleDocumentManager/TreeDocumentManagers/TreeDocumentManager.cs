...
namespace MultipleDocumentManager.TreeDocumentManagers
{
    class TreeDocumentManager : IDocumentManager
    {
        #region Declarations
        readonly DocumentEditorDocument Document;
        readonly DocumentEditorManagerComponent DocumentEditorManagerComponent;
        readonly String Name;
        #endregion

        public TreeDocumentManager(DocumentEditorManagerComponent c, DocumentEditorDocument doc, String name)
        {
        ...
        {
            get { return DocumentEditorManagerComponent.GetBitmapImage("Editor"); }
        }
        ...
        {
            get { return DocumentEditorManagerComponent.GetBitmapImage("Editor_32x32"); }
        }
