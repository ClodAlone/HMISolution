...
namespace MultipleDocumentManager.ComponentService
{
    public class DocumentEditorManagerComponent : ComponentBase<IMultipleDocumentManager>, IMultipleDocumentManager, IDocumentManager, IDisposable
    {
        #region Declaration
        ...
        private bool CloseView(DocumentEditorControl view, bool bSave = true, bool bDispose = true)
        {
            if (view == null)
                return true;
        ...
        private MultipleDocumentManager.DocumentEditorControl CreateDocView(DocumentEditorDocument doc, String title, IDocument parent)
        {
        ...
        public Uri CreateNewDocument(Uri relative, IDocument parent, bool encryptFile = false)
        {
            ...
            if (parent != null && parent.fileSystemProviderBase != null)
            {
                do
                {
                    newScriptName = String.Format("{0}{1}", Properties.Settings.Default.DefaultEditorName, ++i);
