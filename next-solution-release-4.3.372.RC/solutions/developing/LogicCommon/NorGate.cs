    ...
    public class NorGate : GateData
    {
        ...
        public override String Name
        {
            get
            {
                ...
                return "Nor";
#else
                return Properties.Settings.Default.NorGateName;
#endif
            }
        }
        ...
        public override DataTemplateDictionary GetDataTemplates()
        {
            ...
            resourceDictionary.Source = new Uri("/LogicCommon;component/ResourceDictionary/NorLibrary.xaml", UriKind.Relative);
        ...
        public override List<GateData> GetTypes()
        {
            ...
            ret.Add(new NorGate() { Key = "Nor", Text = "Nor", GateDataTemplate = "Nor", Category = "Nor" });
            ret.Add(new NorGate() { Key = "Nor", Text = "Nor", GateDataTemplate = "NorFour", Category = "NorFour" });
            return ret;
        }
