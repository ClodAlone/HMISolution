...
{
    public class RisingEdgeGate : GateData
    {
        #region Abstracts
        ...
        public override String Name
        {
            get
            {
                ...
                return "RisingEdge";
#else
                return Properties.Settings.Default.RisingEdgeGateName;
#endif
            }
        }
        ...
        public override List<GateData> GetTypes()
        {
            ...
            ret.Add(new RisingEdgeGate() { Key = "RisingEdge", Text = "Rising Edge", GateDataTemplate = "RisingEdge", Category = "RisingEdge" });
            return ret;
        }
