    ...
    public partial class App : Application
    {
...
#endif
        #endregion
        //public static CommandLineOptions cl;
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            if (e.Args.Length > 0)
            {
                        ...
                        case Operations.OpSection:
                            {
                                ...
                                if (cl.CrateNew)
                                {
                                    try
                                    {
                                        cert.CreateNewCertificate(cl.SectionName, cl.ExePath, cl.ApplicationType, cl.ApplicationName);
                                    }
                                    catch (Exception ex)
                                    {
                                        result = -2;
                                ...
                                {
                                    result = cert.CheckAndCreate(cl.SectionName, cl.ExePath, cl.ApplicationType, cl.ApplicationName);
                                }
                ...
                {
                    MessageBox.Show(UFUACertificateChecker.Properties.Resources.InvalidOptions, UFUACertificateChecker.Properties.Resources.AppTitle, MessageBoxButton.OK, MessageBoxImage.Exclamation);
