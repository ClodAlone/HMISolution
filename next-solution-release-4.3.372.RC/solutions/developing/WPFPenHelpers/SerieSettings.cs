...
namespace WPFPenHelpers
{
    ...
    public class SerieSettings : INotifyPropertyChanged
    {
        ...
        public IExpressionValueConverter expConverter { get; set; }
        [DataMember]
        string unitConverterLabel;
        //[DataMember]
        public String UnitConverterLabel
        {
            get
            {
                return unitConverterLabel;
            }
            set
            {
                if (unitConverterLabel != value)
                {
                    unitConverterLabel = value;
                    OnPropertyChanged("UnitConverterLabel");
                }
            }
        }
        #endregion
