...
namespace CustomWizardPlugin.ComponentService
{
    public class CustomWizardPluginComponent : ComponentBase<IUFProjectWizardPlugin>, IUFProjectWizardPlugin
    {

        public static ProjectWizardUI wizard;
        public static CustomWizardPluginComponent wizardPluginComponent { get; protected set; }
        ...
        public Uri CreateNewProject(Uri current, Window parent,object projectview)
        {
            ...
            wizard = new ProjectWizardUI() { ProjectView = ProjectView };
