    ...
    public class DocSVGHelper: IDisposable
    {
        ...
        bool GetCliccableForiOS(FrameworkElement fe, ScreenEntity entity)
        {
            ...
            if (entity != null)
            {
                ...
                cliccable = fe.IsHitTestVisible && ((entity?.CommandList as CommandManagerList).Count() > 0 || (fe as EditDisplay.EditDisplay)?.IsReadOnly == false);
            }
            return cliccable;
        }
        ...
        IOsEntity NestiOSEntity(XmlNode uieElement, FrameworkElement fe, IOsEntity iOSentity, string clearedName)
        {
            double left = (double)fe.GetValue(Canvas.LeftProperty);
            double top = (double)fe.GetValue(Canvas.TopProperty);
            iOSentity = GetIosElement(uieElement as XmlElement, fe.Opacity, left, top, fe.Width, fe.Height, elementName: clearedName, updateCoord: true);
        ...
        private XmlNode GetElement(string elementName, FrameworkElement fe,bool deepLoad = false, bool sourceSymbolLinked = false)
        {
            ...
            else if (sourceSymbolLinked)
            {
                ...
                if (!(fe is UserControl) && (fe as ContentControl)?.Content is Buttons.ButtonControl)
                    iOSentity = NestiOSEntity(uieElement, fe, iOSentity, clearedName);
            }
            ...
            else if (fe is Control)
            {
                ...
                if (fe is TextBox || fe is Buttons.ButtonControl || fe is EditDisplay.EditDisplay)
                    iOSentity = NestiOSEntity(uieElement, fe, iOSentity, clearedName);
            }
                        ...
                        if (!String.IsNullOrEmpty(baseObject))
                        {
                            try
                            {
                                ...
                                if ((control.Content is Control))
                                {
                                    ...
                                    Dictionary<string, Brush> urldict = JSONHelper.GetUrlBrushes((control.Content as FrameworkElement), elementName, Document);
...
//#endif
        ...
        private XmlNode GetControlElement(FrameworkElement fe, string elementName)
        {
            ...
            if (fe is Control)
            {
                ...
                Dictionary<string, Brush> urldict = JSONHelper.GetUrlBrushes(fe, elementName, Document);
                Dictionary<string, Dictionary<string, object>> urldictNames = new Dictionary<string, Dictionary<string, object>>();
                urldict?.Keys.ToList().ForEach(key =>
                {
                    ...
                    if (urldict[key] != null && !(urldict[key] is SolidColorBrush))
                    {
                        ...
                        {
                            //if (fe is Buttons.CheckBoxControl && Utilities.WPF.XmlHelper.IsProblematicXamlWriter(fe) && !Document.MapScreenEntities[elementName].SourceSymbolLinked)
                            //{
                            //    var cssGradient = JSONHelper.GetBrushCssString(Document, brush, fe);
                            //    urldictNames.Add(key, new Dictionary<string, object>() { { "Color", cssGradient } });
                            //}
                            //else {
        ...
        private XmlNode GetShapeElement(FrameworkElement fe, string elementName, out IOsEntity iOSentity, XmlDocument doc = null)
        {
            ...
            else if (fe is Rectangle)
            {
                ...
                if (!string.IsNullOrEmpty(source))
                {
                    ...
                    SetShapeStroke(uieDef, doc, rect.StrokeThickness, rect.StrokeDashArray, rect.StrokeDashOffset);
                ...
                else
                {
                    ...
                    SetShapeStroke(uieElement, doc, rect.StrokeThickness, rect.StrokeDashArray, rect.StrokeDashOffset);
            ...
            else if (fe is Ellipse)
            {
                ...
                if (!string.IsNullOrEmpty(source))
                {
                    ...
                    SetShapeStroke(uieDef, doc, ell.StrokeThickness, ell.StrokeDashArray, ell.StrokeDashOffset);
                ...
                else
                {
                    ...
                    SetShapeStroke(uieElement, doc, ell.StrokeThickness, ell.StrokeDashArray, ell.StrokeDashOffset);
            ...
            else if (fe is Polygon)
            {
                ...
                if (!string.IsNullOrEmpty(source))
                {
                    ...
                    { 
                        ...
                        StrokeDashOffset = pol.StrokeDashOffset,
                ...
                else
                {
                    ...
                    SetShapeStroke(uieElement, doc, pol.StrokeThickness, pol.StrokeDashArray, pol.StrokeDashOffset);
                    Size size = new Size(Math.Abs(xmax - xmin), Math.Abs(ymax - ymin));
                    iosWidth = size.Width;
                    iosHeight = size.Height;
            ...
            else if (fe is System.Windows.Shapes.Path)
            {
                ...
                if (!string.IsNullOrEmpty(source))
                {
                    ...
                    SetShapeStroke(uieClipDef, doc, path.StrokeThickness, path.StrokeDashArray, path.StrokeDashOffset);
                ...
                else
                {
                    ...
                    SetShapeStroke(uieElement, doc, path.StrokeThickness, path.StrokeDashArray, path.StrokeDashOffset);
            ...
            else if (fe is System.Windows.Shapes.Line)
            {
                ...
                if (attribute != null)
                    uieElement.Attributes.Append(attribute);
                SetShapeStroke(uieElement, doc, line.StrokeThickness, line.StrokeDashArray, line.StrokeDashOffset);
            ...
            else if (fe is Pipeline.Pipeline)
            {
                ...
                if (!string.IsNullOrEmpty(source))
                    ...
                    strokeName = line.Stroke == null ? "none" : GetCssClassStyle(line.Stroke, ColorMode.Stroke, new Size(fe.Width, fe.Height));
            ...
            else if (fe is Microsoft.Expression.Shapes.Arc)
            {
                ...
                else
                {
                    ...
                    SetShapeStroke(uieElement, doc, ell.StrokeThickness, ell.StrokeDashArray, ell.StrokeDashOffset);
                    SetShapeStroke(iOsuieElement, doc, ell.StrokeThickness, ell.StrokeDashArray, ell.StrokeDashOffset);
            ...
            else if (fe is Microsoft.Expression.Shapes.RegularPolygon)
            {
                ...
                if (ell.PointCount > 0)
                {
                    ...
                    if (!string.IsNullOrEmpty(source))
                    {
                        ...
                        SetShapeStroke(poly, doc, ell.StrokeThickness, ell.StrokeDashArray, ell.StrokeDashOffset);
        ...
        void SetShapeStroke(XmlNode uieElement, XmlDocument doc, double thickness, DoubleCollection dashArray, double dashOffset)
        {
            if (dashArray != null && dashArray.Count > 0)
            {
                var strokeDashString = "";
                foreach (var strokeDash in dashArray)
                    strokeDashString = String.Format("{0}{1} ", strokeDashString, $"{JSONHelper.GetValue(strokeDash * thickness, true)}");
                uieElement.Attributes.Append(JSONHelper.CreateNewAttribute("stroke-dasharray", strokeDashString.TrimEnd(), doc));
                if (dashOffset > 0)
                    uieElement.Attributes.Append(JSONHelper.CreateNewAttribute("stroke-dashoffset", $"{JSONHelper.GetValue(dashOffset * thickness, true)}", doc));
            }
        }
        ...
        private XmlNode DrawLine(int shade, InfoLine infoLine, XmlDocument doc, bool updateStyle = true)
        {
            ...
            SetShapeStroke(uieElement, doc, infoLine.StrokeThickness, infoLine.StrokeDashArray, infoLine.StrokeDashOffset);
        ...
        private string GetNewStyle(Brush brush, string styleName, ColorMode mode, Size size)
        {
            ...
            else if (brush is RadialGradientBrush)
            {
                ...
                if (radialBrush.GradientOrigin.X < 0 || radialBrush.GradientOrigin.X > 1 || radialBrush.GradientOrigin.Y < 0 || radialBrush.GradientOrigin.Y > 1)
                    brushElement.Attributes.Append(JSONHelper.CreateNewAttribute("r", "100%", doc));
...
//                }
        ...
        void AddReference(ScreenSettings.Entities.ScreenEntity entity, FrameworkElement fe,
                                ...
                                Dictionary<string, string> entityDynamics = null)
        {
            ...
            */
            ...
            {                
                ...
                {
                    var xmlReference = dynamicMap[k];
                    if (entityDynamics.ContainsKey(xmlReference))
                        xmlReference = entityDynamics[xmlReference];
                    OPCUAEntityReference newreference = xmlReference.FromXml<OPCUAEntityReference>();
        ...
        internal void AddCommandReference(string item,
                                CommandManager.CommandManager command,
                                Dictionary<string, List<string>> expressionVariables,
                                Dictionary<string, OPCUAEntityReference> resolvedVariables,
                                Dictionary<string, Dictionary<string, string>> dynamicMap,
                                ...
                                ScreenEntity sentity = null)
        {
            if (command != null)
            {
                ...
                {
                    var vcommand = command as ValueCommand;
                    vcommand.SVGTransferReferenceId = GetReferenceID(vcommand.TransferToTag, command.Name, item);
                    var tagMaxValue = vcommand.TagMaxValue;
                    var tagMinValue = vcommand.TagMinValue;
                    if (vcommand.InheritFromControl && sentity?.Element is IInheritPropertiesFromControl)
                    {
                        var control = (IInheritPropertiesFromControl)sentity.Element;
                        vcommand.MinValue = Convert.ToDouble(control.GetMinValue());
                        vcommand.MaxValue = Convert.ToDouble(control.GetMaxValue());
                        vcommand.Decimals = (uint)control.GetPrecisionDigit();
                        vcommand.UseEUnit = control.GetUseEngineeringUnit();
                        vcommand.IdUnitConverter = control.GetUnitConverterFromControl(control);
                        OPCUAEntityReference minReference = null;
                        OPCUAEntityReference maxReference = null;
                        var tagMinValueXml = control.GetTagMinValue();
                        var tagMaxValueXml = control.GetTagMaxValue();
                        if (!String.IsNullOrEmpty(tagMinValueXml))
                        {
                            if (dynamicMap.ContainsKey(item) && dynamicMap[item].ContainsKey(tagMinValueXml))
                                tagMinValueXml = dynamicMap[item][tagMinValueXml];
                            minReference = new OPCUAXMLEntityReference() { TagReferenceXml = tagMinValueXml }.TagReference;
                        }
                        if (!String.IsNullOrEmpty(tagMaxValueXml))
                        {
                            if (dynamicMap.ContainsKey(item) && dynamicMap[item].ContainsKey(tagMaxValueXml))
                                tagMaxValueXml = dynamicMap[item][tagMaxValueXml];
                            maxReference = new OPCUAXMLEntityReference() { TagReferenceXml = tagMaxValueXml }.TagReference;
                        }
                        if (minReference != null)
                            tagMinValue = minReference;
                        if (maxReference != null)
                            tagMaxValue = maxReference;
                    }
                    vcommand.SVGMinValueReferenceId = tagMinValue?.IsValid == false ? -1 : GetReferenceID(tagMinValue, command.Name, item);
                    vcommand.SVGMaxValueReferenceId = tagMaxValue?.IsValid == false ? -1 : GetReferenceID(tagMaxValue, command.Name, item);
                }
                ...
                var oc = command as OpenScreenCommand;
                if (oc != null)
                    oc.ScreenName = Document.MakeRelativeUri(Document.MakeAbosoluteUri(oc.ScreenName));
        ...
        void CreateResourceFiles(string folderPath)
        {
            ...
            var dynamicMap = new Dictionary<string, Dictionary<string,string>>();
            foreach (var key in Document.MapScreenEntities.Keys)
            {
                ...
                if (sentity.Document != null)
                    dynamicMap.Add(key, sentity.ReplaceAllAliasInOnce());
            ...
            foreach (var item in Document.MapScreenEntities.Keys)
            {
                ...
                if (canvasItems.Contains(clearedName))
                    try
                    {
                        var entityDynamics = dynamicMap.ContainsKey(item) ? dynamicMap[item] : null;
                        AddEntityReferences(item, entitiesList, animationList, commandList,
                                                            expressionVariables, resolvedVariables, dynamicMap, resolveditems, entityDynamics);
                    }
                    catch(Exception ex)
                    {
                        Exception e = (ex.InnerException != null ? ex.InnerException : ex);
        ...
        private void AddEntityReferences(string item, entities entitiesList,
            ...
            Dictionary<string, OPCUAEntityReference> resolvedVariables, Dictionary<string, Dictionary<string, string>> dynamicMap, List<string> resolveditems, Dictionary<string, string> entityDynamics = null)
        {
            ...
            animationList, commandList, expressionVariables, resolvedVariables, resolveditems, dynamicMap);
            ...
            int? entityrefID;
            AddReference(sentity, fe, clearedName, expressionVariables, resolvedVariables,out entityrefID, entityReference, entityDynamics);
            ...
            foreach (var command in listCommand)
                AddCommandReference(clearedName, command, expressionVariables, resolvedVariables, dynamicMap, entityReference, sentity);
        ...
        private OPCUAEntityReference GetParentTag(string name, OPCUAEntityReference entityreference, entities entitiesList,
            AnimationManagerList animationList, CommandManagerList commandList, Dictionary<string, List<string>> expressionVariables,
            Dictionary<string, OPCUAEntityReference> resolvedVariables, List<string> resolveditems, Dictionary<string, Dictionary<string, string>> dynamicMap)
        {
                    ...
                    while (names.Count > 0)
                    {
                        ...
                        if (Document.MapScreenEntities.ContainsKey(parent) && IsReferenceValid(Document.MapScreenEntities[parent].OpcuaEntityReference))
                        {
                            AddEntityReferences(parent, entitiesList, animationList, commandList,
                                                       expressionVariables, resolvedVariables, dynamicMap, resolveditems);
    ...
    public static class JSONHelper
    {
        ...
        //public static string GetBrushCssString(IDocument document, Brush brush, FrameworkElement fe)
        //{
        //    string ret = String.Empty;
        //    if (brush is SolidColorBrush)
        //    {
        //        SolidColorBrush color = (brush as SolidColorBrush);
        //        ret = ColorConverterExtensions.ToRgbString(color.Color);
        //    }
        //    else if (brush is LinearGradientBrush)
        //    {
        ...
        //    }
        //    else if (brush is VisualBrush)
        //        ret = WPFUtilities.ImageHelper.BrushToImagePath(document, brush);
        //    else if (brush is ImageBrush)
        //        ret = WPFUtilities.ImageHelper.BrushToImagePath(document, brush);
        //    return ret;
        //}
        ...
        private static JContainer GetBrush(IDocument parent, IDocument document, Brush brush, FrameworkElement fe)
        {
            ...
            else if (brush is LinearGradientBrush)
            {
                ...
                if (color.GradientStops.Count > 0)
                {
                    ...
                    try
                    {
                        var firstStopColor = ColorConverterExtensions.ToRgbString(gradients.First().Color);
                        AddElement(jsonobjvalue, "SolidColor", $"{firstStopColor}");
                    }
                    catch { }
                    for (int i = 0; i < gradients.Count; i++)
                    {
                ...
                try
                {
                    ...
                    if (Attribute.IsDefined(p, typeof(Utilities.SvgValueConverterAttribute)))
                    {
                        ...
                        if (attribute.ConverterType != null)
                        {
                            ...
                            value = converter.ConvertToStorageType(value, customObject, document, dproperty, attribute.ConverterParameter);
                            converter = null;
                        }
                    }
        ...
        public static Dictionary<string, string> GetStyles(FrameworkElement customObject, Dictionary<Type, List<PropertyInfo>> propertyCache)
        {
            ...
            if (customObjectSvgAttribute != null && customObjectSvgAttribute.HasStyles)
            {
                ...
                CustomValueConverter converter = (CustomValueConverter)Activator.CreateInstance(converterType);
                var styles = converter.ConvertToStorageType(null, customObject, null, null, null) as Dictionary<string, string>;
                if(styles == null)
        ...
        public static Dictionary<string, Brush> GetUrlBrushes(FrameworkElement customObject, string elementName, object document)
        {
            Type type = customObject.GetType();
            ...
            var styles = new Dictionary<string, Brush>();

            var txtbox = customObject as TextBox;
            if (txtbox != null)
            {
                if (txtbox.Background != null && !(txtbox.Background is SolidColorBrush))
                    styles.Add("Background", txtbox.Background);
                if (txtbox.BorderBrush != null && !(txtbox.BorderBrush is SolidColorBrush))
                    styles.Add("BorderBrush", txtbox.BorderBrush);
                return styles;
            }
            else if ((customObject is Buttons.ButtonControl || customObject is Buttons.RepeatButtonControl || customObject is Button) && (Utilities.WPF.XmlHelper.IsProblematicXamlWriter(customObject) || customObject is Button) && !((ScreenDocument)document).MapScreenEntities[elementName].SourceSymbolLinked)
            {
                var btn = (Control)customObject;
                if (btn.Background != null && !(btn.Background is SolidColorBrush))
                    styles.Add("Background", btn.Background);
            }
            ...
            if (customPropSvgAttribute != null && customPropSvgAttribute.NeedSVGUrlBrushes)
            {
                ...
                CustomValueConverter converter = (CustomValueConverter)Activator.CreateInstance(converterType);
                if (customObject is Buttons.CheckBoxControl && Utilities.WPF.XmlHelper.IsProblematicXamlWriter(customObject))
                {
                    if (((ScreenDocument)document).MapScreenEntities[elementName].SourceSymbolLinked)
                        styles.Add("BorderBrush", ((Buttons.CheckBoxControl)customObject).BorderBrush);
                }
                var objectStyles = converter.ConvertFromStorageType(null, customObject, document) as Dictionary<string, Brush>;
                if (objectStyles != null)
                    objectStyles.Keys.ToList().ForEach(key =>
                    {
                        if (!styles.ContainsKey(key))
                            styles.Add(key, objectStyles[key]);
                    });
                return styles;
            }
            return styles;
