...
namespace SerialDriverCodeBaseEx
{
    ...
    public class SerialChannelSettings : ChannelSettings
    {
            ...
            : base(session)
        {
            ...
            // fix difference between storage's schema to class schema (properties)
        ...
        public override void CopyProperties(ChannelSettings ch)
        {
            ...
            if(ch is SerialChannelSettings)
            {
                CommPortName = ((SerialChannelSettings)ch).CommPortName;
                CommPortNameLinux = ((SerialChannelSettings)ch).CommPortNameLinux;
                CommPortBaudRate = ((SerialChannelSettings)ch).CommPortBaudRate;
                CommPortDataBits = ((SerialChannelSettings)ch).CommPortDataBits;
                CommPortParity = ((SerialChannelSettings)ch).CommPortParity;
                CommPortStopBits = ((SerialChannelSettings)ch).CommPortStopBits;
                CommPortHandshake = ((SerialChannelSettings)ch).CommPortHandshake;
                CommPortRtsEnable = ((SerialChannelSettings)ch).CommPortRtsEnable;
                CommPortDtrEnable = ((SerialChannelSettings)ch).CommPortDtrEnable;
                CommPortReadTimeout = ((SerialChannelSettings)ch).CommPortReadTimeout;
                CommPortWriteTimeout = ((SerialChannelSettings)ch).CommPortWriteTimeout;
            }
        }
        /////////////////////////////
