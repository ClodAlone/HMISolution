...
namespace UFUAEditor.TreeDocumentManagers
{
    class TreeGeneralSettingsDocManager : IDocumentManager
    {
        ...
        #region Constructors
        internal TreeGeneralSettingsDocManager(UFUAEditorManagerComponent c, UFUAServerDocument doc)
        {
        ...
        public BitmapImage TypeIcon
        {
            get 
            {
                return UFUAEditorManagerComponent.GetBitmapImage("UFUASGeneralSettingsSmall"); 
            }
        }
        ...
        public BitmapImage TypeIconLarge
        {
            get 
            {
                return UFUAEditorManagerComponent.GetBitmapImage("UFUASGeneralSettings"); 
            }
        }
