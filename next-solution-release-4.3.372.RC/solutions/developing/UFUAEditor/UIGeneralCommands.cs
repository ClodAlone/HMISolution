...
namespace UFUAEditor
{
    ...
    public static class UIGeneralCommands
    {
        ...
        public static GeneralCommand ImportEngineeringUnits
        {
            get { return _ImportEngineeringUnits; }
        }


        private static GeneralCommand _ImportEngineeringUnits = new GeneralCommand(
            Properties.UICommandResource.ImportEngineeringUnitsName,
            Properties.UICommandResource.ImportEngineeringUnitsText,
            Properties.UICommandResource.ImportEngineeringUnitsGestures,
            Properties.UICommandResource.ImportEngineeringUnitsGesturesDisplayText,
            Properties.UICommandResource.ImportEngineeringUnitsTooltip,
            Properties.UICommandResource.ImportEngineeringUnitsDescription,
            typeof(UIGeneralCommands));
