...
namespace UFCrossReferenceEditor.TreeDocumentManagers
{
    class TreeDocumentManager : IDocumentManager
    {
        #region Declarations
        readonly CREditorDocument Document;
        readonly CrossReferenceEditorManagerComponent DocumentEditorManagerComponent;
        readonly String Name;
        #endregion

        public TreeDocumentManager(CrossReferenceEditorManagerComponent c, CREditorDocument doc, String name)
        {
        ...
        {
            get { return CrossReferenceEditorManagerComponent.GetBitmapImage("UFCREditorSmall"); }
        }
        ...
        {
            get { return CrossReferenceEditorManagerComponent.GetBitmapImage("UFCREditor"); }
        }
