@ECHO OFF
If "%~1"=="" echo Please supply a valid branch name and retry && Exit 1
SET repositoryName=%~1
SET BaseDEployPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\ 
If Not Exist %BaseDEployPath% echo The base deploy folder is missing, please create it before starting this script. && Exit 1
...
SET ServerRetailVersionPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\Compiled-Files\

SET LocalRetailObfuscatedPath=.\UFSolution\bin\Retail.obfuscated\
SET ServerRetailObfuscatedPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\Compiled-%ObfuscatedSuffix%\

SET LocalVersionConnextPath=.\UFSolution\bin\Retail.Connext\
SET ServerVersionConnextPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\Connext-Files\

SET LocalObfuscatedConnextPath=.\UFSolution\bin\Retail.Connext.obfuscated\
SET ServerObfuscatedConnextPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\Connext-%ObfuscatedSuffix%\

SET LocalNetCoreVersionPath=.\UFSolution\bin\NetCore\
SET ServerNetCoreVersionPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\NetCore-Files\

SET LocalNetCoreObfuscatedPath=.\UFSolution\bin\NetCore.obfuscated\
SET ServerNetCoreObfuscatedPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\NetCore-%ObfuscatedSuffix%\

SET LocalNetCoreConnextVersionPath=.\UFSolution\bin\NetCore.Connext\
SET ServerNetCoreConnextVersionPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\NetCoreConnext-Files\

SET LocalNetCoreConnextObfuscatedPath=.\UFSolution\bin\NetCore.Connext.obfuscated\
SET ServerNetCoreConnextObfuscatedPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\NetCoreConnext-%ObfuscatedSuffix%\

SET LocalDeployServerVersionPath=.\UFSolution\bin\DeployServer\
SET ServerDeployServerVersionPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\DeployServer-Files\

SET LocalDeployServerObfuscatedPath=.\UFSolution\bin\DeployServer.obfuscated\
SET ServerDeployServerObfuscatedPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\DeployServer-%ObfuscatedSuffix%\

SET LocalWebClientHMIVersionPath=.\UFSolution\bin\WebClientHMI\
SET ServerWebClientHMIVersionPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\WebClientHMI-Files\

SET LocalWebClientHMIObfuscatedPath=.\UFSolution\bin\WebClientHMI.obfuscated\
SET ServerWebClientHMIObfuscatedPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\WebClientHMI-%ObfuscatedSuffix%\

SET LocalOptionalsObfuscatedPath=.\UFSolution\bin\Optionals.obfuscated\

SET ServerLibrariesPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\Libraries-Files\
SET ServerProEneryPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\ProEnergy\
SET ServerProLeanPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\ProLean\

SET ServerNExTBAPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\MoviconBA\

SET LocalLicenseRootPath=.\UFSolution\bin\NextLicMng\
SET ServerLicenseRootPath=\\itmdnaspengfs01\update\Latest\%repositoryName%\NextLicMng\

SET OutputPathCompiled="\\itmdnaspengfs01\update\Latest\%repositoryName%\Compiled-Resources"
SET OutputPathLibraries="\\itmdnaspengfs01\update\Latest\%repositoryName%\Libraries-Resources"
SET OutputPathCultures="\\itmdnaspengfs01\update\Latest\%repositoryName%\Cultures-Resources"

SET OutputPathSharedResources="\\Itmdnaspengfs01\grafica\Archivio_Grafico\Grafica Movicon NEXT\SharedResources-Projects\4.2\"

If Not Exist \\itmdnaspengfs01\update\Latest\%repositoryName%\ xcopy /S /Y /Z /Q  \\itmdnaspengfs01\update\Latest\movicon-4-3-test\ \\itmdnaspengfs01\update\Latest\%repositoryName%\ 
