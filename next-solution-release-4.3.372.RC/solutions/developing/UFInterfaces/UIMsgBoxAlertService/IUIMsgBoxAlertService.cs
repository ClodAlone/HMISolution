...
namespace UIMsgBoxAlertService.ComponentService
{
    ...
    public interface IUIMsgBoxAlertService : IUFInterfaceBase
    {
        ...
        CustomDialogResults ShowYesNo(string message, CustomDialogIcons icon, string title = null);
        ...
        /// <param name="icon">The icon to be displayed.</param>
        /// <returns>User selection.</returns>
        CustomDialogResults ShowYesNoCancel(string message, CustomDialogIcons icon, string title = null);
        ...
        /// <param name="icon">The icon to be displayed.</param>
        /// <returns>User selection.</returns>
        CustomDialogResults ShowYesNoAllCancel(string message, CustomDialogIcons icon, string title = null);
        ...
        /// <param name="icon">The icon to be displayed.</param>
        /// <returns>User selection.</returns>
        CustomDialogResults ShowOkCancel(string message, CustomDialogIcons icon, string title = null);
