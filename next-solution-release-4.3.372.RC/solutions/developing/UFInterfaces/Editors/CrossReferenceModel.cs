...
namespace UFInterfaces.Editors
{
    public class CrossReferenceModel
    {
        ...
        public bool ApplyNewNames { get; private set; }
        ...
        public CrossReferenceModel(DocumentManager.ComponentService.IDocument p,
            CancellationToken q, Dictionary<string, object> s, IEnumerable<string> r, CRManagement cRManagement, bool bApplyNewNames)
        {
            Parent = p;
            QuitEvent = q;
            ScriptTagMap = s;
