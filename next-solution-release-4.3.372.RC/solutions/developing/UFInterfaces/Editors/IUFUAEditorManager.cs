...
namespace UFUAEditor.ComponentService
{
    ...
    public interface IUFUAEditorManager : IUFInterfaceBase
    {
        ...
        UserControl GetEngineeringUnitsControl(IDocument parent, bool isPopup = false, string itemToSelect = null);
#endif
...
#endif
        IEnumerable<String> GetFlatListTags(IDocument parent, bool inExecution = false);
        IDictionary<String, IList<string>> GetFlatListChildTags(IDocument parent, bool inExecution = false);
#if !NET_STANDARD
...
#endif
        IDictionary<String, IList<string>> GetListPrototypesDesc(IDocument parent);
        IDictionary<String, IDictionary<String, IList<string>>> GetListChildsPrototypesDesc(IDocument parent);
        IDictionary<String, IList<String>> GetFlatListPrototypes(IDocument parent, bool inExecution = false);
        IDictionary<String, String> GetFlatListPrototypeInstances(IDocument parent, bool inExecution = false);
        IDictionary<String, IDictionary<String, String>> GetFlatListChildsPrototypeInstances(IDocument parent, bool inExecution = false);
        String GetTagEntityReference(IDocument parent, String tagName, String Instance, bool inExecution = false, bool useCachedUow = false, string Project = null);
        ...
        IDocument GetProjectDocument(IDocument parent, string appName, bool inExecution = false);

        String GetWriteVarValuesOPCUAEntityReference(IDocument parent);
        ...
        bool IsTagPrototype(IDocument parent, String tagName, String instance, bool useCachedUow = false, string childProject = null);
    }
}
