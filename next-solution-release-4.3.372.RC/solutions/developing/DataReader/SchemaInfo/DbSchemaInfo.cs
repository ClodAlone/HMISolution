...
namespace DataReader.SchemaInfo
{
    ...
    public abstract class DbSchemaInfo : IDisposable
    {
        ...
        protected virtual bool IsFixedPrecisionScale(string typeName)
        {
            var info = ProviderTypeInfo[typeName];
        ...
        public bool IsTableNameNeedOnDropIndex
        {
            get
            {
                if (dataSourceProductName == null)
                ...
                return !dataSourceProductName.Contains("PostgreSQL") && !dataSourceProductName.Contains("Npgsql");
            }
        }
        #endregion
        ...
        public virtual DbType GetProviderDbType(Type type)
        {
            return GetProviderDataType(type).ToDbType();
        }
