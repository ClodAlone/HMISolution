    ...
    public static class TypeExtensions
    {
        ...
        private static string ToString(object value, Type sourceType)
        {
            ...
            switch (sourceType.Name)
            {
                ...
                case "Boolean": return Convert.ToString((bool)value, System.Globalization.CultureInfo.InvariantCulture);
                case "SByte": return Convert.ToString((sbyte)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Byte": return Convert.ToString((byte)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Int16": return Convert.ToString((short)value, System.Globalization.CultureInfo.InvariantCulture);
                case "UInt16": return Convert.ToString((ushort)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Int32": return Convert.ToString((int)value, System.Globalization.CultureInfo.InvariantCulture);
                case "UInt32": return Convert.ToString((uint)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Int64": return Convert.ToString((long)value, System.Globalization.CultureInfo.InvariantCulture);
                case "UInt64": return Convert.ToString((ulong)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Decimal": return Convert.ToString((decimal)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Single": return Convert.ToString((float)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Double": return Convert.ToString((double)value, System.Globalization.CultureInfo.InvariantCulture);
                case "DateTime": return Convert.ToString((DateTime)value, System.Globalization.CultureInfo.InvariantCulture);
                case "TimeSpan": return Convert.ToString((TimeSpan)value, System.Globalization.CultureInfo.InvariantCulture);
                case "Guid": return Convert.ToString((Guid)value, System.Globalization.CultureInfo.InvariantCulture);
            }
