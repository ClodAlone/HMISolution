...
namespace PropertyControl.Localization
{
    public class PropertyResourceManager
    {
        ...
        internal bool GetElementFromMapItems(string propertyName, out string foundString)
        {
            foundString = null;
            if (mapItems != null && mapItems.ContainsKey(propertyName))
                foundString = mapItems[propertyName];
