...
namespace RecipeUAServer
{
    public partial class RecipeServer : UFUAServer
    {
        ...
        #region Methods
        public UFRecipeEditor.ComponentService.RecipeEditorManagerComponent RecipeManager
        {
            get
            {
        ...
        public UFProjectManager.UFProjectDocument ProjectDocument
        {
            get
            {
        ...
        internal String[] GetSharedRedundancyServers()
        {
            if (projectDocument == null)
                return null;

            return ufuaEditorComponent.GetServerUriArray(projectDocument);
        }
