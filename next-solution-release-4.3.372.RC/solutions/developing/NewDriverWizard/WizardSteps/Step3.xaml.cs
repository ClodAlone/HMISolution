        ...
        public Step3()
        {
            ...
            Loaded += (o, e) =>
            {
                ...
                try
                {
                    ...
                    if (driverWpfEditing is ICommunicationDriverWpfEditingSql)
                        channel = (driverWpfEditing as ICommunicationDriverWpfEditingSql).NewChannelSettingsEditor(NewDriverWizardComponent.genSett, NewDriverWizardComponent.currentConn);
                    else
