...
#region Methods
        ...
        {
            return conditionState.BranchId == null ||
                conditionState.BranchId.Value == null ||
                NodeId.IsNull(conditionState.BranchId.Value);
        }
...
#region Properties
        ...
        public DateTime? TimeOn
        {
            get
            {
                if (ActiveTransitionTime != null)
                    return ActiveTransitionTime;
                else
                    return Time;
            }
        }
        ...
        public DateTime? ActiveEffectiveTransitionTime
        {
            get
            {
                if (conditionState is AlarmConditionState)
                {
                    var alarmcondition = conditionState as AlarmConditionState;
                    if (alarmcondition.ActiveState != null && alarmcondition.ActiveState.EffectiveTransitionTime != null)
                        return alarmcondition.ActiveState.EffectiveTransitionTime.Value;
                }
