...
SET ServerRetailVersionPath=\\Server2\update\Latest\mov4.3\Compiled-Files\

SET LocalRetailObfuscatedPath=.\UFSolution\bin\Retail.obfuscated\
SET ServerRetailObfuscatedPath=\\Server2\update\Latest\mov4.3\Compiled-%ObfuscatedSuffix%\

SET LocalVersionConnextPath=.\UFSolution\bin\Retail.Connext\
SET ServerVersionConnextPath=\\Server2\update\Latest\mov4.3\Connext-Files\

SET LocalObfuscatedConnextPath=.\UFSolution\bin\Retail.Connext.obfuscated\
SET ServerObfuscatedConnextPath=\\Server2\update\Latest\mov4.3\Connext-%ObfuscatedSuffix%\

SET LocalNetCoreVersionPath=.\UFSolution\bin\NetCore\
SET ServerNetCoreVersionPath=\\Server2\update\Latest\mov4.3\NetCore-Files\

SET LocalNetCoreObfuscatedPath=.\UFSolution\bin\NetCore.obfuscated\
SET ServerNetCoreObfuscatedPath=\\Server2\update\Latest\mov4.3\NetCore-%ObfuscatedSuffix%\

SET LocalNetCoreConnextVersionPath=.\UFSolution\bin\NetCore.Connext\
SET ServerNetCoreConnextVersionPath=\\Server2\update\Latest\mov4.3\NetCoreConnext-Files\

SET LocalNetCoreConnextObfuscatedPath=.\UFSolution\bin\NetCore.Connext.obfuscated\
SET ServerNetCoreConnextObfuscatedPath=\\Server2\update\Latest\mov4.3\NetCoreConnext-%ObfuscatedSuffix%\

SET LocalDeployServerVersionPath=.\UFSolution\bin\DeployServer\
SET ServerDeployServerVersionPath=\\Server2\update\Latest\mov4.3\DeployServer-Files\

SET LocalDeployServerObfuscatedPath=.\UFSolution\bin\DeployServer.obfuscated\
SET ServerDeployServerObfuscatedPath=\\Server2\update\Latest\mov4.3\DeployServer-%ObfuscatedSuffix%\

SET LocalWebClientHMIVersionPath=.\UFSolution\bin\WebClientHMI\
SET ServerWebClientHMIVersionPath=\\Server2\update\Latest\mov4.3\WebClientHMI-Files\

SET LocalWebClientHMIObfuscatedPath=.\UFSolution\bin\WebClientHMI.obfuscated\
SET ServerWebClientHMIObfuscatedPath=\\Server2\update\Latest\mov4.3\WebClientHMI-%ObfuscatedSuffix%\

SET LocalOptionalsObfuscatedPath=.\UFSolution\bin\Optionals.obfuscated\

SET ServerLibrariesPath=\\Server2\update\Latest\mov4.3\Libraries-Files\
SET ServerProEneryPath=\\Server2\update\Latest\mov4.3\ProEnergy\
SET ServerProLeanPath=\\Server2\update\Latest\mov4.3\ProLean\

SET ServerNExTBAPath=\\Server2\update\Latest\mov4.3\MoviconBA\

SET LocalLicenseRootPath=.\UFSolution\bin\NextLicMng\
SET ServerLicenseRootPath=\\Server2\update\Latest\mov4.3\NextLicMng\

SET OutputPathCompiled="\\Server2\update\Latest\mov4.3\Compiled-Resources"
SET OutputPathLibraries="\\Server2\update\Latest\mov4.3\Libraries-Resources"
SET OutputPathCultures="\\Server2\update\Latest\mov4.3\Cultures-Resources"
