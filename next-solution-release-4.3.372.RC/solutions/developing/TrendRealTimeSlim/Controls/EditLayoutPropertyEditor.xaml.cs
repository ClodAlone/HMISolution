    ...
    public partial class EditLayoutPropertyEditor : UserControl
    {
        ...
        private void EditLayout_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Workspace != null)
            {
                ...
                if (contextObject is RealTimeTrendControl)
                {
                    var obj = contextObject as RealTimeTrendControl;
                    ...
                    using (var lcontrol = new RealTimeTrendControl()
                    {
                        Width = obj.Width,
                        Height = obj.Height,
                        Document = Document
                    ...
                    { 
                        ...
                        var Dialog = new GeneralDialogContent(lcontrol)
                        {
                            ...
                            HelpLink = "RealTimeTrendControlEditLayout"
                        };
