...
namespace StringModel
{
    ...
    public class UFStringLocale : XPObject
    {
        public UFStringLocale(Session session)
            : base(session)
        { }
        ...
        [Association("UFStringLocale-UFStringLocaleTexts"), Aggregated]
        public XPCollection<UFStringLocaleText> UFStringLocaleTexts
        {
            get
            {
                return GetCollection<UFStringLocaleText>("UFStringLocaleTexts");
            }
        }
        #endregion
