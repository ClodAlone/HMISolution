        ...
        public bool HasCommands
        {
            get
            {
                return !String.IsNullOrEmpty(CommandsOn) ||
                    ...
                    !String.IsNullOrEmpty(ExceptionCommandsOn) ||
                    !String.IsNullOrEmpty(ExceptionCommandsOff);
            }
        }
#endregion
...
#region OpcUaEntityReference
        ...
        public string ExceptionValueOn
        {
            get
            {
                return _ExceptionValueOn;
            }
            set
            {
                SetPropertyValue("ExceptionValueOn", ref _ExceptionValueOn, value);
            }
        }
        ...
        public string ExceptionValueOff
        {
            get
            {
                return _ExceptionValueOff;
            }
            set
            {
                SetPropertyValue("ExceptionValueOff", ref _ExceptionValueOff, value);
            }
        }
        ...
        private string _ExceptionCommandsOff;
        [Category("Execution")]
        [Size(SizeAttribute.Unlimited)]
        public string ExceptionCommandsOff
        {
            get
            {
                return _ExceptionCommandsOff;
            }
            set
            {
                SetPropertyValue("ExceptionCommandsOff", ref _ExceptionCommandsOff, value);
            }
        }

        private string _ExceptionCommandsOn;
        [Category("Execution")]
        [Size(SizeAttribute.Unlimited)]
        public string ExceptionCommandsOn
        {
            get
            {
                return _ExceptionCommandsOn;
            }
            set
            {
                SetPropertyValue("ExceptionCommandsOn", ref _ExceptionCommandsOn, value);
            }
        }
