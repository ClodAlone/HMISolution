    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (maxSessions > 0)
            {
                ...
                {
                    activeSessions = new Semaphore((int)maxSessions, (int)maxSessions);
                }
                catch (WaitHandleCannotBeOpenedException)
                {
                    ...
                    activeSessions = new Semaphore((int)maxSessions, (int)maxSessions, semaphoreName, out createdNew);
                }                
            }
            bool acquired = false;
            ...
            ServicesToRun.StartingService += (ob, ev) =>
            {
                if (maxSessions > 0)
                {
                    ...
                    if (!acquired)
                    {
                        ...
                        {
                            Console.WriteLine(Properties.Resources.MaxServerSessionNumberExceded);
                        }
