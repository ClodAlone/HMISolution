...
namespace SystemTrayApp
{
    public class SysTrayApp : System.Windows.Forms.Form
    {
        ...
        readonly ScriptServiceCMS.ScriptServiceCSMHelpers serverCMSHelper;
        ...
        {
            serverCMSHelper = new ScriptServiceCMS.ScriptServiceCSMHelpers(instanceId);

            title = ScriptServiceCMS.ScriptServiceCSMHelpers.GetServiceDisplayNameWhitoutDecoration();
