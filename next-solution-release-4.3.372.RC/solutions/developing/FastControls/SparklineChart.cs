...
namespace FastControls
{
        ...
        , IStringIDAware
    {
        ...
        async void LoadData()
        {
            ...
            Document = ScreenSettings.ScreenDocument.GetScreenDocument(this);
            if (Document != null)
                sessionString = (Document as ScreenDocument).SessionString;
            ...
            else
            {
                ...
                {
                    string settings = RealTimeConnectionManagerViewModel.ReplaceServerRenamedOnDataSource(ufuaEditorService.GetHistorianDefaultConnection(Document), sessionString);
            ...
            if (ControlDataSource != null && ControlDataSource.ReaderModel != null)
            {
                    ...
                    !string.IsNullOrEmpty(model.Connection))
                {
                    ...
                    defaultConnectionString = XpoHelpers.XpoHelper.NormalizeConnectionString(RealTimeConnectionManagerViewModel.ReplaceServerRenamedOnDataSource(model.Connection, sessionString), Document?.rootBase);
                }
