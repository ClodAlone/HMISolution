...
namespace AlarmWindow
{
    ...
    /// </summary>
    public partial class BannerAlarmWindow : UserControl, IEntityReference, IDisposable, IContainPropertyEditors, IStringIDAware, ISettingsHelper
    {
        ...
        public static readonly DependencyProperty ConnectChildAlarmsProperty = DependencyProperty.Register("ConnectChildAlarms", typeof(bool), typeof(BannerAlarmWindow), new UIPropertyMetadata(false, new PropertyChangedCallback(OnConnectChildAlarmsChanged), new CoerceValueCallback(OnCoerceConnectChildAlarms)));
        ...
        #region Alarms Severity Filter

        public static readonly DependencyProperty SeverityFilterProperty = DependencyProperty.Register("SeverityFilter", typeof(int), typeof(BannerAlarmWindow), new UIPropertyMetadata(0, new PropertyChangedCallback(OnSeverityFilterChanged), new CoerceValueCallback(OnCoerceSeverityFilter)));

        private static object OnCoerceSeverityFilter(DependencyObject o, object value)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                return bannerAlarmWindow.OnCoerceSeverityFilter((int)value);
            else
                return value;
        }

        private static void OnSeverityFilterChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                bannerAlarmWindow.OnSeverityFilterChanged((int)e.OldValue, (int)e.NewValue);
        }

        protected virtual int OnCoerceSeverityFilter(int value)
        {
            return value;
        }

        protected virtual void OnSeverityFilterChanged(int oldValue, int newValue)
        {
            if (oldValue != newValue && !DesignerProperties.GetIsInDesignMode(this) && bLoaded && bInit)
            {
                GetNextAlarm();
            }
        }
        ...
        /// <summary>
        /// Filter for Alarm Severity field
        /// </summary>
        public int SeverityFilter
        {
            ...
            get
            {
                return (int)GetValue(SeverityFilterProperty);
            }
            set
            {
                SetValue(SeverityFilterProperty, value);
            }
        }
        #endregion

        #region Alarms Severity Filter Condition
        public static readonly DependencyProperty SeverityFilterConditionsProperty = DependencyProperty.Register("SeverityFilterConditions", typeof(SeverityFilterCondition), typeof(BannerAlarmWindow), new UIPropertyMetadata(SeverityFilterCondition.Equal, new PropertyChangedCallback(OnSeverityFilterConditionChanged), new CoerceValueCallback(OnCoerceSeverityFilterCondition)));

        private static object OnCoerceSeverityFilterCondition(DependencyObject o, object value)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                return bannerAlarmWindow.OnCoerceSeverityFilterCondition((SeverityFilterCondition)value);
            else
                return value;
        }

        private static void OnSeverityFilterConditionChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                bannerAlarmWindow.OnSeverityFilterConditionChanged((SeverityFilterCondition)e.OldValue, (SeverityFilterCondition)e.NewValue);
        }

        protected virtual SeverityFilterCondition OnCoerceSeverityFilterCondition(SeverityFilterCondition value)
        {
            return value;
        }

        protected virtual void OnSeverityFilterConditionChanged(SeverityFilterCondition oldValue, SeverityFilterCondition newValue)
        {
            if (oldValue != newValue && !DesignerProperties.GetIsInDesignMode(this) && bLoaded && bInit)
            {
                GetNextAlarm();
        ...
        /// <summary>
        /// Set if the Alarm Severity Filter value is Equal, Greater or Equal, Minor or Equal
        /// </summary>
        public SeverityFilterCondition SeverityFilterConditions
        {
            // IMPORTANT: To maintain parity between setting a property in XAML and procedural code, do not touch the getter and setter inside this dependency property!
            get
            {
                return (SeverityFilterCondition)GetValue(SeverityFilterConditionsProperty);
            }
            set
            {
                SetValue(SeverityFilterConditionsProperty, value);
            }
        }

        #endregion

        #region Alarms Mask Filter

        public static readonly DependencyProperty AlarmMaskFilterProperty = DependencyProperty.Register("AlarmMaskFilter", typeof(int), typeof(BannerAlarmWindow), new UIPropertyMetadata((int)AlarmMask.Default, new PropertyChangedCallback(OnAlarmMaskFilterChanged), new CoerceValueCallback(OnCoerceAlarmMaskFilter)));

        private static object OnCoerceAlarmMaskFilter(DependencyObject o, object value)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                return bannerAlarmWindow.OnCoerceAlarmMaskFilter((int)value);
            else
                return value;
        }

        private static void OnAlarmMaskFilterChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                bannerAlarmWindow.OnAlarmMaskFilterChanged((int)e.OldValue, (int)e.NewValue);
        }

        protected virtual int OnCoerceAlarmMaskFilter(int value)
        {
            return value;
        }

        protected virtual void OnAlarmMaskFilterChanged(int oldValue, int newValue)
        {
            if (oldValue != newValue && !DesignerProperties.GetIsInDesignMode(this) && bLoaded && bInit)
            {
                GetNextAlarm();
        ...
        /// <summary>
        /// Filter for Alarm State
        /// </summary>
        public int AlarmMaskFilter
        {
            // IMPORTANT: To maintain parity between setting a property in XAML and procedural code, do not touch the getter and setter inside this dependency property!
            get
            {
                return (int)GetValue(AlarmMaskFilterProperty);
            }
            set
            {
                SetValue(AlarmMaskFilterProperty, value);
            }
        }
        #endregion

        #region Alarms Description Filter

        public static readonly DependencyProperty AlarmDescriptionFilterProperty = DependencyProperty.Register("AlarmDescriptionFilter", typeof(string), typeof(BannerAlarmWindow), new UIPropertyMetadata(String.Empty, new PropertyChangedCallback(OnAlarmDescriptionFilterChanged), new CoerceValueCallback(OnCoerceAlarmDescriptionFilter)));

        private static object OnCoerceAlarmDescriptionFilter(DependencyObject o, object value)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                return bannerAlarmWindow.OnCoerceAlarmDescriptionFilter((string)value);
            else
                return value;
        }

        private static void OnAlarmDescriptionFilterChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                bannerAlarmWindow.OnAlarmDescriptionFilterChanged((string)e.OldValue, (string)e.NewValue);
        }

        protected virtual string OnCoerceAlarmDescriptionFilter(string value)
        {
            return value;
        }

        protected virtual void OnAlarmDescriptionFilterChanged(string oldValue, string newValue)
        {
            if (oldValue != newValue && !DesignerProperties.GetIsInDesignMode(this) && bLoaded && bInit)
            {
                GetNextAlarm();
        ...
        /// <summary>
        /// Filter for Alarm Description field
        /// </summary>
        public string AlarmDescriptionFilter
        {
            // IMPORTANT: To maintain parity between setting a property in XAML and procedural code, do not touch the getter and setter inside this dependency property!
            get
            {
                return (string)GetValue(AlarmDescriptionFilterProperty);
            }
            set
            {
                SetValue(AlarmDescriptionFilterProperty, value);
            }
        }
        #endregion
        ...
        public static readonly DependencyProperty IconWidthProperty = DependencyProperty.Register(
            "IconWidth",
            typeof(int),
            typeof(BannerAlarmWindow),
            new UIPropertyMetadata(
                0,
                new PropertyChangedCallback(OnAllowIconWidthChanged),
                new CoerceValueCallback(OnCoerceIconWidth)));

        private static object OnCoerceIconWidth(DependencyObject o, object value)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                return bannerAlarmWindow.OnCoerceIconWidth((int)value);
            else
                return value;
        }

        private static void OnAllowIconWidthChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            BannerAlarmWindow bannerAlarmWindow = o as BannerAlarmWindow;
            if (bannerAlarmWindow != null)
                bannerAlarmWindow.OnAllowIconWidthChanged((int)e.OldValue, (int)e.NewValue);
        }

        protected virtual int OnCoerceIconWidth(int value)
        {
            // TODO: Keep the proposed value within the desired range.
            return value;
        }

        protected virtual void OnAllowIconWidthChanged(int oldValue, int newValue)
        {
            // TODO: Add your property changed side-effects. Descendants can override as well.
        }
        ...
        PropertyDescriptorCollection conditionStateViewModelDescriptor;
        private readonly ConditionStateCompositeCollection _conditionStateCollection;
        ...
        public BannerAlarmWindow()
        {
            ...
            _conditionStateCollection = new ConditionStateCompositeCollection(_syncLock);
            ...
            Loaded += (o, e) =>
            {
                if (!bLoaded && !bDispose)
                {
                    ...
                    conditionStateViewModelDescriptor = TypeDescriptor.GetProperties(typeof(ConditionStateViewModel));
            ...
            DataContextChanged += (o, e) =>
            {
                ...
                if (DataContext is MonitoredItemViewModel && sourceEntityReference == null)
                {
                    ...
                    if (helper != null && helper.UserManagerEnabled)
                        monitoredItemViewModel.ApplyConditionStateFilter(helper.CurrentUserReadAccessMask, helper.CurrentUserAccessLevel);
        ...
        private void eChild_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == "MonitoredItemViewModel")
            {
                ...
                {
                    if (helper != null && helper.UserManagerEnabled)
                        n.MonitoredItemViewModel.ApplyConditionStateFilter(helper.CurrentUserReadAccessMask, helper.CurrentUserAccessLevel);
        ...
        private void GetNextAlarm()
        {
            try
            {
                List<ConditionStateViewModel> alarms = GetAlarmsList();
        ...
        {
            _conditionStateCollection.Clear();

            if (monitoredItemViewModel?.ConditionStateList != null)
                _conditionStateCollection.Add(monitoredItemViewModel?.ConditionStateList);

            var childrenConditionStateList = childsMonitoredItemViewModel.Values
                .Where(m => m?.ConditionStateList != null)
                .Select(x => x.ConditionStateList)
                .Select(x => x)
                .AsQueryable();

            if (childrenConditionStateList.Any())
                _conditionStateCollection.AddRange(childrenConditionStateList);
        }

        private List<ConditionStateViewModel> GetAlarmsList()
        {
            List<ConditionStateViewModel> alarms = null;

            if (monitoredItemViewModel != null && _conditionStateCollection != null)
                alarms = _conditionStateCollection.OrderByDescending(x => x.TimeOn).ToList();
            ...
            if (alarms != null && alarms.Count > 0)
            {
                if(SeverityFilter != 0)
                {
                    ...
                    {
                        case SeverityFilterCondition.MajorEqual:
                            alarms = alarms.Where(x => x.Severity >= SeverityFilter).ToList();
                            break;
                        case SeverityFilterCondition.MinorEqual:
                            alarms = alarms.Where(x => x.Severity <= SeverityFilter).ToList();
                            break;
                        case SeverityFilterCondition.Equal:
                            alarms = alarms.Where(x => x.Severity == SeverityFilter).ToList();
                            break;
                        default:
                            alarms = alarms.Where(x => x.Severity == SeverityFilter).ToList();
                ...
                if(AlarmMaskFilter != 0)
                {
                    var converter = new AlarmMaskConverter();
                    var filteredList = new List<ConditionStateViewModel>();
                    if ((bool)converter.Convert(AlarmMaskFilter, null, AlarmMask.On, null))
                    {
                        filteredList.AddRange(alarms
                            .Where(x => (x.EnabledState.Contains(ConditionStateNames.Active) && x.EnabledState.Contains(ConditionStateNames.Unacknowledged))
                                        || (!x.IsEnableCallAcknowledge) && x.EnabledState.Contains(ConditionStateNames.Active)));
                    }
                    if ((bool)converter.Convert(AlarmMaskFilter, null, AlarmMask.OnAck, null))
                    {
                        filteredList.AddRange(
                            alarms.Where(x => x.EnabledState.Contains(ConditionStateNames.Active) && x.EnabledState.Contains(ConditionStateNames.Unconfirmed)));
                    }
                    if ((bool)converter.Convert(AlarmMaskFilter, null, AlarmMask.Off, null))
                    {
                        filteredList.AddRange(
                            alarms.Where(x => x.EnabledState.Contains(ConditionStateNames.Inactive) && x.EnabledState.Contains(ConditionStateNames.Unacknowledged)));
                    }
                    if ((bool)converter.Convert(AlarmMaskFilter, null, AlarmMask.OffAck, null))
                    {
                        filteredList.AddRange(
                            alarms.Where(x => x.EnabledState.Contains(ConditionStateNames.Inactive) && x.EnabledState.Contains(ConditionStateNames.Unconfirmed)));
                    }
                    alarms = filteredList;
                }
                else
                ...
                if(!String.IsNullOrWhiteSpace(AlarmDescriptionFilter))
                {
                    ...
                    {
                        var result = (bool)expEval.Evaluate(alarm);
                        if (result)
                        {
        ...
        private void UpdateAlarmText(ConditionStateViewModel currentAlarm)
        {
            ...
            var converter = new ThresholdToIconConverter();
            
            CellImage.Source = (ImageSource)converter.Convert(
                new object[5] { 
                    Thresholds, 
                    currentAlarm.Severity, 
                    UriToImageConverter, 
                    TryFindResource("IconAlarm"), 
                    TryFindResource("IconMessage") }, 
            ...
            try
            {
                if(ShowDateTime)
                {
                    var localTime = currentAlarm.TimeOn.Value;
                    if (RunningOnServer)
            ...
            get
            {
                if (uriToImageConverter == null)
                {
                    ...
                    uriToImageConverter = new UriToUriAbsoluteImageConverter()
                    {
                        ...
                        AbsolutePath = new Uri(System.IO.Path.GetDirectoryName(document.FilePath) + "\\", UriKind.RelativeOrAbsolute),
        ...
        public IDictionary<DependencyProperty, DataTemplate> GetListDataTemplates
        {
            get
            {
                ...
                if (workspace != null)
                {
                    ...
                    dt.VisualTree = factory;
                    mapDataTemplates.Add(SeverityFilterProperty, dt);

                    dt = new DataTemplate();
                    factory = new FrameworkElementFactory(typeof(AlarmMaskPropertyEditor));
                    dt.DataType = typeof(int);
                    dt.VisualTree = factory;
                    mapDataTemplates.Add(AlarmMaskFilterProperty, dt);
                }
        ...
        public void UpdateWriteAccessCommands()
        {
            ...
            {
                if (bDispose || !helper.UserManagerEnabled)
                    return;
