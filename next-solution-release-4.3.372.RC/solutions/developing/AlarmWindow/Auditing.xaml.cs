...
namespace AlarmWindow
{
    ...
    public partial class Auditing : UserControl, IDisposable, IContainPropertyEditors, ISettingsHelper
    {
        ...
        public static readonly DependencyProperty ControlForegroundProperty = DependencyProperty.Register("ControlForeground", typeof(Brush), typeof(Auditing), new UIPropertyMetadata(Brushes.LightGray));
        ...
        void SaveGridConfiguration(bool buserischanged = false)
        {
