    ...
    public partial class EditLayoutPropertyEditor : UserControl
    {
        ...
        private void EditLayout_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Workspace != null)
            {
                ...
                if (contextObject is StatesChartControl)
                {
                    var obj = contextObject as StatesChartControl;
                    ...
                    using (var lcontrol = new StatesChartControl()
                    {
                        Width = obj.Width,
                        Height = obj.Height,
                    ...
                    { 
                        ...
                        System.ComponentModel.DesignerProperties.SetIsInDesignMode(lcontrol, true);
                        ...
                        var Dialog = new GeneralDialogContent(lcontrol)
                        {
                            ...
                            HelpLink = "StatesChartControlEditLayout"
                        };
