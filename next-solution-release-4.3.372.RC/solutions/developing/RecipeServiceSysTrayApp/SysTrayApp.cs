...
namespace SystemTrayApp
{
    public class SysTrayApp : System.Windows.Forms.Form
    {
        ...
        readonly RecipeServiceCMS.RecipeServiceCSMHelpers serverCMSHelper;
        ...
        {
            serverCMSHelper = new RecipeServiceCMS.RecipeServiceCSMHelpers(instanceId);

            title = RecipeServiceCMS.RecipeServiceCSMHelpers.GetServiceDisplayNameWhitoutDecoration();
