                    ...
                    else
                    {
                        ...
                        if (converterMonthDayAny != null)
                        {
                            ...
                            switch ((int)values[0])
                            {
                                ...
                                case 1:
                                    return TranslationHelpers.TranslationHelper.TranlslateText($"_{MSSchedulerSettings.Controls.NewEvent.stringPlaceolder}_MonthDayAny_First", stringList, Properties.Resources.MonthDayAny_First);
                                case 2:
                                    return TranslationHelpers.TranslationHelper.TranlslateText($"_{MSSchedulerSettings.Controls.NewEvent.stringPlaceolder}_MonthDayAny_Last", stringList, Properties.Resources.MonthDayAny_Last);
                                default:
                                    return (int)values[0];
                            }
                        }
