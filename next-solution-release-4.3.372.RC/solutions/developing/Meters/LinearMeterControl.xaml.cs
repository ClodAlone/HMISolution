...
namespace Meters
{
    ...
    public partial class LinearMeterControl : RangeBaseControl.RangeBaseControl, IContainPropertyEditors, IStringIDAware
    {
        ...
        public override void OverrideBaseProperties()
        {
            ...
            dpd = DependencyPropertyDescriptor.FromProperty(BackgroundProperty, typeof(LinearMeterControl));
        ...
        [Browsable(false)]
        [XmlIgnore]
        [SvgValueConverter(typeof(ConvertMajorTickmarkVisibility), RequiredKey = true)]
        public bool MajorTickmarksVisible
        {
            get; set;
        }
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Browsable(false)]
        [XmlIgnore]
        [SvgValueConverter(typeof(ConvertMinorTickmarkVisibility), RequiredKey = true)]
        public bool MinorTickmarksVisible
        {
            get; set;
        }
        ...
        private void UpdateLinearScale()
        {
            ...
            try
            {
                if (linearScale == null)
                {
                    ...
                    scalelabelpresentation.LabelTemplate = (ControlTemplate)LoadTemplate("Templates", "scaleLabelTemplate2");
    ...
    internal class ConvertSVGHasStyles : CustomValueConverter
    {
        public override object ConvertFromStorageType(object value, object sender)
        {
            ...
            if (sender is LinearMeterControl)
            {
                ...
                Brush backBarFill = Brushes.Transparent;
                if (meter.RangeBarVisible)
                    backBarFill = meter.RangeBarBackground;
                else if (meter.LinearBaseModel != PredefinedBaseElementKinds.EmptyBar)
                    backBarFill = meter.LevelBackgroundFill;
                ret.Add("LevelBackgroundFill", backBarFill);
                return ret;
            }
            else if (sender is LinearMeter)
            {
                ...
                if (meter.RangeBarVisible)
                    backBarFill = meter.RangeBarBackground;
                else if (meter.LinearBaseModel != PredefinedBaseElementKinds.None && meter.LinearBaseModel != PredefinedBaseElementKinds.EmptyBar)
                    backBarFill = meter.LevelBackgroundFill;
                ret.Add("LevelBackgroundFill", backBarFill);
                return ret;
            }
    ...
    internal class ConvertMajorTickmarkVisibility : CustomValueConverter
    {
        public override object ConvertFromStorageType(object value, object sender)
        {
            return null;
        ...
        public override object ConvertToStorageType(object value, object sender, object document, object property, object parameter = null)
        {
            ...
            {
                LinearMeterControl meter = sender as LinearMeterControl;
                var bOffsetVis = new ConvertMajorTickmarkOffset().ConvertToStorageType(meter.MajorTickmarkOffset, meter, null, null) as int? == 1;
                var bLengthVis = meter.MajorTickmarkFactorLength != 0;
                var color = (meter.MajorTickmarkFill as SolidColorBrush)?.Color;
                var bColorVis = meter.MajorTickmarkFill.Opacity != 0 && (color == null || ((Color)color).A != 0);
                var bThicknessVis = meter.MajorTickmarkFactorThickness > 0;
                return bOffsetVis && bLengthVis && bColorVis && bThicknessVis;
            }
            else
                return null;
        }
    ...
    internal class ConvertMinorTickmarkVisibility : CustomValueConverter
    {
        public override object ConvertFromStorageType(object value, object sender)
        {
            return null;
        ...
        public override object ConvertToStorageType(object value, object sender, object document, object property, object parameter = null)
        {
            ...
            {
                LinearMeterControl meter = sender as LinearMeterControl;
                var bLengthVis = meter.MinorTickmarkFactorLength != 0;
                var color = (meter.MinorTickmarkFill as SolidColorBrush)?.Color;
                var bColorVis = meter.MinorTickmarkFill.Opacity != 0 && (color == null || ((Color)color).A != 0);
                var bThicknessVis = meter.MinorTickmarkFactorThickness > 0;
                return bLengthVis && bColorVis && bThicknessVis;
            }
            else
                return null;
        }
