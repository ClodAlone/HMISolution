...
namespace UnitConverterManager.TreeDocumentManagers
{
    class TreeDocumentManager : IDocumentManager
    {
        #region Declarations
        readonly UnitConverterEditorDocument Document;
        readonly UnitConverterEditorManagerComponent DocumentEditorManagerComponent;
        readonly String Name;
        bool bIsMaxItemsReached = false;
        #endregion

        public TreeDocumentManager(UnitConverterEditorManagerComponent c, UnitConverterEditorDocument doc, String name, bool bIsMaxItemsReached = false)
        {
            this.bIsMaxItemsReached = bIsMaxItemsReached;
        ...
        {
            get { return UnitConverterEditorManagerComponent.GetBitmapImage("UCMEditorSmall"); }
        }
        ...
        {
            get { return UnitConverterEditorManagerComponent.GetBitmapImage("UCMEditor"); }
        }
        ...
        public string TypeScheme
        {
            get
            {
                return DocumentEditorManagerComponent.TypeScheme;
            }
        }
