...
namespace UFUAModel
{
    public enum BehaviorExistingTagsValues
    {
        Ignore,
        Overwrite,
        CreateNew
    ...
    public enum BehaviorDynamicLinkValues
    {
        AddToExisting,
        ReplaceExisting
    }
    ...
    public class ImportTag
    {
        ...
        public ImportTag(UFUAModel.UFUATag tag)
        {
            ...
            _BehaviorForExistingTags = BehaviorExistingTagsValues.Ignore;
            _BehaviorForDynamicLink = BehaviorDynamicLinkValues.ReplaceExisting;
        }
        #endregion
        ...
        private BehaviorExistingTagsValues _BehaviorForExistingTags;
        public BehaviorExistingTagsValues BehaviorForExistingTags
        {
            get { return _BehaviorForExistingTags; }
            set { _BehaviorForExistingTags = value; }
        }

        private BehaviorDynamicLinkValues _BehaviorForDynamicLink;
        public BehaviorDynamicLinkValues BehaviorForDynamicLink
        {
            get { return _BehaviorForDynamicLink; }
            set { _BehaviorForDynamicLink = value; }
        }
