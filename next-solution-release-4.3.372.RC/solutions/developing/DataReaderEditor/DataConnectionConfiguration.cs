...
namespace Microsoft.Data.ConnectionUI
{
	...
	public class DataConnectionConfiguration : IDataConnectionConfiguration
	{
		...
		public void LoadConfiguration(DataConnectionDialog dialog)
		{
            ...
            dialog.DataSources.Add(DataSource.MySQLDataSource);
            dialog.DataSources.Add(DataSource.SQLiteDataSource);
			dialog.DataSources.Add(DataSource.PostgreSQLDataSource);
            ...
            dialog.UnspecifiedDataSource.Providers.Add(DataProvider.MySQLDataProvider);
            dialog.UnspecifiedDataSource.Providers.Add(DataProvider.SQLiteDataProvider);
			dialog.UnspecifiedDataSource.Providers.Add(DataProvider.PostgreSQLDataProvider);
            ...
            this.dataSources.Add(DataSource.MySQLDataSource.Name, DataSource.MySQLDataSource);
            this.dataSources.Add(DataSource.SQLiteDataSource.Name, DataSource.SQLiteDataSource);
			this.dataSources.Add(DataSource.PostgreSQLDataSource.Name, DataSource.PostgreSQLDataSource);
            ...
            this.dataProviders.Add(DataProvider.MySQLDataProvider.Name, DataProvider.MySQLDataProvider);
            this.dataProviders.Add(DataProvider.SQLiteDataProvider.Name, DataProvider.SQLiteDataProvider);
			this.dataProviders.Add(DataProvider.PostgreSQLDataProvider.Name, DataProvider.PostgreSQLDataProvider);
