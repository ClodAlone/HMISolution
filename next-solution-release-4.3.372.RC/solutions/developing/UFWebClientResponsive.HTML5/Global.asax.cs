...
namespace UFWebClient.HTML5
{
    public class Global : System.Web.HttpApplication
    {
        ...
        static public bool DisableAlarmBuzzing { get; protected set; }
        ...
        static public bool ForceSessionDecrementOnUnload { get; protected set; }
        ...
        void Application_Start(object sender, EventArgs e)
        {
            ...
            DisableAlarmBuzzing = GetSettingValue(settings, "DisableAlarmBuzzing", DisableAlarmBuzzing);
            ...
            ActiveSessionCountVariableName = GetSettingValue(settings, "ActiveSessionCountVariableName", String.Empty);

            ForceSessionDecrementOnUnload = GetSettingValue(settings, "ForceSessionDecrementOnUnload", ForceSessionDecrementOnUnload);
