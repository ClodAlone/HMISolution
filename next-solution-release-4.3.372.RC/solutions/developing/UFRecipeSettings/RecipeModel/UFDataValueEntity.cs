...
#region Persistance
        ...
        [DataMember]
        bool _InheritDataTypeFromTag = true;
        [DataMember]
        ...
        private void PreInitialize(StreamingContext context)
        {
            ...
            _DecimalDigits = 2;
            _MaxLength = -1;
            _autoSetInheritDataTypeFromTag = true;
        }
...
#region Constructors
        ...
        public UFDataValueEntity(bool autoSetInheritDataTypeFromTag)
        {
            _autoSetInheritDataTypeFromTag = autoSetInheritDataTypeFromTag;
        }
        ...
        /// <summary>
        /// This flag allows to a Data Value to inherit the
        /// Data Type from the connected I/O Tag
        /// </summary>
        public bool InheritDataTypeFromTag
        {
            get 
            { 
                return _InheritDataTypeFromTag; 
            }
            set
            {
                if (_InheritDataTypeFromTag == value)
                    return;

                _InheritDataTypeFromTag = value;
#if !NET_STANDARD
                OnPropertyChanged("InheritDataTypeFromTag");
                OnPropertyReadOnlyChanged("InheritDataTypeFromTag");
#endif 
            }
        }
        ...
        public OPCUAEntityReference TagIODataValue
        {
            ...
            set
            {
                ...
                if(tagIODataValue!= null && _autoSetInheritDataTypeFromTag)
                    InheritDataTypeFromTag = true;
#if !NET_STANDARD
                OnPropertyChanged("TagIODataValue");
                OnPropertyReadOnlyChanged("TagIODataValue");
#endif
            }
        }
...
#region Edit Style
        ...
        internal bool _autoSetInheritDataTypeFromTag = false;
        #endregion
        ...
        bool INotifyPropertyReadOnlyChanged.this[string propertyName]
        {
            get
            {
                ...
                else if (propertyName == "DataType" || propertyName == "MaxLength") //Max Length should be disable if string has been selected before and Inherit Data Type From Tag is enable
                    return InheritDataTypeFromTag;
        ...
        public Dictionary<string, object> ToDictionary()
        {
            ...
            res.Add("InheritDataTypeFromTag", InheritDataTypeFromTag);
        ...
        public void CopyAll(UFDataValueEntity source)
        {
            ...
            if (source.tagIODataValue != null)
            {
                ...
                _InheritDataTypeFromTag = source.InheritDataTypeFromTag;
            }
            else
                tagIODataValue = null;
        ...
        public bool IsWritable()
        {
            ...
            if (String.IsNullOrEmpty(StartingAddress))
                return (UFGroupAss == null || String.IsNullOrEmpty(UFGroupAss.StartingAddress))
                    && LinkType != LinkType.None && LinkType != LinkType.WrongLink;
            else
                return LinkType == LinkType.OnlyWrite || LinkType == LinkType.ReadWrite;
        }
        ...
        protected String PerformValidation(String propertyName)
        {
            ...
            else if (propertyName == "InheritDataTypeFromTag")
            {
                if ((TagIODataValue == null || !IsTagIOReferenceValid()) && InheritDataTypeFromTag == true)
                {
                    InheritDataTypeFromTag = false;
                    return Properties.Resources.ErrorInheritDataTypeFromTag;
                }
    ...
    internal class ConvertUFDataValueEntity : CustomValueConverter
    {
        ...
        public override object ConvertToStorageType(object value, object sender, object document, object property, object parameter = null)
        {
            ...
            if (entity == null)
                return (new UFDataValueEntity(true)).ToDictionary();
