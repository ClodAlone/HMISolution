...
namespace UFRecipeSettings.Documents
{
        ...
        IDocument, IEntityReference, IXpoDocument
    {
        ...
        #region Undo/Redo
#if !NET_STANDARD
        public void CreateUndoRedoHelper()
        {
        ...
        public bool UndoContainsSomething()
        {
            if (bObjectDisposed)
                return false;
        ...
        public bool RedoContainsSomething()
        {
            if (bObjectDisposed)
                return false;
        ...
        public String GetNextUndoOwner()
        {
            if (bObjectDisposed)
                return null;
        ...
        public String GetNextRedoOwner()
        {
            if (bObjectDisposed)
                return null;
        ...
        public UndoRedoXpoDataCollection UndoAction(UserControl owner, out UndoRedoAction action)
        {
            if (undoRedoHelper == null)
            {
        ...
        public UndoRedoXpoDataCollection RedoAction(UserControl owner, out UndoRedoAction action)
        {
            if (undoRedoHelper == null)
            {
                action = UndoRedoAction.None;
