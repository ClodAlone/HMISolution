...
namespace UFCrossReferenceModel
{
    ...
    public class UFCrossReferenceScreenFolder : XPObject
    {
        #region Constructors
        public UFCrossReferenceScreenFolder(Session session)
            : base(session)
        { }
        #endregion
        ...
        public XPCollection<UFCrossReferenceScreen> Screens
        {
            get
            {
                return GetCollection<UFCrossReferenceScreen>("Screens");
            }
        }


        private UFCrossReferenceScreenFolder _UFUAFolder;
        [Association("UFCrossReferenceScreenFolder-UFCrossReferenceScreenFolders")]
        public UFCrossReferenceScreenFolder UFUAFolderAss
        {
            get
            {
                return _UFUAFolder;
        ...
        [Association("UFCrossReferenceScreenFolder-UFCrossReferenceScreenFolders"), Aggregated]
        public XPCollection<UFCrossReferenceScreenFolder> UFUAFolders
        {
            get
            {
                return GetCollection<UFCrossReferenceScreenFolder>("UFUAFolders");
            }
        }
