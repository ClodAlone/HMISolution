...
#region Undo/Redo
...
#if NET_STANDARD
                String fileCore = xmlfile + ADServerInfo.ADServerInfo.GetServerCoreExtension();
                try
                {
        ...
        internal static void EditPluginSettings(ADModel.ADPlugin plugin, ADEditorDocument doc)
        {
            ...
            {
                Title = GetPluginDialogTitle(plugin.AssemblyName, plugin.Name),
...
#endif
        static string GetPluginDialogTitle(string value, string defaultValue)
        {
            string pName = value.Replace(".dll", "_FriendlyName");
            string _value = Properties.PluginDescriptionResources.ResourceManager.GetString(pName);
