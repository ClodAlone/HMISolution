...
{
    public class RecipeData : IDisposable, ICheckUserCallable
    {
        ...
        internal bool CanGetInDataServerValues
        {
            get
            {
                return bCanGetInDataServerValues;
            }
            private set
            {
                if (bCanGetInDataServerValues != value)
                {
                    bCanGetInDataServerValues = value;
                    bInvalidateRequerySuggested = true;
                }
            }
        }
        internal bool CanGetOutDataServerValues
        {
            get
            {
                return bCanGetOutDataServerValues;
            }
            private set
            {
                if (bCanGetOutDataServerValues != value)
                {
                    bCanGetOutDataServerValues = value;
                    bInvalidateRequerySuggested = true;
                }
            }
        }
        internal bool CanReadXmlDataSet
        {
            get
            {
                return bCanReadXmlDataSet;
            }
            private set
            {
                if (bCanReadXmlDataSet != value)
                {
                    bCanReadXmlDataSet = value;
                    bInvalidateRequerySuggested = true;
                }
            }
        }
        internal bool CanWriteXmlDataSet
        {
            get
            {
                return bCanWriteXmlDataSet;
            }
            private set
            {
                if (bCanWriteXmlDataSet != value)
                {
                    bCanWriteXmlDataSet = value;
                    bInvalidateRequerySuggested = true;
                }
            }
        }
        ...
        bool bInvalidateRequerySuggested;
        bool bForcedInvalidateCanExecute;
        bool bCanGetInDataServerValues;
        bool bCanGetOutDataServerValues;
        bool bCanReadXmlDataSet;
        bool bCanWriteXmlDataSet;
        public class RecipeCommandsAllowedEventArgs : EventArgs
        {
        ...
        internal Dictionary<string, List<Tuple<string, string>>> mapWrongValues = new Dictionary<string, List<Tuple<string, string>>>();
        #endregion

        #region Ctor
        public RecipeData(IClientProxy caller, string recipePath, int defaultTimeout, bool bExecutingCommand = false)
        {
            this.caller = caller;
        ...
        {
            bInvalidateRequerySuggested = false;
            bool bCan = RecipeExecuter.CanGetInDataServerValues();
            CanGetInDataServerValues = bCan;

            bCan = RecipeExecuter.CanGetOutDataServerValues();
            CanGetOutDataServerValues = bCan;

            bCan = RecipeExecuter.CanReadXmlDataSet();
            CanReadXmlDataSet = bCan;

            bCan = RecipeExecuter.CanWriteXmlDataSet();
            CanWriteXmlDataSet = bCan;

            if (bInvalidateRequerySuggested || bForcedInvalidateCanExecute)
            {
                bForcedInvalidateCanExecute = false;
                caller.SendAsync("RecipeCommandsInvalidate", recipePath, new RecipeCommandsAllowedEventArgs()
                {
                    CanGetInDataServerValues = CanGetInDataServerValues,
                    CanGetOutDataServerValues = CanGetOutDataServerValues,
                    CanReadXmlDataSet = CanReadXmlDataSet,
                    CanWriteXmlDataSet = CanWriteXmlDataSet
                });
            }
        }
        #endregion
        ...
        void TryCreateDataSource(bool bExecutingCommand)
        {
            ...
            try
            {
                dataSet = RecipeExecuter.CreateDataSet(ctsLoading.Token, true, out fillError, ref mapWrongValues, true);
                bDataSetLoaded = true;
            }
            catch (Exception)
            {
        ...
        public void ForceInvalidateCanExecute()
        {
            bForcedInvalidateCanExecute = true;
        }
        ...
        public void Refill()
        {
            ...
            dataSet.Clear();
            LastFillError = recipeExecuter.FillDataSet(dataSet, ctsLoading.Token, ref mapWrongValues, true);
        }       
