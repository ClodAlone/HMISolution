...
namespace UFUAAlarm
{
    public class AlarmStatus : ICloneable
    {
            ...
            : this()
        {
            ...
            this.SeverityExpression = alarm.SeverityExpression;
            ...
            this.ChangeStateTime = alarm.ChangeStateTime;
        ...
        internal void UpdateStatus(AlarmStatus status)
        {
            ...
            ChangeStateTime = status.ChangeStateTime;
        ...
        internal static LocalizedText severityHasChanged = new LocalizedText("SeverityHasChanged", string.Empty, "SeverityHasChanged");
        /// <summary>
        /// Update the alarms severity after an associated severity tag value change
        /// </summary>
        /// <param name="eventSeverity"></param>
        /// <returns>List of updated alarms</returns>
        internal IList<AlarmStatus> UpdateSeverity(EventSeverity eventSeverity)
        {
            var list = new List<AlarmStatus>();
            ...
            lock (lockObject)
            {
                ...
                {
                    if ((Int16)eventSeverity >= 1)
                        Severity = eventSeverity;
                    if (!state.HasFlag(AlarmState.Deleted) && state.HasFlag(AlarmState.Enabled))
                    {
                        EventComment = severityHasChanged.Text;
