...
namespace ScriptService
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var ServicesToRun = new ScriptService();
...
#if !DEBUG
        readonly static Mindscape.Raygun4Net.RaygunClient _raygunClient = new Mindscape.Raygun4Net.RaygunClient("9wl8DAAIHLlLsy1FoD9pQ");
