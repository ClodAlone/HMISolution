...
namespace HistoricalEventControl.Controls
{
    /// <summary>
    ...
    public partial class EditLayoutPropertyEditor : UserControl
    {
        ...
        private void EditLayout_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (Workspace != null)
            {
                ...
                if (contextObject is HistoricalEvents)
                {
                    var obj = contextObject as HistoricalEvents;
                    ...
                    using (var control = new HistoricalEvents()
                    {
                        Width = obj.Width,
                        Height = obj.Height,
                    ...
                    { 
                        ...
                        var Dialog = new GeneralDialogContent(control)
                        {
                            ...
                            HelpLink = "HistoricalEventsEditLayout"
                        };
                        ...
                        Dialog.Closing += (o, ea) =>
                        {
                            if ((o as GeneralDialogContent).DialogResult == true)
                            {
                                ...
                                var defaultsetting = StorageHelper.StorageHelper.LoadMemoryMap<GridLayout.MemorySettings>(obj.Document, obj.Name, null).FirstOrDefault(m => m.Name == GridLayout.GridLayoutHelper.DesignSettingName);
                                if (defaultsetting != null)
                                {
                                    defaultsetting.GridLayout = obj.GridLayout;
