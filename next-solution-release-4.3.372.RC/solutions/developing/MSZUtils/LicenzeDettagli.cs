...
namespace MSZUtils
{
    ...
    public class tbLicenzeDettagli : XPCustomObject
    {
        #region Constructors
        public tbLicenzeDettagli(Session session)
            : base(session)
        { }
        #endregion
       ...
       // [Association("FK_tbLicenzeDettagli_tbLicenze", typeof(int))]
        ...
        //[Association("FK_tbLicenzeDettagli_tbOpzioni", typeof(int))]
