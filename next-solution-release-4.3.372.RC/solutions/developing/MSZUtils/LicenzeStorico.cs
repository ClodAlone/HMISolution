...
namespace MSZUtils
{
    ...
    public class tbLicenzeStorico : XPCustomObject
    {
        #region Constructors
        public tbLicenzeStorico(Session session)
            : base(session)
        { }
        #endregion

        #region Properties
        [Persistent("IdLicenza"), Key(false), MemberDesignTimeVisibility(false)]
        private int _IdLicenza;
        [PersistentAlias("_IdLicenza")]
