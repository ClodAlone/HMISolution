...
namespace IpDriverCodeBaseEx
{
    ...
    public class UdpChannel : Channel, IDisposable
    {
        ...
        #region Data Members
        protected UDPManager SocketManager;
        #endregion
        ...
        ///                                                         operation. </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public UdpChannel(CommunicationDriver commdriver, UdpChannelSettings settings, bool listExec = false)
            : base(commdriver, settings/*, listExec*/)
        {
            SocketManager = new UDPManager(this, settings);
        }

        public UdpChannel(CommunicationDriver commdriver)
            : base(commdriver)
        {
        ...
        public override bool DeviceClose()
        {
            if (SocketManager != null)
                return SocketManager.DeviceClose(bDisposed || CommDriver.bDisposed);
            else
                return true; 
        }
