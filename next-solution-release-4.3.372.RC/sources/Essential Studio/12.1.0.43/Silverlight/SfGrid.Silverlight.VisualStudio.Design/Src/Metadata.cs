...
[assembly: ProvideMetadata(typeof(Syncfusion.SfGrid.Silverlight.VisualStudio.Design.Metadata))]

namespace Syncfusion.SfGrid.Silverlight.VisualStudio.Design
{
    public class Metadata : IProvideAttributeTable
    {
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                //Grid Numeric Column
                builder.AddCustomAttributes(typeof(GridNumericColumn), "TextWrapping", columnTextAtt);
                builder.AddCustomAttributes(typeof(GridNumericColumn), "BlockCharactersOnTextInput", columnTextAtt);
                builder.AddCustomAttributes(typeof(GridNumericColumn), "AllowNullInput", columnTextAtt);
                builder.AddCustomAttributes(typeof(GridNumericColumn), "FormatString", columnTextAtt);
