...
[assembly: ProvideMetadata(typeof(Syncfusion.SfRadialmenu.Silverlight.VisualStudio.Design.Metadata))]

namespace Syncfusion.SfRadialmenu.Silverlight.VisualStudio.Design
{
    internal class Metadata : IProvideAttributeTable
    {
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                builder.AddCallback(typeof(Syncfusion.Tools.Controls.Navigation.SfRadialMenu), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
