...
namespace Syncfusion.Windows.Tools.Controls.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Windows.Tools.Controls.Resources.Syncfusion_Ribbon_Silverlight.ResourceManager;
                //Or
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Windows.Tools.Controls.Resources.Syncfusion_Ribbon_Silverlight.ResourceManager.GetString(name);
            }
            return value;
