...
#else
[assembly: ProvideMetadata(typeof(Syncfusion.Gauge.Silverlight.VisualStudio.Design.RegisterGaugeControlsMetadata))]
namespace Syncfusion.Gauge.Silverlight.VisualStudio.Design
{
    ...
    #region IProvideAttributeTable Members
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                builder.AddCustomAttributes(typeof(CircularScale), "Pointers", new NewItemTypesAttribute(typeof(CircularPointer)));
                builder.AddCustomAttributes(typeof(CircularScale), "Ticks", new NewItemTypesAttribute(typeof(MarkTickSet), typeof(LabelTickSet)));
                ...
                builder.AddCustomAttributes(typeof(LinearScale), "Ticks", new NewItemTypesAttribute(typeof(MarkTickSet), typeof(LabelTickSet)));
