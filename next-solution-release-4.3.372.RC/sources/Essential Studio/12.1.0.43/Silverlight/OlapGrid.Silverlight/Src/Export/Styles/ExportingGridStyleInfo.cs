...
namespace Syncfusion.Silverlight.Grid.Olap
{
    ...
    public class ExportingGridStyleInfo
    {
        ...
        internal List<string> fontFamily;
        internal List<String> fontStyle;
        ...
        public void LoadStyles()
        {
            ...
            fontFamily.Add(PdfFontFamily.Courier.ToString());
            fontFamily.Add(PdfFontFamily.Helvetica.ToString());
            //fontFamily.Add(PdfFontFamily.Symbol.ToString());
            fontFamily.Add(PdfFontFamily.TimesRoman.ToString());
            fontFamily.Add(PdfFontFamily.ZapfDingbats.ToString());            
        }
