...
namespace Syncfusion.OlapShared.Silverlight.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.OlapShared.Silverlight.Resources.Syncfusion_OlapShared_Silverlight.ResourceManager;
            }
            else
            {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.OlapShared.Silverlight.Resources.Syncfusion_OlapShared_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
