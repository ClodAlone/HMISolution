...
namespace Syncfusion.Silverlight.Chart.Olap.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Silverlight.Chart.Olap.Resources.Syncfusion_OlapChart_Silverlight.ResourceManager;
            }
            else
            {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Silverlight.Chart.Olap.Resources.Syncfusion_OlapChart_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
