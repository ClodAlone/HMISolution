...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class HtmlNode
    {
        ...
        private HtmlNode _previousnode;
        ...
        private double _afterSpacing = 0.0;
        private double _beforeSpacing = 0.0;
        ...
        public double LeftIndent
        {
            get
            {
                if (this.HTMLTag != null && this.HTMLTag.TagName == HtmlConstants.BlockQuoteTag)
                    return ParentNode.LeftIndent + 35;
                return _leftindent;
            }
            set
            {
        ...
        Color _actualcolor = System.Windows.Media.Color.FromArgb(0, 0, 0, 0);
        ...
        public string FontSize
        {
            ...
            set
            {
                ...
                if (!(double.TryParse(value, NumberStyles.AllowDecimalPoint, CultureInfo.InvariantCulture, out temfontsize)))
                {
                    switch (value)
                    {
                        ...
                        case CssConstants.Smaller:
                            temfontsize = double.Parse(this.ParentNode.FontSize, CultureInfo.InvariantCulture) - 2;
                            break;
                        ...
                        case CssConstants.XXLarge:
                            ...
                            break;
                        default:
                            temfontsize = ConvertSize(value, double.Parse(this.ParentNode.FontSize, CultureInfo.InvariantCulture));
                            break;
                    }
                }
                _fontsize = temfontsize.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        private Color StringToColor(string colorValue,bool IsHyperlinkColor,bool IsBackgroundColor)
        {
            ...
            if (string.IsNullOrEmpty(colorValue))
                return IsHyperlinkColor? onError: System.Windows.Media.Color.FromArgb(0, 0, 0, 0);
        ...
        private void InheritStyle(HtmlNode father, bool everything,List<PropertyInfo> NotInherit)
        {
            if (father != null)
            {
        ...
        {
            if(this.ParentNode!=null && this.HTMLTag!=null)
                InheritStyle(ParentNode, false,GetPropertiesforTag(this.HTMLTag.TagName));
        }

        internal static void GatherPropertiesList()
        {
            PropertyInfo[] properties = typeof(HtmlNode).GetProperties();
            foreach (PropertyInfo property in properties)
            {
        ...
        {
            return name == HtmlConstants.TableTag || name == HtmlConstants.TableRowTag || name == HtmlConstants.TableBodyTag || name == HtmlConstants.TableCellDataTag
                || name == HtmlConstants.TableCellHeaderTag || name == HtmlConstants.TableFooterTag || name == HtmlConstants.TableHeaderTag;
        }
        ...
        {
            if (HTMLTag.TagName != HtmlConstants.TableTag)
                return ParentNode.RootTableNode();
            else 
                return this;
        }
