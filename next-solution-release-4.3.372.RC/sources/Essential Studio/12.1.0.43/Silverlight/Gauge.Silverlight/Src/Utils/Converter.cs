...
namespace Syncfusion.Windows.Gauge
{
    ...
    /// <summary>
    /// Convertor class for converting Radius to Height property value
    /// </summary>
    public class RadiusToHeightConverter : IValueConverter
    {
        #region IValueConverter Members
    ...
    /// <summary>
    /// Convertor class for converting TooltipText to ToolTip property value
    /// </summary>
    public class TooltipTextToToolTipConverter : IValueConverter
    {
        #region IValueConverter Members
