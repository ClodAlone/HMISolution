...
using Syncfusion.Tools.Controls.Media;
    ...
    internal class Metadata : IProvideAttributeTable
    {
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                // tool box filtering
             builder.AddCallback(typeof(Syncfusion.Tools.Controls.Media.SfColorPalette), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
