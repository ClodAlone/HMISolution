...
{
    public class FillColorCommand:CommandBase
    {
        public FillColorCommand(SpreadsheetControl excelEditorControl) : base(excelEditorControl)
        {
        }
        ...
        protected override void ExecuteCommand(object parameter)
        {
            //if (parameter != null && parameter is Brush)
                //AssociatedSpreadsheet.ChangeFillColor(parameter as Brush);
