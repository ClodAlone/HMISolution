...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class ItemContainerGeneratorAdv
    {
        ...
        /// 
        /// </summary>
        protected internal ItemsControl parent
        {
            get;
            set;
        }
        internal IDictionary<DependencyObject, object> ChildrenToItems
        {   get;
            set;
        }
        ...
        internal ItemContainerGeneratorAdv(ItemsControl itemscontrol)
        {
        ...
        internal void ApplyPropertiesTochild(DependencyObject element, object item, Style parentItemContainerStyle)
        {
