...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class TabItemAdvBorderIE : TabItemAdvBorder
    {
        ...
        /// <summary>
        /// Initializes new instance of the TabItemAdvBorderIE class.
        /// </summary>
        public TabItemAdvBorderIE()
        {
            DefaultStyleKey = typeof(TabItemAdvBorderIE);
        }
        #endregion
        ...
        private PathGeometry GetBorderGeometry(Size borderSize)
        {
            ...
            if (this.isSelected)
            {
                borderFigure.StartPoint = new Point(-1.5, borderSize.Height - 5);

                arc = new ArcSegment();
                arc.Point = new Point(0.5, borderSize.Height - 7);
                arc.Size = new Size(2.5, 2);
            ...
            {
                borderFigure.StartPoint = new Point(0.5, borderSize.Height - 6);
            }

            LineSegment line = new LineSegment();
            line.Point = new Point(0.5, 4);
            borderFigure.Segments.Add(line);

            arc = new ArcSegment();
            arc.Point = new Point(3, 0.5);
            ...
            line.Point = new Point(borderSize.Width - 3, 0.5);
            borderFigure.Segments.Add(line);

            arc = new ArcSegment();
            arc.Point = new Point(borderSize.Width, 3);
            arc.Size = new Size(3, 3);
            arc.SweepDirection = SweepDirection.Clockwise;
            arc.IsLargeArc = false;
            arc.RotationAngle = 0;
            ...
            line = new LineSegment();
            line.Point = new Point(borderSize.Width, borderSize.Height - 7);
            borderFigure.Segments.Add(line);

            if (this.isSelected)
            {
                arc = new ArcSegment();
                arc.Point = new Point(borderSize.Width + 1.5, borderSize.Height - 5);
                arc.Size = new Size(2.5, 2);
                arc.SweepDirection = SweepDirection.Counterclockwise;
                arc.IsLargeArc = false;
                arc.RotationAngle = 0;
            ...
            {
                line = new LineSegment();
                line.Point = new Point(borderSize.Width, borderSize.Height - 6);
                borderFigure.Segments.Add(line);
            }
