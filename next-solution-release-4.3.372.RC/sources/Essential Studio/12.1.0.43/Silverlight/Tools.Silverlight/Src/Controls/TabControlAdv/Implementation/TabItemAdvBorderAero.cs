...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class TabItemAdvBorderAero : TabItemAdvBorder
    {
        #region Constants
        /// <summary>
        ...
        /// Used for drawing the border.
        /// </summary>
        private Path mouseOverUpperBorderPath;

        /// <summary>
        /// Used for drawing the border.
        /// </summary>
        private Path mouseOverDownBorderPath;

        /// <summary>
        /// Used for drawing the border.
        /// </summary>
        private Path selectedUpperBorderPath;

        /// <summary>
        /// Used for drawing the border.
        /// </summary>
        private Path selectedDownBorderPath;
        ...
        /// <summary>
        /// Initializes new instance of the TabItemAdvBorderAero class.
        /// </summary>
        public TabItemAdvBorderAero()
        {
            DefaultStyleKey = typeof(TabItemAdvBorderAero);
        }
        #endregion
        ...
        public override void OnApplyTemplate()
        {
            ...
            this.mouseOverDownBorderPath = this.GetTemplateChild("MouseOverDownBorderPath") as Path;
            this.mouseOverUpperBorderPath = this.GetTemplateChild("MouseOverUpperBorderPath") as Path;
            this.selectedDownBorderPath = this.GetTemplateChild("SelectedDownBorderPath") as Path;
            this.selectedUpperBorderPath = this.GetTemplateChild("SelectedUpperBorderPath") as Path;
        ...
        private void InitializePaths(Size borderSize)
        {
            ...
            if (this.upperBorderPath != null)
            {
                ...
                this.mouseOverUpperBorderPath.Data = this.GetUpperBorderGeometry(borderSize);
                this.selectedUpperBorderPath.Data = this.GetUpperBorderGeometry(borderSize);
            }

            if (this.downBorderPath != null)
            {
                this.downBorderPath.Data = this.GetDownBorderGeometry(borderSize);
                this.mouseOverDownBorderPath.Data = this.GetDownBorderGeometry(borderSize);
                this.selectedDownBorderPath.Data = this.GetDownBorderGeometry(borderSize);
            }
        ...
        private PathGeometry GetUpperBorderGeometry(Size borderSize)
        {
            ...
            else
            {
                ...
                {
                    line = new LineSegment();
                    line.Point = new Point(borderSize.Height + 1.0, 0.5);
                    borderFigure1.Segments.Add(line);
                }
        ...
        private PathGeometry GetDownBorderGeometry(Size borderSize)
        {
            ...
            else
            {
                ...
                {
                    line = new LineSegment();
                    line.Point = new Point(borderSize.Height + 1.0, 1.5);
                    borderFigure.Segments.Add(line);
                }
                else
                {
