...
namespace Syncfusion.Windows.Controls
{
    ...
    [Syncfusion.Windows.Shared.SkinType(SkinVisualStyle = Syncfusion.Windows.Shared.VisualStyle.Office2003,
        Type = typeof(NumericUpDown), XamlResource = "/Syncfusion.Theming.Office2003;component/NumericUpDown.xaml")]
    ...
    public partial class NumericUpDown : UpDownBase<double>, IUpdateVisualState
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            text = (TextBox)base.GetTemplateChild("Text");
            if (text != null)
            {
        ...
        /// <summary>
        /// Handles the KeyDown event of the Text control.
        /// </summary>
        ...
        void Text_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                if (text.Text.Contains(CultureInfo.InvariantCulture.NumberFormat.NumberDecimalSeparator))
                {
                    e.Handled = true;
                }
                else
