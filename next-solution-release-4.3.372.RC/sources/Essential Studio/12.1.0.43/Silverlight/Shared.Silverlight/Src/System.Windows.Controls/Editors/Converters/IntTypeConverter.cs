...
{
    /// <summary>
    /// Represents the IntType Converter Class.
    /// </summary>
    public class IntTypeConverter:TypeConverter
    {
        ...
        {
            return Type.GetTypeCode(destinationType) == TypeCode.String ? true : TypeConverters.CanConvertTo<Int64?>(destinationType);
        }
        /// <summary>
        /// Converts from.
        /// </summary>
