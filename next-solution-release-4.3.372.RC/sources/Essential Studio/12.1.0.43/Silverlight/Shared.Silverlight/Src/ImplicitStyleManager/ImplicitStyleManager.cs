...
[assembly: SuppressMessage("Compatibility", "SWC4000:GeneralWPFCompatibilityRule", MessageId = "Syncfusion.Windows.Controls.Theming.ImplicitStyleManager", Justification = "Implicit styling is built into WPF.")]
...
namespace Syncfusion.Windows.Controls.Theming
{
    ...
    internal static class ImplicitStyleManager
    {
        ...
        internal static bool GetHasBeenStyled(FrameworkElement element)
        {
            if (element == null)
            {
        ...
        internal static ResourceDictionary GetExternalResourceDictionary(FrameworkElement element)
        {
            if (element == null)
            {
                throw new ArgumentNullException("element");
        ...
        internal static BaseMergedStyleDictionary GetMergedStyleDictionary(FrameworkElement styledElement)
        {
