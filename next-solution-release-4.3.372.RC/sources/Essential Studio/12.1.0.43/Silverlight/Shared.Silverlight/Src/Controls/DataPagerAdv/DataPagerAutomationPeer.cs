...
namespace Syncfusion.Windows.Shared
{
    ...
    public class DataPagerAutomationPeer : FrameworkElementAutomationPeer, IRangeValueProvider
    {
        ...
        /// </summary>
        private DataPagerExt OwningDataPager
        {
            get
            {
                return this.Owner as DataPagerExt;
            }
        }
                ...
                this.OwningDataPager.PagedSource.TotalItemCount == -1)
            {
                ...
                return string.Format(
                    CultureInfo.InvariantCulture,
                     Syncfusion.Windows.Shared.Resources.Syncfusion_Shared_Silverlight.AutomationPeerName_TotalPageCountUnknown,
                    (this.OwningDataPager.PageIndex + 1).ToString(CultureInfo.CurrentCulture));
            }
            // Returns "Page M of N"
            return string.Format(
                CultureInfo.InvariantCulture,
                Syncfusion.Windows.Shared.Resources.Syncfusion_Shared_Silverlight.AutomationPeerName_TotalPageCountKnown,
                (this.OwningDataPager.PageIndex + 1).ToString(CultureInfo.CurrentCulture),
