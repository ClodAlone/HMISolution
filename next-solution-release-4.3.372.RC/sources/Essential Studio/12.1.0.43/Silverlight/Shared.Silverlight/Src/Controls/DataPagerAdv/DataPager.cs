...
using System;
using Syncfusion.Windows.Controls.Properties;
...
namespace Syncfusion.Windows.Shared
{
    ...
    public class DataPagerExt : Control
    {
        ...
        /// <summary>
        /// This Property for enable the OnDemand Paging
        /// </summary>
        ...
        public override void OnApplyTemplate()
        {
           ...
           //This code for OnDemandPaging
            if (OnDemandDataSourceLoad != null && IsPagingOnDemand)
            {
                this.OnDemandPaging(new GridDataOnDemandPageLoadingEventArgs(_currentPageIndex, this.PageSize));                
            }
            //Till This
            ...
            if (this._numericButtonPanel != null)
            {
                ...
                {
                    throw new InvalidOperationException(SR.GetString(CultureInfo.CurrentUICulture,"InvalidButtonPanelContent"));
                }
                ...
                if ((int)e.NewValue < 0)
                {
                    ...
                    throw new ArgumentOutOfRangeException(
                        ...
                        string.Format(
                            ...
                            SR.GetString(CultureInfo.CurrentUICulture,"ValueMustBeGreaterThanOrEqualTo"),
                            "NumericButtonCount",
                            0));
                }
        ...
        private static void OnPageIndexPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!pager.AreHandlersSuspended())
            {
                ...
                if ((pager.Source == null || pager.PageSize == 0) && newPageIndex != -1)
                {
                    ...
                    throw new ArgumentOutOfRangeException(
                        "value",
                        SR.GetString(CultureInfo.CurrentUICulture,"PageIndexMustBeNegativeOne"));
                }
        ...
        private static void OnReadOnlyPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (pager != null && !pager.AreHandlersSuspended())
            {
                ...
                throw new InvalidOperationException(
                    string.Format(
                        CultureInfo.InvariantCulture,
                         SR.GetString(CultureInfo.CurrentUICulture, "UnderlyingPropertyIsReadOnly"),
                        e.Property.ToString()));
            }
        }
        ...
        /// </summary>
        /// <param name="isOndemandPaging"></param>
        /// <returns></returns>
        ...
        {
            //This code for OnDemand Paging
            if (IsPagingOnDemand)
            {
                if (this.OnDemandDataSourceLoad != null)
                {
                    if(this._currentPageTextBox.Text!=(this._currentPageIndex+1).ToString(CultureInfo.CurrentCulture))
                    {
                        int pageindex=Int32.Parse(this._currentPageTextBox.Text)-1;
                        _currentPageIndex = pageindex;
                        int startidx = pageindex * this.PageSize;
                        this.OnDemandPaging(new GridDataOnDemandPageLoadingEventArgs(startidx, this.PageSize));
                        UpdateControl();
                        this._currentPageTextBox.Text = (pageindex + 1).ToString(CultureInfo.CurrentCulture);
		...
		{	
            //This for ondemand paging
            if (this.IsPagingOnDemand)
            {
                int _startIndex = 0 * this.PageSize;
                if (OnDemandDataSourceLoad != null)
                    this.OnDemandPaging(new GridDataOnDemandPageLoadingEventArgs(_startIndex, this.PageSize));
                _currentPageIndex = 0;
                UpdateControl();
                this._currentPageTextBox.Text = (1).ToString(CultureInfo.CurrentCulture);
            }
            //Till This
            else
            {
		...
		private void OnLastPageButtonBaseClick(object sender, RoutedEventArgs e)
		{
            ...
            if (IsPagingOnDemand)
            {
                int _startIndex = (this.PageCount - 1) * this.PageSize;
                if (OnDemandDataSourceLoad != null)
                    this.OnDemandPaging(new GridDataOnDemandPageLoadingEventArgs(_startIndex, this.PageSize));
                this._currentPageIndex = this.PageCount - 1;
                UpdateControl();
                this._currentPageTextBox.Text = (this.PageCount).ToString(CultureInfo.CurrentCulture);
            }
            //Till This
            else
            {
        ...
        //This property for onDemand Paging
       ...
       //Till This
		...
		private void OnNextPageButtonBaseClick(object sender, RoutedEventArgs e)
		{
            ...
            {                
                int _startIndex = (_currentPageIndex + 1) * this.PageSize;
                if(OnDemandDataSourceLoad!=null)
                    this.OnDemandPaging(new GridDataOnDemandPageLoadingEventArgs(_startIndex,this.PageSize));
        ...
        //This event for ondemand paging
        internal virtual void OnDemandPaging(GridDataOnDemandPageLoadingEventArgs args)
        {
            GridDataOnDemandPageLoadingEventHandler handler = this.OnDemandDataSourceLoad;            
            if (handler != null)
            {
                handler(this, args);               
            }        
        ...
        private void UpdateButtonCount()
        {
            ...
            if (this._numericButtonPanel != null)
            {
                ...
                if (this.IsPagingOnDemand)//This is for ondemand paging
		...
		//This method for ondemand paging
        private void UpdateButtonDisplay(bool isPagingOnDemand)
		{
			if (this._numericButtonPanel != null)
			{
				...
				foreach (UIElement ui in this._numericButtonPanel.Children)
				{
					...
					if (button != null)
					{
                        ...
                        {
                            button.Content = Syncfusion.Windows.Shared.Resources.Syncfusion_Shared_Silverlight.AutoEllipsisString;
                        }
                        else
                        {
        ...
        private void UpdateCurrentPagePrefixAndSuffix(bool needPage)
        {
            ...
            if (this._currentPagePrefixTextBlock != null)
            {
                if (this._currentPagePrefixTextBlock != null)
                {
                    ...
                    {
                        textBlockCaption = SR.GetString(CultureInfo.CurrentUICulture, "CurrentPagePrefix_TotalPageCountUnknown");
                    }
                    else
                    {
                        textBlockCaption = string.Format(
                            CultureInfo.InvariantCulture,
                            SR.GetString(CultureInfo.CurrentUICulture, "CurrentPagePrefix_TotalPageCountKnown"),
            ...
            if (this._currentPageSuffixTextBlock != null)
            {
                if (needTotalPageCountUnknownState)
                {
                    textBlockCaption = SR.GetString(CultureInfo.CurrentUICulture, "CurrentPageSuffix_TotalPageCountUnknown");
                }
                else
                {
                    textBlockCaption = string.Format(CultureInfo.InvariantCulture, SR.GetString(CultureInfo.CurrentUICulture, "CurrentPageSuffix_TotalPageCountKnown"), this.PageCount.ToString());
                }
    ...
    /// 
    /// </summary>
    public sealed class GridDataOnDemandPageLoadingEventArgs : EventArgs
    {
        /// <summary>
        /// 
        /// </summary>
