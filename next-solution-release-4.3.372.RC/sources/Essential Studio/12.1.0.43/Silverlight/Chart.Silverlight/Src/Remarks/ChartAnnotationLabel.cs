...
namespace Syncfusion.Windows.Chart
{
    public class ChartAnnotationLabel:DependencyObject,IDisposable
    {
        ...
        public static readonly DependencyProperty OffsetXProperty =
            DependencyProperty.Register("OffsetX", typeof(double), typeof(ChartAnnotationLabel), new PropertyMetadata(0d));

        /// <summary>
        /// Identifies the OffsetY dependency property.
        /// </summary>
        public static readonly DependencyProperty OffsetYProperty =
            DependencyProperty.Register("OffsetY", typeof(double), typeof(ChartAnnotationLabel), new PropertyMetadata(0d));
