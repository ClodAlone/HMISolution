...
#if !WinRT
    [
    TypeConverter(typeof(Syncfusion.Windows.Controls.Grid.GridRangeInfoListConverter)),
    ]
#else
    [ClassReference(IsReviewed = false)]
#endif
    public class GridRangeInfoList : List<GridRangeInfo>, ICloneable, IFormattable
    {
        ...
        {
            GridRangeInfoList rl = new GridRangeInfoList();
            string[] parts = parseText.Split(separators);
