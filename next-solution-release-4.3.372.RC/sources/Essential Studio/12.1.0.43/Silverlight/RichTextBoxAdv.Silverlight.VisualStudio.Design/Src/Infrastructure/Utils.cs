...
namespace Syncfusion.RichTextBoxAdv.Silverlight.VisualStudio.Design.Infrastructure
{
    internal class Utils
    {
        ...
        internal static void InvalidateProperty(ModelItem item,Microsoft.Windows.Design.Metadata.PropertyIdentifier propertyIdentifier)
        {
