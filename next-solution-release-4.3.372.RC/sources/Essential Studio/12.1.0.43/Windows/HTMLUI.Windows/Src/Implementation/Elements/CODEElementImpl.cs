...
namespace Syncfusion.Windows.Forms.HTMLUI
{
    ...
    /// </summary>
    [ElementTag(TagName.Code)]
    public class CODElementImpl : BaseElement
    {
        #region Class constants
        /// <summary>
        /// Name of the tag this class indicates.
        /// </summary>
        private const string DEF_TAG_NAME = TagName.Code;
        ...
        /// </summary>
        static CODElementImpl()
        {
            Type type = typeof(CODElementImpl);
