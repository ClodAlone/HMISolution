...
//
[assembly: AssemblyTitle("Syncfusion.Tools.Frameworks")]
#if DEBUG
...
/// </summary>
	public class ToolsAdvAssembly
	{
		...
		static ToolsAdvAssembly()
		{
			Assembly = typeof(ToolsAdvAssembly).Assembly;
	...
	internal class AssemblyInfo : ToolsAdvAssembly
	{
	}
