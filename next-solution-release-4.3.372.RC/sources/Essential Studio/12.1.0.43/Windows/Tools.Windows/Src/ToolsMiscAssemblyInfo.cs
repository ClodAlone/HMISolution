...
//
[assembly: AssemblyTitle("Syncfusion.Tools.Misc")]
#if DEBUG
[assembly: AssemblyDescription("Debug")]
[assembly: AssemblyConfiguration("DEBUG")]
#else
[assembly: AssemblyDefaultAlias("Syncfusion.Tools")]
[assembly: AssemblyInformationalVersion("2.1.0.x")]
[assembly: AssemblyDescription("Prebuilt Release")]
[assembly: AssemblyConfiguration("Prebuilt Release")]
#endif
[assembly: AssemblyCompany("Syncfusion, Inc.")]
[assembly: AssemblyProduct("Essential Tools Editors")]
...
// Make sure to update all reflection code that looks for a Tools assembly by versiion.
...
/// </summary>
	public class ToolsMiscAssembly
	{
		/// <summary>
		...
		static ToolsMiscAssembly()
		{
			Assembly = typeof(ToolsMiscAssembly).Assembly;
		...
		{
			if (e.Name.StartsWith(Syncfusion.SharedAssembly.Name))
				return SharedAssembly.Assembly;
			else if (e.Name.StartsWith(Syncfusion.SharedBaseAssembly.Name))
				return SharedBaseAssembly.Assembly;
			else if (e.Name.StartsWith(GridBaseAssembly.Name))
				return GridBaseAssembly.Assembly;
			else if (e.Name.StartsWith(ToolsAdvAssembly.Name))
				return ToolsAdvAssembly.Assembly;
			else if (e.Name.StartsWith(ToolsControlsAssembly.Name))
				return ToolsControlsAssembly.Assembly;
			else if (e.Name.StartsWith(ToolsMiscAssembly.Name))
				return ToolsMiscAssembly.Assembly;

			return null;
		}
	}

	internal class AssemblyInfo : ToolsMiscAssembly
	{
	}
