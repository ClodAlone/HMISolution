...
namespace Syncfusion.Windows.Forms.Tools
{
	...
	/// </summary>
	public class ControlBarWeakContainer: WeakReference
	{
		public ControlBarWeakContainer(ControlBar target) 
			: base(target) 
		{
		}
		...
		{
			ControlBar comboDropDown = (ControlBar)this.Target;

			if (comboDropDown != null)
			{
				comboDropDown.Office2003Colors_MenuColorsChanged(sender, args);
			}
			else
			{
