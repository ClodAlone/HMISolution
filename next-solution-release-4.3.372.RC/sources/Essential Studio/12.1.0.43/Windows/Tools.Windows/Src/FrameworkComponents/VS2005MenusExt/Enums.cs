...
namespace Syncfusion.Windows.Forms.Tools.Win32API
{
	...
	#region flags used for WM_SIZE message
	public enum WmSizeFlags : int
	{
		SIZE_RESTORED = 0,
		SIZE_MINIMIZED = 1,
		SIZE_MAXIMIZED = 2,
	...
	public enum StrechModeFlags : int
	{
		BLACKONWHITE = 1,
		WHITEONBLACK = 2,
		COLORONCOLOR = 3,
	...
	#region Layered window attributes flags
