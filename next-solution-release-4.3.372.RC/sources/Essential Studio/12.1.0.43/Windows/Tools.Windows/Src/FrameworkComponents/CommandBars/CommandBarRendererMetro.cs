...
namespace Syncfusion.Windows.Forms.Tools
{
    ...
    /// </summary>
    internal class CommandBarRendererMetro : CommandBarRenderer
    {
        #region Class Initialize/Finalize Methods
        public CommandBarRendererMetro(CommandBar commandBar)
            : base(commandBar)
        {
        }
        #endregion
        ...
        /// </summary>
        internal static bool IsMetroSet = false;
            ...
            CBButtonState state, bool bShowChevron, bool bShowArrow)
        {
            ...
            switch (state)
            {
                case CBButtonState.Hot:
                    {
                        startColor = this.CmdBar.cbController.MetroColor;
                        endColor = this.CmdBar.cbController.MetroColor;
                        break;
                    }
        ...
        {
            CommandBarPainter.PaintMetroGripper(g, rect, bRTL, bVertical,
    ...
    /// </summary>
    internal class CommandBarFloatingRendererMetro : CommandBarFloatingRenderer
    {
        #region Class Initialize/Finalize Methods
        public CommandBarFloatingRendererMetro(CommandBar commandBar)
            : base(commandBar)
        {
        }
        #endregion
    ...
    /// </summary>
    internal class ControlBarRendererMetro : ControlBarRenderer
    {
        #region Class Initialize/Finalize Methods
        public ControlBarRendererMetro(ControlBar controlBar)
            : base(controlBar)
        {
        }
        #endregion
