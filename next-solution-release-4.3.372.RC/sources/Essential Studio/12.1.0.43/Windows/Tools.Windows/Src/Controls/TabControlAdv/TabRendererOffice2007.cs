...
{
    /// <summary>
    /// TabRenderer Office2007.
    /// </summary>
    public class TabRendererOffice2007 : TabRenderer2D
    {
        #region Class Constants
        private const int DEF_CORNER_RADIUS = 2;
        private const string DEF_RENDERER_NAME = "Office2007Style";
        #endregion
        ...
        /// </summary>
        private static StyleRendererPropertyOffice2007 m_tabPropertyExtender;
        ...
        /// </summary>
        public static new StyleRendererPropertyOffice2007 TabPanelPropertyExtender
        {
            get
            {
        ...
        static TabRendererOffice2007()
        {
            m_tabPropertyExtender = new StyleRendererPropertyOffice2007();
            TabRendererFactory.RegisterTabType(TabStyleName, typeof(TabRendererOffice2007), TabPanelPropertyExtender);
        }
        ...
        {
            m_parent = parent;
            this.Theme = parent.Office2007ColorScheme;
            ...
            if (curBounds.Width > 0 && curBounds.Height > 0)
            {
                ...
                if (bIsHotLight)
                {
                    ...
                    else
                    {
                        ...
                        if (m_parent.Office2007ColorScheme != Office2007Theme.Black)
                        {
                            using (GraphicsPath innerPath = this.GetBorderPathFromBounds(innerBounds))
                            {
        ...
        {
            if (m_theme == Office2007Theme.Managed)
            {
                OnOffice2007ColorSchemeChanged();
            }
        }
    ...
    public class StyleRendererPropertyOffice2007 : TabPanelProperty2D
    {
        #region Class Constants
        /// <summary>
        ...
        {
            TabRendererOffice2007 trOffice2007 = null;
            if (tabControl.Renderer.Renderers.Count > 0)
            {
                trOffice2007 = tabControl.Renderer.Renderers[0] as TabRendererOffice2007;
            }
            if (trOffice2007 != null)
            {
                return trOffice2007.ThemeColors.TabSelectedGradientBottomColor;
            }
            else
            {
                return Office2007Colors.Default.TabSelectedGradientBottomColor;
            }
        }
        ...
        public override Color DefaultTabForeColor(ITabPanelData panelData, ITabControl tabControl)
        {
            ...
            if (trOffice2007 != null)
            {
                return trOffice2007.ThemeColors.TabForeColor;
            }
            else
            {
                return Office2007Colors.Default.TabForeColor;
            }
        }
        ...
        public override void OnPaintPanelBackground(ITabControl tabControl, Graphics g, Color bgColor, Rectangle bounds)
        {
            ...
            if (trOffice2007 != null)
            {
                ...
                borderPen = new Pen(trOffice2007.ThemeColors.TabDefaultBorderColor);
            }
            else
            {
                g.FillRectangle(br, newBounds);
