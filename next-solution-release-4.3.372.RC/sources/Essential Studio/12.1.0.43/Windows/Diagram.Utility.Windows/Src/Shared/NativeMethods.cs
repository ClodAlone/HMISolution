...
namespace Syncfusion.Runtime.InteropServices.WinAPI
{
    ...
    internal class Window
    {
        ...
        // internal Read-only static int WM_MOUSEENTER;
        ...
        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        extern internal static int MapWindowPoints(IntPtr hWndFrom, IntPtr hWndTo, [MarshalAs(UnmanagedType.LPArray)] POINT[] lpPoints, uint cPoints);
    ...
    internal class GDI
    {
        ...
        extern internal static IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel, [MarshalAs(System.Runtime.InteropServices.UnmanagedType.LPArray)] short[] lpvBits);
