...
//
[assembly: AssemblyTitle("Syncfusion.Diagram.Windows")]
#if DEBUG
...
namespace Syncfusion
{
	...
	/// </summary>
	public class DiagramWindowsAssembly
	{
		/// <summary>
		...
		static DiagramWindowsAssembly()
		{
			Assembly = typeof(DiagramWindowsAssembly).Assembly;
		...
		public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
		{
			...
			else if (e.Name.StartsWith(DiagramBaseAssembly.Name))
			...
			public class Binder : SerializationBinder
		{
				...
				string assemblyName, string typeName)
			{
				...
				foreach (Assembly asm in new Assembly[] { Syncfusion.DiagramWindowsAssembly.Assembly, 
	...
	internal class AssemblyInfo : DiagramWindowsAssembly
	{
	}
}
