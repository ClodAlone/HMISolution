...
namespace Syncfusion.Windows.Forms.Diagram
{
        ...
        : PolyLineBase
    {
        ...
        /// ConnectionPoint to which Head EndPoint could be connected.
        /// </summary>
        private ConnectionPoint m_headPossConn = null;
        #endregion
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SplineTool"/> class.
        /// </summary>
        /// <param name="controller">The controller.</param>
        public SplineTool(DiagramController controller)
            : base(controller, Resources.Strings.Toolnames.Get("SplineTool"))
        {
        ...
        public override Tool ProcessMouseMove(MouseEventArgs evtArgs)
        {
            ...
            if (this.InAction)
            {
                ...
                {
                    this.HeadPossibleConnection = CheckConnectionPossibility(this.Points[1], out canConnectWithPort);                    
                }
                else
                    this.m_headPossConn = CheckConnectionPossibility(this.CurrentPoint, out canConnectWithPort);
                ...
                if (rectTemp != this.WorkRectPrev)
                {
                    ...
                    UpdatePortRefreshRect(this.TailPossibleConnection, ref m_rectTailPC);
                    UpdatePortRefreshRect(this.m_headPossConn, ref m_rectHeadPC);
                }
        ...
        protected override Node CompleteAction(PointF[] ptsShape)
        {
            ...
            SplineNode node = (SplineNode)base.CompleteAction(ptsShape);
        ...
        public override void Draw(Graphics gfx)
        {
            ...
            if (this.HeadPossibleConnection != null)
                ...
                OutlineConnectionPoint(gfx, this.m_headPossConn);
        ...
        {
            if (pts.Length == 2)
                pts = new PointF[] { pts[0], pts[1], new PointF((pts[0].X + pts[1].X) / 2f, (pts[0].Y + pts[1].Y) / 2f) };

            LineBase toReturn = new SplineNode(pts);
        ...
        protected override GraphicsPath CreatePath(PointF[] pts)
        {
            ...
            {
                path = PathFactory.CreateLine(pts[0], pts[1]);
            }
            else if (pts.Length > 2)
            {
                path = PathFactory.CreateCurve(pts[0], pts[1], pts[2]);
            }
        ...
        : LineBaseTool
    {
        #region Class initialize/finalize methods
        /// <summary>
        /// Initializes a new instance of the <see cref="BezierTool"/> class.
        /// </summary>
        /// <param name="controller">The controller.</param>
        public BezierTool(DiagramController controller)
            : base(controller, Resources.Strings.Toolnames.Get("BezierTool"))
        {
            this.ToolCursor = this.ActionCursor = Cursors.Cross;
        }
        #endregion
        ...
        {
            LineBase toReturn = new BezierCurve(ptStart, ptEnd);
