...
#endif
[assembly: AssemblyTitle("Syncfusion.Grouping.Windows")]
#if DEBUG
...
[assembly: DocumentationNamespaceExclude("Syncfusion.Grouping.Internals")]	
...
namespace Syncfusion
{
	...
	/// </summary>
	public class GroupingWindowsAssembly
	{
		/// <summary>
		...
		/// <summary>
		/// A reference to the <see cref="System.Reflection.Assembly"/> for the Grouping assembly.
		/// </summary>
		...
		/// </summary>
		public static readonly string RootNamespace = "Syncfusion.Grouping.Windows";

		static GroupingWindowsAssembly()
		{
			Assembly = typeof(GroupingWindowsAssembly).Assembly;
		...
		public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
		{
			if (e.Name.StartsWith(SharedBaseAssembly.Name))
				...
				return GroupingBaseAssembly.Assembly;
			if (e.Name.StartsWith(SharedWindowsAssembly.Name))
				return SharedWindowsAssembly.Assembly;
			else if (e.Name.StartsWith(GroupingWindowsAssembly.Name))
				return GroupingWindowsAssembly.Assembly;
			else
			{
...
{
	internal class AssemblyInfo : Syncfusion.GroupingWindowsAssembly
	{
	}
}