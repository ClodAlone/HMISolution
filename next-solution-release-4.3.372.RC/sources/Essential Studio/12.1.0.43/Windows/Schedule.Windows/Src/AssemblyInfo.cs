...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
//  Copyright Syncfusion Inc. All rights reserved. Use of this code is subject to the terms of our 
...
#endif
[assembly: AssemblyTitle("Syncfusion.Schedule.Windows")]
#if DEBUG
...
//[assembly: DocumentationNamespaceExclude("Syncfusion.Windows.Forms.Grid.GridInternal")]	
...
namespace Syncfusion
{
	...
	/// </summary>
	public class ScheduleWindowsAssembly
	{
		/// <summary>
		...
		/// </summary>
		public static readonly string RootNamespace = "Syncfusion.Windows.Forms.Schedule";

		static ScheduleWindowsAssembly()
		{
			Assembly = typeof(ScheduleWindowsAssembly).Assembly;
		...
		public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
		{
			...
			else if (e.Name.StartsWith(GridWindowsAssembly.Name))
				return GridWindowsAssembly.Assembly;
			else if (e.Name.StartsWith(ScheduleWindowsAssembly.Name))
				return ScheduleWindowsAssembly.Assembly;
...
namespace Syncfusion
{
	internal class AssemblyInfo : Syncfusion.ScheduleWindowsAssembly
	{
	}
}
