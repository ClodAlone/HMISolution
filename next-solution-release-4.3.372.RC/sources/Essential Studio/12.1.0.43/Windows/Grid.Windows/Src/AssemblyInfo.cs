...
#endif
[assembly: AssemblyTitle("Syncfusion.Grid.Windows")]
#if DEBUG
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class GridWindowsAssembly
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Windows.Forms.Grid";

        static GridWindowsAssembly()
        {
            Assembly = typeof(GridWindowsAssembly).Assembly;
...
namespace Syncfusion
{
    internal class AssemblyInfo : Syncfusion.GridWindowsAssembly
    {
    }
}
