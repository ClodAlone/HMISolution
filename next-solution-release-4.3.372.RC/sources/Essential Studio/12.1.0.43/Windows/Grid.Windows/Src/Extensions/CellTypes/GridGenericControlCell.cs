//-------------------------------------------------------------------------------------------------
// <copyright file="GridGenericControlCell.cs" company="syncfusion">
...
namespace Syncfusion.Windows.Forms.Grid
{
    ...
    /// A <see cref="GridGenericControlCellModel"/> can serve as model for several <see cref="GridCurrencyTextBoxCellRenderer"/>
    /// instances if a there are several <see cref="GridControlBase"/> views for a <see cref="GridModel"/>.
    /// <para/>
    /// See <see cref="GridGenericControlCellRenderer"/> for more detailed information about this cell type.
    /// </remarks>
    [Serializable]
    public class GridGenericControlCellModel : GridStaticCellModel
    {
        /// <overload>
        /// Initializes a new <see cref="GridGenericControlCellModel"/> object.
        /// </overload>
        /// <summary>
        /// Initializes a new <see cref="GridGenericControlCellModel"/> object 
        ...
        /// </remarks>
        public GridGenericControlCellModel(GridModel grid)
            : base(grid)
        {
            AllowFloating = false;
            AllowMerging = false;
        ...
        /// <summary>
        /// Initializes a new <see cref="GridGenericControlCellModel"/> from a serialization stream.
        /// </summary>
        /// <param name="info">An object that holds all the data needed to serialize or deserialize this instance.</param>
        /// <param name="context">Describes the source and destination of the serialized stream specified by info. </param>
        protected GridGenericControlCellModel(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            return new GridGenericControlCellRenderer(control, this);
        }
    }
    ...
    ///     <item>
    ///         <term>Renderer</term>
    ///         <description><see cref="GridGenericControlCellRenderer"/></description>
    ///     </item>
    ///     <item>
    ///         <term>Model</term>
    ///         <description><see cref="GridGenericControlCellModel"/></description>
    ///     </item>
    ///     <item>
    ...
    /// <para/>   
    /// </remarks>
    public class GridGenericControlCellRenderer : GridStaticCellRenderer
    {
