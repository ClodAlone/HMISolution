//-------------------------------------------------------------------------------------------------
// <copyright file="GridRangeInfo.cs" company="syncfusion">
...
namespace Syncfusion.Windows.Forms.Grid
{
    ...
    /// </summary>
    [TypeConverter(typeof(Syncfusion.Windows.Forms.Grid.GridRangeInfoConverter))]
    [Serializable]
    [ImmutableObject(true)]
    [DesignerSerializer(typeof(Syncfusion.Windows.Forms.Grid.GridRangeInfoCodeDomSerializer), typeof(System.ComponentModel.Design.Serialization.CodeDomSerializer))]
    public class GridRangeInfo : IFormattable, ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Gets the <see cref="GridRangeInfoType"/> of this <see cref="GridRangeInfo"/> object.
        /// </summary>
        ...
        /// <summary>
        /// <para>Gets a value indicating whether this <see cref="GridRangeInfo"/> has a <see cref="GridRangeInfoType"/> of Empty.</para>
        /// </summary>
        /// <value>
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            if (GridUtil.IsEmpty(format) || format == "G")
            {
        ...
        /// <returns>The <see cref="GridRangeInfo"/> with coordinates specified in the string.</returns>
        /// <remarks>
