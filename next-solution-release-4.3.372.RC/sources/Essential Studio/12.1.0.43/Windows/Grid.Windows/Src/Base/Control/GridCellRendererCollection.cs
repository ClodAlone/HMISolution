//-------------------------------------------------------------------------------------------------
// <copyright file="GridCellRendererCollection.cs" company="syncfusion">
...
namespace Syncfusion.Windows.Forms.Grid
{
    ...
    /// </example>
    public class GridCellRendererCollection : GridSubComponent, ICollection 
    {
        //// Fields
        string cachedKey = string.Empty;
        GridCellRendererBase cachedRenderer = null;
        ...
        public virtual void Remove(string key)
        {
            if (ContainsKey(key))
            {
                GridCellRendererBase control = content[key] as GridCellRendererBase;
                if (control != null && control.Grid != null)
                {
                    control.Dispose();
                }
        ...
        /// </summary>
        public virtual GridCellRendererBase this[string key] 
        {
            set
            {
            ...
            get
            {
                ...
                if (!this.ContainsKey(key))
                {
                    ...
                    cachedRenderer = cellModel.CreateRenderer(grid);
                ...
                {
                    cachedRenderer = (GridCellRendererBase)content[key];
                }
        ...
        /// <summary>
        /// <para>Gets a value indicating whether access to the <see cref="GridCellRendererCollection" /> is synchronized (thread-safe).</para>
        /// </summary>
