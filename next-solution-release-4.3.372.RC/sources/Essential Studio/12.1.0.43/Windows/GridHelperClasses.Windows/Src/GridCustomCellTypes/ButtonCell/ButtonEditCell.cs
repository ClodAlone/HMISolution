//-------------------------------------------------------------------------------------------------
// <copyright file="ButtonEditCell.cs" company="Syncfusion">
...
namespace Syncfusion.GridHelperClasses
{
    ...
    public class ButtonEditCellModel : GridTextBoxCellModel
    {
        ...
        /// <param name="e">A <see cref="GridDrawButtonFaceEventHandler"/> that contains the event data.</param>
        ...
        /// </summary>
        /// <remarks>
        /// See <see cref="GridDrawButtonFaceEventHandler"/> for more detailed discussion about this event.
        /// </remarks>
        ...
        /// <overload>
        /// Initializes a new instance of the <see cref="ButtonEditCellModel"/> class.
        /// </overload>
        /// <summary>
        /// Initializes a new instance of the <see cref="ButtonEditCellModel"/> class from a serialization stream.
        /// </summary>
        ...
        protected ButtonEditCellModel(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            this.ButtonBarSize = new Size(20, 20);
        }
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ButtonEditCellRenderer"/> class for the given GridControlBase
        /// and <see cref="ButtonEditCellModel"/> class.
        /// </summary>
        ...
        /// <remarks>References to GridControlBase,        /// and GridTextBoxCellModel will be saved.</remarks>
        ...
        /// <param name="innerBounds">The System.Drawing.Rectangle with the inner bounds of a cell.</param>
        /// <param name="buttonsBounds">An array of System.Drawing.Rectangle with bounds for each cell button element.</param>
        /// <returns>A System.Drawing.Rectangle with the bounds.</returns>
    ...
    public class ButtonEditCellButton : GridCellButton
    {
        ...
        {
            iconPainter = new GridIconPaint("Syncfusion.GridHelperClasses.", typeof(ButtonEditCellButton).Assembly);
        }
        ...
        /// <param name="bActive">True if this is the current cell; False otherwise.</param>
        /// <param name="style">GridStyleInfo object that provides cell information.</param>
        public override void Draw(Graphics g, int rowIndex, int colIndex, bool bActive, GridStyleInfo style)
        {
            ...
            this.DrawButtonFace(g, buttonState, style);
        }
        ...
        public void DrawDefaultButtonFace(Graphics g, ButtonState buttonState, GridStyleInfo style)
        {
            ...
            if (sp.ButtonEditInfo.ButtonEditType != ButtonType.None)
            {
                ...
                string prefix = "GridCustomCellTypes.ButtonCell.ButtonImages.";
        ...
        /// <param name="drawDisabled">if set to <c>true</c> [draw disabled].</param>
        ...
        internal static int MeasureDisplayStringWidth(Graphics graphics, string text, Font font)
        {
    ...
    /// <summary>
    /// Provides data about <see cref="GridDrawButtonFaceEventArgs"/> event which can be handled
    /// </summary>
    /// <remarks>
    /// GridDrawButtonFaceEventArgs is a custom event argument class used by the
    /// <see cref="GridDrawButtonFaceEventArgs"/> event to allow custom drawing of
    ...
    public sealed class GridDrawButtonFaceEventArgs : SyncfusionHandledEventArgs
    {
        ...
        /// <summary>
        /// Initializes new instance of the <see cref="GridDrawButtonFaceEventArgs"/> class
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="ButtonEditCellButton"/> that is associated with the cell
        /// </summary>
        /// <value>The button.</value>
        /// <remarks>
        /// If you do not set <see cref="ButtonEditCellButton"/> to True, this buttons's <see cref="ButtonEditCellButton.DrawDefaultButtonFace"/>
        /// will get called.
        /// </remarks>
        [TraceProperty(true)]
