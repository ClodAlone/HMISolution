...
namespace Syncfusion.UI.Xaml.Grid
{
    ...
    public class GridVirtualizingCollectionView : VirtualizingCollectionView
    {
        ...
        internal void SetDataGrid(SfDataGrid sfDataGrid)
        {
            dataGrid = sfDataGrid;
            if (propertyAccessProvider is GridItemPropertiesProvider)
                (propertyAccessProvider as GridItemPropertiesProvider).SetDataGrid(sfDataGrid);
#if !WP
            else if (propertyAccessProvider is GridDynamicPropertiesProvider)
                (propertyAccessProvider as GridDynamicPropertiesProvider).SetDataGrid(sfDataGrid);
#endif
        }
    }
