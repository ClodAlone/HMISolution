...
#endif
{
...
#if WINDOWS_PHONE
    [TemplatePart(Name = PresenterName, Type = typeof(ContentControl))]
#else
    ...
    public sealed class LayoutTransformer : ContentControl
    {
        ...
        public static readonly DependencyProperty LayoutTransformProperty = DependencyProperty.Register(
            "LayoutTransform", typeof(Transform), typeof(LayoutTransformer), new PropertyMetadata(null,new PropertyChangedCallback(LayoutTransformChanged)));
...
#if WINDOWS_PHONE
            _contentPresenter = GetTemplateChild(PresenterName) as ContentControl;
#else
