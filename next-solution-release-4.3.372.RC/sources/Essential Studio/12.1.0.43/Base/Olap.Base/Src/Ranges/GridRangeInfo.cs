...
#endif
{
    ...
    [DesignerSerializer(typeof(GridRangeInfoCodeDomSerializer), typeof(System.ComponentModel.Design.Serialization.CodeDomSerializer))]
    public class GridRangeInfo: IFormattable, ICloneable, ISerializable
#else
    public class GridRangeInfo : IFormattable 
 ...
 #endif
    {
        ...
        /// <summary>
        /// Represents the delimeter sign.
        /// </summary>
        public const char DelimitSign = '-';
                ...
                switch (range.RangeType)
                {
                    ...
                    case GridRangeInfoType.Cols:
                            ...
                            parts = new string[] 
                        {
                            ...
                            GridRangeInfo.DelimitSign.ToString(),
        ...
        public static GridRangeInfo Parse(string parseText)
        {
            ...
            try
            {
                ...
                string[] parts = parseText.Split(new char[] { GridRangeInfo.DelimitSign });
                if (parts.Length == 1)
...
#if !SILVERLIGHT
        private static void TraceExceptionCatched(Exception e)
        {
