...
namespace Syncfusion.Windows.Data
{
    ...
    using System;
    using Syncfusion.Windows.Common;
    ...
    public sealed class PagedCollectionView : ICollectionView, IPagedCollectionView, IEditableCollectionView, INotifyPropertyChanged,IEnumerable
    {
        ////------------------------------------------------------
        ////
        ////  Constants
       ...
       // private CollectionViewGroupRoot _group;
        ...
        {
            get { return this.SortDescriptions.Count > 0 || this.CanFilter || this._pageSize > 0; }// || this.GroupDescriptions.Count > 0; }
        }
        ...
        public bool PassesFilter(object record)
        {
        ...
        private void ProcessAddEvent(object addedItem, int addIndex)
        {
            ...
            int internalIndex = this.InternalIndexOf(addedItem);
            ...
            if (internalIndex > 0 && addedIndex == -1 && this.CollectionChanged != null)
