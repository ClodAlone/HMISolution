...
#endif
{
    ...
    public static class StringExtensions
    {
        ...
        public static string FormatByName(this string format, IFormatProvider provider, Func<string, object> valueProvider)
        {
            ...
            resultString = Regex.Replace(resultString, @"{-1(\:\w?\})", m =>
            {
                return string.Empty;
            }, RegexOptions.IgnoreCase);
...
#else
        public static void ParseFormat(this string value, bool raiseException, Dictionary<string, PropertyInfo> pdc, out string result, out PropertyInfo[] pds)
#endif
        {
#if !SILVERLIGHT
