...
namespace Syncfusion.Windows.Forms.Chart.SvgBase
{
    ...
    public sealed class LinearGradientElement : SuperElement
    {
        #region Proprties
        /// <summary>
        ...
        /// <summary>
        /// Creates the <see cref="LinearGradientElement"/> element by the specified GDI+ brush.
        /// </summary>
