...
namespace Syncfusion.Windows.Forms.Chart.SvgBase
{
        ...
        IOpacityAttribute
    {
        ...
        private static Regex Divisor
        {
            get
            {
                if (m_divisor == null)
                {
                    m_divisor = new Regex(@"\s*(?<text>[^:; ]+)\s*[:;]?",
        ...
        private object GetAttribute(object key, object defValue)
        {
        ...
        /// <param name="value">The value.</param>
        /// <param name="defValue">The def value.</param>
        private void SetAttribute(object key, object value, object defValue)
        {
            if (value == defValue)
            {
