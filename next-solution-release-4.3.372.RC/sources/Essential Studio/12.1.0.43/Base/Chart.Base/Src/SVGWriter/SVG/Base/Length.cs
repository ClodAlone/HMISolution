...
namespace Syncfusion.Windows.Forms.Chart.SvgBase
{
    ...
    public struct Length
    {
        ...
        internal static Regex LengthRegex
        {
            get
            {
                if (m_lengthRegex == null)
                {
                    m_lengthRegex = new Regex(@"(?<number>[-]?[0-9]+([.][0-?9]+)?(\s*e[+-][0-9]+)?)(?<type>%|em|ex|px|cm|mm|in|pt|pc)?",
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.Length"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Int32"/> to <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.Length"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Single"/> to <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.Length"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.Length"/> to <see cref="System.Single"/>.
        /// </summary>
