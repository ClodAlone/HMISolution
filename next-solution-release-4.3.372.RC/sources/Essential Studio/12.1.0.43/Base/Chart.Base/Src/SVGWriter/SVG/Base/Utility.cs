...
namespace Syncfusion.Windows.Forms.Chart.SvgBase
{
    ...
    static class Utility
    {
        ...
        public static CultureInfo FloatFormat
        {
            get
            {
        ...
        public static Regex NumberRegex
        {
            get
            {
                ...
                {
                    m_numberRegex = new Regex(@"[-]?[0-9]+([.][0-?9]+)?(\s*e[+-][0-9]+)?",
        ...
        public static Regex UrlRegex
        {
            get
            {
                if (m_urlRegex == null)
                {
                    m_urlRegex = new Regex(@"url[(][#]*(?<text>\w+)[)]",
                        RegexOptions.Compiled | RegexOptions.IgnoreCase);
                }
        ...
        public static string GetIdFromUrl(string ulr)
        {
            Match mch = UrlRegex.Match(ulr);

            return mch.Success ? mch.Groups["text"].Value : "";
        }
