...
namespace Syncfusion.SVG.IO
{
    ...
    public struct NoneColor
    {
        ...
        public static Regex ColorRegexPercent
        {
            get
            {
                if (m_colorRegexPercent == null)
                {
                    m_colorRegexPercent = new Regex(
                                          @"[rgb ]+\( *(?<r>\d+)%[, ]+(?<g>\d+)%[, ]+(?<b>\d+)% *\)",
                                          RegexOptions.Compiled | RegexOptions.IgnoreCase);
                }
        ...
        public static Regex Hex6ColorRegex
        {
            get
            {
                if (m_hex6ColorRegex == null)
                {
                    m_hex6ColorRegex = new Regex(
        ...
        public static Regex Hex3ColorRegex
        {
            get
            {
                if (m_hex3ColorRegex == null)
                {
                    m_hex3ColorRegex = new Regex(
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="NoneColor"/> struct.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Drawing.Color"/> to <see cref="Syncfusion.SVG.IO.NoneColor"/>.
        /// </summary>
        /// <param name="color">The color.</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="Syncfusion.SVG.IO.NoneColor"/>.
        /// </summary>
        /// <param name="color">The color.</param>
        /// <returns>The result of the conversion.</returns>
