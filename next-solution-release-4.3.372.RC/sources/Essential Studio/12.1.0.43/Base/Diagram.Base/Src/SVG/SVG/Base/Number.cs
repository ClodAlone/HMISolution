...
namespace Syncfusion.SVG.IO
{
    ...
    public struct Number
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.String"/> to <see cref="Syncfusion.SVG.IO.Number"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Int32"/> to <see cref="Syncfusion.SVG.IO.Number"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Single"/> to <see cref="Syncfusion.SVG.IO.Number"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        public override string ToString()
        {
            return m_isEmpty ? SVG.VALUE_NONE :
              (m_primary != string.Empty ? m_primary : Utility.GetFloat(m_value));
        }
        #endregion
    }
}
