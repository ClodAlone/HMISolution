...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    public class HeaderConverter : System.ComponentModel.ExpandableObjectConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                Header header = value as Header;
                if (header != null)
                {
                    System.Text.StringBuilder str = new StringBuilder();
                    if (header.Left != null)
                    {
                        str.Append("Left=" + header.Left);
                    }
                    if (header.Center != null)
                    {
                        if (str.Length != 0)
                            str.Append(", ");
                        str.Append("Center=" + header.Center);
                    }
                    if (header.Right != null)
                    {
                        if (str.Length != 0)
                            str.Append(", ");
                        str.Append("Right=" + header.Right);
                    }
