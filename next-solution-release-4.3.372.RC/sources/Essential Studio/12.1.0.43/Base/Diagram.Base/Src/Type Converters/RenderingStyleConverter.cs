...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    /// </summary>
    public class RenderingStyleConverter : System.ComponentModel.ExpandableObjectConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                RenderingStyle renderingStyle = value as RenderingStyle;
                if (renderingStyle != null)
                {
                    return ("{" + renderingStyle.SmoothingMode.ToString() + "}");
                }
            }
