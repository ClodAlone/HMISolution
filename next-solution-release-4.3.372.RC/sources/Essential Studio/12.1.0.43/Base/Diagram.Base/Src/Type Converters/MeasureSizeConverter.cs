...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    /// </summary>
    public class MeasureSizeConverter : System.ComponentModel.ExpandableObjectConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                if (model != null)
                {
                    SizeF szSize = (SizeF)value;

                    return string.Format("{0} {2}; {1} {2}", szSize.Width, szSize.Height, MeasureUnitsConverter.GetAbbreviation(model.MeasurementUnits));
                }
            }
