    ...
    public class EditStyleConverter : System.ComponentModel.TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                if (editStyle != null)
                {
                    return ("AllowMoveX=" + editStyle.AllowMoveX.ToString() + "AllowMoveY=" + editStyle.AllowMoveY.ToString()
                            + ", AllowRotate=" + editStyle.AllowRotate.ToString() + ", AllowChangeWidth=" + editStyle.AllowChangeWidth.ToString()
                            + ", AllowChangeHeight=" + editStyle.AllowChangeHeight.ToString() + "AllowSelect=" + editStyle.AllowSelect.ToString()
                            + "AllowVertexEdit=" + editStyle.AllowVertexEdit.ToString());
                }
            }
