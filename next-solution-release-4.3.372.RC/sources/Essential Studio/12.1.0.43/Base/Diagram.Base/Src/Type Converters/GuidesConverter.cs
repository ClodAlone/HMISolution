...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    /// </summary>
    public class GuidesConverter : System.ComponentModel.ExpandableObjectConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                Guides guides = value as Guides;
                if (guides != null)
                {
                    return ("{" + "Enable = " + guides.Enable.ToString() + ", Guides = " + guides.Type.ToString() +
                         ", Margin = " + guides.Margin.ToString() + "}");
                }
            }
