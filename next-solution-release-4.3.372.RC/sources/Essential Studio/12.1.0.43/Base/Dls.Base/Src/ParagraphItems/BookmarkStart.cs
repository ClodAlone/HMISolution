...
namespace Syncfusion.DLS
{
    ...
    public BookmarkStart( IDocument doc )
      : base( doc )
    {
      //
	  ...
	  protected BookmarkStart( BookmarkStart bookmark, IParagraph paragraph ) 
    ...
    public override IParagraphItem Clone( IParagraph paragraph )
    {
      ...
      BookmarkStart start = new BookmarkStart( this, paragraph );
      bookmark.m_bkmkStart = start;
    ...
    protected override void ReadXmlAttributes( IXDLSAttributeReader reader )
    {
      ...
      Document.Bookmarks.Add( new Bookmark( this, this ));
    }
    #endregion
