...
namespace Syncfusion.XlsIO.Parser.Biff_Records
{
    ...
    public class TextWithFormat : IComparable, ICloneable
    {
        ...
        /// </summary>
        //private SortedListEx m_arrFormattingRuns;// = new SortedListEx();
        ...
        /// <returns>A new object that is a copy of this instance.</returns>
        public TextWithFormat Clone( IDictionary dicFontIndexes )
        {
        ...
        /// <param name="bDefragment">Indicates wheter defragmentation is needed.</param>
        ...
        public void SetFontByIndex( int index, int iFontIndex )
        {
            CreateFormattingRuns();
              ...
              int iKey = m_arrFormattingRuns.Keys[ index ];
        ...
        {
            int iStartPos = 0;
              int iEndPos = m_arrFormattingRuns.Count - 1;
              int iMiddle;
              int iCurPos;
        ...
        private void RemoveAllInsideRange( int iStartPos, int iEndPos )
        {
        ...
        /// </summary>
        /// <param name="dicFontIndexes">Dictionary with new font indexes.</param>
        private void UpdateFontIndexes( IDictionary dicFontIndexes )
        {
            if( dicFontIndexes == null )
        ...
        /// otherwise 1.
        /// </returns>
        public static int CompareFormattingRuns( SortedListEx fRuns1, SortedListEx fRuns2 )
        {
            if( fRuns1 == null && fRuns2 == null ) return 0;
              ...
              {
            int result = ( int )fRuns1.GetKey( i ) - ( int )fRuns2.GetKey( i );

            if( result != 0 ) return result;

            result = ( int )fRuns1.GetByIndex( i ) - ( int )fRuns2.GetByIndex( i );
