...
namespace Syncfusion.XlsIO.Parser.Biff_Records.PivotTable
{
  ...
  public class SelectionInfoRecord : BiffRecordRaw
  {
    ...
    public ushort WindowIndex
    {
      get
      {
        return m_usWindowIndex;
      }
      set
      {
        m_usWindowIndex = value;
      }
    }
    /// <summary>
    /// 0-based index of the pane of the window.
    ...
    {
      m_usWindowIndex = provider.ReadUInt16( iOffset + 0 );
      m_usPaneIndex = provider.ReadUInt16( iOffset + 2 );
    }
    /// <summary>
    ...
    {
      provider.WriteUInt16( iOffset + 0, m_usWindowIndex );
      provider.WriteUInt16( iOffset + 2, m_usPaneIndex );
      provider.WriteByte( DefaultRecordSize - 1, 0 );
