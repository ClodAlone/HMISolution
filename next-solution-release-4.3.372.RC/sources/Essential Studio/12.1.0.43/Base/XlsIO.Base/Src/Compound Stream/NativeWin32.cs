...
namespace Syncfusion.XlsIO.IO.Stream.Win32
{
  /// <summary>
  ...
  public enum LOCKTYPE
  {
    ...
    /// prohibited except for the owner granted this lock.
    /// </summary>
    LOCK_WRITE      = 1,
    /// <summary>
  ...
  public struct _LARGE_INTEGER
  {
    ...
    /// <summary>
    /// Operator that return _LARGE_INTEGER from lData.
    /// </summary>
    /// <param name="lData">Current Data.</param>
    /// <returns>_LARGE_INTEGER as lData.</returns>
    public static explicit operator _LARGE_INTEGER( long lData )
    {
      _LARGE_INTEGER larg = new _LARGE_INTEGER();
      larg.QuadPart = lData;
      return larg;
    }

    /// <summary>
    /// Operator that return QuadPart property as Long
    /// </summary>
    /// <param name="data">Implement of IData.</param>
    /// <returns>QuadPart property.</returns>
    public static implicit operator long( _LARGE_INTEGER data )
    {
  ...
  public struct _ULARGE_INTEGER
  {
    ...
    /// <summary>
    /// Operator to update ULARGE INTEGER type.
    /// </summary>
    /// <param name="lData">Value to update.</param>
    /// <returns>Returns updated instance.</returns>
    public static explicit operator _ULARGE_INTEGER( ulong lData )
    {
      _ULARGE_INTEGER larg = new _ULARGE_INTEGER();
      larg.QuadPart = lData;
      return larg;
    }
    /// <summary>
    /// Converted lData to QuadPart property of _ULARGE_INTEGER.
    /// </summary>
    /// <param name="lData">Paramater to convert.</param>
    /// <returns>_ULARGE_INTEGER where init property QuadPart by lData.</returns>
    public static explicit operator _ULARGE_INTEGER( long lData )
    {
      _ULARGE_INTEGER larg = new _ULARGE_INTEGER();
      larg.QuadPart = Convert.ToUInt64( lData );
      return larg;
    }
    /// <summary>
    /// Convert QuadPart property to ulong.
    /// </summary>
    /// <param name="data">_ULARGE_INTEGER.</param>
    /// <returns>QuadPart property as ulong.</returns>
    public static implicit operator ulong( _ULARGE_INTEGER data )
    {
      return data.QuadPart;
    }
    /// <summary>
    /// Convert QuadPart property to long.
    /// </summary>
    /// <param name="data">_ULARGE_INTEGER.</param>
    /// <returns>QuadPart property as long.</returns>
    public static implicit operator long( _ULARGE_INTEGER data )
    {
      return Convert.ToInt64( data.QuadPart );
    }
  }
  ...
  public struct STGOPTIONS
  {
    ...
    UInt16 reserved;
    uint ulSectorSize;
    [MarshalAs(UnmanagedType.LPWStr)] string pwcsTemplateFile;
  }
  ...
  public interface IStream
  {
    ...
    /// of bytes.</param>
    /// <returns></returns>
    int SetSize( _ULARGE_INTEGER libNewSize );
    /// <summary>
    ...
    /// <returns></returns>
    int LockRegion( _ULARGE_INTEGER libOffset,
      _ULARGE_INTEGER cb,
      uint dwLockType );
    /// <summary>
    ...
    /// <param name="dwLockType"></param>
    /// <returns></returns>
    int UnlockRegion( _ULARGE_INTEGER libOffset,
      _ULARGE_INTEGER cb,
      uint dwLockType );
    /// <summary>
  ...
  public interface IPropertyStorage
  {
    ...
    void ReadMultiple( uint cpspec, ref tagPROPSPEC rgpspec, IntPtr rgpropvar );
    /// <summary>
    ...
    void WriteMultiple( uint cpspec, ref tagPROPSPEC rgpspec, IntPtr rgpropvar, PID propidNameFirst );
    /// <summary>
    ...
    void DeleteMultiple( uint cpspec, ref tagPROPSPEC rgpspec );
    /// <summary>
  ...
  public class ENUMLOGFONTEX 
  {
    ...
    private string GetZeroTerminatedString( byte[] arrData )
    {
      if( arrData != null )
      {
        ...
        {
          if( arrData[ i ] == '\0' ) break;
        }

        return Encoding.Default.GetString( arrData, 0, i );
      }
      else
      {
        return null;
...
// 
  ...
  sealed public class API
  {
    ...
    [ DllImport( "iprop.dll", SetLastError=true ) ]
    ...
    /// determines the initial amount of memory that is commited for the heap.
