...
//
[assembly: AssemblyTitle("Syncfusion.Grid.Grouping.Base")]
...
namespace Syncfusion
{
    /// <exclude/>
     ...
     /// </summary>
     public class GridGroupingBaseAssembly
     {
          /// <summary>
          ...
          static GridGroupingBaseAssembly()
          {
               Assembly = typeof(GridGroupingBaseAssembly).Assembly;
     ...
     internal class AssemblyInfo : Syncfusion.GridGroupingBaseAssembly
     {
     }
}
