...
{
    /// <summary>
    /// Summary description for ILCOperator.
    /// </summary>
  public interface ILCOperator
  {
    ...
    /// <summary>
    /// Sends the event that current leaf LayoutedWidget complete.
    /// </summary>
  ...
  public abstract class LayoutContext
  {
    ...
    /// </summary>
    /// <returns>
    /// 	 if ensure splitted, set to <c>true</c>.
    /// </returns>
