...
#endif
{
    public sealed class Font
    {
        ...
        private Syncfusion.DocIO.DLS.UnderlineStyle m_underlineStyle = UnderlineStyle.None;
        #endregion
    ...
    {
#if !SILVERLIGHT && !WP
        internal static Color ColorFromHtml(string paramValue)
        {
            System.Drawing.Color color = System.Drawing.ColorTranslator.FromHtml(paramValue);
            int argb = color.ToArgb();
            return Color.FromArgb(argb);
        }
        ...
        {
            int argb = color.ToArgb();
            System.Drawing.Color destColor = System.Drawing.Color.FromArgb(argb);
            return System.Drawing.ColorTranslator.ToHtml(destColor);
        }

        internal static System.Drawing.Color ToSystemColor(Color color)
        {
            int argb = color.ToArgb();
            return System.Drawing.Color.FromArgb(argb);
        }

        internal static System.Drawing.RectangleF ToSystemRectangleF(RectangleF rect)
        {
            System.Drawing.RectangleF sysRect = new System.Drawing.RectangleF();
            sysRect.X = rect.X;
            sysRect.Y = rect.Y;
        ...
        internal static RectangleF ToRectangleF( System.Drawing.RectangleF sysRect)
        {
            RectangleF rect = new RectangleF();
            rect.X = sysRect.X;
            rect.Y = sysRect.Y;
            rect.Width = sysRect.Width;
            rect.Height = sysRect.Height;

            return rect;
        }

        internal static System.Drawing.Rectangle ToSystemRectangle(Rectangle rect)
        {
        ...
        internal static Size ToSize(System.Drawing.Size sysSize)
        {
            Size size = new Size();
            size.Width = sysSize.Width;
            size.Height = sysSize.Height;            

            return size;
        }

        internal static SizeF ToSizeF(System.Drawing.SizeF sysSize)
        {
        ...
        internal static System.Drawing.SizeF ToSystemSizeF(SizeF size)
        {
            System.Drawing.SizeF sysSize = new System.Drawing.SizeF();
            sysSize.Width = size.Width;
            sysSize.Height = size.Height;
            return sysSize;
        }

        internal static System.Drawing.PointF ToSystemPointF(PointF point)
        {
            System.Drawing.PointF sysPoint = new System.Drawing.PointF();
            sysPoint.X = point.X;
            sysPoint.Y = point.Y;
            return sysPoint;
        }
