...
namespace Syncfusion.DocIO.DLS
{
  ...
  public class DLSGraphics : CustomGraphics
  {
    ...
    public virtual void DrawParagraph( WParagraph paragraph, LayoutedWidget ltWidget )
    {
      ...
      if( paragraph.ListFormat.ListType != ListType.NoList )
      {
        ...
        switch( listStyle.ListType )
        {
          case ListType.Bulleted:
            ...
            break;
          default:
            font = paragraph.BreakCharacterFormat.Font;
            break;
        }

        SolidBrush brush = new SolidBrush( paragraph.BreakCharacterFormat.TextColor );
    ...
    public virtual void DrawBackgroundImage( WPageSetup setup, Image image )
    {
    ...
    /// <param name="ltWidget"></param>
    public virtual void DrawPicture( WPicture picture, LayoutedWidget ltWidget )
    {
    ...
    public virtual void DrawTextRange( WTextRange txtRange, LayoutedWidget ltWidget, string text )
    {
      ...
      WCharacterFormat format = txtRange.CharacterFormat;
    ...
    protected virtual void DrawText( string text, WCharacterFormat format, Brush brush, float x, float y, float fontSize )
    {
        ...
        format.TextBackgroundColor != Color.White )
      {
        ...
        SizeF size = Graphics.MeasureString( text, format.Font );
      ...
      if( format.Emboss )
      {
        ...
        Graphics.DrawString( text, format.Font, brush2, x + 1, y + 1 );
      }
      ...
      if( format.AllCaps || format.SmallCaps )
      {
        text = text.ToUpper();
      }

      //
      Graphics.DrawString( text, format.Font, brush, x, y );
    ...
    /// <param name="picture"></param>
    /// <returns></returns>
    public virtual SizeF MeasurePicture( WPicture picture )
    {
      return new SizeF( 
    ...
    /// <param name="txtRange"></param>
    /// <returns></returns>
    public virtual SizeF MeasureTextRange( WTextRange txtRange, string text )
    {
    ...
    /// <param name="txtRange"></param>
    /// <returns></returns>
    public virtual float GetAscentTextRange( WTextRange txtRange )
    {
...
*/
    ...
    /// <param name="ltWidget"></param>
    public virtual void DrawTable( WTable table, LayoutedWidget ltWidget )
    {
    ...
    /// <param name="ltWidget"></param>
    public virtual void DrawTableRow( WTableRow row, LayoutedWidget ltWidget )
    {
    ...
    /// <param name="ltWidget"></param>
    public virtual void DrawTableCell( WTableCell cell, LayoutedWidget ltWidget )
    {
      if( cell == null )
    ...
    /// <param name="cell"></param>
    /// <param name="ltWidget"></param>
    protected internal virtual void DrawCellBorders( WTableCell cell, LayoutedWidget ltWidget )
    {
      RectangleF bounds = ltWidget.Bounds;
      Borders cellBorders = cell.CellFormat.Borders;
      RowFormat tableFormat = cell.OwnerRow.RowFormat;
      ...
      Border leftBorder = ( cellBorders.Left.BorderType != BorderStyle.None )
                      ? cellBorders.Left
                      : ( cellIndex == 0 ) ? tableBorders.Left : defaultBorders.Vertical;
      ...
      Border topBorder = ( cellBorders.Top.BorderType != BorderStyle.None )
                         ? cellBorders.Top
                         : ( rowIndex == 0 ) ? tableBorders.Top : defaultBorders.Horizontal;
      ...
      if( !bNotDrawRight )
      {
        ...
        Border rightBorder = ( cellBorders.Right.BorderType != BorderStyle.None )
                               ? cellBorders.Right
                               : ( cellIndex == cellLast ) ? tableBorders.Right : defaultBorders.Vertical;
      ...
      if( !bNotDrawBottom || bRowSplitted || tableInfo.IsExactlyRowHeight )
      {
        ...
        Border bottomBorder = ( cellBorders.Bottom.BorderType != BorderStyle.None )
                                ? cellBorders.Bottom
                                : ( rowIndex == rowlLast ) ? tableBorders.Bottom : defaultBorders.Horizontal;
      ...
      : RowFormat
    {
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="DefaultBorders"/> class.
      /// </summary>
