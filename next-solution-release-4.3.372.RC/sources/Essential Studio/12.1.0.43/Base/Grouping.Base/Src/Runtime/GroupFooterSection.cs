//-------------------------------------------------------------------------------------------------
// <copyright file="GroupFooterSection.cs" company="syncfusion">
...
namespace Syncfusion.Grouping
{
    ...
    /// </summary>
    public class GroupFooterSection : Section, IDisplayElement
    {
        /// <summary>
        ...
        {
            get { return DisplayElementKind.GroupFooter; }
        }
        ...
        {
            return ParentTable.DefaultGroupFooterSectionHeight;
        }
