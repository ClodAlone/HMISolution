...
namespace Syncfusion.JavaScript.Mobile.Models
{
    ...
    public class MobileTextBoxProperties :TextBoxPropertiesBase, IMobileBase
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [indicate error].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [indicate error]; otherwise, <c>false</c>.
        /// </value>
        [JsonProperty("indicateError")]
        [DefaultValue(false)]
        public bool IndicateError { get { return indicateError; } set { indicateError = value; } }
        ...
        public MobileTextBoxWindowsProperties Windows { get; set; }
       ...
       #region constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileTextBoxProperties"/> class.
        /// </summary>
        public MobileTextBoxProperties()
        {
            this.Windows = new MobileTextBoxWindowsProperties();
        }
       #endregion
