...
namespace Syncfusion.JavaScript.Mobile.Models
{
    public class MobileRadioButtonProperties :RadioButtonPropertiesBase, IMobileBase
    {
        ...
        [DefaultValue(RenderMode.Windows)]
        public MobileRadioButtonWindowsProperties Windows { get; set; }

        #endregion

       #region constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileRadioButtonProperties"/> class.
        /// </summary>
        public MobileRadioButtonProperties()
        {
            this.Windows = new MobileRadioButtonWindowsProperties();
        }
       #endregion
