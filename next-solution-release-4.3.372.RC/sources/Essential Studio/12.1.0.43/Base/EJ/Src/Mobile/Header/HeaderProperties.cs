...
{
    public class MobileHeaderProperties : IMobileBase
    {
        #region Fields
        ...
        private MobileHeaderPosition position = MobileHeaderPosition.Fixed;
        private string leftButtonCaption = "Back";
        private string rightButtonCaption = "Right";
        private LeftButtonStyle leftButtonStyle = LeftButtonStyle.Back;
        ...
        [DefaultValue(MobileHeaderPosition.Fixed)]
        public MobileHeaderPosition Position { get { return position; } set { position = value; } }
        ...
        /// <summary>
        /// Gets or sets the left button style.
        /// </summary>
        /// <value>
        /// The left button style.
        /// </value>
        [JsonProperty("leftButtonStyle")]
        [DefaultValue(LeftButtonStyle.Back)]
        public LeftButtonStyle LeftButtonStyle { get { return leftButtonStyle; } set { leftButtonStyle = value; } }
        ...
        public MobileHeaderWindowsProperties Windows { get; set; }
        ...
        public MobileHeaderAndroidProperties Android { get; set; }
       ...
       #region constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileHeaderProperties"/> class.
        /// </summary>
        public MobileHeaderProperties()
        {
            this.Windows = new MobileHeaderWindowsProperties();
            this.Android = new MobileHeaderAndroidProperties();
        }
       #endregion
