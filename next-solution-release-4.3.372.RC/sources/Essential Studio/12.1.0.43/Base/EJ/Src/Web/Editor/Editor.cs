...
namespace Syncfusion.JavaScript
{
    ...
    {
        public static string editName = "ejNumericTextbox";

        public Numeric() { }
        public Numeric(String id, EditorProperties propModel)
        {
            this.ID = id;
            this.EditorModel = propModel;
        }
        public EditorProperties EditorModel
        {
            get;
            set;
        }
    ...
    public class Percent : Control
    {
        public static string editName = "ejPercentageTextbox";
        public Percent() { }
    ...
    public class Currency : Control
    {
        public static string editName = "ejCurrencyTextbox";
