...
namespace Syncfusion.Windows.Controls.Spreadsheet.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            if (localizedManager == null)
            {
                this.resources = Syncfusion.Windows.Controls.Spreadsheet.Resources.Syncfusion_Speradsheet_Wpf.ResourceManager;
            }
            else
            {
                    ...
                    foreach (var resourceName in assembly.GetManifestResourceNames())
                     {
                        ...
                        {
                            manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Controls.Spreadsheet.Resources.{0}", controlAssembly.FullName.Split(new char[] { ',' })[0]), controlAssembly);
                        }
                    }
                     else
                     {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Windows.Controls.Spreadsheet.Resources.Syncfusion_Speradsheet_Wpf.ResourceManager.GetString(name);
            }
            return value;
        }
