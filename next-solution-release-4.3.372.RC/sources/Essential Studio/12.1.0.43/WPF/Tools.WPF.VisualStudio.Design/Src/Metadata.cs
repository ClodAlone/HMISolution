...
[assembly: ProvideMetadata(typeof(Syncfusion.Tools.WPF.VisualStudio.Design.Metadata))]
#endif
namespace Syncfusion.Tools.WPF.VisualStudio.Design
{
    ...
    internal class Metadata : IProvideAttributeTable
    {
        public AttributeTable AttributeTable
        {
            ...
            get
            {
                ...
                builder.AddCustomAttributes(typeof(QATAlertDialog), new ToolboxBrowsableAttribute(false));
                builder.AddCustomAttributes(typeof(QATCustomizationDialog), new ToolboxBrowsableAttribute(false));
                builder.AddCustomAttributes(typeof(QATResetDialog), new ToolboxBrowsableAttribute(false));
                ...
                builder.AddCustomAttributes(typeof(FontListComboBox), new ToolboxBrowsableAttribute(true));
    ...
    #region RibbonButton
                ...
                builder.AddCustomAttributes(typeof(Ribbon), "Items", new NewItemTypesAttribute(typeof(RibbonTab)));
                builder.AddCustomAttributes(typeof(RibbonTab), "Items", new NewItemTypesAttribute(typeof(RibbonBar)));
                builder.AddCustomAttributes(typeof(RibbonBar), "Items", new NewItemTypesAttribute(typeof(RibbonButton),typeof(RibbonGallery),typeof(SplitButton),typeof(ButtonPanel), typeof(RibbonComboBox), typeof(DropDownButton)));
                builder.AddCustomAttributes(typeof(QuickAccessToolBar), "Items", new NewItemTypesAttribute(typeof(RibbonButton), typeof(SplitButton), typeof(RibbonComboBox), typeof(DropDownButton)));

                builder.AddCustomAttributes(typeof(ApplicationMenu), "Items", new NewItemTypesAttribute(typeof(SimpleMenuButton), typeof(SplitMenuButton)));
                builder.AddCustomAttributes(typeof(ApplicationMenu), "MenuItems", new NewItemTypesAttribute(typeof(FrameworkElement)));
                builder.AddCustomAttributes(typeof(ApplicationMenu), "ApplicationItems", new NewItemTypesAttribute(typeof(RibbonButton)));
                builder.AddCustomAttributes(typeof(ButtonPanel), "Items", new NewItemTypesAttribute(typeof(RibbonButton)));
                builder.AddCustomAttributes(typeof(SplitButton), "Items", new NewItemTypesAttribute(typeof(RibbonButton)));
                builder.AddCustomAttributes(typeof(DropDownButton), "Items", new NewItemTypesAttribute(typeof(RibbonMenuItem)));
                builder.AddCustomAttributes(typeof(ApplicationMenuGroup), "Items", new NewItemTypesAttribute(typeof(RibbonMenuItem)));
    ...
    #region AutoComplete
                ...
                builder.AddCustomAttributes(typeof(AutoComplete), "Items", new NewItemTypesAttribute(typeof(Object)));
                #endregion
    ...
    #region FontListBox
                ...
                builder.AddCustomAttributes(typeof(FontListBox), "RecentlyUsedFonts", new BrowsableAttribute(false));
    #endregion
    ...
    #region FontListComboBox
                ...
                builder.AddCustomAttributes(typeof(FontListComboBox), "RecentlyUsedFonts", new BrowsableAttribute(false));
    #endregion
    ...
    #region Gallery
                ...
                builder.AddCustomAttributes(typeof(Gallery), "Items", new NewItemTypesAttribute(typeof(GalleryItem), typeof(GalleryGroup)));
                builder.AddCustomAttributes(typeof(GalleryGroup), "Items", new NewItemTypesAttribute(typeof(GalleryItem)));
                #endregion
    ...
    #region TreeViewAdv
                ...
                builder.AddCustomAttributes(typeof(TreeViewItemAdv), "Items", new NewItemTypesAttribute(typeof(TreeViewItemAdv)));
    #endregion
    ...
    #region HierarchyNavigator
                ...
                builder.AddCustomAttributes(typeof(HierarchyNavigator), "Items", new NewItemTypesAttribute(typeof(HierarchyNavigatorItem)));
                builder.AddCustomAttributes(typeof(HierarchyNavigatorItem), "Items", new NewItemTypesAttribute(typeof(HierarchyNavigatorItem)));
    #endregion
    ...
    #region RangeSlider
				...
				builder.AddCustomAttributes(typeof(RangeSliderControl), "ItemsCollection", new ToolboxBrowsableAttribute(false));
    #endregion
    ...
    #region Wizard
                ...
                builder.AddCustomAttributes(typeof(WizardPage), new FeatureAttribute(typeof(PrimarySelectionTaskProviderBase)));
                builder.AddCustomAttributes(typeof(WizardControl), "Items", new NewItemTypesAttribute(typeof(WizardPage)));
    #endregion
  #region CardView
     builder.AddCustomAttributes(typeof(CardView), new FeatureAttribute(typeof(CardViewInitializer)));
     builder.AddCustomAttributes(typeof(CardView), new FeatureAttribute(typeof(CardViewAdornerProvider)));
     builder.AddCustomAttributes(typeof(CardView), new FeatureAttribute(typeof(PrimarySelectionTaskProviderBase)));
  #endregion
               
  #region TabNavigationControl
     builder.AddCustomAttributes(typeof(TabNavigationControl), new FeatureAttribute(typeof(TabNavigationControlInitializer)));
     builder.AddCustomAttributes(typeof(TabNavigationControl), new FeatureAttribute(typeof(TabNavigationControlAdornerProvider)));
     builder.AddCustomAttributes(typeof(TabNavigationControl), new FeatureAttribute(typeof(PrimarySelectionTaskProviderBase)));
  #endregion
