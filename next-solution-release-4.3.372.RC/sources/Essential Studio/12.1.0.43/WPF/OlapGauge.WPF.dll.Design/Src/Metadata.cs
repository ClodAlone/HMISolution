...
***************************************************************************/
namespace Syncfusion.OlapGauge.WPF.dll.Design
{
    using System;
    ...
    #region IProvideAttributeTable Members
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                builder.AddCustomAttributes(typeof(OlapCircularGauge), new ToolboxBrowsableAttribute(true));
                builder.AddCustomAttributes(typeof(OlapGauge), new ToolboxBrowsableAttribute(false));
