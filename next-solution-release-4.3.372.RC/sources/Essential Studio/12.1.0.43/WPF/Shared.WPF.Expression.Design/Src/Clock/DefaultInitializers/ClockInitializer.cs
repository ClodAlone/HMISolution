...
{
    /// <summary>
    /// Represents the ClockInitializer to add default child
    /// </summary>
    internal class ClockInitializer:DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClockInitializer"/> class.
        /// </summary>
        public ClockInitializer()
        {
        }
        /// <summary>
        ...
        public override void InitializeDefaults(ModelItem item)
        {
            ...
            {            
                ...
                item.Properties["Width"].SetValue(175d);			
                scope.Complete();
            }
        }
    }
