...
namespace Syncfusion.Shared.WPF.Expression.Design
{
    ...
    /// </summary>
    internal class ColorEditorInitializer:DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ColorEditorInitializer"/> class.
        /// </summary>
        public ColorEditorInitializer()
        {
        }
        ...
        public override void InitializeDefaults(ModelItem item)
        {
            ...
            {
                //ColorEdit colorEditor = new ColorEdit();
                //item.Properties["Items"].Collection.Add(colorEditor);                          
                item.Properties["IsScRGBColor"].SetValue(true);
