...
[assembly: AssemblyTitle("Syncfusion.OlapGauge.WPF")]
#if DEBUG
...
[assembly: XmlnsDefinition("http://schemas.syncfusion.com/wpf", "Syncfusion.Windows.Gauge.Olap")]


namespace Syncfusion
{
    public class OlapGaugeWPFAssembly
    {
        public static readonly string Name;

        public static readonly Assembly Assembly;

        public static readonly string RootNamespace = "Syncfusion.Windows.Gauge.Olap";

        static OlapGaugeWPFAssembly()
        {
            Assembly = typeof(OlapGaugeWPFAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else if (e.Name.StartsWith(OlapGaugeWPFAssembly.Name))
                return OlapGaugeWPFAssembly.Assembly;
    ...
    internal class AssemblyInfo : OlapGaugeWPFAssembly
    {
    }
}