    ...
    public class FilterToRibbonButtonConverter : IValueConverter
    {
       #region IValueConverter Members
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (value.GetType() != typeof(RibbonGalleryFilter))
            {
                throw new ArgumentException("Value of RibbonGalleryFilter type is expected.", "value");
            }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (button == null)
            {
                throw new ArgumentException("Value of RibbonButton type is expected.", "value");
            }

            RibbonGalleryFilter filter = button.Content as RibbonGalleryFilter;
