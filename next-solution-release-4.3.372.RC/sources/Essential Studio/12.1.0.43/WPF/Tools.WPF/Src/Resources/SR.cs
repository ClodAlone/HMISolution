...
namespace Syncfusion.Windows.Tools.Controls.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            if (localizedManager == null)
            {
                this.resources = Syncfusion.Windows.Tools.Controls.Resources.Syncfusion_Tools_Wpf.ResourceManager;
            }
            else
            {
            ...
            if (Application.Current != null)
            {
                try
                {
                    ...
                    if (!tryDiffBaseName)
                    {
                        ...
                        {
                            manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Tools.Controls.Resources.{0}",
                                controlAssembly.FullName.Split(new char[] { ',' })[0]), controlAssembly);
                        }
                    }
                    else
                    {
						//Fix for Localization in VB to work
                    ...
                    if (manager != null)
                    {
                        ...
                        if ((manager.GetResourceSet(currentUICulture, true, false) != null))
                        {
                            return manager;
                        }
                    }
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Windows.Tools.Controls.Resources.Syncfusion_Tools_Wpf.ResourceManager.GetString(name);
            }
            return value;
        }
