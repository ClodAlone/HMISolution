// <copyright file="PopupAreaVisibilityProvider.cs" company="Syncfusion">
...
#endif
    public class PopupAreaVisibilityProvider : IMultiValueConverter
    {
        #region IMultiValueConverter Members

        /// <summary>
        /// If the level of an item is grater than the MaxDrillDownLevel, then we don't want to show it's children anymore via the popup.
        ...
        {
            int maxLevels = (int)values[0];
            int itemLevel = (int)values[1];

            if (maxLevels < 0)
            {
                return Visibility.Visible;
            }
            else if (itemLevel < maxLevels)
            {
                return Visibility.Visible;
            }
            else
