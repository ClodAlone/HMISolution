// <copyright file="VS2008TabBorder.cs" company="Syncfusion">
...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class VS2008TabBorder : Decorator
    {
        ...
        /// </summary>
        public static readonly DependencyProperty BackgroundProperty = Panel.BackgroundProperty.AddOwner(typeof(VS2008TabBorder), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.SubPropertiesDoNotAffectRender | FrameworkPropertyMetadataOptions.AffectsRender));

        /// <summary>
        /// Dependency property for storing the BorderBrush
        /// </summary>
        public static readonly DependencyProperty BorderBrushProperty = DependencyProperty.Register("BorderBrush", typeof(Brush), typeof(VS2008TabBorder), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.SubPropertiesDoNotAffectRender | FrameworkPropertyMetadataOptions.AffectsRender));

        /// <summary>
        /// Dependency property for storing the BorderInnerBrush
        /// </summary>
        public static readonly DependencyProperty BorderInnerBrushProperty = DependencyProperty.Register("BorderInnerBrush", typeof(Brush), typeof(VS2008TabBorder), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.SubPropertiesDoNotAffectRender | FrameworkPropertyMetadataOptions.AffectsRender));

        /// <summary>
        /// Dependency property for storing the BottomBorderBrush
        /// </summary>
        public static readonly DependencyProperty BottomBorderBrushProperty = DependencyProperty.Register("BottomBorderBrush", typeof(Brush), typeof(VS2008TabBorder), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.SubPropertiesDoNotAffectRender | FrameworkPropertyMetadataOptions.AffectsRender));
        #endregion
        ...
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            TabLayoutPanel layoutPanel=null;
            bool needShrink=false, multiline=false;

            if (parent != null)
            {
                // TabControlExt parent = (TemplatedParent as TabItemExt).Parent as TabControlExt;
                layoutPanel = parent.TabLayoutPanel;
                needShrink = parent.TabLayoutPanel.NeedShrink;
                multiline = parent.TabItemLayout == TabItemLayoutType.MultiLineWithFullWidth && layoutPanel.m_NumRows == layoutPanel.VisibleItemsCount;
            }
            // To place the content inside the tab items
            ...
            if (Child != null)
            {
                // Arranging the contents in the tab items
                Child.Arrange(arrangeRect);
            }

            // To construct the look of the tab item
            path1 = new PathGeometry();
            path2 = new PathGeometry();
            if (layoutPanel != null && layoutPanel.m_ParentTabControl.TabVisualStyle == TabVisualStyle.None)
            {
                    ...
                    new PathSegment[] 
                {
                  ...
                  new LineSegment(new Point(arrangeSize.Height + 1.0, 1.5), true), 
            ...
            else
            {
                   ...
                   new PathSegment[] 
                {
                  new LineSegment(new Point(arrangeSize.Height - 3.0, 4.0), true), 
                  new LineSegment(new Point(arrangeSize.Height, 2.5), true), 
                  new LineSegment(new Point(arrangeSize.Height + 0.5, 1.5), true), 
                  new LineSegment(new Point(arrangeSize.Width - 5.0, 1.5), true), 
                  new ArcSegment(new Point(arrangeSize.Width - 1.5, 5.0), new Size(3.5, 3.5), 0.0, false, SweepDirection.Clockwise, true), 
                  new LineSegment(new Point(arrangeSize.Width - 1.5, arrangeSize.Height), true) 
                },
            ...
            if (layoutPanel != null && layoutPanel.m_ParentTabControl.TabVisualStyle == TabVisualStyle.None)
            {
                ...
                { 
                    ...
                    new LineSegment(new Point(arrangeSize.Height +0.5, 0.5), true), 
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            if (Child != null)
            {
                ...
                // (TemplatedParent as TabItemExt).Parent as TabControlExt;                
                bool needShrink = parent!=null ?parent.TabLayoutPanel.NeedShrink:false;
