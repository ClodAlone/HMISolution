...
using Syncfusion.Chart.Wpf.VisualStudio.Design.SmartTagSupportingFiles.AdornerProviders;
using Syncfusion.Windows.Design;



#if SyncfusionFramework4_0 || SyncfusionFramework4_5 || SyncfusionFramework4_5_1
[assembly: ProvideMetadata(typeof(Syncfusion.Chart.Wpf.VisualStudio.Design.Metadata))]
#endif
...
namespace Syncfusion.Chart.Wpf.VisualStudio.Design
{
    ...
    #region IProvideAttributeTable Members
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                builder.AddCustomAttributes(typeof(Syncfusion.Windows.Chart.Chart), "AnnotationLabelTemplateProperty",
                            PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));

                builder.AddCustomAttributes(typeof(Syncfusion.Windows.Chart.Chart), "ApplyPropertyPages",
                            PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));

                builder.AddCustomAttributes(typeof(Syncfusion.Windows.Chart.Chart), "AreasPanelProperty",
                            PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));




                builder.AddCustomAttributes(typeof(ChartArea), "Header", new CategoryAttribute("Header"), new TypeConverterAttribute(typeof(StringConverter)));
                builder.AddCustomAttributes(typeof(ChartAnnotationLabel), "Content", new CategoryAttribute("Content"), new TypeConverterAttribute(typeof(StringConverter)));
                builder.AddCustomAttributes(typeof(ChartAxisLabel), "Content", new CategoryAttribute("Content"), new TypeConverterAttribute(typeof(StringConverter)));

                builder.AddCustomAttributes(typeof(ChartAxis), "Header", new CategoryAttribute("HHeader"), new TypeConverterAttribute(typeof(StringConverter)));


                builder.AddCustomAttributes(typeof(Syncfusion.Windows.Chart.Chart), new FeatureAttribute(typeof(PrimarySelectionTaskProviderBase)));
                builder.AddCustomAttributes(typeof(ChartArea), new FeatureAttribute(typeof(PrimarySelectionTaskProviderBase)));
                builder.AddCustomAttributes(typeof(ChartLegend), new FeatureAttribute(typeof(PrimarySelectionTaskProviderBase)));
                ...
                PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));
                builder.AddCustomAttributes(typeof(ChartArea), "InteractiveCursors",
                PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));

                // builder.AddCustomAttributes(typeof(ChartArea), "Series",
                // PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));

                builder.AddCustomAttributes(typeof(ChartArea), "Axes",
                 PropertyValueEditor.CreateEditorAttribute(typeof(ForbiddenPropertyEditor)));
    ...
    #region Implementation
        ...
        private void ProceedToolboxHiddenElements(AttributeTableBuilder builder)
        {
            ...
            builder.AddCustomAttributes(typeof(Syncfusion.Windows.Chart.ChartBreakRange), ToolboxBrowsableAttribute.No);
            builder.AddCustomAttributes(typeof(Syncfusion.Windows.Chart.ChartWatermarkElement), ToolboxBrowsableAttribute.No);
            builder.AddCustomAttributes(typeof(FastSplinePresenter), ToolboxBrowsableAttribute.No);
