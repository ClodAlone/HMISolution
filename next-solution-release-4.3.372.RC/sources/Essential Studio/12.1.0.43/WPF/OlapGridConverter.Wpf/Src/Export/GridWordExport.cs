...
namespace Syncfusion.Windows.Grid.Olap.Converter
{
    ...
    public class GridWordExport
    {
        ...
        public void Export(string filename, ExportingGridStyleInfo styleinfo)
        {
            ...
            styleinfo = styleinfo == null ? new ExportingGridStyleInfo() : styleinfo;
            ...
            for (col = 7; col < Engine.TableColumns.Count; col += 7)
            {
                ...
                docTable.ResetCells(Engine.RowsCount, 7, format, 140);
            ...
            if ((col - 7) < Engine.TableColumns.Count)
            {
                ...
                {
                    docTable.ResetCells(Engine.RowsCount, Engine.TableColumns.Count - temp, format, 140);
                }
                else
                {
                    docTable.ResetCells(Engine.RowsCount, Engine.TableColumns.Count, format, 140);
                }
        ...
        {
            Export(fileName, styleInfo as ExportingGridStyleInfo);
        }
    }
}
