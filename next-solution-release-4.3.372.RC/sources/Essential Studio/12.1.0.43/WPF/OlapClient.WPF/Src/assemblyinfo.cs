...
[assembly: AssemblyTitle("Syncfusion.OlapClient.WPF")]
#if DEBUG
...
[assembly: XmlnsDefinition("http://schemas.syncfusion.com/wpf", "Syncfusion.Windows.Client.Olap")]

namespace Syncfusion
{
    public class OlapClientWPFAssembly
    {
        /// <summary>
        /// OLAP Client Assembly
        /// </summary>
        public static readonly Assembly Assembly;

        /// <summary>
        /// OLAP Client Assembly name
        /// </summary>
        public static readonly string Name;

        /// <summary>
        /// OLAP Client RootNamespace
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Windows.Client.Olap";

        static OlapClientWPFAssembly()
        {
            Assembly = typeof(OlapClientWPFAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else if (e.Name.StartsWith(OlapClientWPFAssembly.Name))
            {
                return OlapClientWPFAssembly.Assembly;
            }
    ...
    internal class AssemblyInfo : OlapClientWPFAssembly
    {
    }
}
