    ...
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            if (localizedManager == null)
            {
                ...
                //// ******************************* Change Namespace here ******************************
                ////
                this.resources = Syncfusion.Windows.Client.Olap.Resources.Syncfusion_OlapClient_WPF.ResourceManager;
                //Or
                  ...
                  //  System.Resources.ResourceManager manager = new System.Resources.ResourceManager(@"FieldListDemo.Syncfusion.PivotGrid.WPF", assembly);
                    ...
                    if (found || !CultureInfo.CurrentUICulture.Name.Equals("en-US"))
                    {
                     ...
                     else
                     {
                         ...
                         manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Client.Olap.Resources.{0}",
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            catch
            {
                ...
                //// ******************************* Change Namespace here ******************************
                ////
                value = Syncfusion.Windows.Client.Olap.Resources.Syncfusion_OlapClient_WPF.ResourceManager.GetString(name);
            }
            return value;
        }
