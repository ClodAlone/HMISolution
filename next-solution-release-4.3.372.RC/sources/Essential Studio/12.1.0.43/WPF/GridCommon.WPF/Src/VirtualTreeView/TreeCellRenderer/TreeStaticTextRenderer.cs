...
{
    /// <summary>
    /// A renderer for displaying formatted text inside a cell.
    /// </summary>
    /// <exclude/>
    public class TreeCellStaticTextRenderer : TreeCellRenderer
    {
        /// <summary>
        ...
        protected override void OnRender(DrawingContext dc, RenderCellArgs rca, TreeRenderStyleInfo style)
        {
            ...
            TextBoxPaint rt = new TextBoxPaint(new Typeface("Segoe UI"), 12, Brushes.Black);
            //rt.Trimming = TextTrimming.CharacterEllipsis;
            rt.WrapText = true;
