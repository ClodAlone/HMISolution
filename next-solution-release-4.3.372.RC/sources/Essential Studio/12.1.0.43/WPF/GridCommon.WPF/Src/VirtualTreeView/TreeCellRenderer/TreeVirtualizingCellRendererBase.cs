...
{
    // B = Base Class 
    using B = Syncfusion.Windows.Controls.VirtualTreeView.TreeCellRenderer;
    ...
    // S = Style
    using S = Syncfusion.Windows.Controls.VirtualTreeView.TreeRenderStyleInfo;
    ...
    public abstract class TreeVirtualizingCellRendererBase<T> : B, IDisposable
...
#if !SILVERLIGHT
            // With Silverlight we let ScrollControlChildFrame.ArrangeOverride loop
            // through arranged UIElement children and call el.Arrange.
            el.Arrange(rect);
#endif
