...
{
    /// <summary>
    /// A provider for Overlapping Cell. GridOverlappingCellInfoCollection
    /// is a default implementation of this interface. The <see cref="VirtualizingCellsControl"/>
    /// retrieves Overlapping Cell through this interface from it <see cref="VirtualizingCellsControl.OverlappingCellsProvider"/>
    /// </summary>
