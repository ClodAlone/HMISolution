...
{
   internal class SfInputInitializer:DefaultInitializer
    {
       public SfInputInitializer()
       { }
       ...
       public override void InitializeDefaults(ModelItem item)
       {
           ...
           {
               item.Properties["Height"].SetValue(250d);
               item.Properties["Width"].SetValue(180d);
               //item.Properties["Content"].SetValue("SfInput");
