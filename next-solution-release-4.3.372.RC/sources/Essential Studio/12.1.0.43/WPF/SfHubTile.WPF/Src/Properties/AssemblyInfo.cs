...
[assembly: AssemblyTitle("Syncfusion.SfHubTile.WPF")]
[assembly: AssemblyProduct("Syncfusion.SfHubTile.WPF")]
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class SfHubTileBaseAssembly
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="SfHubTileBaseAssembly"/> class.
        /// </summary>
        static SfHubTileBaseAssembly()
        {
            Assembly = typeof(SfHubTileBaseAssembly).Assembly;
        ...
        {
            if (e.Name.StartsWith(SfHubTileBaseAssembly.Name))
            {
                return SfHubTileBaseAssembly.Assembly;
            }
    ...
    /// Assembly info class
    /// </summary>
    internal class AssemblyInfo : SfHubTileBaseAssembly
    {
    }
}
...
namespace Syncfusion.Licensing
{
    ...
    /// </summary>
    public class EnvironmentTestHubTile
    {
