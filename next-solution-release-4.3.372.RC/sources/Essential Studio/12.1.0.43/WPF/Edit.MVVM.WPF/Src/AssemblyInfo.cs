...
[assembly: AssemblyTitle("Syncfusion.Edit.MVVM.WPF")]
[assembly: AssemblyProduct("Syncfusion.Edit.MVVM.WPF")]
...
[assembly: XmlnsDefinition("http://schemas.syncfusion.com/wpf", "Syncfusion.Windows.Edit.MVVM")]
...
{
    /// <summary>
    /// EditMVVMWPF assembly class.
    /// </summary>
    public class EditMVVMWPFAssembly
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Windows.Edit.MVVM";

        /// <summary>
        /// Initializes static members of the <see cref="EditMVVMWPFAssembly"/> class.
        /// </summary>
        static EditMVVMWPFAssembly()
        {
            Assembly = typeof(EditMVVMWPFAssembly).Assembly;
        ...
        {
            if (e.Name.StartsWith(EditMVVMWPFAssembly.Name))
            {
                return EditMVVMWPFAssembly.Assembly;
            }
    ...
    /// Assembly info class
    /// </summary>
    internal class AssemblyInfo : EditMVVMWPFAssembly
    {
    }
}
