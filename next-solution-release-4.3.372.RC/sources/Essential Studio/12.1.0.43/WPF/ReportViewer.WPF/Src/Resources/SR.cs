...
namespace Syncfusion.Windows.Reports.Viewer.Resources
{
	sealed class SR
	{
		// Fields
		...
		private SR()
		{
			...
			if (localizedManager == null)
			{
				this.resources = Syncfusion.ReportViewer.WPF.Resources.Syncfusion_ReportViewer_Wpf.ResourceManager;
			}
			else
			{
		...
		public static void SetResources(Assembly assembly)
		{
			...
			if (localizedManager == null)
			{
				loader.resources = Syncfusion.ReportViewer.WPF.Resources.Syncfusion_ReportViewer_Wpf.ResourceManager;
			}
			else
			{
		...
		private static System.Resources.ResourceManager GetLocalizedResourceManager(System.Reflection.Assembly controlAssembly, Assembly assembly, bool tryDiffBaseName)
		{
			try
			{
				...
				if (!tryDiffBaseName)
				{
					...
					{
                        manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Reports.Viewer.Resources.{0}", controlAssembly.FullName.Split(new char[] { ',' })[0]), controlAssembly);
					}
				}
				else
				{
		...
		public static string GetString(CultureInfo culture, string name)
		{
			...
			catch
			{
                try
                {
                    value = Syncfusion.ReportViewer.WPF.Resources.Syncfusion_ReportViewer_Wpf.ResourceManager.GetString(name);
                }
                catch
                {
                    return name;
