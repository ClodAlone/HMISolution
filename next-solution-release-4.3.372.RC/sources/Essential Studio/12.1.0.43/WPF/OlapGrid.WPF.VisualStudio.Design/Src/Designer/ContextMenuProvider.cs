...
namespace Syncfusion.OlapGrid.WPF.VisualStudio.Design
{
        ...
        : PrimarySelectionContextMenuProvider
    {
        ...
        //private MenuAction propertiesMenuItem;
        private OlapGridUIPropertiesLayoutModel olapGridUIPropertiesModel;
        private OlapGridUIPropertiesLayoutView olapGridUIPropertiesView;
        ...
        public ContextMenuProvider()
        {
            ...
            //// Creating sub-menu item.
            // propertiesMenuItem = new MenuAction(MENU_ACTION_UI_PROPERTIES);

            //// Event tagging for the sub-menu item.
            // propertiesMenuItem.Execute += new EventHandler<MenuActionEventArgs>(wizard_Execute);
        ...
        private void wizard_Execute(object sender, MenuActionEventArgs e)
        {
            ...
            {
                // connectionPropertiesModel = new ConnectionPropertiesModel();
                // connectionPropertiesView = new ConnectionPropertiesView();
                wizardWindow = new WizardWindow(selectedControl);
                wizardWindow.Show();
            }
            else if (action.DisplayName == MENU_ACTION_UI_PROPERTIES)
            {
                //this.Model = new OlapGridUIPropertiesLayoutModel(selectedControl);
                //this.View = new OlapGridUIPropertiesLayoutView();
                //this.Presenter = new DesignerPresenter(this.Model, this.View);
            }
        } 
