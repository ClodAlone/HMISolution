...
namespace Syncfusion
{
    ...
    /// </summary>
    public class GridConverterWpfAssembly
    {
        /// <summary>
        ...
        static GridConverterWpfAssembly()
        {
            Assembly = typeof(GridConverterWpfAssembly).Assembly;
...
{
    internal class AssemblyInfo : Syncfusion.GridConverterWpfAssembly
    {
    }
}