...
namespace Syncfusion.Windows.Automation.Peers
{
    ...
    public sealed class CalendarDayButtonAutomationPeer : ButtonAutomationPeer, IGridItemProvider, ISelectionItemProvider, ITableItemProvider
    {
        ...
        public CalendarDayButtonAutomationPeer(Syncfusion.Windows.Controls.Primitives.CalendarDayButton owner)
            : base(owner)
        {
        }
        ...
        private Syncfusion.Windows.Controls.Primitives.CalendarDayButton OwningCalendarDayButton
        {
            get
            {
                return this.Owner as Syncfusion.Windows.Controls.Primitives.CalendarDayButton;
            }
        }
        ...
        private bool EnsureSelection()
        {
            ...
            if (this.OwningCalendarDayButton.IsBlackedOut ||
                this.OwningCalendar.SelectionMode == Syncfusion.Windows.Controls.CalendarSelectionMode.None)
            {
                return false;
            }
