...
namespace Syncfusion.Windows.Automation.Peers
{
    ...
    public sealed class DatePickerAutomationPeer : FrameworkElementAutomationPeer, IExpandCollapseProvider, IValueProvider
    {
        ...
        public DatePickerAutomationPeer(Syncfusion.Windows.Controls.DatePicker owner)
            : base(owner)
        {
        }
        ...
        private Syncfusion.Windows.Controls.DatePicker OwningDatePicker
        {
            get
            {
                return this.Owner as Syncfusion.Windows.Controls.DatePicker;
            }
        }
