...
namespace Syncfusion.Tools.WPF.Expression.Design
{
    ...
    /// </summary>
    public class RibbonButtonInitializer : DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RibbonButtonInitializer"/> class.
        /// </summary>
        public RibbonButtonInitializer( )
        {
        }
        /// <summary>
