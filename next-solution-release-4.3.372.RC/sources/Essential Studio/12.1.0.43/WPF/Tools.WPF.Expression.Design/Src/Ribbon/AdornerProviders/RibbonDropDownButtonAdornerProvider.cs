...
namespace Syncfusion.Tools.WPF.Expression.Design
{
    ...
    /// </summary>
    public class RibbonDropDownButtonAdornerProvider : PrimarySelectionAdornerProviderBase
    {
        /// <summary>
        ...
        {
            RibbonDropDownButtonSmartTag TabSmartTag = new RibbonDropDownButtonSmartTag();
