...
namespace Syncfusion.Tools.WPF.Expression.Design
{
   /// <summary>
    ...
    /// </summary>
    internal class WizardPageInitializer : DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WizardPageInitializer"/> class.
        /// </summary>
        public WizardPageInitializer() { }
        ...
        public override void InitializeDefaults(ModelItem item)
        {
            ...
            {
                item.Properties["Title"].SetValue("Page Title");
                item.Properties["Decription"].SetValue("Page Description");
