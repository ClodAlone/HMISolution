...
namespace Syncfusion.Tools.WPF.Expression.Design
{
    ...
    /// </summary>
    internal class FontListBoxInitializer : DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FontListBoxInitializer"/> class.
        /// </summary>
        public FontListBoxInitializer()
        {
        }
