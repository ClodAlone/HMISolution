            ...
            if (Application.Current != null)
            {
                try
                {
                    ...
                    if (!tryDiffBaseName)
                    {
                        ...
                        {
                            manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Shared.Resources.{0}", controlAssembly.FullName.Split(new char[] { ',' })[0]), controlAssembly);
                        }
                    }
