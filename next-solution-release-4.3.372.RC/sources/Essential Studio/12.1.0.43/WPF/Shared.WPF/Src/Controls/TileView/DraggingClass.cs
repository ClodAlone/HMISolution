...
namespace Syncfusion.Windows.Shared
{
    ...
    public class TileViewItemBase : TileViewItemAnimationBase
    {
        ...
        internal static int CurrentZIndex
        {
            get
            {
                return TileViewItemBase.currZIndex;
            }
            set
            {
                TileViewItemBase.currZIndex = value;
            }
        }
        ...
        internal Point DragCompletedPoint
        {
            get
            {
                return dragCompletedPoint;
            }
            set
            {
                dragCompletedPoint = value;
            }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TileViewItemBase"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Identifies IsMovableProperty Dependency property
        /// </summary>
        ...
        {
            if (dragging && IsMovable && e.LeftButton == MouseButtonState.Pressed)
            {
                Point position = e.GetPosition(sender as UIElement);
