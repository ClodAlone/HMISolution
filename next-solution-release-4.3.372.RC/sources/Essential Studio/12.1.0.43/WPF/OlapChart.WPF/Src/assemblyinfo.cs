...
[assembly: AssemblyTitle("Syncfusion.OlapChart.WPF")]
#if DEBUG
...
[assembly: XmlnsDefinition("http://schemas.syncfusion.com/wpf", "Syncfusion.Windows.Chart.Olap")]

namespace Syncfusion
{
    public class OlapChartWPFAssembly
    {

        public static readonly Assembly Assembly;
        public static readonly string Name;

        public static readonly string RootNamespace = "Syncfusion.Windows.Chart.Olap";

        static OlapChartWPFAssembly()
        {
            Assembly = typeof(OlapChartWPFAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else if (e.Name.StartsWith(OlapChartWPFAssembly.Name))
                return OlapChartWPFAssembly.Assembly;
    ...
    internal class AssemblyInfo : OlapChartWPFAssembly
    {
    }
}
