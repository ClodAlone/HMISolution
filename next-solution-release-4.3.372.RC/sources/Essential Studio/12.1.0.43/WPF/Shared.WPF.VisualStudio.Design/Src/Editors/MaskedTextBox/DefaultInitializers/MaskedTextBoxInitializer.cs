...
{
    /// <summary>
    /// Represents MaskedTextBoxInitializer to add default childs
    /// </summary>
    internal class MaskedTextBoxInitializer : DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaskedTextBoxInitializer"/> class.
        /// </summary>
        public MaskedTextBoxInitializer()
        {
        }
