// <copyright file="ChartStackingSplineType.cs" company="Syncfusion">
...
#endif
    public class ChartStackingSplineType : ChartSplineType
    {
        #region Properties
        ...
        public static readonly DependencyProperty RequiresNegativeSeriesStackProperty =
              DependencyProperty.RegisterAttached("RequiresNegativeSeriesStack", typeof(bool), typeof(ChartStackingSplineType), new UIPropertyMetadata(true, new PropertyChangedCallback(OnRequiresNegativeSeriesStackChanged)));
        ...
        protected override void CalculateSegments(ChartSeries series, ChartIndexedDataPoint[] points)
        {
            ...
            if (points.Length >= 2)
            {
                for (int i = 0; i < points.Length; i++)
                {
                    ...
                    if (ChartStackingSplineType.GetRequiresNegativeSeriesStack(series.Area))
                    {
                ...
                {
                    if (series.Area.Series[i].Type == ChartTypes.StackingSpline)
                    {
                        firstStackedIndex = i;
                        break;
                    }
