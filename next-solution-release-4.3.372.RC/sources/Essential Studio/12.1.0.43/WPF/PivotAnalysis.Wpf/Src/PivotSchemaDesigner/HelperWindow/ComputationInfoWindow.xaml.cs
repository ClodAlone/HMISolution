...
#endif
    public partial class ComputationInfoWindow : ChromelessWindow
    {
        /// <summary>
        ...
        {
            var array = System.Enum.GetValues(typeof(SummaryType));
            foreach (var item in array)
            {
                this.cmbSummaryType.Items.Add(item);
            }

            array = System.Enum.GetValues(typeof(CalculationType));
            foreach (var item in array)
            {
            ...
            if (computationInfo != null)
            {
                ...
                this.ComputationInfoClone.BaseField = computationInfo.BaseField;
        ...
        void CmbCalculationType_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (this.ComputationInfoClone.CalculationType == CalculationType.PercentageOfParentTotal)
            {
                ...
                if (string.IsNullOrEmpty(ComputationInfoClone.BaseField))
                {
                    this.cmbBaseField.SelectedIndex = 0;
                }
                else
                {
                    this.cmbBaseField.SelectedItem = this.ComputationInfoClone.BaseField;
                }
            }
            else
            {
