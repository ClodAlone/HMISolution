namespace Unosquare.FFME
{
    ...
    public partial class MediaElement
    {
        ...
        internal void RaiseMediaFailedEvent(Exception ex)
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(CreateExceptionRoutedEventArgs(MediaFailedEvent, this, ex)); });
        ...
        internal void RaiseMediaOpenedEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(new RoutedEventArgs(MediaOpenedEvent, this)); });
        ...
        internal void RaiseMediaOpeningEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () =>
            {
        ...
        private void RaiseBufferingStartedEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(new RoutedEventArgs(BufferingStartedEvent, this)); });
        ...
        private void RaiseBufferingEndedEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(new RoutedEventArgs(BufferingEndedEvent, this)); });
        ...
        private void RaiseSeekingStartedEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(new RoutedEventArgs(SeekingStartedEvent, this)); });
        ...
        private void RaiseSeekingEndedEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(new RoutedEventArgs(SeekingEndedEvent, this)); });
        ...
        private void RaiseMediaEndedEvent()
        {
            ...
            this.runner.UIInvoke(DispatcherPriority.DataBind, () => { RaiseEvent(new RoutedEventArgs(MediaEndedEvent, this)); });
