...
namespace Microsoft.Data.ConnectionUI
{
	public class AdoDotNetConnectionProperties : IDataConnectionProperties, ICustomTypeDescriptor
	{
		public AdoDotNetConnectionProperties(string providerName)
		{
            ...
            if (_providerName == DataProvider.MySQLDataProvider.Name)
                factory = new MySql.Data.MySqlClient.MySqlClientFactory();
            else if (_providerName == DataProvider.SQLiteDataProvider.Name)
                factory = new System.Data.SQLite.SQLiteFactory();
            else if (_providerName == DataProvider.PostgreSQLDataProvider.Name)
