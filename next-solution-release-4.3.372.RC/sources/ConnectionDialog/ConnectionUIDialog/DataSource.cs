	...
	public class DataSource
	{
        ...
        public static DataSource MySQLDataSource
        {
            get
            {
                ...
                {
                    _mysqlDataSource = new DataSource("MySQL", Strings.DataSource_MySQL);
                    _mysqlDataSource.Providers.Add(DataProvider.MySQLDataProvider);
                    _mysqlDataSource.Providers.Add(DataProvider.OleDBDataProvider);
                    _mysqlDataSource.DefaultProvider = DataProvider.MySQLDataProvider;
                }
                return _mysqlDataSource;
            }
        }
        private static DataSource _mysqlDataSource;
        ...
        public static DataSource SQLiteDataSource
        {
            get
            {
                ...
                {
                    _sqliteDataSource = new DataSource("SQLite", Strings.DataSource_SQLite);
                    _sqliteDataSource.Providers.Add(DataProvider.SQLiteDataProvider);
                    //_sqliteDataSource.Providers.Add(DataProvider.OleDBDataProvider);
                    //_sqliteDataSource.DefaultProvider = DataProvider.SQLiteDataProvider;
                }
		...
		public static DataSource PostgreSQLDataSource
		{
			get
			{
				...
				{
					_postgreSQLDataSource = new DataSource("PostgreSQL", Strings.DataSource_PostgreSQL);
					_postgreSQLDataSource.Providers.Add(DataProvider.PostgreSQLDataProvider);
				}
				return _postgreSQLDataSource;
			}
		}
		private static DataSource _postgreSQLDataSource;
