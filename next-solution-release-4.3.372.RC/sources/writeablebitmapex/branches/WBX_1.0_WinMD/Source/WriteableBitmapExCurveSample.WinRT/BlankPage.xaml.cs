...
//   Changed on:        $Date: 2011-12-16 21:54:09 +0100 (Fr, 16 Dez 2011) $
//   Changed in:        $Revision: 83937 $
//   Project:           $URL: https://writeablebitmapex.svn.codeplex.com/svn/branches/WBX_1.0_BitmapContext/Source/WriteableBitmapEx/Properties/AssemblyInfo.cs $
//   Id:                $Id: AssemblyInfo.cs 83937 2011-12-16 20:54:09Z unknown $
//
//
...
namespace WriteableBitmapExCurveSample.WinRT
{
   ...
   public sealed partial class BlankPage : Page
   {
      ...
      private ControlPoint GetMousePoint(PointerEventArgs e)
      {
      ...
      private void Viewport_PointerPressed_1(object sender, PointerEventArgs e)
      {
         // Pick control point
      ...
      private void Viewport_PointerReleased_1(object sender, PointerEventArgs e)
      {
      ...
      private void Viewport_PointerMoved_1(object sender, PointerEventArgs e)
      {
         // Move control point
         if (PickedPoint != null)
         {
