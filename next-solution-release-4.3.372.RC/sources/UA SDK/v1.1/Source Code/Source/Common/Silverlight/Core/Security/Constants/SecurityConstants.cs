...
{    
    ...
    public static class Profiles
    {
        ...
        /// Communicates with SOAP 1.2, WS Security and UA Binary.
        /// </summary>
        public const string UaHttpBinaryTransport = "http://opcfoundation.org/UA-Profile/Transport/soaphttp-uasc-uabinary";
        ...
        public static string NormalizeUri(string profileUri)
        {
            ...
            switch (profileUri)
            {
                ...
                case Profiles.WsHttpBinaryTransport_DoesNotMatchSpec: { return Profiles.UaHttpBinaryTransport; }
