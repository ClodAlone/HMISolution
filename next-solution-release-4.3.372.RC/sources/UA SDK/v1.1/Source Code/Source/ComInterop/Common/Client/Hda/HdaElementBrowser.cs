    ...
    public class HdaElementBrower : NodeBrowser
    {
        ...
        private void NextStage()
        {
            ...
            if (m_stage == Stage.Browse)
            {
                ...
                if (m_typeDefinitionId == Opc.Ua.ObjectTypeIds.FolderType)
                {
            ...
            if (m_stage == Stage.Children)
            {
                ...
                if (m_typeDefinitionId == Opc.Ua.ObjectTypeIds.AggregateFunctionsType)
                {
                ...
                try
                {
                    ...
                    if (m_typeDefinitionId == Opc.Ua.VariableTypeIds.DataItemType)
                    {
                        FindChildrenForHdaItem(client, children, attributes);
                    }

                    if (m_typeDefinitionId == Opc.Ua.ObjectTypeIds.HistoricalDataConfigurationType)
                    {
