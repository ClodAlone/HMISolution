        ...
        public void Add(NodeId key, T value)
        {
            ...
            switch (key.IdType)
            {
                case IdType.Numeric:
                {
                    ...
                    if (!m_numericIds.ContainsKey(id))
                ...
                case IdType.String:
                {
                    ...
                    if (!dictionary.ContainsKey((string)key.Identifier))
                ...
                case IdType.Guid:
                {
                    ...
                    if (!dictionary.ContainsKey((Guid)key.Identifier))
                ...
                case IdType.Opaque:
                {
                    ...
                    var k = new NodeIdDictionary<T>.ByteKey((byte[])key.Identifier);
