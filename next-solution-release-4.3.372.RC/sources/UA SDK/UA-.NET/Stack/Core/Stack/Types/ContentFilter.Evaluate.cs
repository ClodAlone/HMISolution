...
namespace Opc.Ua
{
    ...
    public partial class ContentFilter
    {
        ...
        /// </summary>
        private int? BitwiseAnd(FilterContext context, IFilterTarget target, ContentFilterElement element)
        {
            FilterOperand[] operands = GetOperands(element, 2);
            ...
            try
            {
                var lint = Convert.ToInt32(lhs);
                var rint = Convert.ToInt32(rhs);
                return (lint & rint);
            }
            catch
            {
                // return null if the types are not convertibile on interger.
                return null;
            }
        }
        ...
        /// </summary>
        private int? BitwiseOr(FilterContext context, IFilterTarget target, ContentFilterElement element)
        {
            FilterOperand[] operands = GetOperands(element, 2);
