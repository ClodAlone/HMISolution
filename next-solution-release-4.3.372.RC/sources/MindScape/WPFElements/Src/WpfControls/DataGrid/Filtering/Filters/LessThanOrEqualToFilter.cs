...
namespace Mindscape.WpfElements.WpfDataGrid
{
  ...
  /// </summary>
  public class LessThanOrEqualToFilter : IFilter
  {
    private readonly IComparable _value;

    /// <summary>
    /// Initializes a new instance of the <see cref="LessThanOrEqualToFilter"/>.
    /// </summary>
    /// <param name="value">The comparison value.</param>
    public LessThanOrEqualToFilter(IComparable value)
    {
      _value = value;
