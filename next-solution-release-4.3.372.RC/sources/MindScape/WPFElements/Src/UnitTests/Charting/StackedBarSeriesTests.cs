...
namespace Mindscape.WpfElements.UnitTests
{
  ...
  public class StackedBarSeriesTests
  {
    ...
    [Test]
    [Ignore("Now that stacked bar charts can use data sampling, the DataPoints collection is not fully populated in a testing environment")]
    ...
    public void OneLegendItemForEachBarSeriesByDefault()
    {
      ...
      chart.XAxis = new ChartAxis();
      chart.YAxis = new ChartAxis();
      StackedBarSeries series1 = new StackedBarSeries() { Title = "First Bar Series" };
      StackedBarSeries series2 = new StackedBarSeries() { Title = "Second Bar Series" };
