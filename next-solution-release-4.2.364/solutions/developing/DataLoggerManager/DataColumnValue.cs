...
#region Methods
        public bool UpdateValue(NodeId nodeId, DataValue newValue)
        {
            ...
            if (index != -1)
            {
                ...
                return !object.Equals(prevValue, wrappedValue.Value) ||
                    (DateTime)prevSourceTimeStamp != newValue.SourceTimestamp ||
                    (DateTime)prevServerTimeStamp != newValue.ServerTimestamp ||
                    (uint)prevStatusCode != newValue.StatusCode.Code;
            }
