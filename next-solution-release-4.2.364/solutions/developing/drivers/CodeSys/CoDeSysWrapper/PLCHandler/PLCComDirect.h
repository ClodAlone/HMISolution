...
typedef DLL_DECL short (*PFSYMGETALLSYMBOLS)(DirectSymbolDesc **, unsigned long *);
...
typedef DLL_DECL HVARLIST (*PFSYMDEFINEVARLIST)(char **, unsigned long);

/*	Delete a specified VarList */
/*	Returnvalues: OK: 1, Failed: 0 */
DLL_DECL short SymDeleteVarList(HVARLIST hVarList);
typedef DLL_DECL short (*PFSYMDELETEVARLIST)(HVARLIST);
...
typedef DLL_DECL DirectVarValue* (*PFSYMGETVALUELIST)(HVARLIST);

/*	Read values in ValueList of symbols defined by VarList */
/*	Returnvalues: OK: 1, Failed: 0 */
DLL_DECL short SymReadVarList(HVARLIST hVarList);
typedef DLL_DECL short (*PFSYMREADVARLIST)(HVARLIST);
...
typedef DLL_DECL short (*PFSYMWRITEVARLIST)(HVARLIST);
...
typedef DLL_DECL int (*PFRTSSTOPALLTASKS)(void);

/*	Set all IEC tasks of the application to running. */
DLL_DECL void RtsStartAllTasks(void);
typedef DLL_DECL void (*PFRTSSTARTALLTASKS)(void);
...
typedef DLL_DECL void (*PFRTSPROGRAMRESET)(unsigned char);
...
typedef DLL_DECL unsigned long (*PFSYMGETIDENTITY)(void);

/* Enter synchronization of the symbol interface */
DLL_DECL short SymEnterAccess(void);
typedef DLL_DECL short (*PFSYMENTERACCESS)(void);

/* Enter synchronization of the symbol interface */
DLL_DECL short SymLeaveAccess(void);
typedef DLL_DECL short (*PFSYMLEAVEACCESS)(void);
...
class CPLCComDirect : public CPLCComBase
{
	public:
		...
		virtual long GetDevInfo(DeviceInfo2 **ppDeviceInfo);
