...
namespace Databoom
{
    public class DataboomDriver : CommunicationDriver
    {
        ...
        public override void GetDriverErrorInfo(int errorcode, out uint quality, out string error)
        {
            ...
            switch ((DataboomErrorCodes)errorcode)
            {
                case DataboomErrorCodes.ErrorCodeErrorPreparingPublishMessage:
                    quality = StatusCodes.BadCommunicationError;
                    error = Properties.Resources.DataboomErrorPreparingPublishMessage;
                    break;
                case DataboomErrorCodes.ErrorCodeErrorSubscription:
                    quality = StatusCodes.BadCommunicationError;
                    error = Properties.Resources.DataboomErrorSubscription;
                    break;
                case DataboomErrorCodes.ErrorCodeErrorPublish:
                    quality = StatusCodes.BadCommunicationError;
...
//                System.Diagnostics.Debug.WriteLine(String.Format("Databoom DBG - {0} Suspend calling databoom.EndPendingRequests",
//                                                   currentTime));
//#endif
//                databoom.EndPendingRequests();
//            }
...
//#if DEBUG
//                string currentTime = DateTime.Now.ToString("HH:mm:ss.fff");
//                System.Diagnostics.Debug.WriteLine(String.Format("Databoom DBG - {0} Terminate calling databoom.EndPendingRequests",
//                                                   currentTime));
//#endif
//                databoom.EndPendingRequests();
//            }
