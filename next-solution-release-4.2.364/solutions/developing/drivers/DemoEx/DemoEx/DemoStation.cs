...
namespace Demo
{
    class DemoStation : Station
    {
        ...
        public override void ManageUpdatedValueForTheStateCommandVariable(DataValue value)
        {
            base.ManageUpdatedValueForTheStateCommandVariable(value);
        ...
        private void StartStopSimulation(State state)
        {
            ...
            lock (((DemoChannel)Channel).GetlockThreadObject())
            {
