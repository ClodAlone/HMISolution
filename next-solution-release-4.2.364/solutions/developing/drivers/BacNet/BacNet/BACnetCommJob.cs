...
namespace BACnet
{
    ...
    public class BACnetCommJob : CommJob
    {
        ...
        private void init()
        {
            ...
            SubscriberID = 0;
            lastWhoHasTestTime = DateTime.MinValue;
        ...
        public UInt32 SubscriberID;
        public DateTime lastWhoHasTestTime;
        ...
        public void setError( DriverErrorCodes ErrorCode)
        {
            ...
            if (ErrorCode != DriverErrorCodes.ErrorNoError)
            {
                ...
                if (Station.LastErrorCode == DriverErrorCodes.ErrorNoError)
                {
                    ...
                    Station.AdditionalError = (TagsList.Count > 0 ? TagsList[0].DynSettings.ToString() : null);
                }
        ...
        public bool IsRelinquishForced()
        {
            ...
            if (conditionalVariableHasBeenSet == true )
            {
                ...
                bool bitValue = false;
                if (GetConditionalVariableBit(ref bitValue,BACnetConditionalVariableBits.RelinquishCommand))
                {
        ...
        public void ResetRelinquishForced()
        {
            if (conditionalVariableHasBeenSet == true)
            {
                ...
                {
                    if (bitValue)
                        SetConditionalVariableBit(false, BACnetConditionalVariableBits.RelinquishCommand);
                }
            }
        }
        public void ResetForceReadWrite()
        {
            ...
            {
                bool bitValue = false;
                if (GetConditionalVariableBit(ref bitValue, BACnetConditionalVariableBits.ForceReadWrite))
                {
                    if (bitValue)
                        SetConditionalVariableBit(false, BACnetConditionalVariableBits.ForceReadWrite);
                }
            }
        }
        ...
        public override uint OnWriteTag(NodeId tagnodeid, ref object value)
        {
            lock (lockListObject)
            {
                ...
                //System.Diagnostics.Debug.WriteLine("CommJob.OnWriteTag tag:{0}", tagnodeid.ToString());
