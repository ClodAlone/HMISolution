...
namespace Simotion
{
    ...
    public class AGLinkReadWriteElement
    {
        ...
        public SimotionCommJob Job { set; get; }
        ...
        public AGLinkReadWriteElement(int symbolicRWSIndex, SimotionCommJob job, DriverErrorCodes errorCode) {
    ...
    public enum S7DataFormats
    {
        ...
        // Char = AGL4.SystemType.S7_Char,  // Unsupported
        ...
        //LWord = AGL4.SystemType.S7_LWord, // Unsupported
        //LInt = AGL4.SystemType.S7_LInt,   // Unsupported
        //S7_DTL = AGL4.SystemType.S7_DTL,  // Unsupported
        //ULInt = AGL4.SystemType.S7_ULInt, // Unsupported
        //WString = AGL4.SystemType.S7_WString,// Unsupported
    }
    ...
    public class SimotionProtocol
    {
        ...
        public const string SYMBOLIC_FILE_EXT = ".sti";

        public enum SaveMode
        {
            SaveOverride,
            AutoGenerateAlternativeName
        }

        #region methods override

        public static bool ParseData(byte[] receivebuffer, ref SimotionCommJob job, ref List<object> items)
        {
        ...
        public static bool ConvertToS5Time(Step7WordTrans trans, byte[] jobdata, ref byte[] tempBuffer)
        {
            ...
            do
            {
                ...
                {
                    case Step7WordTrans.wtW:
                        SimotionCommJob.SwapByteBuffer(ref pDst, (int)idx/*4*/, (int)nLength);
                        Len = 1;
                        break;
                    case Step7WordTrans.wtC:
                        WordVal = pDst[idx + 1];
        ...
        public static string GetSymbolicFileImportName(string projectFile)
        {
        ...
        public static bool IsImportedSymbolicFile(string projectFile, string importedPath = null)
        {
            if (!String.IsNullOrEmpty(projectFile))
            {
        ...
        {
            return string.Format("{0}_{1}{2}", stationName, SimotionProtocol.GetDriverName(), SimotionProtocol.SYMBOLIC_FILE_EXT);
        }
