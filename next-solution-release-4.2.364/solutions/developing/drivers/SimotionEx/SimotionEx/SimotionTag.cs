...
namespace Simotion
{
    public sealed class SimotionTag : Tag
    {
        #region Constructors

        public SimotionTag(TagDefinition tag, uint byteoffset, uint bitoffset)
            : base(tag, byteoffset, bitoffset)
        {

        }

        public SimotionTag(TagDefinition tag)
            : base(tag)
        {
        ...
        {
            bool res = SimotionDynTagSettings.TryParse(dynamicSettings);
            return res;
        }

        public override DynTagSettings DynSettings
        {
            get { return (DynTagSettings)SimotionDynTagSettings; }
        }
        ...
        private readonly SimotionDynTagSettings _SimotionDynTagSettings = new SimotionDynTagSettings();
        public SimotionDynTagSettings SimotionDynTagSettings
        {
            get { return _SimotionDynTagSettings; }
        }
