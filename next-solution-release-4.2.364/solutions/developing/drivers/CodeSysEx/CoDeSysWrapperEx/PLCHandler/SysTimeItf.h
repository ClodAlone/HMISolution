 ...
 * <category>Settings</category>
 * <type>String</type>
 * <description>Setting to specify a customer specific function for SysTimeGetMs (VxWorks only).</description>
 */
#define SYSTIMEKEY_INT_VXWORKS_CUSTOMSYSTIMEGETMS				"VxWorks.CustomSysTimeGetMs"
#define SYSTIMEVALUE_INT_VXWORKS_CUSTOMSYSTIMEGETMS				""
...
typedef void (CDECL CDECL_EXT* PFSYSTIMEGETMS_IEC) (systimegetms_struct *p);
	...
	#define EXTREF_ITF_systimegetms {(RTS_VOID_FCTPTR)systimegetms, "systimegetms", RTSITF_GET_SIGNATURE(0, 0x9306CA2B), 0x03051100}
...
typedef void (CDECL CDECL_EXT* PFSYSTIMEGETNS_IEC) (systimegetns_struct *p);
	...
	#define EXTREF_ITF_systimegetns {(RTS_VOID_FCTPTR)systimegetns, "systimegetns", RTSITF_GET_SIGNATURE(0, 0x7EED4E09), 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSTIME_EXTERNAL)
	#define USE_systimegetns
	#define EXT_systimegetns
	#define GET_systimegetns(fl)  CAL_CMGETAPI( "systimegetns" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSTIMEGETUS_IEC) (systimegetus_struct *p);
	...
	#define EXTREF_ITF_systimegetus {(RTS_VOID_FCTPTR)systimegetus, "systimegetus", RTSITF_GET_SIGNATURE(0, 0x6C6308BF), 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSTIME_EXTERNAL)
	#define USE_systimegetus
	#define EXT_systimegetus
	#define GET_systimegetus(fl)  CAL_CMGETAPI( "systimegetus" ) 
