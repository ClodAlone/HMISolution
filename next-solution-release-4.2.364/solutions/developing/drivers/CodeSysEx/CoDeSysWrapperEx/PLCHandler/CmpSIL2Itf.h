 ...
 */
#define USERDB_OBJECT_SIL2				"Device.SIL2"
#define USERDB_OBJECT_SIL2_ENTERDEBUG	"Device.SIL2.Enter Debug"
...
#define RTS_SIL2_EXCEPTION_TIMERCONSISTENCY			0x26	/* Timer consistency check failed */
...
/* Define the list of PSP components, that need a safety COMM-Cycle */
#ifndef PSP_SAFETY_COMPONENTS
	...
	#define PSP_SAFETY_COMPONENTS 							\
		{"CmpScheduleTimer", CmpScheduleTimer__Entry, 1}, 	\
		{"CmpSIL2", CmpSIL2__Entry, 1}, 					\
		{"IoDrvUnsafeBridge", IoDrvUnsafeBridge__Entry, 1}
#endif

/* Safety components list termination */
#ifndef SAFETY_COMPONENTS_TERMINATION
	#define SAFETY_COMPONENTS_TERMINATION 	\
		{NULL, NULL, 0}
#endif
...
/* Define the default list of components, that need a safety COMM-Cycle */
	...
	#define RTS_SAFETY_COMPONENTS			\
		PSP_SAFETY_COMPONENTS,				\
		SAFETY_COMPONENTS_TERMINATION
#endif
...
typedef void (CDECL CDECL_EXT* PFSIL2CHECKCALLERCONTEXT_IEC) (sil2checkcallercontext_struct *p);
	...
	#define EXTREF_ITF_sil2checkcallercontext {(RTS_VOID_FCTPTR)sil2checkcallercontext, "sil2checkcallercontext", 0x829BB451, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2checkcallercontext
	#define EXT_sil2checkcallercontext
	#define GET_sil2checkcallercontext(fl)  CAL_CMGETAPI( "sil2checkcallercontext" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2COPYCODEGUID_IEC) (sil2copycodeguid_struct *p);
	...
	#define EXTREF_ITF_sil2copycodeguid {(RTS_VOID_FCTPTR)sil2copycodeguid, "sil2copycodeguid", 0x638D4565, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2copycodeguid
	#define EXT_sil2copycodeguid
	#define GET_sil2copycodeguid(fl)  CAL_CMGETAPI( "sil2copycodeguid" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2COPYDATAGUID_IEC) (sil2copydataguid_struct *p);
	...
	#define EXTREF_ITF_sil2copydataguid {(RTS_VOID_FCTPTR)sil2copydataguid, "sil2copydataguid", 0x44F9CD8A, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2copydataguid
	#define EXT_sil2copydataguid
	#define GET_sil2copydataguid(fl)  CAL_CMGETAPI( "sil2copydataguid" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMEXCEPTION_IEC) (sil2oemexception_struct *p);
	...
	#define EXTREF_ITF_sil2oemexception {(RTS_VOID_FCTPTR)sil2oemexception, "sil2oemexception", 0xA54830DE, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemexception
	#define EXT_sil2oemexception
	#define GET_sil2oemexception(fl)  CAL_CMGETAPI( "sil2oemexception" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2ADDLOG_IEC) (sil2addlog_struct *p);
	...
	#define EXTREF_ITF_sil2addlog {(RTS_VOID_FCTPTR)sil2addlog, "sil2addlog", 0x742BC625, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2addlog
	#define EXT_sil2addlog
	#define GET_sil2addlog(fl)  CAL_CMGETAPI( "sil2addlog" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMGETOPERATIONMODE_IEC) (sil2oemgetoperationmode_struct *p);
	...
	#define EXTREF_ITF_sil2oemgetoperationmode {(RTS_VOID_FCTPTR)sil2oemgetoperationmode, "sil2oemgetoperationmode", 0xB292F534, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemgetoperationmode
	#define EXT_sil2oemgetoperationmode
	#define GET_sil2oemgetoperationmode(fl)  CAL_CMGETAPI( "sil2oemgetoperationmode" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMGETCALLERCONTEXT_IEC) (sil2oemgetcallercontext_struct *p);
	...
	#define EXTREF_ITF_sil2oemgetcallercontext {(RTS_VOID_FCTPTR)sil2oemgetcallercontext, "sil2oemgetcallercontext", 0x2A37A2FD, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemgetcallercontext
	#define EXT_sil2oemgetcallercontext
	#define GET_sil2oemgetcallercontext(fl)  CAL_CMGETAPI( "sil2oemgetcallercontext" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMGETMEMORYSTATE_IEC) (sil2oemgetmemorystate_struct *p);
	...
	#define EXTREF_ITF_sil2oemgetmemorystate {(RTS_VOID_FCTPTR)sil2oemgetmemorystate, "sil2oemgetmemorystate", 0x2FE5CB14, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemgetmemorystate
	#define EXT_sil2oemgetmemorystate
	#define GET_sil2oemgetmemorystate(fl)  CAL_CMGETAPI( "sil2oemgetmemorystate" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2OEMSTACKISVALID_IEC) (sil2oemstackisvalid_struct *p);
	...
	#define EXTREF_ITF_sil2oemstackisvalid {(RTS_VOID_FCTPTR)sil2oemstackisvalid, "sil2oemstackisvalid", 0x56A27207, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2oemstackisvalid
	#define EXT_sil2oemstackisvalid
	#define GET_sil2oemstackisvalid(fl)  CAL_CMGETAPI( "sil2oemstackisvalid" ) 
...
typedef void (CDECL CDECL_EXT* PFSIL2EXECUTENONSAFETYJOB_IEC) (sil2executenonsafetyjob_struct *p);
	...
	#define EXTREF_ITF_sil2executenonsafetyjob {(RTS_VOID_FCTPTR)sil2executenonsafetyjob, "sil2executenonsafetyjob", 0x142EECAE, 0x03051100}
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_sil2executenonsafetyjob
	#define EXT_sil2executenonsafetyjob
	#define GET_sil2executenonsafetyjob(fl)  CAL_CMGETAPI( "sil2executenonsafetyjob" ) 
...
/**
 * <description>
 * <p>Function to check whether an external function is available in safe run.</p>
 * <p>This is a non-safe function and it only reads safe data, compares the function name with functions in the pre defined externel function table and returns the result.</p>
 * <p>It is used to figure out whether all required external functions from a downloaded application are available in safe run.</p>
 * </description> 
 * <param name="pExtRef" type="IN">Pointer to the external function info structure.</param>
 * <errorcode name="RTS_RESULT Result" type="ERR_OK">Requested function was found and is available in safe run.</errorcode>
 * <errorcode name="RTS_RESULT Result" type="ERR_FAILED">Requested function was not found and the external link will fail when booting in safe mode.</errorcode>
 * <errorcode name="RTS_RESULT Result" type="ERR_PARAMETER">Invalid parameter.</errorcode>
 * <result>Result of the check</result>
 */
RTS_RESULT CDECL SIL2AppCheckExternalReference(EXT_REF_INFO *pExtRef);
typedef RTS_RESULT (CDECL * PFSIL2APPCHECKEXTERNALREFERENCE) (EXT_REF_INFO *pExtRef);
#if defined(CMPSIL2_NOTIMPLEMENTED) || defined(SIL2APPCHECKEXTERNALREFERENCE_NOTIMPLEMENTED)
	#define USE_SIL2AppCheckExternalReference
	#define EXT_SIL2AppCheckExternalReference
	#define GET_SIL2AppCheckExternalReference(fl)  ERR_NOTIMPLEMENTED
	#define CAL_SIL2AppCheckExternalReference(p0)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_SIL2AppCheckExternalReference  FALSE
	#define EXP_SIL2AppCheckExternalReference  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_SIL2AppCheckExternalReference
	#define EXT_SIL2AppCheckExternalReference
	#define GET_SIL2AppCheckExternalReference(fl)  CAL_CMGETAPI( "SIL2AppCheckExternalReference" ) 
	#define CAL_SIL2AppCheckExternalReference  SIL2AppCheckExternalReference
	#define CHK_SIL2AppCheckExternalReference  TRUE
	#define EXP_SIL2AppCheckExternalReference  CAL_CMEXPAPI( "SIL2AppCheckExternalReference" ) 
#elif defined(MIXED_LINK) && !defined(CMPSIL2_EXTERNAL)
	#define USE_SIL2AppCheckExternalReference
	#define EXT_SIL2AppCheckExternalReference
	#define GET_SIL2AppCheckExternalReference(fl)  CAL_CMGETAPI( "SIL2AppCheckExternalReference" ) 
	#define CAL_SIL2AppCheckExternalReference  SIL2AppCheckExternalReference
	#define CHK_SIL2AppCheckExternalReference  TRUE
	#define EXP_SIL2AppCheckExternalReference  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"SIL2AppCheckExternalReference", (RTS_UINTPTR)SIL2AppCheckExternalReference, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpSIL2SIL2AppCheckExternalReference
	#define EXT_CmpSIL2SIL2AppCheckExternalReference
	#define GET_CmpSIL2SIL2AppCheckExternalReference  ERR_OK
	#define CAL_CmpSIL2SIL2AppCheckExternalReference pICmpSIL2->ISIL2AppCheckExternalReference
	#define CHK_CmpSIL2SIL2AppCheckExternalReference (pICmpSIL2 != NULL)
	#define EXP_CmpSIL2SIL2AppCheckExternalReference  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_SIL2AppCheckExternalReference
	#define EXT_SIL2AppCheckExternalReference
	#define GET_SIL2AppCheckExternalReference(fl)  CAL_CMGETAPI( "SIL2AppCheckExternalReference" ) 
	#define CAL_SIL2AppCheckExternalReference pICmpSIL2->ISIL2AppCheckExternalReference
	#define CHK_SIL2AppCheckExternalReference (pICmpSIL2 != NULL)
	#define EXP_SIL2AppCheckExternalReference  CAL_CMEXPAPI( "SIL2AppCheckExternalReference" ) 
#else /* DYNAMIC_LINK */
	#define USE_SIL2AppCheckExternalReference  PFSIL2APPCHECKEXTERNALREFERENCE pfSIL2AppCheckExternalReference;
	#define EXT_SIL2AppCheckExternalReference  extern PFSIL2APPCHECKEXTERNALREFERENCE pfSIL2AppCheckExternalReference;
	#define GET_SIL2AppCheckExternalReference(fl)  s_pfCMGetAPI2( "SIL2AppCheckExternalReference", (RTS_VOID_FCTPTR *)&pfSIL2AppCheckExternalReference, (fl), 0, 0)
	#define CAL_SIL2AppCheckExternalReference  pfSIL2AppCheckExternalReference
	#define CHK_SIL2AppCheckExternalReference  (pfSIL2AppCheckExternalReference != NULL)
	#define EXP_SIL2AppCheckExternalReference  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"SIL2AppCheckExternalReference", (RTS_UINTPTR)SIL2AppCheckExternalReference, 0, 0) 
#endif
...
typedef struct
{
	...
	PFSIL2APPBOOT ISIL2AppBoot;
 	...
 	PFSIL2APPCHECKEXTERNALREFERENCE ISIL2AppCheckExternalReference;
 } ICmpSIL2_C;
...
class ICmpSIL2 : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL ISIL2AppCheckExternalReference(EXT_REF_INFO *pExtRef) =0;
};
	#ifndef ITF_CmpSIL2
