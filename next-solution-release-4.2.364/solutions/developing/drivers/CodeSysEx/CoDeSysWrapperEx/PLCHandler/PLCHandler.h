...
class PLCH_DLL_DECL CPLCHandler
{
	public:
		...
		// Update the firmware of the PLC with the given package. (only for V3. Not released yet)
		//virtual long InstallFirmwareUpdate(/*[In]*/ char *pszFirmwarePackage);
		//virtual long GetFirmwareUpdateResult(/*[In]*/ char *pszFirmwarePackage, /*[Out]*/ char **ppSummary, /*[Out]*/ char **ppErrors, /*[Out]*/ char **ppWarnings, /*[Out]*/ char **ppUserActions);
		//virtual long GetFirmwareUpdateResultRelease(/*[In]*/ char* pSummary, /*[In]*/ char* pErrors, /*[In]*/ char* pWarnings, /*[In]*/ char* pUserActions);
	...
	private:
		...
		virtual long ExitOldUpdateThreads(int bWaitForEndedThreads);
