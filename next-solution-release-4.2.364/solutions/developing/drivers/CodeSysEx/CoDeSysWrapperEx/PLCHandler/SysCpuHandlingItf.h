 ...
 */
#define SYSCPU_STACK_MARKER_64Bit		0xCDE1F2CDCDE1F2CD
#define SYSCPU_STACK_MARKER_32Bit		0xCDE1F2CD
#ifdef TRG_64BIT
	#define SYSCPU_STACK_MARKER		SYSCPU_STACK_MARKER_64Bit
#else
	#define SYSCPU_STACK_MARKER		SYSCPU_STACK_MARKER_32Bit
#endif
 ...
 * </description>
 */
#define SYSCPU_STACK_ALIGNMENT_X86		16
#define SYSCPU_STACK_ALIGNMENT_X64		16
#define SYSCPU_STACK_ALIGNMENT_ARM		4
#define SYSCPU_STACK_ALIGNMENT_ARM64	4
#define SYSCPU_STACK_ALIGNMENT_CORTEX	4
#define SYSCPU_STACK_ALIGNMENT_PPC		4
#define SYSCPU_STACK_ALIGNMENT_MIPS		4
#define SYSCPU_STACK_ALIGNMENT_SH		4

#ifndef SYSCPU_STACK_ALIGNMENT
	#if defined(TRG_X86)
		#if defined(TRG_64BIT)
			#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_X64
		#else
			#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_X86
		#endif
	#elif defined(TRG_ARM)
		#if defined(TRG_64BIT)
			#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_ARM64
		#else
			#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_ARM
		#endif
	#elif defined(TRG_CORTEX)
		#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_CORTEX
	#elif defined(TRG_PPC)
		#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_PPC
	#elif defined(TRG_MIPS)
		#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_MIPS
	#elif defined(TRG_SH)
		#define SYSCPU_STACK_ALIGNMENT SYSCPU_STACK_ALIGNMENT_SH
	#else
 ...
 * <category>Platform defines - IEC code-generator specific!</category>
 * <description>
 *	This is the offset between the stack marker, which the CODESYS compiler places on the stack
 *  before an external call, and the instruction pointer before the call to the C code.
 * </description>
 */
#define SYSCPU_STACK_MARKER_IP_OFFSET_X86		-5
#define SYSCPU_STACK_MARKER_IP_OFFSET_X64		-5
#define SYSCPU_STACK_MARKER_IP_OFFSET_ARM32		-1
#define SYSCPU_STACK_MARKER_IP_OFFSET_ARM64		-1
#define SYSCPU_STACK_MARKER_IP_OFFSET_CORTEX	-1
#define SYSCPU_STACK_MARKER_IP_OFFSET_PPC		-9
#define SYSCPU_STACK_MARKER_IP_OFFSET_MIPS		-5
#define SYSCPU_STACK_MARKER_IP_OFFSET_SH		-3
#define SYSCPU_STACK_MARKER_IP_OFFSET_LOONGSON64 -1

#ifndef SYSCPU_STACK_MARKER_IP_OFFSET
	#if defined(TRG_X86)
		#if defined(TRG_64BIT)
			#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_X64
		#else
			#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_X86
		#endif
	#elif defined(TRG_ARM)
		#if defined(TRG_64BIT)
			#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_ARM64
		#else
			#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_ARM32
		#endif
	#elif defined(TRG_CORTEX)
		#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_CORTEX
	#elif defined(TRG_PPC)
		#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_PPC
	#elif defined(TRG_MIPS)
		#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_MIPS
	#elif defined(TRG_SH)
		#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_SH
	#elif defined (TRG_LOONGSON64)		
		#define SYSCPU_STACK_MARKER_IP_OFFSET	SYSCPU_STACK_MARKER_IP_OFFSET_LOONGSON64
	#else
		/* TODO: throw error in this case */
		#define SYSCPU_STACK_MARKER_IP_OFFSET	0
	#endif
#endif
 ...
 * <description>
 *	Offset from stackframe marker to base pointer
 * </description>
 */
#define SYSCPU_STACK_MARKER_BP_OFFSET_DEFAULT	sizeof(RTS_UINTPTR)
#define SYSCPU_STACK_MARKER_BP_OFFSET_DSP		-sizeof(RTS_UINTPTR)

#ifndef SYSCPU_STACK_MARKER_BP_OFFSET
	#if defined(TRG_DSP)
		#define SYSCPU_STACK_MARKER_BP_OFFSET	SYSCPU_STACK_MARKER_BP_OFFSET_DSP
	#else
		#define SYSCPU_STACK_MARKER_BP_OFFSET	SYSCPU_STACK_MARKER_BP_OFFSET_DEFAULT
	#endif
#endif
...
/**
 * <category>Platform specific - Maximum offset to locate return address on stack!</category>
 * <description>
 *  Is used for locating the return address of an external library
 *  call in SysCpuGetCallstackEntry3().
 * </description>
 */
#ifdef SYSTARGET_OS_VXWORKS
    #define SYSCPU_MAX_SEARCH_RETURN_OFFSET     20
#else
    #define SYSCPU_MAX_SEARCH_RETURN_OFFSET     10
#endif
 ...
 */
/* x86: 0x90 */
#define SYSCPU_NOP_OPCODE_X86 {0x90}
#define SYSCPU_NOP_OPCODE_SIZE_X86 1
/* ARM32: 0x60000000 */
#define SYSCPU_NOP_OPCODE_ARM32 {0x00,0x00,0x00,0x60}
#define SYSCPU_NOP_OPCODE_SIZE_ARM32 4
/* ARM64: 0xD503201F */
#define SYSCPU_NOP_OPCODE_ARM64 {0x1F,0x20,0x03,0xD5}
#define SYSCPU_NOP_OPCODE_SIZE_ARM64 4
/* CortexM3:  0xBF00 */
#define SYSCPU_NOP_OPCODE_CORTEX {0x00,0xBF}
#define SYSCPU_NOP_OPCODE_SIZE_CORTEX 2
/* PPC: 0x60000000 */
#define SYSCPU_NOP_OPCODE_PPC {0x60,0x00,0x00,0x00}
#define SYSCPU_NOP_OPCODE_SIZE_PPC 4
/* SH: 0x0009 */
#define SYSCPU_NOP_OPCODE_SH {0x09,0x00}
#define SYSCPU_NOP_OPCODE_SIZE_SH 2
/* LOONGSON64: 0x03400000 */
#define SYSCPU_NOP_OPCODE_LOONGSON64 {0x00,0x00,0x40,0x03}
#define SYSCPU_NOP_OPCODE_SIZE_LOONGSON64 4

#ifndef SYSCPU_NOP_OPCODE
	#if defined(TRG_X86)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_X86
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_X86
	#elif defined(TRG_ARM) && defined (TRG_X64)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_ARM64
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_ARM64
	#elif defined(TRG_ARM)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_ARM32
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_ARM32
	#elif defined(TRG_CORTEX)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_CORTEX
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_CORTEX
	#elif defined(TRG_PPC)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_PPC
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_PPC
	#elif defined(TRG_SH)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_SH
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_SH
	#elif defined(TRG_LOONGSON64)
		#define SYSCPU_NOP_OPCODE SYSCPU_NOP_OPCODE_LOONGSON64
		#define SYSCPU_NOP_OPCODE_SIZE SYSCPU_NOP_OPCODE_SIZE_LOONGSON64	
	#else
		/* TODO: Throw error when opcode is not known */
...
typedef void (CDECL CDECL_EXT* PFSYSCPUATOMICADD_IEC) (syscpuatomicadd_struct *p);
	...
	#define EXTREF_ITF_syscpuatomicadd {(RTS_VOID_FCTPTR)syscpuatomicadd, "syscpuatomicadd", 0x414E4706, 0x03051100}
...
typedef void (CDECL CDECL_EXT* PFSYSCPUATOMICADD64_IEC) (syscpuatomicadd64_struct *p);
	...
	#define EXTREF_ITF_syscpuatomicadd64 {(RTS_VOID_FCTPTR)syscpuatomicadd64, "syscpuatomicadd64", 0xA535E8A0, 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpuatomicadd64
	#define EXT_syscpuatomicadd64
	#define GET_syscpuatomicadd64(fl)  CAL_CMGETAPI( "syscpuatomicadd64" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUATOMICCOMPAREANDSWAP_IEC) (syscpuatomiccompareandswap_struct *p);
	...
	#define EXTREF_ITF_syscpuatomiccompareandswap {(RTS_VOID_FCTPTR)syscpuatomiccompareandswap, "syscpuatomiccompareandswap", 0xCBB4ED00, 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpuatomiccompareandswap
	#define EXT_syscpuatomiccompareandswap
	#define GET_syscpuatomiccompareandswap(fl)  CAL_CMGETAPI( "syscpuatomiccompareandswap" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUCALLIECFUNCWITHPARAMS_IEC) (syscpucalliecfuncwithparams_struct *p);
	...
	#define EXTREF_ITF_syscpucalliecfuncwithparams {(RTS_VOID_FCTPTR)syscpucalliecfuncwithparams, "syscpucalliecfuncwithparams", RTSITF_GET_SIGNATURE(0, 0x837FB349), 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpucalliecfuncwithparams
	#define EXT_syscpucalliecfuncwithparams
	#define GET_syscpucalliecfuncwithparams(fl)  CAL_CMGETAPI( "syscpucalliecfuncwithparams" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUTESTANDRESET_IEC) (syscputestandreset_struct *p);
	...
	#define EXTREF_ITF_syscputestandreset {(RTS_VOID_FCTPTR)syscputestandreset, "syscputestandreset", RTSITF_GET_SIGNATURE(0, 0xCD8E165F), 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscputestandreset
	#define EXT_syscputestandreset
	#define GET_syscputestandreset(fl)  CAL_CMGETAPI( "syscputestandreset" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUTESTANDSET_IEC) (syscputestandset_struct *p);
	...
	#define EXTREF_ITF_syscputestandset {(RTS_VOID_FCTPTR)syscputestandset, "syscputestandset", RTSITF_GET_SIGNATURE(0, 0xC50F8C00), 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscputestandset
	#define EXT_syscputestandset
	#define GET_syscputestandset(fl)  CAL_CMGETAPI( "syscputestandset" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUTESTANDSETBIT_IEC) (syscputestandsetbit_struct *p);
	...
	#define EXTREF_ITF_syscputestandsetbit {(RTS_VOID_FCTPTR)syscputestandsetbit, "syscputestandsetbit", 0x6A76133F, 0x03051100}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscputestandsetbit
	#define EXT_syscputestandsetbit
	#define GET_syscputestandsetbit(fl)  CAL_CMGETAPI( "syscputestandsetbit" ) 
...
typedef void (CDECL CDECL_EXT* PFSYSCPUDEBUGHANDLER_IEC) (void);
	...
	#define EXTREF_ITF_syscpudebughandler {(RTS_VOID_FCTPTR)syscpudebughandler, "syscpudebughandler", 0, 0}
#elif defined(MIXED_LINK) && !defined(SYSCPUHANDLING_EXTERNAL)
	#define USE_syscpudebughandler
	#define EXT_syscpudebughandler
	#define GET_syscpudebughandler(fl)  CAL_CMGETAPI( "syscpudebughandler" ) 
