...
/**
 * <category>Global constants</category>
 * <description>Content alignment</description>
 * <element name="align_00">Don't care. RESTRICTION: May only be used for calls of the functions BTagReaderGetContent2() and BTagReaderCheckSizeAlignment().</element>
 * <element name="align_20">Divisible by 2 without remainder. RESTRICTION: May only be used for calls of the functions BTagReaderGetContent2() and BTagReaderCheckSizeAlignment().</element>
 * <element name="align_40">Divisible by 4 without remainder.</element>
 * <element name="align_42">Divisible by 4 with remainder 2.</element>
 */
static const BTAG_ALIGNMENT align_00 = { 0, 0 };
static const BTAG_ALIGNMENT align_20 = { 2, 0 };
static const BTAG_ALIGNMENT align_40 = { 4, 0 };
static const BTAG_ALIGNMENT align_42 = { 4, 2 };
 ...
 * </param>
 */
RTS_RESULT CDECL BTagReaderGetTagId(const BINTAGREADER *pReader, RTS_UI32 *pulTagId);
typedef RTS_RESULT (CDECL * PFBTAGREADERGETTAGID) (const BINTAGREADER *pReader, RTS_UI32 *pulTagId);
 ...
 * </param>
 */
RTS_RESULT CDECL BTagReaderGetTagLen(const BINTAGREADER *pReader, RTS_UI32 *pulTagLen);
typedef RTS_RESULT (CDECL * PFBTAGREADERGETTAGLEN) (const BINTAGREADER *pReader, RTS_UI32 *pulTagLen);
 ...
 * </param>
 */
RTS_RESULT CDECL BTagReaderIsDataTag(const BINTAGREADER *pReader, RTS_I32 *pbIsDataTag);
typedef RTS_RESULT (CDECL * PFBTAGREADERISDATATAG) (const BINTAGREADER *pReader, RTS_I32 *pbIsDataTag);
...
/**
 * <description>Get a pointer on the content of the current tag.</description>
 * <param name="pReader" type="INOUT">Pointer to a BINTAGREADER.</param>
 * <param name="ppBuffer" type="OUT">Points to a byte pointer to store the address of the content of the current tag.</param>
 * <param name="pSize" type="OUT">Points to an RTS_UI32 to store the size of the content.</param>
 * <param name="contentAlignment" type="IN">How the content is expected to be aligned within this tag (see BTAG_ALIGNMENT).</param>
 * <param name="requiredMinSize" type="IN">The minimum expected size of the content of this tag.</param>
 * <result>error code</result>
 * <errorcode name="RTS_RESULT" type="ERR_OK">Completed successfully.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_NODATATAG">The current tag of the *pReader is not a data tag.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_FAILED">if ((pReader->iType == BINTAGTYPE_FILE) && (tag->ulSize > pReader->ulBufferSize))</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_ALIGNMENT">The content is not aligned as required.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_ALIGNMENT">The 1st byte after the content is not 4-byte aligned.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_TAGDATASIZE">The size of the content is smaller than the required minimum size.</errorcode>
 */
RTS_RESULT CDECL BTagReaderGetContent2(BINTAGREADER* pReader, RTS_UI8** ppBuffer, RTS_UI32* pSize, BTAG_ALIGNMENT contentAlignment, RTS_UI32 requiredMinSize);
typedef RTS_RESULT (CDECL * PFBTAGREADERGETCONTENT2) (BINTAGREADER* pReader, RTS_UI8** ppBuffer, RTS_UI32* pSize, BTAG_ALIGNMENT contentAlignment, RTS_UI32 requiredMinSize);
#if defined(CMPBINTAGUTIL_NOTIMPLEMENTED) || defined(BTAGREADERGETCONTENT2_NOTIMPLEMENTED)
	#define USE_BTagReaderGetContent2
	#define EXT_BTagReaderGetContent2
	#define GET_BTagReaderGetContent2(fl)  ERR_NOTIMPLEMENTED
	#define CAL_BTagReaderGetContent2(p0,p1,p2,p3,p4)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_BTagReaderGetContent2  FALSE
	#define EXP_BTagReaderGetContent2  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_BTagReaderGetContent2
	#define EXT_BTagReaderGetContent2
	#define GET_BTagReaderGetContent2(fl)  CAL_CMGETAPI( "BTagReaderGetContent2" ) 
	#define CAL_BTagReaderGetContent2  BTagReaderGetContent2
	#define CHK_BTagReaderGetContent2  TRUE
	#define EXP_BTagReaderGetContent2  CAL_CMEXPAPI( "BTagReaderGetContent2" ) 
#elif defined(MIXED_LINK) && !defined(CMPBINTAGUTIL_EXTERNAL)
	#define USE_BTagReaderGetContent2
	#define EXT_BTagReaderGetContent2
	#define GET_BTagReaderGetContent2(fl)  CAL_CMGETAPI( "BTagReaderGetContent2" ) 
	#define CAL_BTagReaderGetContent2  BTagReaderGetContent2
	#define CHK_BTagReaderGetContent2  TRUE
	#define EXP_BTagReaderGetContent2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"BTagReaderGetContent2", (RTS_UINTPTR)BTagReaderGetContent2, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpBinTagUtilBTagReaderGetContent2
	#define EXT_CmpBinTagUtilBTagReaderGetContent2
	#define GET_CmpBinTagUtilBTagReaderGetContent2  ERR_OK
	#define CAL_CmpBinTagUtilBTagReaderGetContent2 pICmpBinTagUtil->IBTagReaderGetContent2
	#define CHK_CmpBinTagUtilBTagReaderGetContent2 (pICmpBinTagUtil != NULL)
	#define EXP_CmpBinTagUtilBTagReaderGetContent2  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_BTagReaderGetContent2
	#define EXT_BTagReaderGetContent2
	#define GET_BTagReaderGetContent2(fl)  CAL_CMGETAPI( "BTagReaderGetContent2" ) 
	#define CAL_BTagReaderGetContent2 pICmpBinTagUtil->IBTagReaderGetContent2
	#define CHK_BTagReaderGetContent2 (pICmpBinTagUtil != NULL)
	#define EXP_BTagReaderGetContent2  CAL_CMEXPAPI( "BTagReaderGetContent2" ) 
#else /* DYNAMIC_LINK */
	#define USE_BTagReaderGetContent2  PFBTAGREADERGETCONTENT2 pfBTagReaderGetContent2;
	#define EXT_BTagReaderGetContent2  extern PFBTAGREADERGETCONTENT2 pfBTagReaderGetContent2;
	#define GET_BTagReaderGetContent2(fl)  s_pfCMGetAPI2( "BTagReaderGetContent2", (RTS_VOID_FCTPTR *)&pfBTagReaderGetContent2, (fl), 0, 0)
	#define CAL_BTagReaderGetContent2  pfBTagReaderGetContent2
	#define CHK_BTagReaderGetContent2  (pfBTagReaderGetContent2 != NULL)
	#define EXP_BTagReaderGetContent2  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"BTagReaderGetContent2", (RTS_UINTPTR)BTagReaderGetContent2, 0, 0) 
#endif
...
/**
 * <description>Check alignment and size of the content.</description>
 * <param name="pContent" type="IN">Byte pointer to the content of the current tag.</param>
 * <param name="size" type="IN">Size of the content.</param>
 * <param name="contentAlignment" type="IN">How the content is expected to be aligned within this tag (see BTAG_ALIGNMENT).</param>
 * <param name="requiredMinSize" type="IN">The minimum expected size of the content of this tag.</param>
 * <result>error code</result>
 * <errorcode name="RTS_RESULT" type="ERR_OK">All alignment and size checks passed.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_ALIGNMENT">The content is not aligned as required.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_ALIGNMENT">The 1st byte after the content is not 4-byte aligned.</errorcode>
 * <errorcode name="RTS_RESULT" type="ERR_BTAG_TAGDATASIZE">The size of the content is smaller than the required minimum size.</errorcode>
 */
RTS_RESULT CDECL BTagReaderCheckSizeAlignment(const void* pContent, RTS_UI32 size, BTAG_ALIGNMENT contentAlignment, RTS_UI32 requiredMinSize);
typedef RTS_RESULT (CDECL * PFBTAGREADERCHECKSIZEALIGNMENT) (const void* pContent, RTS_UI32 size, BTAG_ALIGNMENT contentAlignment, RTS_UI32 requiredMinSize);
#if defined(CMPBINTAGUTIL_NOTIMPLEMENTED) || defined(BTAGREADERCHECKSIZEALIGNMENT_NOTIMPLEMENTED)
	#define USE_BTagReaderCheckSizeAlignment
	#define EXT_BTagReaderCheckSizeAlignment
	#define GET_BTagReaderCheckSizeAlignment(fl)  ERR_NOTIMPLEMENTED
	#define CAL_BTagReaderCheckSizeAlignment(p0,p1,p2,p3)  (RTS_RESULT)ERR_NOTIMPLEMENTED
	#define CHK_BTagReaderCheckSizeAlignment  FALSE
	#define EXP_BTagReaderCheckSizeAlignment  ERR_OK
#elif defined(STATIC_LINK)
	#define USE_BTagReaderCheckSizeAlignment
	#define EXT_BTagReaderCheckSizeAlignment
	#define GET_BTagReaderCheckSizeAlignment(fl)  CAL_CMGETAPI( "BTagReaderCheckSizeAlignment" ) 
	#define CAL_BTagReaderCheckSizeAlignment  BTagReaderCheckSizeAlignment
	#define CHK_BTagReaderCheckSizeAlignment  TRUE
	#define EXP_BTagReaderCheckSizeAlignment  CAL_CMEXPAPI( "BTagReaderCheckSizeAlignment" ) 
#elif defined(MIXED_LINK) && !defined(CMPBINTAGUTIL_EXTERNAL)
	#define USE_BTagReaderCheckSizeAlignment
	#define EXT_BTagReaderCheckSizeAlignment
	#define GET_BTagReaderCheckSizeAlignment(fl)  CAL_CMGETAPI( "BTagReaderCheckSizeAlignment" ) 
	#define CAL_BTagReaderCheckSizeAlignment  BTagReaderCheckSizeAlignment
	#define CHK_BTagReaderCheckSizeAlignment  TRUE
	#define EXP_BTagReaderCheckSizeAlignment  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"BTagReaderCheckSizeAlignment", (RTS_UINTPTR)BTagReaderCheckSizeAlignment, 0, 0) 
#elif defined(CPLUSPLUS_ONLY)
	#define USE_CmpBinTagUtilBTagReaderCheckSizeAlignment
	#define EXT_CmpBinTagUtilBTagReaderCheckSizeAlignment
	#define GET_CmpBinTagUtilBTagReaderCheckSizeAlignment  ERR_OK
	#define CAL_CmpBinTagUtilBTagReaderCheckSizeAlignment pICmpBinTagUtil->IBTagReaderCheckSizeAlignment
	#define CHK_CmpBinTagUtilBTagReaderCheckSizeAlignment (pICmpBinTagUtil != NULL)
	#define EXP_CmpBinTagUtilBTagReaderCheckSizeAlignment  ERR_OK
#elif defined(CPLUSPLUS)
	#define USE_BTagReaderCheckSizeAlignment
	#define EXT_BTagReaderCheckSizeAlignment
	#define GET_BTagReaderCheckSizeAlignment(fl)  CAL_CMGETAPI( "BTagReaderCheckSizeAlignment" ) 
	#define CAL_BTagReaderCheckSizeAlignment pICmpBinTagUtil->IBTagReaderCheckSizeAlignment
	#define CHK_BTagReaderCheckSizeAlignment (pICmpBinTagUtil != NULL)
	#define EXP_BTagReaderCheckSizeAlignment  CAL_CMEXPAPI( "BTagReaderCheckSizeAlignment" ) 
#else /* DYNAMIC_LINK */
	#define USE_BTagReaderCheckSizeAlignment  PFBTAGREADERCHECKSIZEALIGNMENT pfBTagReaderCheckSizeAlignment;
	#define EXT_BTagReaderCheckSizeAlignment  extern PFBTAGREADERCHECKSIZEALIGNMENT pfBTagReaderCheckSizeAlignment;
	#define GET_BTagReaderCheckSizeAlignment(fl)  s_pfCMGetAPI2( "BTagReaderCheckSizeAlignment", (RTS_VOID_FCTPTR *)&pfBTagReaderCheckSizeAlignment, (fl), 0, 0)
	#define CAL_BTagReaderCheckSizeAlignment  pfBTagReaderCheckSizeAlignment
	#define CHK_BTagReaderCheckSizeAlignment  (pfBTagReaderCheckSizeAlignment != NULL)
	#define EXP_BTagReaderCheckSizeAlignment  s_pfCMRegisterAPI( (const CMP_EXT_FUNCTION_REF*)"BTagReaderCheckSizeAlignment", (RTS_UINTPTR)BTagReaderCheckSizeAlignment, 0, 0) 
#endif
...
typedef struct
{
	...
	PFBTAGSWAPHEADER IBTagSwapHeader;
 	...
 	PFBTAGREADERGETCONTENT2 IBTagReaderGetContent2;
 	PFBTAGREADERCHECKSIZEALIGNMENT IBTagReaderCheckSizeAlignment;
...
class ICmpBinTagUtil : public IBase
{
	public:
		...
		virtual RTS_RESULT CDECL IBTagReaderGetTagId(const BINTAGREADER *pReader, RTS_UI32 *pulTagId) =0;
		virtual RTS_RESULT CDECL IBTagReaderGetTagLen(const BINTAGREADER *pReader, RTS_UI32 *pulTagLen) =0;
		virtual RTS_RESULT CDECL IBTagReaderIsDataTag(const BINTAGREADER *pReader, RTS_I32 *pbIsDataTag) =0;
		...
		virtual RTS_RESULT CDECL IBTagReaderGetContent2(BINTAGREADER* pReader, RTS_UI8** ppBuffer, RTS_UI32* pSize, BTAG_ALIGNMENT contentAlignment, RTS_UI32 requiredMinSize) =0;
		virtual RTS_RESULT CDECL IBTagReaderCheckSizeAlignment(const void* pContent, RTS_UI32 size, BTAG_ALIGNMENT contentAlignment, RTS_UI32 requiredMinSize) =0;
