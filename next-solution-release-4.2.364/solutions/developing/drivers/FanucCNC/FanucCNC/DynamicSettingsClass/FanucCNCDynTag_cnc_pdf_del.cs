...
namespace FanucCNC
{
	public class FanucCNCDynTag_cnc_pdf_del : FanucCNCDynTag_BaseFunction
	{
		const String CNCSourcePathParameter = "CNCSOURCEPATH";

		public FanucCNCDynTag_cnc_pdf_del(FanucCNCDynTagSettings main, string settings) : base(main, settings)
		{
