...
namespace FanucCNC.Focas_Library
{
    ...
    public class ODBAXISNAME
    {
        ...
        /* cnc_srcsrdidinfo:ReadDAreaD ID information of SERCOS I/F */
        ...
        /* cnc_srcsrdlayout:ReadDAreaD drive assign of SERCOS I/F */
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 4)]
    ...
    public static extern short cnc_rdprogdir2( ushort FlibHndl,
        ...
        /* ReadDAreaD ID information of SERCOS I/F */
        ...
        /* ReadDAreaD operation data from data buffer for SERCOS I/F */
        ...
        /* ReadDAreaD drive assign of SERCOS I/F */
        ...
        /* ReadDAreaD communication phase of drive of SERCOS I/F */
        ...
        /* ReadDAreaD graphic command data */
        ...
        /* ReadDAreaD data from remote diagnostics I/F */
        ...
        [DllImport("FWLIB32.dll", EntryPoint = "pmc_rdpmcrng")]
        public static extern short pmc_rdpmcrng_AF(ushort FlibHndl,
            short a, short b, ushort c, ushort d, ushort e, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPMC0_AF f);
        [DllImport("FWLIB32.dll", EntryPoint = "pmc_rdpmcrng")]
        public static extern short pmc_rdpmcrng(ushort FlibHndl,
        ...
        [DllImport("FWLIB32.dll", EntryPoint = "pmc_rdpmcrng")]
        public static extern short pmc_rdpmcrng_AF(ushort FlibHndl,
            short a, short b, ushort c, ushort d, ushort e, [Out, MarshalAs(UnmanagedType.LPStruct)] IODBPMC2_AF f);
        ...
        /* read alarm message(2) */
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 4)]
        public struct ODBALMMSG2_data_custom
        {
            public int alm_no;
            public short type;
            public short axis;
        ...
        [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdalmmsg2")]
        public static extern short cnc_rdalmmsg2_custom(ushort FlibHndl, short a, ref short b, [Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 17)] ODBALMMSG2_data_custom[] c);

        /* read operator message(2) */
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi, Pack = 4)]
        public struct OPMSG3_data_custom  // <- This should be a struct.
        {
            public short datano;
            public short type;
        ...
        [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdopmsg3")]
        public static extern short cnc_rdopmsg3_custom(ushort FlibHndl, short a, ref short b, [Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 17)] OPMSG3_data_custom[] c);
        ...
        /* read servo load meter */
        [DllImport("FWLIB32.dll", EntryPoint = "cnc_rdsvmeter")]
        public static extern short cnc_rdsvmeter_custom(ushort FlibHndl, ref short a, [Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 32)] LOADELM_custom[] c);
