...
namespace EIB
{
    public sealed class EIBDynTagSettings : DynTagSettings
    {
            ...
            : base()
        {
            ...
            DataFormat = (int)EIBProtocol.EISDATAFORMAT.EISDFBit;
            PollingTime = 0;
        }
        #endregion
        ...
        public override void Parse(String dynamicSettings)
        {
            ...
            DataFormat = (int)(EIBProtocol.EISDATAFORMAT)(helper.GetPartByName(DataFormatParameter, (byte)EIBProtocol.EISDATAFORMAT.EISDFBit));
        }
        ...
        private EIBProtocol.EISDATAFORMAT _NewDataFormat = EIBProtocol.EISDATAFORMAT.EISDFDWord;
        [Category("Device Data")]
        [Description("New Data Format")]
        public EIBProtocol.EISDATAFORMAT NewDataFormat
        {
            get
            {
