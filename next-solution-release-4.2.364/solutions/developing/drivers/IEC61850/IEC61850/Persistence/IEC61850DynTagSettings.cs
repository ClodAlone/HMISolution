                    ...
                    switch (_MMSDataType) {
                        case MMSDataTypes.Structure:
                            if (TagLinkType != (int)LinkType.Input)
                                return string.Format(Properties.Resources.IEC61850StructureSupportOnlyInputLinkType, DriverCodeBase.Properties.Resources.LinkType_Input);
                            break;                        
                    }
                    break;
                    ...
                    switch (_FunctionalConstraint)
                    {
                        ...
                        case FunctionalConstraints.SG:
                            if ((LinkType)TagLinkType != LinkType.Input)
                                return string.Format(Properties.Resources.IEC61850FCInconsistentWithLinkType, DriverCodeBase.Properties.Resources.LinkType_Input);
                            break;
