        ...
        private void CheckJobValid()
        {
            ...
            switch (_FunctionalConstraint)
            {
                ...
                case FunctionalConstraints.SG:
                    ...
                    {
                        IsValid = false;
                        InvalidReason = string.Format(Properties.Resources.IEC61850ErrorReadOnlyFunctionalConstraint, TagsList[0].TagNode.DynamicSettings,DriverCodeBase.Properties.Resources.LinkType_Input);
                        return;
                    }
                    break;
                case FunctionalConstraints.CO:
                                ...
                                case (uint)BuiltInType.SByte:
                                    {
                                        ...
                                        encodedDataLength = (int)P.AsnEncoderCheckLongSize((int)value);
                                    }
                                    break;
                                case (uint)BuiltInType.Int16:
                                ...
                                case (uint)BuiltInType.SByte:
                                    {
                                        ...
                                        encodedDataLength = (int)P.AsnEncoderCheckLongSize(value);
                                    }
                                    break;
                                case (uint)BuiltInType.Int16:
                                    {
                                ...
                                case (uint)BuiltInType.Byte:
                                    {
                                        ...
                                        encodedDataLength = (int)P.AsnEncoderCheckUnsignedSize(value);
                                    }
                                    break;
                                case (uint)BuiltInType.UInt16:
