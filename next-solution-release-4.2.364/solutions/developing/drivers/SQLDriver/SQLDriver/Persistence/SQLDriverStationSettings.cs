...
namespace SQLDriver
{
    ...
    public class SQLDriverStationSettings : StationSettings
    {
            ...
            : base(session)
        {
            ...
            session.UpdateSchema(typeof(SQLDriverStationSettings));
        }
        ...
        //steve 080711
        public void CopyProperties(SQLDriverStationSettings st)
        {
            base.CopyProperties(st);
            _SQLDriverTableName = st.SQLDriverTableName;
            _SQLDriverColumnNameTagName = st.SQLDriverColumnNameTagName;
            _SQLDriverColumnValue = st.SQLDriverColumnValue;
        }
        //////////////////
