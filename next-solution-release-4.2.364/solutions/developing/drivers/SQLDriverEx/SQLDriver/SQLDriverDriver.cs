...
namespace SQLDriver
{
    public class SQLDriverDriver : CommunicationDriver, ICommunicationDriver3
    {
        ...
        public override void GetDriverErrorInfo(int errorcode, out uint quality, out string error)
        {
            ...
            switch ((SQLDriverErrorCodes)errorcode)
            {
                ...
                case SQLDriverErrorCodes.ErrorDriverSettings:
                    ...
                    break;
                case SQLDriverErrorCodes.ErrorUnmappedTag:
        ...
        /// <summary>
        /// Return the root project folder path
        /// </summary>
        /// <param name="connectionString"></param>
        /// <returns></returns>
        public static String GetRootProjectPah(String connectionString)
        {
            if (XpoHelpers.XpoHelper.IsSQlDataProvider(connectionString))
            {
                return String.Format("{0}{4}{1}{4}{2}{4}{3}{4}",
                    ...
                    XpoHelpers.XpoHelper.GetDataSourceTitle(connectionString, onlytitle: true),
            ...
            else
            {
                try
                {
                    var filePath = XpoHelpers.XpoHelper.GetDataSourceFilePath(connectionString);
