...
namespace GESRTP2.UI
{
    ...
    {        
                ...
                foreach (var elem in list)
                {
                    ...
                    if (single != null)
                    {
                        if (single.AreaType == AreaTypes.Symbolic)
                        {
                            ...
                            if (isStructure)
                            {
                                proto = AddPrototypeSymbolic(protoMap, single);
                                if (proto == null)
                                    continue;
                            }
        ...
        private static ImportPrototype AddPrototypeSymbolic(Dictionary<string, ImportPrototype> protoMap, ImportData elem)
        {
            ImportPrototype proto = null;
                ...
                if (elem.Children.Count != 0)
                {
                    ...
                    foreach (var t in elem.Children)
                    {
                        ...
                        if (el != null)
                        {
                            ...
                            {
                                ImportPrototype protoElem = AddPrototypeSymbolic(protoMap, el);
                                if (protoElem == null)
                                    continue;
