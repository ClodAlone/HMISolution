...
{
    public class DriverSerialExampleSerialChannel : SerialChannel
    {
        #region Constructors

        /// <summary>
        /// Initializes the DriverSerialExampleChannel object.
        /// </summary>
        public DriverSerialExampleSerialChannel(CommunicationDriver commdriver, DriverSerialExampleChannelSettings settings)
        ...
        */
        ...
        public override bool ProcessNewData(DriverErrorCodes conn, CommJob pendingjob)
        {
            ...
            { 
                ...
                {
                    eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorReplayCodeMalformed;
                    lock (lockThreadObject)
                        ReceiveBuffer.Clear();
            ...
            if ((replycode & 0x80) > 0)
            {
                ...
                else
                {
                    ...
                    {
                        eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorErrorCodeMalformed;
                        lock (lockThreadObject)
                            ReceiveBuffer.Clear();
                ...
                eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)(DriverSerialExampleProtocol.PROTOCOL_ERROR + errorcode);
                lock (lockThreadObject) 
            ...
            else
            {
                ...
                { 
                    ...
                    case 4://Read Input Register
                        ...
                        else
                        {
                            ...
                            {
                                eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorReplayFrameMalformed;
                                lock (lockThreadObject) 
                                    ReceiveBuffer.Clear();
                    ...
                    case 7://Read Excetion Status
                        ...
                        break;
                    default:
                        eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorUnknownFunctionCode;
                        lock (lockThreadObject)
                            ReceiveBuffer.Clear();
                ...
                if (FrameType == 0)
                {
                    ...
                    {
                        //error
                        eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorCRCError;
                    }
                    else
                        eJob.Values = Answer;
                    lock (lockThreadObject)
                ...
                else
                {
                    ...
                    {
                        eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorReceivedDataMalformed;
                        lock (lockThreadObject)
                            ReceiveBuffer.Clear();
                    ...
                    {
                        eJob.ErrorCode = (DriverCodeBaseEx.Enumerators.DriverErrorCodes)DriverSerialExampleErrorCodes.ErrorLRCMalformed;
                        lock (lockThreadObject)
                            ReceiveBuffer.Clear();
