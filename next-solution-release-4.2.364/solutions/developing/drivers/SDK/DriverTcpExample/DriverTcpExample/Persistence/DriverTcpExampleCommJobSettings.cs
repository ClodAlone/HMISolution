////////////////////////////////////////////////////////////////////////////////////////////////////
// file:	Persistence\DriverTcpExampleCommJobSettings.cs
//
// summary:	Implements the driver TCP example communications job settings class
////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
    /// <summary>   Settings for the protocol's task(DriverTcpExampleCommJob). </summary>
    [MapInheritance(MapInheritanceType.ParentTable)]
    public class DriverTcpExampleCommJobSettings : CommJobSettings, IDataErrorInfo
    {
        #region Constructors

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Set propertys from DriverTcpExampleCommJob "job". </summary>
        ///
        /// <param name="session">  . </param>
        /// <param name="job">      . </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public DriverTcpExampleCommJobSettings(Session session, DriverTcpExampleCommJob job)
            : base(session, job)
        {
        ...
        /// <param name="session">  . </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public DriverTcpExampleCommJobSettings(Session session)
            : base(session)
        {
        ...
        protected DriverTcpExampleCommJobSettings()
        {
            // This constructor is used when an object is loaded from a persistent storage.
            // Do not place any code here.
        }
