    ...
    public partial class StationDetails : UserControl
    {
        ...
        public StationDetails()
        {
            ...
            Loaded += (o, e) =>
            {
                ...
                CmbPviInterfaceType.ItemsSource = Enum.GetValues(typeof(BrPviProcol.InterfaceTypes));
        ...
        {
            if (CmbPviInterfaceType.Text == BrPviProcol.InterfaceTypes.Ethernet.ToString())
            {
