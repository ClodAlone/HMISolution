...
namespace ADEditor.TreeDocumentManagers
{
    class TreeDocumentManager : IDocumentManager
    {
        ...
        public TreeDocumentManager(ADEditorManagerComponent c, ADEditorDocument doc, String name)
        {
        ...
        {
            get { return ADEditorManagerComponent.GetBitmapImage("ADEditorSmall"); }
        }

        public BitmapImage TypeIconLarge
        {
            get { return ADEditorManagerComponent.GetBitmapImage("ADEditor"); }
        }
