...
namespace Utilities
{
    ...
    public sealed class SvgValueConverterAttribute : Attribute
    {
        ...
        public SvgValueConverterAttribute(Type converterType)
        {
            RequiredKey = true;
    ...
    public abstract class CustomValueConverter
    {
        ...
        public abstract object ConvertToStorageType(object value, object sender, object document, object property);
