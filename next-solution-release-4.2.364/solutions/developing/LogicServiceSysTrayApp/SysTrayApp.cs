...
namespace SystemTrayApp
{
    public class SysTrayApp : System.Windows.Forms.Form
    {
        ...
        readonly LogicServiceCMS.LogicServiceCSMHelpers serverCMSHelper;
        ...
        {
            serverCMSHelper = new LogicServiceCMS.LogicServiceCSMHelpers(instanceId);

            title = LogicServiceCMS.LogicServiceCSMHelpers.GetServiceDisplayNameWhitoutDecoration();
