    ...
    public partial class DashBoard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // if (!IsPostBack)
            {
                ...
                ASPxDashboardDesigner1.SetDataSourceStorage(datasourceStorage);
                // DashboardConfigurator.Default.SetDataSourceStorage(datasourceStorage);

                ASPxDashboardDesigner1.AllowCreateNewDashboard = !Global.DisableCreateNewDashboard;
                ASPxDashboardDesigner1.AllowExecutingCustomSql = !Global.DisableExecutingCustomSqlDashboard;
            }
        }
        ...
        protected void ASPxDashboard1_ConfigureDataConnection(object sender, DevExpress.DashboardWeb.ConfigureDataConnectionWebEventArgs e)
        {
            foreach (DataGridElement element in _Config.DataGrids)
            {
                if (e.DataSourceName == element.Name)
                {
                    var parameters = new CustomStringConnectionParameters();
                    parameters.ConnectionString = element.ConnectionString;
