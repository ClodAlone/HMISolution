<%@ Page Title="DataGrids" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DataGrid.aspx.cs" Inherits="UFWebClient.HTML5.DataGrid" %>
...
<%@ Register src="UserControls/ToolbarExport.ascx" tagname="ToolbarExport" tagprefix="uc1" %>
        ...
        <panes>
            ...
            <dx:SplitterPane ShowCollapseBackwardButton="True" >
                <ContentCollection>
                    ...
                    <uc1:ToolbarExport runat="server" ID="ToolbarExport" ExportItemTypes="Pdf,Xls,Xlsx,Rtf,Csv" OnItemClick="ToolbarExport_ItemClick" />
