<%@ Page Title="DataAnalisys" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="DataAnalisys.aspx.cs" Inherits="UFWebClient.HTML5.DataAnalisys" %>
...
<% } %>
    ...
    <script type="text/javascript">
        ...
        function onSuccessGetData(data) {
            ...
            newStart.setTime(newStart.getTime() - tzOffset * 60 * 1000)
            newEnd.setTime(newEnd.getTime() - tzOffset * 60 * 1000)
            deStart.SetDate(newStart);
            deEnd.SetDate(newEnd);
        }
