    ...
    <dx:ASPxGridView style="padding-left: 4px"
        ...
        <Columns>
            <dx:GridViewDataDateColumn Caption="Time" FieldName="Time" Width="200px">
                ...
                <DataItemTemplate>
                    <%# GetTimeText(Container,"Time") %>                    
                </DataItemTemplate>
            </dx:GridViewDataDateColumn>
            <dx:GridViewDataDateColumn Caption="ActiveTransitionTime" FieldName="ActiveTransitionTime" Width="200px">
                <PropertiesDateEdit DisplayFormatString="yyyy/MM/dd hh:mm:ss" >
                </PropertiesDateEdit>
                <DataItemTemplate>
                    <%# GetTimeText(Container,"ActiveTransitionTime") %>                    
                </DataItemTemplate>
            </dx:GridViewDataDateColumn>
