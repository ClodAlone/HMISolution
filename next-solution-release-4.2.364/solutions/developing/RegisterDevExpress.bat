...
SET AssembliesPath="C:\Program Files (x86)\DevExpress 21.2\Components\Bin\Framework\*.dll"
...
SET AssembliesPath="C:\Program Files\DevExpress 21.2\Components\Bin\Framework\*.dll"
...
FOR /F "delims=" %%a IN ('DIR /B /S %AssembliesPath%') DO %GacUtil% /if "%%a"
