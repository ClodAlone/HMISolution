    ...
    public partial class DataValidation : UserControl, IContainPropertyEditors, IDisposable, ISettingsHelper
    {
        ...
        private void LoadData(string designSource, bool bLoadConfig)
        {
            ...
            task1.ContinueWith(ret =>
            {
                ...
                if (ret.Result != null)
                {
                    viewModel = new DataValidationViewModel(ret.Result);
        ...
        internal void CallSaveCommand(bool bForce = false)
        {
            ...
            try
            {
                ...
                if (configname == defaultTagSetting && !bForce)
                    return;
        ...
        void StringManager_CultureChanged(object sender, EventArgs e)
        {
            Dispatcher.BeginInvokeInBackgroundIfRequired(() =>
            {
                ...
                DataSourceLabel.Content = TranslationHelper.TranlslateText($"_{stringPlaceolder}_DataSourceLabel", stringlist, Properties.Resources.DataSourceNameLabel);
        ...
        public void Dispose()
        {
            ...
            if (cts != null)
                cts.Cancel();
            if (!bDesign && this.ReadLocalValue(ValidationSourceProperty) == DependencyProperty.UnsetValue)
                SaveRuntimeLayout();
            if (helper != null)
                helper.Dispose();
