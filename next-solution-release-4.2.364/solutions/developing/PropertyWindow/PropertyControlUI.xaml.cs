    ...
    public partial class PropertyControlUI : UserControl, IDisposable, INotifyPropertyChanged
    {
        ...
        */
                ...
                view.Filter = obj =>
                    {
                        ...
                        else if (PropertyFilterState == PropertyFilterEnum.GroupByCategory)
                        {
                            ...
                            node.CategoryPriority = priority == -1 ? int.MaxValue : priority;
                            ...
                            else
                            {
                                ...
                                node.Priority = priority == 0 ? int.MaxValue - 1 : priority;
                            }
                        }
        ...
        private void LocalizePropertyBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            var property = new DisplayInvariantStrings(propertyGrid.SelectedGridItem.Node);
            ...
            if (localizeDialog.ShowDialog() == true)
            {
                ...
                if (int.TryParse(content.txtPropertyCategoryPriority.Text, out newCategoryPriority) && oldCategoryPriority != newCategoryPriority)
