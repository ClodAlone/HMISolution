...
namespace PropertyControl.ComponentService
{
    public class Aggregated : ICustomTypeDescriptor, IDataErrorInfo, IDisposable
    {
        ...
        public Aggregated(PropertyControlUI owner, Object main, IList<Object> extended = null, IList<Object> parents = null)
        {
            _main = main;
            if (extended != null)
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            ...
            retAttributes = new LocalizablePropertyDescriptorCollection();
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties()
        {
            ...
            ret = new LocalizablePropertyDescriptorCollection();
