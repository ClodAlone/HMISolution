...
namespace SystemTrayApp
{
    public class SysTrayApp : System.Windows.Forms.Form
    {
        ...
        readonly MSServerCMS.MSServerCMSHelpers serverCMSHelper;
        ...
        {
            serverCMSHelper = new MSServerCMS.MSServerCMSHelpers(instanceId);

            title = serverCMSHelper.GetApplicationName();
            if (title == null)
                title = MSServerCMS.MSServerCMSHelpers.GetServiceDisplayNameWhitoutDecoration();
