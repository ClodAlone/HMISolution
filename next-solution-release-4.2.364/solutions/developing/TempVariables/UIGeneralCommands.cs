...
namespace TempVariablesManager
{
    ...
    public static class UIGeneralCommands
    {
        ...
        private static GeneralCommand _AddNewTag = new GeneralCommand(
            String.Format("{0} ({1})", Properties.UICommandResource.AddNewTagName, Properties.UICommandResource.LocalKey),
        ...
        private static GeneralCommand _AddNewFolder = new GeneralCommand(
            String.Format("{0} ({1})", Properties.UICommandResource.AddNewFolderName, Properties.UICommandResource.LocalKey),
