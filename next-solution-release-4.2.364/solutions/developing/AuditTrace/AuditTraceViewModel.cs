    ...
    public class AuditTraceViewModel : ViewModelBase
    {
        ...
        protected override String PerformValidation(String propertyName)
        {
            if (propertyName == "AuditComment")
            {
                ...
                {
                    return Properties.Resources.AuditCommentEmptyError;
                }
            }
        ...
        public bool SetValue(string newValue)
        {
            ...
            var auditDialog = new GeneralDialogContent(auditTraceComment)
            {
                Owner = owner,
            };
        ...
        bool CheckAudit()
        {
            ...
            {
                if (UIInterface != null)
                    UIInterface.ShowError(Properties.Resources.AuditCallMethodNotReday);
            }
            else
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (UIInterface != null)
                                UIInterface.ShowError(Properties.Resources.AuditLoginRequired);
                            return false;
                        }
                    ...
                    catch (Exception ex)
                    {
                        ...
                        {
                            var error = string.Format(Properties.Resources.AuditCallMethodFailed, ex.Message);
                            if (UIInterface != null)
                        ...
                        else
                        {
                            ...
                            {
                                var error = string.Format(Properties.Resources.AuditCallMethodFailed, exception.Message);
                                if (UIInterface != null)
                                    UIInterface.ShowError(error);
                                return false;
                            }
