...
namespace UFUAModel
{
    public abstract class ConfigurationBase : XPObject, INotifyPropertyVisibilityChanged, IDataErrorInfo
    {
        ...
        private TimeSpan _RedundancyTimeout;
        [Category("Redundancy")]
        ...
        private uint? _RedundancyPortNumber;
        [Category("Redundancy")]
        ...
        protected String PerformValidation(String propertyName, String prototypeModel = null)
        {
