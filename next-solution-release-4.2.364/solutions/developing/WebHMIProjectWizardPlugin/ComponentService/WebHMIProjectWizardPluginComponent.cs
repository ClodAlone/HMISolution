...
namespace WebHMIProjectWizardPlugin.ComponentService
{
    public class WebHMIProjectWizardPluginComponent : ComponentBase<IUFProjectWizardPlugin>, IUFProjectWizardPlugin
    {

        public static ProjectWizardUI wizard;
        public static WebHMIProjectWizardPluginComponent wizardPluginComponent { get; protected set; }
