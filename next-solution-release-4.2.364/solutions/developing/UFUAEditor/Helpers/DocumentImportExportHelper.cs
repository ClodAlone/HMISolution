                        ...
                        else
                        {
                            ...
                            if (!string.IsNullOrEmpty(sourcename))
                            {
                                ...
                                if (alarmsource != null)
                                {
                                    ...
                                    alarmthreshold = new UFUAModel.UFUAAlarmThreshold(uow) { UFUAAlarmDefinitionRef = alarmdef };
                                }
                                else
                                    throw new Exception(string.Format(Properties.Resources.InvalidAlarmDefinitionDuringTagImporting, tag.GetFullName(), alarm));
            ...
            if (objectOptions.ExistingObjects != null && objectOptions.ExistingObjects.ContainsKey(objectOptions.EntryKey))
            {
                ...
                if (existingObject != null)
                {
                        ...
                        options.dialogRetValue != CustomDialogResults.Cancel)
                    {
                        ...
                        workspace?.ResetBusy();
                        options.dialogRetValue = options.serverDocument.AskCreateVariable(string.Format(Properties.Resources.ImportTagNameExist, objectName), Properties.Resources.ImportTagInProgress);
                        workspace?.RestoreBusy();
                    }
