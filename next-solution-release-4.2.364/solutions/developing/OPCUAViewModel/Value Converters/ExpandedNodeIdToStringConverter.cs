...
namespace OPCUAViewModel
{
    ...
    /// </summary>
    [ValueConversion(typeof(ExpandedNodeId), typeof(String))]
    public class ExpandedNodeIdToStringConverter : IValueConverter
    {
        #region IValueConverter implementation
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (targetType != typeof(String) || !(value is ExpandedNodeId))
                return null;

            ExpandedNodeId input = value as ExpandedNodeId;
