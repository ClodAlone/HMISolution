...
namespace LogicManager.TreeDocumentManagers
{
    class TreeDocumentManager : IDocumentManager
    {
        ...
        {
            get { return DocumentEditorManagerComponent.GetBitmapImage("LGEditorSmall"); }
        }

        public BitmapImage TypeIconLarge
        {
            get { return DocumentEditorManagerComponent.GetBitmapImage("LGEditor"); }
        }
