<%@ Page Title="Alarms" Language="C#" MasterPageFile="~/ServerStuff/ServerStuff.master" AutoEventWireup="true" CodeBehind="Alarm.aspx.cs" Inherits="UFWebClient.HTML5.Alarm" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="body">
    ...
    <dx:ASPxGridView style="padding-left: 4px"
        ...
        <Columns>
            <dx:GridViewDataDateColumn Caption="Time" FieldName="Time" Width="200px">
                <PropertiesDateEdit DisplayFormatString="yyyy/MM/dd hh:mm:ss" >
                </PropertiesDateEdit>
                <DataItemTemplate>
                    <%# GetTimeText(Container) %>                    
                </DataItemTemplate>
