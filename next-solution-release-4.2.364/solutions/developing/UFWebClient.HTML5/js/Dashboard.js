...
function onSuccessListTileInfo(listTiles) {
    ...
    $.each(listTiles, function () {
        ...
        $.each(this, function () {
            ...
            var tileParams =
            {
                uniqueId: this.Name.replace(re, '_'),
                name: this.Name.replace(re, '_'),
                appTitle: this.Name,
                label: this.Name,
                color: this.Color,
                iconSrc: this.ImageUrl,
                appUrl: "Screen.aspx?url=" + this.Url
            };
            ...
            var tile = new Tile(tileParams, ui);

            sectionTiles.push(tile);
        });

        //var newSection = new Section({ sections are not fully supported
        //    name: listTiles[i].Key,
        //    tiles: sectionTiles
        //}, viewModel);
    ...
    viewModel.sections(sectionArray);
...
$(document).ready(function () {
    ...
    // ScreenSinkService.GetListTileInfo(onSuccessListTileInfo, onFailureListTileInfo)
