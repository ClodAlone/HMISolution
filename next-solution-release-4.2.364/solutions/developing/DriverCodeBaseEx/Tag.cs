...
namespace DriverCodeBaseEx
{
    ...
    public abstract class Tag
    {
                    ...
                    case (uint)Opc.Ua.DataTypes.UInt16:
                        {
                            ...
                            if (nbuf != null && nbuf.Length >= (index + size))
                            {
                                if (TagNode.ArrayDimension == 0)
                                {
                                    ...
                                    //bCopy = (ReadValue == null || (UInt16)ReadValue != (UInt16)val || (LastValue != null && (UInt16)LastValue != (UInt16)val));
                                }
                                else
                                {
                            ...
                            if (nbuf != null && nbuf.Length >= (index + size))
                            {
                                ...
                                else
                                {
                                    ...
                                    for (int i = 0; i < TagNode.ArrayDimension; i++)
                                    {
                                        ...
                                        if (check && a[i] != Convert.ToUInt64(b.GetValue(i)) || (checkL && a[i] != Convert.ToUInt64(bL.GetValue(i))))//aggiunta
                                            bCopy = true;
                                    }
                                    val = a;
                                }
        ...
        private bool _IsChildReadValueChanged = false;
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public bool IsChildReadValueChanged
        {
            get { return _IsChildReadValueChanged; }
            set { _IsChildReadValueChanged = value; }
        }
        #endregion
        ...
        public void SetIniternalValue(object value)
        {
            LastValue = value;
            ReadValue = value;
            WriteVal = value;
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary> Set readed value of big job child </summary>
        ///
        /// <param name="value" type="object"> new value </param>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public void SetReadValueChildJob(object value)
        {                       
            IsChildReadValueChanged = true;
            SetIniternalValue(value);            
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary> Init tag internal value in of atomic struct child before job exectuion</summary>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        public virtual void InitChildReadValueBeforeExecution()
        {
            IsChildReadValueChanged = false;
            // don't reset WriteVal and Value.Value = value;
