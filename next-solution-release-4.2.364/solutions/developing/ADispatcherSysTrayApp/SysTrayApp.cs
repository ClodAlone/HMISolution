...
namespace SystemTrayApp
{
    public class SysTrayApp : System.Windows.Forms.Form
    {
        ...
        readonly ADServerCMS.ADServerCSMHelpers serverCMSHelper;
        ...
        {
            serverCMSHelper = new ADServerCMS.ADServerCSMHelpers(instanceId);

            title = serverCMSHelper.GetApplicationName();
            if (title == null)
                title = ADServerCMS.ADServerCSMHelpers.GetServiceDisplayNameWhitoutDecoration();
