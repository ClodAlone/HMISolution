...
namespace UFCrossReferenceModel
{
    ...
    public class UFCrossReferenceConnection : XPObject
    {
        #region Constructors
        public UFCrossReferenceConnection(Session session)
            : base(session)
        { }
        #endregion
        ...
        [Association("CrossReferenceConnection-Entities"), Aggregated]
        ...
        public UFCrossReferenceConnectionFolder UFUAFolder
        {
            get
            {
                return _UFUAFolder;
