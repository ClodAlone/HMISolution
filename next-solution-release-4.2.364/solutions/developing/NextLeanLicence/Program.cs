...
namespace NextLeanLicense
{
    class Program
    {
        ...
        const int demoModeMeasuresNum = 3;
        ...
        static int iState = 1;
        private static readonly ILog log = LogManager.GetLogger("NextLeanLicense");
        ...
        private static void CheckLicence(bool mSZState)
        {
            try
            {
                ...
                measEnabled = MSZ.MSZView.GetModule("KXS7y64HI+TAGrwcJgBbSp8rwADghe5thN77IIPXmuqG+ab5543ZRBCCsCBJbBNxzKojW/Qlqpgmbof/sU8ezA=="/* PLN */);
                measEnabled = !mSZState ? measEnabled == -1 ? 0 : measEnabled : demoModeMeasuresNum;
                date = DateTime.Now;
#if DEBUG
