namespace StreamMediaElement
{
    ...
    public class DelegateCommand : ICommand
    {
        ...
        {
            ExecuteWithDispatcher(Application.Current.Dispatcher, parameter);
        }

        public async void ExecuteWithDispatcher(Dispatcher dispatcher, object parameter = null)
        {
            ...
            try
            {
                ...
                await dispatcher.BeginInvoke(ExecuteAction, DispatcherPriority.Normal, parameter);
            }
            catch (Exception ex)
            {
