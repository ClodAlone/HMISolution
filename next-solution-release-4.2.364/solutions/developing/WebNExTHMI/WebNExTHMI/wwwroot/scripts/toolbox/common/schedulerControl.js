function onSchedulerLoaded(obj) {
    ...
    if (parameters.ShowWorkTimeOnly) {
        ...
        var weeklyViewEndDate = new Date(1991, 0, 7, finalEndH, finalEndM, 0);
    ...
    var weeklyViewStartDate = new Date(1991, 0, 7, startH, startM, 0);
            ...
            form: {
                ...
                onContentReady: function (e) {
                    setTimeout(function () {
                        ...
                        $(btnSave).css("min-width", "120px");
                        $(btnCancel).css("min-width", "120px");
        ...
        onContentReady: function (e) {
            ...
            setTimeout(function () {
                ...
                if (componentHeight > 0)
                    initWeeklyView(thisParent.height() - componentHeight - schedulerChooserDiv.height() - 12 - parameters.BorderThickness.Top - parameters.BorderThickness.Bottom);
            }, 1);
        },
    ...
    function repeatEvent(startDate, endDate, neweventid, neweventindex, repeatEveryDays) {
        ...
        while (true) {
            ...
            if (newEndDate > new Date(1991, 0, 13, 23, 59, 59))
                break;
    ...
    function getCurrentWeeklyCursorCells() {
        ...
        var currentTimeFirstCell = (Math.ceil(rowCells / hourCells) + 2) + Math.floor((new Date(1991, 0, 7, now.getHours(), now.getMinutes(), 0) - weeklyViewStartDate) / weeklyCellMs);
    ...
    function initWeeklyView(desiredHeight) {
        if (bWeeklyViewInit)
            return;
        ...
        fastdom.mutate(function () {
            ...
            weeklyViewDiv.find(".cellTimeCol:not(.daylabel)").on({
                ...
                touchend: function (e) {
                    ...
                    var cell = $(this);
                    if ($(this).hasClass("creatingEvent"))
                        lastLeavedCell = cell;
                    ...
                    if (creatingEventCells.length == 0 && cell.hasClass("eventCell")) {
                        ...
                        if (!dblClickedTimeout) {
                            dblClickedTimeout = setTimeout(function () {
                                ...
                                if (weeklyContextMenu.option("visible") == true)
                                    return;
                ...
                mousedown: function (e) {
                    if ($(this).hasClass("eventCell") || e.which == 3)
                        return;
        ...
        weeklyContextMenu = contextMenuEdit.dxContextMenu({
            dataSource: [],
            target: ".cellTimeCol:not(.daylabel)",
            onPositioning: function (e) {
                rightClickedCell = e.event.target;
                            ...
                            },
                            {
                                ...
                                buttonOptions: {
                                    ...
                                    onClick: function (e) {
                                        ...
                                        if (parameters.ShowWorkTimeOnly) {
                                            var startFormDateTime = new Date(1991, 0, 7, startFormDate.getHours(), startFormDate.getMinutes(), startFormDate.getSeconds());
                                            var endFormDateTime = new Date(1991, 0, 7, endFormDate.getHours(), endFormDate.getMinutes(), endFormDate.getSeconds());
    ...
    function clearWeeklyEvent(eid) {
        ...
        var tooltipElem = thisPage.find("#tooltip" + eid);
    ...
    function findStartEndColIndex(eventStartDate, eventEndDate, eventID) {
        ...
        var startColRelativeIndex = Math.floor((moment(new Date(1991, 0, 7, eventStartDate.getHours(), eventStartDate.getMinutes(), eventEndDate.getSeconds())).add(eventStartWeekDay, "days").toDate() - dayStart_StartDate) / weeklyCellMs) + 1;
        var endColRelativeIndex = Math.ceil((moment(new Date(1991, 0, 7, eventEndDate.getHours(), eventEndDate.getMinutes(), eventEndDate.getSeconds())).add(eventEndWeekDay, "days").toDate() - dayEnd_StartDate) / weeklyCellMs) + 1;
        ...
        while (i < weeklyTotalCells) {
            ...
            if (!currentCell.hasClass("daylabel")) {
                if (currentCell.hasClass("eventCell"))
                    ...
                    currentCell.css("background-color", eventBackgroundColor).addClass("eventCell");
    ...
    function addWeeklyEvent(eventStartDate, eventEndDate, eventID, eventIndex, bInitialDataLoading, overlappedEvents) {
        ...
        if (eventsToMerge.length > 0) {
            ...
            newEventEntry.StartDate = new Date(1991, 0, dayStart_StartDate, minStartEvent.StartDate.getHours(), minStartEvent.StartDate.getMinutes(), minStartEvent.StartDate.getSeconds());
            newEventEntry.EndDate = new Date(1991, 0, dayEnd_StartDate, maxEndEvent.EndDate.getHours(), maxEndEvent.EndDate.getMinutes(), maxEndEvent.EndDate.getSeconds());
