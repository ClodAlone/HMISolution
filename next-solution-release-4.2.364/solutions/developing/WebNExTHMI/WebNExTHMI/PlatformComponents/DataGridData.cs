...
namespace WebNExTHMI.PlatformComponents
{
    public class DataGridData
    {
        ...
        public string LoadDataGridData(string connectionString, string sessionString, string dataProvider, string connection, string select, string where, string groupBy, string sort, string tableName, uint maxTransactionsBeforeCommit, bool allowPrimaryKeyChanging, CancellationToken ct)
        {
            if (dataSet == null)
            {
                dataSet = new DataSet();
