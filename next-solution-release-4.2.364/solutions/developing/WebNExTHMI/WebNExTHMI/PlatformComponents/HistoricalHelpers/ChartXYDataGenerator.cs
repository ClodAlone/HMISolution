...
namespace WPFPenHelpers
{
    public class ChartXYDataGenerator : BaseDataGenerator
    {
        ...
        #region Constructors
        public ChartXYDataGenerator(string XTagName, string YTagName, WPFPenHelpers.DataGeneratorSettings settings, int commandTimeout)
        ...
        public void ResetData(ResetType resetType)
        {
            ...
            MyDataValue _data1 = new MyDataValue() { Value = lastValue.Value1.Value, SourceTimeStamp = DateTime.MaxValue };
            MyDataValue _data2 = new MyDataValue() { Value = lastValue.Value2.Value, SourceTimeStamp = DateTime.MaxValue };
        ...
        protected override void SetDataSources(CancellationToken ct)
        {
            ...
            //{
                ...
                var _sampnum = (from c in templ
                                where DateTime.Compare((c.Value1 as MyDataValue).SourceTimeStamp, date) >= 0
