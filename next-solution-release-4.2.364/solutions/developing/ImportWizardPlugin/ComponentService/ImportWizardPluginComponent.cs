...
namespace ImportWizardPlugin.ComponentService
{
    public class ImportWizardPluginComponent : ComponentBase<IUFProjectWizardPlugin>, IUFProjectWizardPlugin
    {

        public static ProjectWizardUI wizard;
        public static ImportWizardPluginComponent wizardPluginComponent { get; protected set; }
            ...
            try
            {
                if (wnd.ShowDialog() == true)
                {
                    ...
                    //using (new WaitCursor())
                    {
                        ...
                        captions[GeneralDialogButtons.CloseButton] = Properties.Resources.LabelCancel;
                        ImportWizardDialog = new GeneralDialogContent(messageControl, GeneralDialogButtons.CloseHelpButtons, captions)
                        {
                            Owner = Application.Current.MainWindow,
                            Title = Properties.Resources.DisclaimerTitle,
                            HelpLink = "ImportWizardPlugin"
                        };
        ...
        #region Properties
        public static GeneralDialogContent ImportWizardDialog;
        static Uri projectUri;
        ...
        public static DataSourceFileSystemProvider DocFileSystemProvider;
