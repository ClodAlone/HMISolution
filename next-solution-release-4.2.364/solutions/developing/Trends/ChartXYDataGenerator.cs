...
namespace Trends
{
    public class ChartXYDataGenerator : WPFPenHelpers.BaseDataGenerator
    {
        #region Declarations
        ...
        #region Constructors
        public ChartXYDataGenerator(string penId, WPFPenHelpers.DataGeneratorSettings settings, int commandTimeout)
        ...
        public void AddData(object newValue1, object newValue2, int _count)
        {
            ...
            if (newValue1 != null)
            {
                ...
                values[index].Value1 = LastValue.Value1 = new DataValue()
                {
                    Value = newValue,
            ...
            if (newValue2 != null)
            {
                ...
                values[index].Value2 = LastValue.Value2 = new DataValue()
                {
                    Value = newValue,
                    SourceTimestamp = Settings.ClientTimezoneOffset != TimeSpan.Zero ? DateTime.UtcNow + Settings.ClientTimezoneOffset : DateTime.Now
                };
        ...
        public void ResetData(ResetType resetType)
        {
            ...
            DataValue _data1 = new DataValue() { Value = lastValue.Value1.Value, SourceTimestamp = DateTime.MaxValue };
            DataValue _data2 = new DataValue() { Value = lastValue.Value2.Value, SourceTimestamp = DateTime.MaxValue };
        ...
        void InitializeValues()
        {
            ...
            for (int i = 0; i < Settings.HDataCount; i++)
            {
                ...
                {
                    Value1 = new DataValue()
                    {
                        Value = double.NaN,
                        SourceTimestamp = sourceTimestamp
                    },
                    Value2 = new DataValue()
                    {
                        Value = double.NaN,
                        SourceTimestamp = sourceTimestamp
                    }
        ...
        List<DataValue> CreateDataSource(string nodeid, DateTime date)
        {
        ...
        protected override void Initialize()
        {
            ...
            {
                Value1 = new DataValue() { Value = (double)0.0, SourceTimestamp = DateTime.MaxValue },
                Value2 = new DataValue() { Value = (double)0.0, SourceTimestamp = DateTime.MaxValue }
            };
        ...
        protected override void SetDataSources()
        {
            ...
            var task1 = Task.Factory.StartNew(() =>
            {
                ...
                var _sampnum = (from c in templ
                                where DateTime.Compare((c.Value1 as DataValue).SourceTimestamp, date) >= 0
