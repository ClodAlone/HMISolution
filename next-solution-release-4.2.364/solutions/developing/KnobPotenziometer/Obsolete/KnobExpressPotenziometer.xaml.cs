...
namespace KnobPotenziometer
{
    ...
    public partial class KnobExpressPotenziometer : UserControl, IDisposable, IEntityReference, IDynamicTagAware
    {
        ...
        private void OverrideBaseProperties()
        {
            ...
            dpd = DependencyPropertyDescriptor.FromProperty(ForegroundProperty, typeof(KnobExpressPotenziometer));
            dpd.AddValueChangedSafe(this, OnForegroundChanged);
            dpd = DependencyPropertyDescriptor.FromProperty(IsEnabledProperty, typeof(KnobExpressPotenziometer));
            dpd.AddValueChangedSafe(this, OnIsEnabledChanged);
            dpd = DependencyPropertyDescriptor.FromProperty(FontStyleProperty, typeof(KnobExpressPotenziometer));
            dpd.AddValueChangedSafe(this, OnFontStyleChanged);
            dpd = DependencyPropertyDescriptor.FromProperty(FontFamilyProperty, typeof(KnobExpressPotenziometer));
            dpd.AddValueChangedSafe(this, OnFontFamilyChanged);
            dpd = DependencyPropertyDescriptor.FromProperty(FontWeightProperty, typeof(KnobExpressPotenziometer));
            dpd.AddValueChangedSafe(this, OnFontWeightChanged);
            dpd = DependencyPropertyDescriptor.FromProperty(FontSizeProperty, typeof(KnobExpressPotenziometer));
            dpd.AddValueChangedSafe(this, OnFontSizeChanged);

            //dpd = DependencyPropertyDescriptor.FromProperty(BackgroundProperty, typeof(KnobExpressPotenziometer));
            //dpd.AddValueChangedSafe(this, OnBackgroundChanged);
            //dpd = DependencyPropertyDescriptor.FromProperty(BorderBrushProperty, typeof(KnobExpressPotenziometer));
        ...
        //{
        //    var control = sender as KnobExpressPotenziometer;
        //    if (control != null)
        //    {
        ...
        //    {
        //        bOverride = true;
        //        BackgroundBorderBrush = BorderBrush;
        //    }
        //    else
        //        bOverride = false;
        //}
        ...
        #region ShowLabels
        public static readonly DependencyProperty ShowLabelsProperty = DependencyProperty.Register("ShowLabels", typeof(bool), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(true, new PropertyChangedCallback(OnShowLabelsChanged), new CoerceValueCallback(OnCoerceShowLabels)));

        private static object OnCoerceShowLabels(DependencyObject o, object value)
        {
            KnobExpressPotenziometer control = o as KnobExpressPotenziometer;
            if (control != null)
        ...
        public static readonly DependencyProperty ShowFirstLabelProperty = DependencyProperty.Register("ShowFirstLabel", typeof(Boolean), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(true, new PropertyChangedCallback(OnShowFirstLabelChanged), new CoerceValueCallback(OnCoerceShowFirstLabel)));

        private static object OnCoerceShowFirstLabel(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceShowFirstLabel((Boolean)value);
            else
                return value;
        }
        ...
        private static void OnShowFirstLabelChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnShowFirstLabelChanged((Boolean)e.OldValue, (Boolean)e.NewValue);
        }
        ...
        public static readonly DependencyProperty ShowLastLabelProperty = DependencyProperty.Register("ShowLastLabel", typeof(Boolean), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(true, new PropertyChangedCallback(OnShowLastLabelChanged), new CoerceValueCallback(OnCoerceShowLastLabel)));

        private static object OnCoerceShowLastLabel(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceShowLastLabel((Boolean)value);
            else
                return value;
        }
        ...
        private static void OnShowLastLabelChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnShowLastLabelChanged((Boolean)e.OldValue, (Boolean)e.NewValue);
        }
        ...
        public static readonly DependencyProperty MajorTickBrushProperty = DependencyProperty.Register("MajorTickBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.Gray), new PropertyChangedCallback(OnMajorTickBrushChanged), new CoerceValueCallback(OnCoerceMajorTickBrush)));

        private static object OnCoerceMajorTickBrush(DependencyObject o, object value)
        {
            KnobExpressPotenziometer knobPotenziometer = o as KnobExpressPotenziometer;
        ...
        public static readonly DependencyProperty MinorTickBrushProperty = DependencyProperty.Register("MinorTickBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.Gray), new PropertyChangedCallback(OnMinorTickBrushChanged), new CoerceValueCallback(OnCoerceMinorTickBrush)));
        ...
        #endregion
        #region Value
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)0.0, new PropertyChangedCallback(OnValueChanged), new CoerceValueCallback(OnCoerceValue)));

        private static object OnCoerceValue(DependencyObject o, object value)
        {
            KnobExpressPotenziometer circularGaugeObject = o as KnobExpressPotenziometer;
        ...
        public static readonly DependencyProperty ValueStringFormatProperty = DependencyProperty.Register("ValueStringFormat", typeof(String), typeof(KnobExpressPotenziometer), new UIPropertyMetadata("0", new PropertyChangedCallback(OnValueStringFormatChanged), new CoerceValueCallback(OnCoerceValueStringFormat)));
        ...
        public static readonly DependencyProperty MinorIntervalCountProperty = DependencyProperty.Register("MinorIntervalCount", typeof(int), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((int)3, new PropertyChangedCallback(OnMinorIntervalCountChanged), new CoerceValueCallback(OnCoerceMinorIntervalCount)));
        ...
        public static readonly DependencyProperty MajorIntervalCountProperty = DependencyProperty.Register("MajorIntervalCount", typeof(int), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((int)4, new PropertyChangedCallback(OnMajorIntervalCountChanged), new CoerceValueCallback(OnCoerceMajorIntervalCount)));
        ...
        public static readonly DependencyProperty LabelStringFormatProperty = DependencyProperty.Register("LabelStringFormat", typeof(String), typeof(KnobExpressPotenziometer), new UIPropertyMetadata("{0:0}", new PropertyChangedCallback(OnLabelStringFormatChanged), new CoerceValueCallback(OnCoerceLabelStringFormat)));

        private static object OnCoerceLabelStringFormat(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceLabelStringFormat((String)value);
            else
                return value;
        }
        ...
        private static void OnLabelStringFormatChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnLabelStringFormatChanged((String)e.OldValue, (String)e.NewValue);
        }
        ...
        public static readonly DependencyProperty LabelFontSettingsProperty = DependencyProperty.Register("LabelFontSettings", typeof(FontSettings), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new FontSettings(FontWeights.DemiBold, FontStyles.Normal, new FontFamily("Segoe UI"), 12), new PropertyChangedCallback(OnLabelFontSettingsChanged), new CoerceValueCallback(OnCoerceLabelFontSettings)));

        private static object OnCoerceLabelFontSettings(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceLabelFontSettings((FontSettings)value);
            else
                return value;
        }
        ...
        private static void OnLabelFontSettingsChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnLabelFontSettingsChanged((FontSettings)e.OldValue, (FontSettings)e.NewValue);
        }
        ...
        public static readonly DependencyProperty LabelForegroundProperty = DependencyProperty.Register("LabelForeground", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.DimGray)));
        [Browsable(false)]
        [XmlIgnore]
        [Category("KnobStyle")]
        ...
        private static void OnLableOrientationChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnLableOrientationChanged((ArcScaleLabelOrientation)e.OldValue, (ArcScaleLabelOrientation)e.NewValue);
        }
        ...
        #endregion
        #region LabelOffset
        public static readonly DependencyProperty LabelOffsetProperty = DependencyProperty.Register("LabelOffset", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(-13.0, new PropertyChangedCallback(OnLabelOffsetChanged), new CoerceValueCallback(OnCoerceLabelOffset)));

        private static object OnCoerceLabelOffset(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceLabelOffset((Double)value);
            else
                return value;
        }
        ...
        private static void OnLabelOffsetChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnLabelOffsetChanged((Double)e.OldValue, (Double)e.NewValue);
        }
        ...
        public static readonly DependencyProperty NeedleBorderBrushProperty = DependencyProperty.Register("NeedleBorderBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.SeaGreen), new PropertyChangedCallback(OnNeedleBorderBrushChanged), new CoerceValueCallback(OnCoerceNeedleBorderBrush)));
        ...
        public static readonly DependencyProperty NeedleBackBrushProperty = DependencyProperty.Register("NeedleBackBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.MediumSeaGreen), new PropertyChangedCallback(OnNeedleBackBrushChanged), new CoerceValueCallback(OnCoerceNeedleBackBrush)));
        ...
        public static readonly DependencyProperty BackgroundBrushProperty = DependencyProperty.Register("BackgroundBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.LightGray), new PropertyChangedCallback(OnBackgroundBrushChanged), new CoerceValueCallback(OnCoerceBackgroundBrush)));
        ...
        public static readonly DependencyProperty BackgroundBorderBrushProperty = DependencyProperty.Register("BackgroundBorderBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.Silver), new PropertyChangedCallback(OnBackgroundBorderBrushChanged), new CoerceValueCallback(OnCoerceBackgroundBorderBrush)));
        ...
        public static readonly DependencyProperty RingBackBrushProperty = DependencyProperty.Register("RingBackBrush", typeof(Brush), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(new SolidColorBrush(Colors.LightGray), new PropertyChangedCallback(OnRingBackBrushChanged), new CoerceValueCallback(OnCoerceRingBackBrush)));
        ...
        #endregion
        #region KnobRadius
        public static readonly DependencyProperty KnobRadiusProperty = DependencyProperty.Register("KnobRadius", typeof(double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(76.0, new PropertyChangedCallback(OnKnobRadiusChanged), new CoerceValueCallback(OnCoerceKnobRadius)));
        ...
        #region MinValue
        public static readonly DependencyProperty MinValueProperty = DependencyProperty.Register("MinValue", typeof(double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(0.0, new PropertyChangedCallback(OnMinValueChanged), new CoerceValueCallback(OnCoerceMinValue)));
        ...
        #endregion
        #region MaxValue
        public static readonly DependencyProperty MaxValueProperty = DependencyProperty.Register("MaxValue", typeof(double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(100.0, new PropertyChangedCallback(OnMaxValueChanged), new CoerceValueCallback(OnCoerceMaxValue)));
        ...
        #endregion
        #region UseEUnit
        public static readonly DependencyProperty UseEUnitProperty = DependencyProperty.Register("UseEUnit", typeof(bool), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(false, new PropertyChangedCallback(OnUseEUnitChanged), new CoerceValueCallback(OnCoerceUseEUnit)));
        ...
        #region TagMinValue
        public static readonly DependencyProperty TagMinValueProperty = DependencyProperty.Register("TagMinValue", typeof(OPCUAXMLEntityReference), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(null, new PropertyChangedCallback(OnTagMinValueChanged), new CoerceValueCallback(OnCoerceTagMinValue)));
        ...
        #endregion
        #region TagMaxValue
        public static readonly DependencyProperty TagMaxValueProperty = DependencyProperty.Register("TagMaxValue", typeof(OPCUAXMLEntityReference), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(null, new PropertyChangedCallback(OnTagMaxValueChanged), new CoerceValueCallback(OnCoerceTagMaxValue)));
        ...
        #region KnobOptions
        #region StartValue
        public static readonly DependencyProperty StartValueProperty = DependencyProperty.Register("StartValue", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)0.0, new PropertyChangedCallback(OnStartValueChanged), new CoerceValueCallback(OnCoerceStartValue)));

        private static object OnCoerceStartValue(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceStartValue((Double)value);
            else
                return value;
        }
        ...
        private static void OnStartValueChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnStartValueChanged((Double)e.OldValue, (Double)e.NewValue);
        }
        ...
        #region EndValue
        public static readonly DependencyProperty EndValueProperty = DependencyProperty.Register("EndValue", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)100.0, new PropertyChangedCallback(OnEndValueChanged), new CoerceValueCallback(OnCoerceEndValue)));

        private static object OnCoerceEndValue(DependencyObject o, object value)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                return KnobExpressPotenziometer.OnCoerceEndValue((Double)value);
            else
                return value;
        }
        ...
        private static void OnEndValueChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            KnobExpressPotenziometer KnobExpressPotenziometer = o as KnobExpressPotenziometer;
            if (KnobExpressPotenziometer != null)
                KnobExpressPotenziometer.OnEndValueChanged((Double)e.OldValue, (Double)e.NewValue);
        }
        ...
        public static readonly DependencyProperty TickmarksPresentationProperty = DependencyProperty.Register("TickmarksPresentation", typeof(PredefinedElementKinds), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(PredefinedElementKinds.CleanWhite, new PropertyChangedCallback(OnTickmarksPresentationChanged), new CoerceValueCallback(OnCoerceTickmarksPresentation)));

        private static object OnCoerceTickmarksPresentation(DependencyObject o, object value)
        {
            KnobExpressPotenziometer circularGauge = o as KnobExpressPotenziometer;
        ...
        public static readonly DependencyProperty MajorTickmarkFactorLengthProperty = DependencyProperty.Register("MajorTickmarkFactorLength", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)0.4, new PropertyChangedCallback(OnMajorTickmarkFactorLengthChanged), new CoerceValueCallback(OnCoerceMajorTickmarkFactorLength)));
        ...
        public static readonly DependencyProperty MajorTickmarkZIndexProperty = DependencyProperty.Register("MajorTickmarkZIndex", typeof(int), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((int)20, new PropertyChangedCallback(OnMajorTickmarkZIndexChanged), new CoerceValueCallback(OnCoerceMajorTickmarkZIndex)));
        ...
        public static readonly DependencyProperty MajorTickmarkFactorThicknessProperty = DependencyProperty.Register("MajorTickmarkFactorThickness", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)1.0, new PropertyChangedCallback(OnMajorTickmarkFactorThicknessChanged), new CoerceValueCallback(OnCoerceMajorTickmarkFactorThickness)));
        ...
        public static readonly DependencyProperty MajorTickmarkOffsetProperty = DependencyProperty.Register("MajorTickmarkOffset", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)(-0.5), new PropertyChangedCallback(OnMajorTickmarkOffsetChanged), new CoerceValueCallback(OnCoerceMajorTickmarkOffset)));
        ...
        public static readonly DependencyProperty MajorTickmarkShowFirstProperty = DependencyProperty.Register("MajorTickmarkShowFirst", typeof(Boolean), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(true, new PropertyChangedCallback(OnMajorTickmarkShowFirstChanged), new CoerceValueCallback(OnCoerceMajorTickmarkShowFirst)));
        ...
        public static readonly DependencyProperty MajorTickmarkShowLastProperty = DependencyProperty.Register("MajorTickmarkShowLast", typeof(Boolean), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(true, new PropertyChangedCallback(OnMajorTickmarkShowLastChanged), new CoerceValueCallback(OnCoerceMajorTickmarkShowLast)));
        ...
        public static readonly DependencyProperty MinorTickmarkFactorLengthProperty = DependencyProperty.Register("MinorTickmarkFactorLength", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)0.5, new PropertyChangedCallback(OnMinorTickmarkFactorLengthChanged), new CoerceValueCallback(OnCoerceMinorTickmarkFactorLength)));
        ...
        public static readonly DependencyProperty MinorTickmarkZIndexProperty = DependencyProperty.Register("MinorTickmarkZIndex", typeof(int), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((int)10, new PropertyChangedCallback(OnMinorTickmarkZIndexChanged), new CoerceValueCallback(OnCoerceMinorTickmarkZIndex)));
        ...
        public static readonly DependencyProperty MinorTickmarkOffsetProperty = DependencyProperty.Register("MinorTickmarkOffset", typeof(Double), typeof(KnobExpressPotenziometer), new UIPropertyMetadata((Double)(-0.5), new PropertyChangedCallback(OnMinorTickmarkOffsetChanged), new CoerceValueCallback(OnCoerceMinorTickmarkOffset)));
        ...
        public static readonly DependencyProperty MinorTickmarkShowTicksForMajorProperty = DependencyProperty.Register("MinorTickmarkShowTicksForMajor", typeof(Boolean), typeof(KnobExpressPotenziometer), new UIPropertyMetadata(true, new PropertyChangedCallback(OnMinorTickmarkShowTicksForMajorChanged), new CoerceValueCallback(OnCoerceMinorTickmarkShowTicksForMajor)));
        ...
        public KnobExpressPotenziometer()
        {
            InitializeComponent();
        ...
        private void UpdateNeedle()
        {
            ...
            try
            {
                if (arcNeedle == null)
                {
                    ...
                    scaleneedlepresentation.NeedleTemplate = LoadTemplate("OscilloscopeMarkerTemplate");
        ...
        private void UpdateArcLayer()
        {
            ...
            try
            {
                if (arcLayer == null)
                {
                    ...
                    scalelayerpresentation.ScaleLayerTemplate = LoadTemplate("OscilloscopeScaleLayerTemplate");
                ...
                if (arcLayer1 == null)
                {
                    arcLayer1 = new ArcScaleLayer();
                    CustomArcScaleLayerPresentation scalelayerpresentation = new CustomArcScaleLayerPresentation();
                    scalelayerpresentation.ScaleLayerTemplate = LoadTemplate("OscilloscopeForegroundLayerTemplate");
                    arcLayer1.Presentation = scalelayerpresentation;

                    arcLayer1.Options = new LayerOptions();
                    arcLayer1.Options.ZIndex = 350;


                    if (!arcScale.Layers.Contains(arcLayer1))
                        arcScale.Layers.Add(arcLayer1);
                }
            }
            catch (Exception)
            {
        ...
        private ControlTemplate LoadTemplate(string template)
        {
            try
            {
                ...
                Stream stream = Utilities.ExtractFileFromResource.Extract(System.Reflection.Assembly.GetExecutingAssembly(),
                                                          String.Format("{0}.GaugeContainers.{1}", typeof(KnobExpressPotenziometer).Namespace, basename));
        ...
        public void KnobExpressPotenziometerInvokeAction()
        {
