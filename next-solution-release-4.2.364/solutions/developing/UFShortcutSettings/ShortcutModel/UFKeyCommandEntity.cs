...
namespace UFShortcutSettings.ShortcutModel
{
    ...
    public class UFKeyCommandEntity : INotifyPropertyChanged, IDataErrorInfo, ICloneable, ICommandable, IEntityReference
    {
        ...
        {
            bool getScreen = cRMapsHeler.CrossReferenceTypes.Contains(CrossReferenceType.Screens);
            ...
            {
                if (getScreen && command is OpenScreenCommand && (command as OpenScreenCommand).ScreenName != null)
                {
        ...
        public IEnumerable<dynamic> GetOpenScreenCommand(OpenScreenCommand command)
        {
            List<object> list = new List<object>();
