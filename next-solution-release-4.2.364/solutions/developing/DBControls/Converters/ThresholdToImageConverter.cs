...
namespace DBControls.Converters
{
    public class ThresholdToImageConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var matchingThreshold = FindMatchingThreshold(cellValue, thresholdsMap);
        ...
        public ImageThreshold FindMatchingThreshold(String cellValue, ImageThresholdCollection thresholdsMap)
        {
            if (cellValue == null || thresholdsMap == null)
                return null;

            var matchingThreshold = (from ImageThreshold t in thresholdsMap.AsParallel() where t.ImageThresholdValue == cellValue select t).FirstOrDefault();
