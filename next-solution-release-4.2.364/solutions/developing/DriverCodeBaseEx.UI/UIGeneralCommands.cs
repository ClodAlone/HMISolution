...
namespace DriverCodeBaseEx.UI
{
    public static class UIGeneralCommands
    {
        ...
        private static GeneralCommand _TestComm = new GeneralCommand(
            Properties.UICommandResource.TestCommName,
            Properties.UICommandResource.TestCommText,
            Properties.UICommandResource.TestCommGestures,
            Properties.UICommandResource.TestCommGesturesDisplayText,
            Properties.UICommandResource.TestCommTooltip,
            Properties.UICommandResource.TestCommDescription,
            typeof(UIGeneralCommands));

        public static GeneralCommand TestComm
        {
            get { return _TestComm; }
        }        
