...
namespace RecipeService.Core
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var ServicesToRun = new RecipeService();
...
#if !DEBUG
        readonly static Mindscape.Raygun4Net.RaygunClient _raygunClient = new Mindscape.Raygun4Net.RaygunClient("pP5ygKBDdwjjuOxLOGUwQ");
        static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            Logger.WriteToEventLog(Properties.Resources.LoggerSource, e.ExceptionObject.ToString(), System.Diagnostics.EventLogEntryType.Error, LoggerDestination.RecipeService);
        }
#endif
    }
}
