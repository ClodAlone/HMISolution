...
#region Abstracts
        ...
        public override bool ReadData()
        {
            ...
            return ret && bret1 && (bret2 || _runtimeSetValueTag == null);
        }
        ...
        public override String Name
        {
            get
            {
                ...
                return "Set";
#else
                return Properties.Settings.Default.SetGateName;
#endif
            }
        }
#if !WINDOWS_UWP && !NET_STANDARD
        public override DataTemplateDictionary GetDataTemplates()
        {
            ...
            resourceDictionary.Source = new Uri("/LogicCommon;component/ResourceDictionary/SetLibrary.xaml", UriKind.Relative);
        ...
        public override List<GateData> GetTypes()
        {
            ...
            ret.Add(new SetGate() { Key = "Set", Text = "Set", GateDataTemplate = "Set", Category = "Set" });
            return ret;
        }
#endif
        #endregion
