...
namespace Microsoft.Data.ConnectionUI
{
	public partial class MySQLConnectionUIControl : UserControl, IDataConnectionUIControl
	{
		...
		public void Initialize(IDataConnectionProperties connectionProperties)
		{
			...
			{
				throw new ArgumentException(Strings.MySQLConnectionUIControl_InvalidConnectionProperties);
			}
		...
		public void LoadProperties()
		{
			...
			{
				savePasswordCheckBox.Checked = (bool)Properties["persistsecurityinfo"];
			}
			else
			{
