    ...
    public class DataForm : Control
    {
        ...
        private static void OnCurrentItemPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dataForm != null && !dataForm.AreHandlersSuspended())
            {
                ...
                bool condition1 = (!dataForm.AutoCommitPreventsCurrentItemChange && dataForm.IsItemValid);
                bool condition2 = (e.NewValue == null || dataForm._collectionView == null || dataForm._collectionView.Contains(dataForm.CurrentItem));
                ...
                else
                {
                    ...
                    throw new InvalidOperationException("System.Windows.Controls.Data.DataForm.Toolkit.Resources.DataForm_CannotChangeCurrency");
                }
            }
        }
        ...
        internal int ItemsCount
        {
            get
            {
                ...
                BindingListCollectionView pagedCollectionView = this._originalItemsSource as BindingListCollectionView;
        ...
        internal void GenerateUI(bool clearEntityErrors, bool swapOldAndNew)
        {
            ...
            if (contentRootElement != null)
            {
                Validation.RemoveErrorHandler(contentRootElement, this.OnContentRootElementBindingValidationError);
            ...
            Validation.AddErrorHandler(contentRootElement, this.OnContentRootElementBindingValidationError);
            //contentRootElement.BindingValidationError += new EventHandler<ValidationErrorEventArgs>(this.OnContentRootElementBindingValidationError);
            contentRootElement.GotFocus += new RoutedEventHandler(this.OnContentRootElementGotFocus);
            contentRootElement.LostFocus += new RoutedEventHandler(this.OnContentRootElementLostFocus);
        ...
        private static ICollectionView CreateView(IEnumerable source)
        {
            ...
            if (collectionView == null)
            {
                ...
                collectionView = CollectionViewSource.GetDefaultView(source);
            }
