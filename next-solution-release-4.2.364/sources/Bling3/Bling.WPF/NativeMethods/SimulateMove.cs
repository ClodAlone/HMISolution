...
namespace NativeMethods {
  public static class SimulateMove {
    ...
    public static void DoMove(System.Windows.Forms.WebBrowser browser, int x, int y) {
      ...
      SendMessage(handle, moveCode, wParam, lParam); //move

      //IntPtr hcursor = GetCursor();
      //Console.WriteLine(hcursor);
