...
using Syncfusion.Diagram.WPF.Expression.Design;
using Syncfusion.Windows.Design;

// The ProvideMetadata assembly-level attribute indicates to designers
// that this assembly contains a class that provides an attribute table. 
#if !SyncfusionFramework3_5
[assembly: ProvideMetadata(typeof(Syncfusiom.Diagram.WPF.Expression.Design.Metadata))]
#endif
namespace Syncfusiom.Diagram.WPF.Expression.Design
{
    ...
    internal class Metadata : IProvideAttributeTable
    {
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                //builder.AddCustomAttributes(typeof(DiagramControl), new Microsoft.Windows.Design.Features.FeatureAttribute(typeof(Syncfusion.Diagram.WPF.VisualStudio.Design.DiagramControlInitializer)));
