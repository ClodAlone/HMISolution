...
[assembly: AssemblyTitle("Syncfusion.SfRadialMenu.WPF")]
[assembly: AssemblyProduct("Syncfusion.SfRadialMenu.WPF")]
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class SfRadialMenuBaseAssembly
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="SfRadialMenuBaseAssembly"/> class.
        /// </summary>
        static SfRadialMenuBaseAssembly()
        {
            Assembly = typeof(SfRadialMenuBaseAssembly).Assembly;
        ...
        {
            if (e.Name.StartsWith(SfRadialMenuBaseAssembly.Name))
            {
                return SfRadialMenuBaseAssembly.Assembly;
            }
    ...
    /// Assembly info class
    /// </summary>
    internal class AssemblyInfo : SfRadialMenuBaseAssembly
    {
    }
}
...
namespace Syncfusion.Licensing
{
    ...
    /// </summary>
    public class EnvironmentTestNavigation
    {
