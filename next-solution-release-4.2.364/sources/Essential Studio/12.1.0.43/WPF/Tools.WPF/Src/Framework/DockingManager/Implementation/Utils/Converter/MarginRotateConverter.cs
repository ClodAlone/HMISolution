// <copyright file="MarginRotateConverter.cs" company="Syncfusion">
...
{
    /// <summary>
    /// This class change thickness of the window when rotate.
    /// </summary>
    /// <exclude/>
#if SyncfusionFramework4_0
    [System.ComponentModel.DesignTimeVisible(false)]
#endif
    public class MarginRotateConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (Dock.Right == tabStrip || Dock.Left == tabStrip)
            {
                thickness = new Thickness(left, top, right, bottom);
            }
            else if (Dock.Top == tabStrip || Dock.Bottom == tabStrip)
            {
                thickness = new Thickness(top, right, bottom, left);
            }
