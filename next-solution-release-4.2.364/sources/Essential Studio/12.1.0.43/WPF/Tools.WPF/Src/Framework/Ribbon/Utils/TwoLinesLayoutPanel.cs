// <copyright file="TwoLinesLayoutPanel.cs" company="Syncfusion">
...
#endif
    public class TwoLinesLayoutPanel : Panel
    {
        /// <summary>
        /// Represents the two lines height
        /// </summary>
        public const int MIN_TWOLINES_HEIGHT = 32;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TwoLinesLayoutPanel"/> class.
        /// </summary>
        public TwoLinesLayoutPanel()
            : base()
        {
        }
        #endregion
        ...
        {
            Size childSize, desiredSize;
            UIElement child = InternalChildren[0];
            child.Measure(availableSize);
            desiredSize = child.DesiredSize;

            if (availableSize.Width > 0 && desiredSize.Height > MIN_TWOLINES_HEIGHT)
            {
                Width = availableSize.Width + STEP;
                childSize = new Size(availableSize.Width + STEP, availableSize.Height);
                Measure(childSize);
            }
        ...
        {
            InternalChildren[0].Arrange(new Rect(new Point(0, 0), this.DesiredSize));
            return finalSize;
        }
        #endregion
    }
