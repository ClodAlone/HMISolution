    ...
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            if (localizedManager == null)
            {
                ...
                //// ******************************* Change Namespace here ******************************
                ////
                this.resources = Syncfusion.Windows.Controls.PivotGrid.Resources.Syncfusion_PivotAnalysis_Wpf.ResourceManager;
                //Or
        ...
        private static System.Resources.ResourceManager GetLocalizedResourceManager(System.Reflection.Assembly controlAssembly)
        {
            if (Application.Current != null || Application.ResourceAssembly != null)
            {
                try
                {
                    ...
                    //System.Resources.ResourceManager manager = new System.Resources.ResourceManager(@"FieldListDemo.Syncfusion.PivotGrid.WPF", assembly);
                    ...
                    if (found || !CultureInfo.CurrentUICulture.Name.Equals("en-US"))
                    {
                     ...
                     else
                     {
                         ...
                         manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Controls.PivotGrid.Resources.{0}",
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            catch
            {
                ...
                //// ******************************* Change Namespace here ******************************
                ////
                value = Syncfusion.Windows.Controls.PivotGrid.Resources.Syncfusion_PivotAnalysis_Wpf.ResourceManager.GetString(name);
            }
            return value;
        }
