...
[assembly: ProvideMetadata(typeof(Syncfusion.ReportViewer.WPF.VisualStudio.Design.Metadata))]
#endif

namespace Syncfusion.ReportViewer.WPF.VisualStudio.Design
{
    using System;
    ...
    using Syncfusion.ReportViewer.WPF;
    ...
    internal class Metadata : IRegisterMetadata
    {
        public void Register()
        {
            AttributeTableBuilder builder = new AttributeTableBuilder();
            //// Tool box filtering
            builder.AddCustomAttributes(typeof(Syncfusion.Windows.Reports.Viewer.ReportViewer), new ToolboxBrowsableAttribute(true));
            builder.AddCustomAttributes(typeof(LoadingIndicator), new ToolboxBrowsableAttribute(false));     
