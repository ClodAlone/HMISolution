...
namespace Syncfusion.Windows.Grid.Olap.Converter
{
    ...
    public class GridExcelExport
    {
        ...
        /// <param name="layout">The layout.</param>
        /// <param name="ItemSource">if set to <c>true</c> [item source].</param>
        public GridExcelExport(PivotEngine drillResult, object styleInfo, GridLayout layout, bool ItemSource)
            : this(drillResult, styleInfo as ExportingGridStyleInfo, layout, ItemSource)
        {
        }
