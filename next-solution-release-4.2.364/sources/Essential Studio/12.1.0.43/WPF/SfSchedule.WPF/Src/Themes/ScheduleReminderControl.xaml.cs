...
namespace Syncfusion.UI.Xaml.Schedule
{
    ...
    public partial class ScheduleReminderControl
    {
        ...
        {
            var snoozeCollection = new ObservableCollection<Snooze>
             {
            ...
            Closing += ScheduleReminderControl_Closing;
        } 
        ...
        public static readonly DependencyProperty ReminderAppointmentCollectionProperty =
            DependencyProperty.Register("ReminderAppointmentCollection", typeof(ScheduleAppointmentCollection), typeof(ScheduleReminderControl), new PropertyMetadata(null, OnChanged));

        private static void OnChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is ScheduleReminderControl)
                (d as ScheduleReminderControl).Focus();
        }
        #endregion 
        ...
        private void ScheduleReminderControl_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            e.Cancel = true;
