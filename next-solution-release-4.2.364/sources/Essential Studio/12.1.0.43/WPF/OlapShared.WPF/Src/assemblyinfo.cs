...
[assembly: AssemblyTitle("Syncfusion.OlapShared.WPF")]
#if DEBUG
...
[assembly: XmlnsDefinition("http://schemas.syncfusion.com/wpf", "Syncfusion.Windows.Shared.Olap")]
...
{
    public class SharedWPFAssembly
    {
        ...
        static SharedWPFAssembly()
        {
            Assembly = typeof(SharedWPFAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else if (e.Name.StartsWith(SharedWPFAssembly.Name))
                return SharedWPFAssembly.Assembly;
    ...
    internal class AssemblyInfo : SharedWPFAssembly
    {
    }
}
