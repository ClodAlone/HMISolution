...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class LineSpacingToIsChecked : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (double.Parse(value.ToString(), culture.NumberFormat) == double.Parse(parameter.ToString(), culture.NumberFormat))
                return true;
            return false;
        }
    ...
    public class StringToBooleanMultiConverter : IMultiValueConverter
    {
