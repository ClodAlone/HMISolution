...
namespace Syncfusion.Windows.Automation.Peers
{
    ...
    public sealed class CalendarButtonAutomationPeer : ButtonAutomationPeer, IGridItemProvider, ISelectionItemProvider
    {
        ...
        public CalendarButtonAutomationPeer(Syncfusion.Windows.Controls.Primitives.CalendarButton owner)
            : base(owner)
        {
        }
        ...
        private Syncfusion.Windows.Controls.Primitives.CalendarButton OwningCalendarButton
        {
            get
            {
                return this.Owner as Syncfusion.Windows.Controls.Primitives.CalendarButton;
            }
        }
        ...
        protected override string GetNameCore()
        {
            ...
            if (date.HasValue)
            {
                if (this.OwningCalendar.DisplayMode == Syncfusion.Windows.Controls.CalendarMode.Decade)
                {
