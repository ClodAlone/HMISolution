...
namespace Syncfusion.Windows.Shared
{
    ...
    public class TileViewItemAnimationBase : HeaderedContentControl
    {
        ...
        internal TimeSpan PositionAnimationDuration
        {
            get
            {
                return (TimeSpan)GetValue(PositionAnimationDurationProp);
            }

            set
            {
                SetValue(PositionAnimationDurationProp, value);
            }
        }
        ...
        internal TimeSpan SizeAnimationDuration
        {
            get
            {
                // return this.animationTimeSpanSize;
                return (TimeSpan)GetValue(SizeAnimationDurationProp);
            }

            set
            {
                // this.animationTimeSpanSize = value;
                SetValue(SizeAnimationDurationProp, value);
            }
        }
        ...
        /// <summary>
        /// Identifies SizeAnimationDurationProp Dependency property
        /// </summary>
        ...
        /// <summary>
        /// Identifies PositionAnimationDurationProp Dependency property
        /// </summary>
        ...
        /// <summary>
        /// This is an Event, gets fired once the Animation Size is Completed
        /// </summary>
        ...
        /// <summary>
        /// This is an Event, gets fired once the Animation Position is Completed
        /// </summary>
        /// <param name="sender">objects as sender</param>
        /// <param name="e">event as eventargs</param>
