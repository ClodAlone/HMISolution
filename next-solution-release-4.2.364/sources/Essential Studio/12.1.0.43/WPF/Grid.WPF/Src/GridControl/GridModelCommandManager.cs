...
namespace Syncfusion.Windows.Controls.Grid
{
    ...
    /// </remarks>
    public sealed class GridModelCommandManager: NonFinalizeDisposable
    {
        #region GridModelBound
#if !SILVERLIGHT
        [NonSerialized]
#else
        ...
        public GridSelectionStateCommand CreateSelectionStateCommand()
        {
            ...
            if (!InTransaction  && !Model.CurrentCellState.IsEmpty)
            {
                ...
                selectionStateCommand = new GridSelectionStateCommand(Model, Model.CurrentCellState.RowIndex, Model.CurrentCellState.ColumnIndex, ranges);
        ...
        public bool ShouldGenerateUndoInfo
        {
            get
            {
                return enabled && model.ShouldRecordUndo && mode != GridCommandMode.Rollback && !SuspendUndo;
            }
        }
        ...
        public void Undo()
        {
            try
            {
                GridCurrentCell cc = Model.ActiveGridView.CurrentCell;
...
#endif
                    cc.Refresh();
                    RedoStack.Push(new GridCurrentCellValueCommand(Model, cc.RowIndex, cc.ColumnIndex, val));
                    return;
                }
