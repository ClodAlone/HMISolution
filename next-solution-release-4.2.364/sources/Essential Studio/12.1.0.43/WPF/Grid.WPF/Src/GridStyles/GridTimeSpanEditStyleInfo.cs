...
namespace Syncfusion.Windows.Controls.Grid
{
        ...
        public static GridTimeSpanEditStyleInfo Default
        {
            ...
            get
            {
                if (defaultTimeSpanEditInfo == null)
                {
                    ...
                    defaultTimeSpanEditInfo.AllowNull = (bool)TimeSpanEdit.AllowNullProperty.DefaultMetadata.DefaultValue;
                    defaultTimeSpanEditInfo.Format = (string)TimeSpanEdit.FormatProperty.DefaultMetadata.DefaultValue;
                    defaultTimeSpanEditInfo.IncrementOnScrolling  = (bool)TimeSpanEdit.IncrementOnScrollingProperty.DefaultMetadata.DefaultValue;
                    defaultTimeSpanEditInfo.MaxValue = (TimeSpan)TimeSpanEdit.MaxValueProperty.DefaultMetadata.DefaultValue;
                    defaultTimeSpanEditInfo.MinValue = (TimeSpan)TimeSpanEdit.MinValueProperty.DefaultMetadata.DefaultValue;
                    defaultTimeSpanEditInfo.NullString  = (string)TimeSpanEdit.NullStringProperty.DefaultMetadata.DefaultValue;
                    defaultTimeSpanEditInfo.ShowArrowButtons  = (bool)TimeSpanEdit.ShowArrowButtonsProperty.DefaultMetadata.DefaultValue;                    
                }
    ...
    public class GridTimeSpanEditStyleInfoStore : StyleInfoStore
    {
        ...
        /// <summary>
        /// Initializes a new <see cref="GridTimeSpanEditStyleInfoStore"/> from a serialization stream.
        /// </summary>
        /// <param name="info">An object that holds all the data needed to serialize or deserialize this instance.</param>
        /// <param name="context">Describes the source and destination of the serialized stream specified by info. </param>
        [System.Security.SecurityCritical()]
        protected GridTimeSpanEditStyleInfoStore(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
#endif
