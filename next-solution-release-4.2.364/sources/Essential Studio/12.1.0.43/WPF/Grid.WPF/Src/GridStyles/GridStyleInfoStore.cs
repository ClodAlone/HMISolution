...
namespace Syncfusion.Windows.Controls.Grid
{
    ...
    public class GridStyleInfoStore : StyleInfoStore, IDisposable
    {
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.IsThemed"/> property.
        /// </summary>
        public readonly static StyleInfoProperty IsThemedProperty = sd.CreateStyleInfoProperty(typeof(bool), "IsThemed", 1, true);
        ...
        /// </summary>
        public readonly static StyleInfoProperty ItemsSourceProperty = sd.CreateStyleInfoProperty(typeof(object), "ItemsSource", StyleInfoPropertyOptions.Serializable);

        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.AutoPopulateDropDownColumns"/> property.
        /// </summary>
        public readonly static StyleInfoProperty AutoPopulateDropDownColumnsProperty = sd.CreateStyleInfoProperty(typeof(bool), "AutoPopulateDropDownColumns");

        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.DropDownColumnSizer"/> property.
        /// </summary>
        public readonly static StyleInfoProperty DropDownColumnSizerProperty = sd.CreateStyleInfoProperty(typeof(GridControlLengthUnitType), "DropDownColumnSizer");
        /// <summary>
        /// Provides information about the <see cref="GridSyleInfo.DropDownVisibleColumns"/> Property.
        /// </summary>
        public readonly static StyleInfoProperty DropDownVisibleColumnsProperty = sd.CreateStyleInfoProperty(typeof(GridListColumnsCollection), "DropDownVisibleColumns");
        /// <summary>
        /// provides information about the <see cref=" cref="GridStyleInfo.ChildRelationalColumn"/>
        /// </summary>
        public readonly static StyleInfoProperty ChildRelationalColumnProperty = sd.CreateStyleInfoProperty(typeof(string), "ChildRelationalColumn");


        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.CellValue2"/> property.
        /// </summary>
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.IsThreeState"/> property.
        /// </summary>
        public readonly static StyleInfoProperty IsThreeStateProperty = sd.CreateStyleInfoProperty(typeof(bool), "IsThreeState",1, true);
        /// <summary>
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.SelectionBrush"/> property.
        /// </summary>
        public readonly static StyleInfoProperty SelectionBrushProperty = sd.CreateStyleInfoProperty(typeof(Brush), "SelectionBrush");

        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.CaretBrush"/> property.
        /// </summary>
        public readonly static StyleInfoProperty CaretBrushProperty = sd.CreateStyleInfoProperty(typeof(Brush), "CaretBrush");

        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.SelectionOpacity"/> property.
        /// </summary>
        public readonly static StyleInfoProperty SelectionOpacityProperty = sd.CreateStyleInfoProperty(typeof(double), "SelectionOpacity");
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.ShowDropDownHeaders"/> property.
        /// </summary>
        public readonly static StyleInfoProperty ShowDropDownHeadersProperty = sd.CreateStyleInfoProperty(typeof(bool), "ShowDropDownHeaders", 1, true);
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.IsMouseTrackingEnabled"/> property.
        /// </summary>
        public readonly static StyleInfoProperty IsMouseTrackingEnabledProperty = sd.CreateStyleInfoProperty(typeof(bool), "IsMouseTrackingEnabled", 1, true);
        /// <summary>
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.DropdownEdit"/> property.
        /// </summary>
        public readonly static StyleInfoProperty DropdownEditStyleInfoProperty = sd.CreateStyleInfoProperty(typeof(GridDropdownEditStyleInfo), "DropdownEdit");
        ...
        public readonly static StyleInfoProperty IntegerEditStyleInfoProperty = sd.CreateStyleInfoProperty(typeof(GridIntegerEditStyleInfo), "IntegerEdit");
        ...
        public readonly static StyleInfoProperty TooltipTemplateProperty = sd.CreateStyleInfoProperty(typeof(DataTemplate), "TooltipTemplate");
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.CommentBrush"/> property.
        /// </summary>
        public readonly static StyleInfoProperty CommentBrushProperty = sd.CreateStyleInfoProperty(typeof(Brush), "CommentBrush");
        /// <summary>
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.ShowTooltip"/> property.
        /// </summary>
        public readonly static StyleInfoProperty ShowTooltipProperty = sd.CreateStyleInfoProperty(typeof(bool), "ShowTooltip");
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.IncrementalUpdate"/> property.
        /// </summary>
        public static readonly StyleInfoProperty IncrementalFilterProperty = sd.CreateStyleInfoProperty(typeof(IncrementalFilter), "IncrementalFilter");
        ...
        /// <summary>
        /// Provides information about the <see cref="GridStyleInfo.ErrorAlertText"/> property.
        /// </summary>
        public static readonly StyleInfoProperty ErrorAlertTextProperty = sd.CreateStyleInfoProperty(typeof(string), "ErrorAlertText");
        ...
        public static readonly StyleInfoProperty ContextMenuItemsProperty = sd.CreateStyleInfoProperty(typeof(IEnumerable), "ContextMenuItems");
        public static readonly StyleInfoProperty ContextMenuItemSourceProperty = sd.CreateStyleInfoProperty(typeof(IEnumerable), "ContextMenuItemSource");
        public static readonly StyleInfoProperty ContextMenuTemplateProperty = sd.CreateStyleInfoProperty(typeof(DataTemplate), "ContextMenuTemplate");
        /// <override/>
        ...
        static GridStyleInfoStore()
        {
            ...
            PaddingProperty.CreateObject = new CreateSubObjectHandler(CellMarginsInfo.CreateObject);
            ...
            MaskEditInfoProperty.CreateObject = new CreateSubObjectHandler(GridMaskEditInfo.CreateObject);
            ...
            TimeSpanEditStyleInfoProperty.CreateObject = new CreateSubObjectHandler(GridTimeSpanEditStyleInfo.CreateObject);
            CurrencyEditStyleInfoProperty.CreateObject = new CreateSubObjectHandler(GridCurrencyEditStyleInfo.CreateObject);
            DropdownEditStyleInfoProperty.CreateObject = new CreateSubObjectHandler(GridDropdownEditStyleInfo.CreateObject);
            ...
            CellItemTemplateProperty.SerializeXmlBehavior = SerializeXmlBehavior.Skip;
            CellEditTemplateProperty.SerializeXmlBehavior = SerializeXmlBehavior.Skip;
            ImageListProperty.SerializeXmlBehavior = SerializeXmlBehavior.SerializeAsString;
            //ToolTipProperty.SerializeXmlBehavior = SerializeXmlBehavior.Skip;
        }
        ...
        {
            this.Clear();
            BorderMarginsProperty.CreateObject = null;
            PaddingProperty.CreateObject = null;
            TextMarginsProperty.CreateObject = null;
            BordersProperty.CreateObject = null;
            FontProperty.CreateObject = null;
            MaskEditInfoProperty.CreateObject = null;
            UpDownEditInfoProperty.CreateObject = null;
            DateTimeEditStyleInfoProperty.CreateObject = null;
            TimeSpanEditStyleInfoProperty.CreateObject = null;
            CurrencyEditStyleInfoProperty.CreateObject = null;
            DropdownEditStyleInfoProperty.CreateObject = null;
            ErrorInfoProperty.CreateObject = null;
        }
    }
