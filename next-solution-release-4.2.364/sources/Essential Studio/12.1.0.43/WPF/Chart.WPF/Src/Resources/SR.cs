...
namespace Syncfusion.Windows.Chart
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Windows.Chart.Resources.Syncfusion_Chart_WPF.ResourceManager;
                //Or
                ...
                //this.resources = new ResourceManager("Syncfusion.Windows.Chart.SyncfusionChartWPFResources", typeof(Syncfusion.Windows.Chart.SyncfusionChartWPFResources).Assembly);
            }
            else
            {
            ...
            if (Application.Current != null)
            {
                try
                {
                    ...
                    if (found || !CultureInfo.CurrentUICulture.Name.Equals("en-US"))
                    {
                     ...
                     {
                        manager = new System.Resources.ResourceManager(string.Format("Syncfusion.Windows.Chart.Resources.{0}",
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Windows.Chart.Resources.Syncfusion_Chart_WPF.ResourceManager.GetString(name);
            }
            return value;
        }
