...
namespace Syncfusion.Tools.WPF.VisualStudio.Design
{
    ...
    /// </summary>
    internal class AutoCompleteInitializer : DefaultInitializer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutoCompleteInitializer"/> class.
        /// </summary>
        public AutoCompleteInitializer()
        {
        }
        ...
        public override void InitializeDefaults( ModelItem item )
        {
            ...
            {
                item.Properties["Height"].SetValue(35d);
