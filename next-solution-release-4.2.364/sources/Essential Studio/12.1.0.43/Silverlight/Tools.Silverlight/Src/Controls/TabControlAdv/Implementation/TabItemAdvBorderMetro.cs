...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class TabItemAdvBorderMetro:TabItemAdvBorder 
    {
        ...
        private PathGeometry GetSelectedOutterLineGeometry(Size borderSize)
        {
            ...
            selectedOutterLineFigure.StartPoint = new Point(1, borderSize.Height);

            LineSegment line = new LineSegment();
            line.Point = new Point(1, borderSize.Height);
            selectedOutterLineFigure.Segments.Add(line);

            line = new LineSegment();
            line.Point = new Point(1, 0);
            selectedOutterLineFigure.Segments.Add(line);
        ...
        private PathGeometry GetHoverInnerLineGeometry(Size borderSize)
        {
            ...
            hoverInnerLineFigure.StartPoint = new Point(1, borderSize.Height);
