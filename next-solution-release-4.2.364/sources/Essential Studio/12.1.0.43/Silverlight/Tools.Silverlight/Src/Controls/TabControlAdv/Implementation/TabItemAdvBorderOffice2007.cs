...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class TabItemAdvBorderOffice2007 : TabItemAdvBorder
    {
        ...
        /// </summary>
        public TabItemAdvBorderOffice2007()
        {
        ...
        private PathGeometry GetHoverInnerLineGeometry(Size borderSize)
        {
            ...
            arc = new ArcSegment();
            arc.Point = new Point(borderSize.Width - 4, 5);
            arc.Size = new Size(4, 4);
            arc.SweepDirection = SweepDirection.Clockwise;
            arc.IsLargeArc = false;
            arc.RotationAngle = 0;
