...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    public class TabItemAdvBorderBlend : TabItemAdvBorder
    {
        ...
        /// <summary>
        /// Initializes new instance of the TabItemAdvBorderBlend class.
        /// </summary>
        public TabItemAdvBorderBlend()
        {
            DefaultStyleKey = typeof(TabItemAdvBorderBlend);
        }
        #endregion
        ...
        private PathGeometry GetBorderGeometry(Size borderSize)
        {
            ...
            ArcSegment arc;
            LineSegment line;
            borderFigure.StartPoint = new Point(0.5, borderSize.Height - 5);

            line = new LineSegment();
            line.Point = new Point(0.5, 2);
            borderFigure.Segments.Add(line);

            arc = new ArcSegment();
            arc.Point = new Point(2, 0.5);
            arc.Size = new Size(2, 2);
            ...
            line = new LineSegment();
            line.Point = new Point(borderSize.Width, borderSize.Height - 5);
            borderFigure.Segments.Add(line);
