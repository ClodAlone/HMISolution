...
namespace Syncfusion.Windows.Tools.Controls
{
    ...
    /// 
    /// </summary>
    public class SplitMenuButton : HeaderedItemsControl
    {
        #region Constructor
        ...
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty.Register("Command", typeof(ICommand), typeof(SplitMenuButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CommandParameterProperty =
            DependencyProperty.Register("CommandParameter", typeof(Object), typeof(SplitMenuButton), new PropertyMetadata(null));
        ...
        protected override void OnItemsChanged(System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case System.Collections.Specialized.NotifyCollectionChangedAction.Add:
                    ...
                    var appitm = e.NewItems[0] as SimpleMenuButton;
        ...
        {
            var senderItem = (SplitMenuButton)sender;
        ...
        private void HideMouseOverMenuButtonItems(SplitMenuButton parentObj)
        {
            if (parentObj.Items.Count > 0)
            {
                ...
                {
                    if (item.GetType().Name == "SimpleMenuButton")
                    {
                        var menuItem = item as SimpleMenuButton;
                        if (menuItem != null)
                            if (menuItem.IsMouseOver)
        ...
        void ApplicationSplitButton_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                var parentItem = ((SplitMenuButton)this).Parent;
        ...
        public static readonly DependencyProperty IconSizeProperty =
            DependencyProperty.Register("IconSize", typeof(Size), typeof(SplitMenuButton), new PropertyMetadata(new Size(20d, 20d)));
        ...
        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(ImageSource), typeof(SplitMenuButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty IsMouseOverProperty =
            DependencyProperty.Register("IsMouseOver", typeof(bool), typeof(SplitMenuButton), new PropertyMetadata(false, OnMouseOverChanged));
        ...
        public static readonly DependencyProperty ScrollerHeightProperty =
            DependencyProperty.Register("ScrollerHeight", typeof(double), typeof(SplitMenuButton), new PropertyMetadata(0d));
