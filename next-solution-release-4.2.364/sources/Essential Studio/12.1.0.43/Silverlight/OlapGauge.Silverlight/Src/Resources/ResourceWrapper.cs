...
namespace Syncfusion.Silverlight.Olap.Gauge.Resources
{
    ...
    public sealed class ResourceWrapper
    {
        ...
        const string TOOLTIP_VALUE = "OlapGauge_ToolTip_Value";
        const string TOOLTIP_GOAL = "OlapGauge_ToolTip_Goal";
        ...
        public ResourceWrapper()
        {
            ...
            toolTipGoal = SR.GetString(culture, TOOLTIP_GOAL);
            toolTipGoal = SR.GetString(culture, TOOLTIP_VALUE);
        }
