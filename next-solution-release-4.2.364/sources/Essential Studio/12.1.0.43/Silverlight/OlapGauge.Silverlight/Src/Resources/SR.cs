...
namespace Syncfusion.Silverlight.Olap.Gauge.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Silverlight.Olap.Gauge.Resources.Syncfusion_OlapGauge_Silverlight.ResourceManager;
            }
            else
            {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Silverlight.Olap.Gauge.Resources.Syncfusion_OlapGauge_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
