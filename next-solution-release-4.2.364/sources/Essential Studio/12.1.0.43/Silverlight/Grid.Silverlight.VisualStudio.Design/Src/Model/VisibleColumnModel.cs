...
namespace Syncfusion.Grid.WPF.VisualStudio.Design
{
    public class VisibleColumnModel : INotifyPropertyChanged
    {
        ...
        public bool GenerateStyle
        {
            ...
            set
            {
                ...
                if (value == true)
                {
                    ...
                    //     ="{x:Null}" CacheValues="False" DataContext="{x:Null}" FormattedText="" Identity="{x:Null}" 
                    ...
                    //     //="{x:Null}" ="False" ="{x:Null}" ="{x:Null}" ="" ="{x:Null}" 

                    //     //colStyle.Properties["CellIdentityData"].ClearValue();
                    ////     colStyle.Properties["CommentAlignment"].ClearValue();
                    //     colStyle.Properties["ImageIndex"].ClearValue();


                    colStyle.Properties["Binding"].ClearValue();
                    colStyle.Properties["CacheValues"].ClearValue();
                    colStyle.Properties["DataContext"].ClearValue();
                    colStyle.Properties["FormattedText"].ClearValue();
                    colStyle.Properties["CellIdentity"].ClearValue();
                    colStyle.Properties["Identity"].ClearValue();
                    colStyle.Properties["CommentAlignment"].ClearValue();
                    colStyle.Properties["CellTypeEnum"].ClearValue();
                    SetCellType(colStyle);
                    this.ColumnStyleModel = new ColumnStyleModel(colStyle,this.SpecialCellType,this.Type);
        ...
        public void SetCellType(ModelItem ColStyle)
        {
            ColStyle.Properties["CellType"].SetValue("TextBox");
        }

        //public VisibleColumnModel(ModelItem VisibleColumn)
