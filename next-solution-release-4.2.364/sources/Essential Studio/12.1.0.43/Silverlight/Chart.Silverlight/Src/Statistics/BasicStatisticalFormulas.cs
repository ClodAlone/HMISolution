...
namespace Syncfusion.Windows.Chart
{
    ...
    /// <summary>
    /// Class implementation for BasicStatisticalFormulas
    /// </summary>
    ...
    {       
        ...
        public static AnovaResult Anova(double probability, ChartSeries[] inputSeries)
        {
            ...
            ChartPointsCollection withinGroupVariance = new ChartPointsCollection();
            for (int i = 0; i < a; i++)
            ...
            ChartPointsCollection amongGroupVariance = new ChartPointsCollection();
            for (int i = 0; i < a; i++)
        ...
        private static ChartSeries DifferenceY(ChartSeries series1, ChartSeries series2, int yIndex)
        {
            ...
            cs.DataSource = data;
            cs.BindingPathX = "X";
            cs.BindingPathsY = new List<string> { "Y" };
            return cs;
        }
        #endregion
    }
