...
namespace Syncfusion.Windows.Chart
{
    ...
    /// <summary>
    /// Represents Bar chart type segment.
    /// </summary>
    /// <remarks>Class instance is created automaticaly by Silverlight Chart building system.</remarks>
    public class BarSegment : Segment
    {
        #region Dependency properties

        internal static readonly DependencyProperty LayerBrushProperty =
    DependencyProperty.Register("LayerBrush", typeof(Brush), typeof(BarSegment), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty HeightProperty =
            DependencyProperty.Register("Height", typeof(double), typeof(BarSegment), new PropertyMetadata(0d));
        ...
        public static readonly DependencyProperty TemplateProperty =
            DependencyProperty.Register("Template", typeof(DataTemplate), typeof(BarSegment), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the Width depency property.
        /// </summary>
        public static readonly DependencyProperty WidthProperty =
            DependencyProperty.Register("Width", typeof(double), typeof(BarSegment), new PropertyMetadata(0d));

        /// <summary>
        /// Identifies the X depency property.
        /// </summary>
        public static readonly DependencyProperty XProperty =
          DependencyProperty.Register("X", typeof(double), typeof(BarSegment), new PropertyMetadata(0d));

        /// <summary>
        /// Identifies the Y depency property.
        /// </summary>
        public static readonly DependencyProperty YProperty =
          DependencyProperty.Register("Y", typeof(double), typeof(BarSegment), new PropertyMetadata(0d));
        ...
        public static readonly DependencyProperty XWidthProperty =
            DependencyProperty.Register("XWidth", typeof(double), typeof(BarSegment), new PropertyMetadata(0d));
        ...
        internal BarSegment(ChartPoint bottomLeftPnt, ChartPoint topRightPnt, ChartPoint correspondingPoint, ChartSeries series)
        ...
        public override void Update(IChartTransformer transformer)
        {
            ...
            Point blPoint = transformer.TransformToVisible(m_bottomLeftPoint.X + (series.YAxis.VisibleRange.Start * (-1)), m_bottomLeftPoint.Y+(series.XAxis.VisibleRange.Start * (-1)), series);
            Point trPoint = transformer.TransformToVisible(m_topRightPoint.X - (series.YAxis.VisibleRange.Start), m_topRightPoint.Y + (series.XAxis.VisibleRange.Start * (-1)), series);
    ...
    /// <summary>
    /// Represents Bar chart type.
    /// </summary>
    /// <remarks>Class instance is created automaticaly by Silverlight Chart building system.</remarks>
    public class ChartBarType : ChartType
    {
        #region Implementation
        /// <summary>
            ...
            if (series.Area != null)
            {
                ...
                for (int i = 0; i < points.Count; i++)
                {
                    ...
                    else if (series.ShowEmptyPoints)
                    {
                        ...
                        {
                            double x1 = points[i].Y ;
                            double y1 = points[i].X ;
                            double x2 = 0;
                            double y2 = 0;
                            
                            ChartPoint cdpBottomLeft = new ChartPoint(x1, y1);
                            ChartPoint cdpRightTop = new ChartPoint(x2, y2);
                            //if (x1 >= -1 && x1 <= (series.XAxis.VisibleRange.End - series.XAxis.VisibleRange.Start) + 1)
                            //{
