...
namespace Syncfusion.Windows.Controls.Grid.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Windows.Controls.Grid.Resources.Syncfusion_Grid_Silverlight.ResourceManager;
                //Or
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Windows.Controls.Grid.Resources.Syncfusion_Grid_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
