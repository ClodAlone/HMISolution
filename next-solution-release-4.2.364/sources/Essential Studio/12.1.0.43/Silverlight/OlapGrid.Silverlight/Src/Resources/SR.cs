...
namespace Syncfusion.Silverlight.Grid.Olap.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Silverlight.Grid.Olap.Resources.Syncfusion_OlapGrid_Silverlight.ResourceManager;
            }
            else
            {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Silverlight.Grid.Olap.Resources.Syncfusion_OlapGrid_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
