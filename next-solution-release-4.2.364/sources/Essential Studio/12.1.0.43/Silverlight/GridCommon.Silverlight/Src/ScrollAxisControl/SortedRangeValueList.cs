...
#endif
{
    ...
    public class RangeValuePair<T> : IComparable
    {
        ...
        public int CompareTo(object obj)
        {
            ...
            RangeValuePair<T> y = (RangeValuePair<T>)obj;
    ...
    public class SortedRangeValueList<T> : IEnumerable<RangeValuePair<T>>
    {
        ...
        public void Insert(int insertAt, int count, T value, SortedRangeValueList<T> moveRanges)
        {
            ...
            else
            {
                ...
                else
                {
                    n = Split(insertAt, n);
                    Split(insertAt + 1);
                    RangeValuePair<T> rv2 = new RangeValuePair<T>(insertAt, count, value);
        ...
        public void SetRange(int index, int count, T value)
        {
            ...
            RangeValuePair<T> rv = new RangeValuePair<T>(index, count, value);
        ...
        int Split(int index, int n)
        {
            ...
            RangeValuePair<T> rv2 = new RangeValuePair<T>(index, count2, rv.Value);
