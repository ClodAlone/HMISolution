...
#endif
{
    ...
    public class PixelScrollAxis : ScrollAxisBase
    {
        ...
        public override DoubleSpan[] RangeToRegionPoints(int first, int last, bool allowEstimatesForOutOfViewLines)
        {
            ...
            p2 = last >= Distances.Count - 1 ? Distances.TotalDistance - GetPaddingDistance() : Distances.GetCumulatedDistanceAt(last + 1);
        ...
        private double GetPaddingDistance()
        {
            var paddingDistance = (Distances is IDistancePadding) ? ((IDistancePadding)Distances).PaddingDistance : 0d;
