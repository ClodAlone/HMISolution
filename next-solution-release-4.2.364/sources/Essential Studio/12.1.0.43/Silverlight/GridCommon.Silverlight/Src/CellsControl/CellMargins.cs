...
#endif
{
...
#endif
	public class CellMarginsInfoStore: StyleInfoStore
	{
    ...
    [ClassReference(IsReviewed = false)]
#endif
    public class CellMarginsInfo : StyleInfoSubObjectBase
	{
		// Static Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CellMarginsInfo"/> class.
        /// </summary>
        /// <param name="thickness">The thickness.</param>
        public CellMarginsInfo(double thickness)
            : base(new CellMarginsInfoStore())
        {
            this.Left = thickness;
