//------------------------------------------------------------------------------
// <copyright file="BitVectorInt32.cs" company="Microsoft">
...
#endif
{
    ...
    public struct BitVectorInt32 {
        ...
        public int this[Section section] {
            get {
                return (int)((data & (Int32)(section.Mask << section.Offset)) >> section.Offset);
            }
            set {
#if DEBUG
                if ((value & section.Mask) != value) {
                    throw new Exception("Value out of bounds on BitVectorInt32 Section Set!");
                }
#endif
                value <<= section.Offset;
                int offsetMask = (0xFFFF & (int)section.Mask) << section.Offset;
                data = (data & ~(Int32)offsetMask) | ((Int32)value & (Int32)offsetMask);
            }
        }
        ...
        private static Section CreateSectionHelper(short maxValue, short priorMask, short priorOffset) {
            ...
            Debug.Assert(maskCheck <= short.MaxValue && offsetCheck < 32, "Overflow on BitVectorInt32");
#endif
        ...
        public override bool Equals(object o) {
            if (!(o is BitVectorInt32)) {
                return false;
            }
            
            return data == ((BitVectorInt32)o).data;
        }
        ...
        public static string ToString(BitVectorInt32 value) {
            StringBuilder sb = new StringBuilder(/*"BitVectorInt32{".Length*/12 + /*32 bits*/32 + /*"}".Length"*/1);
            sb.Append("BitVectorInt32{");
        ...
        public override string ToString() {
            return BitVectorInt32.ToString(this);
        }
