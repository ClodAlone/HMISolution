...
namespace Syncfusion.Windows.Tools.Controls
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            if (localizedManager == null)
            {
                this.resources = Syncfusion.Windows.Tools.Controls.Resources.Syncfusion_DockingManager_Silverlight.ResourceManager;
            }
            else
            {
            ...
            if (Application.Current != null)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        manager = new System.Resources.ResourceManager(string.Format("{0}",
                            controlAssembly.FullName.Split(new char[] { ',' })[0]), assembly);
                    }
        ...
        // Methods
        private static SR GetLoader(bool flag)
        {
            lock (typeof(SR))
            {
                if (SR.loader == null || flag)
                    SR.loader = new SR();
                return SR.loader;
            }
        }
        ...
        public static string GetString(CultureInfo culture, string name, bool flag)
        {
            SR sr = SR.GetLoader(flag);
            if (sr == null)
                return null;
            string value = "";
            try
            ...
            {
                value = Syncfusion.Windows.Tools.Controls.Resources.Syncfusion_DockingManager_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
