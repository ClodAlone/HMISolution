...
using Syncfusion.DockingManager.Silverlight.Expression.Design.Infrastructure;
using Microsoft.Windows.Design;

namespace Syncfusion.DockingManager.Silverlight.Expression.Design
{
    internal class DockManagerInitializer : DefaultInitializer
    {
        public DockManagerInitializer()
            : base() 
        {
        }
