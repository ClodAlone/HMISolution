...
namespace Syncfusion.Shared.Silverlight.VisualStudio.Design
{
    ...
    #region IRegisterMetadata Members
        ...
        public void Register()
        {
            ...
            builder.AddCustomAttributes(typeof(ColorPickerPalette), new ToolboxBrowsableAttribute(true));
            ...
            builder.AddCallback(typeof(TileViewItem), AttributeCallbackBuilder => AttributeCallbackBuilder.AddCustomAttributes("Header", new CategoryAttribute("Custom"), new TypeConverterAttribute(typeof(StringConverter))));
...
#else
using Syncfusion.Tools.Silverlight.VisualStudio.Design;
...
namespace Syncfusion.Shared.Silverlight.VisualStudio.Design
{
    ...
    internal class Metadata : IProvideAttributeTable
    {
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                SharedControlsAttributesTableBuilder builder = new SharedControlsAttributesTableBuilder();
                ...
                builder.AddCallback(typeof(IntegerTextBox),b=>b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                builder.AddCallback(typeof(DoubleTextBox), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                builder.AddCallback(typeof(CurrencyTextBox), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                builder.AddCallback(typeof(PercentTextBox), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                builder.AddCallback(typeof(MaskedTextBox), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                builder.AddCallback(typeof(DateTimeEdit), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                ...
                builder.AddCallback(typeof(MenuAdv), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                ...
                builder.AddCallback(typeof(BrushEdit),b=>b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
                builder.AddCallback(typeof(BrushSelector),b=>b.AddCustomAttributes(new ToolboxBrowsableAttribute(true)));
