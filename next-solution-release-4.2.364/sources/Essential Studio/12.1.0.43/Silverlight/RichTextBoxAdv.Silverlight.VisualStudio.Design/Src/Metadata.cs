...
using Syncfusion.RichTextBoxAdv.Silverlight.VisualStudio.Design;

[assembly: ProvideMetadata(typeof(Syncfusion.RichTextBoxAdv.Silverlight.VisualStudio.Design.Metadata))]
namespace Syncfusion.RichTextBoxAdv.Silverlight.VisualStudio.Design
{
    internal class Metadata : IProvideAttributeTable
    {
        AttributeTable IProvideAttributeTable.AttributeTable
        {
            get
            {
                RichTextBoxAdvAttributeTableBuilder tablebuilder = new RichTextBoxAdvAttributeTableBuilder();
