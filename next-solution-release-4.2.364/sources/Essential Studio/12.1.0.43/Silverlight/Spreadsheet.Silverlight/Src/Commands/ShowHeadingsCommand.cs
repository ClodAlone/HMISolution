...
{
    public class RowColumnHeadersVisiblityCommand:CommandBase
    {
        public RowColumnHeadersVisiblityCommand(SpreadsheetControl excelEditorControl) : base(excelEditorControl)
        {
        }
        ...
        {
            AssociatedSpreadsheet.GridProperties.IsRowColumnHeadersVisible = !AssociatedSpreadsheet.GridProperties.IsRowColumnHeadersVisible;
