...
namespace Syncfusion.Windows.Controls.Spreadsheet.Commands
{
    ...
    {
        public HyperlinkCommand(SpreadsheetControl excelEditorControl)
        ...
        protected override void ExecuteCommand(object parameter)
        {
            if (this.AssociatedSpreadsheet.GridProperties.CurrentCell != null && this.AssociatedSpreadsheet.ExcelProperties.WorkBook != null && this.AssociatedSpreadsheet.ExcelProperties.WorkBook.Worksheets.Count > 0)
            {
                ...
                HyperlinkWindow window = new HyperlinkWindow
                {
            ...
            {
#if !SILVERLIGHT
                MessageBox.Show(SpreadsheetResourceWrapper.ValidationMessage_SelectCellToInsertHyperlink, SpreadsheetResourceWrapper.ValidationMessage_Error);
#else
                MessageBox.Show(SpreadsheetResourceWrapper.ValidationMessage_SelectCellToInsertHyperlink, SpreadsheetResourceWrapper.ValidationMessage_Error, MessageBoxButton.OK);
#endif
