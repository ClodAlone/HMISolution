...
namespace Syncfusion.Windows.Controls.Spreadsheet.Commands
{
    ...
    {
        public RowHeightCommand(SpreadsheetControl excelEditorControl) : base(excelEditorControl)
        {
        }
