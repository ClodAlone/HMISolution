...
namespace Syncfusion.Silverlight.Controls.PivotGrid.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Silverlight.Controls.PivotGrid.Resources.Syncfusion_PivotAnalysis_Silverlight.ResourceManager;
            }
            else
            {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Silverlight.Controls.PivotGrid.Resources.Syncfusion_PivotAnalysis_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
