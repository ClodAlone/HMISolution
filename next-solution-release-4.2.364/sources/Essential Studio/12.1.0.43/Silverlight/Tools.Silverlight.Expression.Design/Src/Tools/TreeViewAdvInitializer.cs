...
namespace Syncfusion.Tools.Silverlight.Expression.Design
{
    internal class TreeViewAdvInitializer : DefaultInitializer
    {
        ...
        public override void InitializeDefaults(ModelItem item, EditingContext context) 
        {
            ...
            TreeViewItemAdv treeviewitem2 = new TreeViewItemAdv();
            item.Properties["Items"].Collection.Add(treeviewitem2);
            TreeViewItemAdv treeviewitem3 = new TreeViewItemAdv();
            TreeViewItemAdv treeviewitem4 = new TreeViewItemAdv();
            treeviewitem3.Items.Add(treeviewitem4);
            item.Properties["Items"].Collection.Add(treeviewitem3);            
            item.Properties["Items"].Collection.Add(treeviewitem4);
