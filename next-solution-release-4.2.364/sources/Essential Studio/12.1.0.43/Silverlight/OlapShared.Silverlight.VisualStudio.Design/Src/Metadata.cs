...
[assembly: ProvideMetadata(typeof(Syncfusion.OlapShared.Silverlight.VisualStudio.Design.Metadata))]
#endif
namespace Syncfusion.OlapShared.Silverlight.VisualStudio.Design
{
#if SyncfusionFramework4_0 || SyncfusionSLFramework3_5
    ...
    #region IProvideAttributeTable Members
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                builder.AddCustomAttributes(typeof(OlapPagedCollectionView), new ToolboxBrowsableAttribute(false));
                builder.AddCustomAttributes(typeof(Syncfusion.Silverlight.Shared.Olap.DisplayMode), new ToolboxBrowsableAttribute(false));
                builder.AddCustomAttributes(typeof(PageSetupWindow), new ToolboxBrowsableAttribute(false));
