...
namespace Syncfusion.Windows.Shared.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            if (localizedManager == null)
            {
                this.resources = Syncfusion.Windows.Shared.Resources.Syncfusion_Shared_Silverlight.ResourceManager;
                //Or
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Windows.Shared.Resources.Syncfusion_Shared_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
        ...
        public static object GetObject(CultureInfo culture, string name)
        {
            ...
            if (sr == null)
                return null;
            object value = null;
            value = sr.resources.GetObject(name, culture);
