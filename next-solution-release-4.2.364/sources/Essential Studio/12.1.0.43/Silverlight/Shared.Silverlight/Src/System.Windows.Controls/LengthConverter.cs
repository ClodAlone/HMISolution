        ...
        public override object ConvertFrom(ITypeDescriptorContext typeDescriptorContext, CultureInfo cultureInfo, object source)
        {
            if (source == null)
            {
                string message = string.Format(
                    ...
                    Syncfusion.Windows.Controls.Properties.Resources.TypeConverters_ConvertFrom_CannotConvertFromType,
                    GetType().Name,
                    "null");
            ...
            if (text != null)
            {
                ...
                catch (FormatException)
                {
                    string message = string.Format(
                        CultureInfo.CurrentCulture,
                        Syncfusion.Windows.Controls.Properties.Resources.TypeConverters_Convert_CannotConvert,
                        GetType().Name,
                        text,
                        typeof(double).Name);
