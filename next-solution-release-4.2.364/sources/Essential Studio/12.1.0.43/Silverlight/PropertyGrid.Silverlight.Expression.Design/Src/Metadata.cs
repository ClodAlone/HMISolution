...
[assembly: ProvideMetadata(typeof(Syncfusion.PropertyGrid.Silverlight.Expression.Design.RegisterToolstControlsMetadata))]
namespace Syncfusion.PropertyGrid.Silverlight.Expression.Design
{
    internal class RegisterToolstControlsMetadata : IProvideAttributeTable 
    {
        public AttributeTable AttributeTable
        {
            get
            {
                PropertyGridAttributeTableBuilder builder = new PropertyGridAttributeTableBuilder();
