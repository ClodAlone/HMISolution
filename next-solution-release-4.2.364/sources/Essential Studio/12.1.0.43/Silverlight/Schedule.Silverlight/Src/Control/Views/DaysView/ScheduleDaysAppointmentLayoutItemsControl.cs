...
namespace Syncfusion.Windows.Controls.Schedule
{
    ...
    /// <summary>
    /// Represents schedule's DaysAppointmentLayout ItemsControl 
    /// </summary>
...
#endif
    public class ScheduleDaysAppointmentLayoutItemsControl : ItemsControl, IScheduleCalendarViewModelHost
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleDaysAppointmentLayoutItemsControl"/> class.
        /// </summary>
        public ScheduleDaysAppointmentLayoutItemsControl()
        {
            this.DefaultStyleKey = typeof(ScheduleDaysAppointmentLayoutItemsControl);
        ...
        {
            var item = new ScheduleDaysAppointmentViewControl();
            ...
            BindingOperations.SetBinding(item, ScheduleDaysAppointmentViewControl.BackgroundProperty, BackgroundColorBinding);
          

            Binding BorderBrushBinding = new Binding() { Path = new PropertyPath("StrokeLine"), Source = this.model };
            BindingOperations.SetBinding(item, ScheduleDaysAppointmentViewControl.BorderBrushProperty, BorderBrushBinding);
        ...
        ///  Gets / Sets the AppointmentStyle property.
        /// </summary>
        public static readonly DependencyProperty AppointmentStyleProperty = DependencyProperty.Register("AppointmentStyle", typeof(Style), typeof(ScheduleDaysAppointmentLayoutItemsControl), new PropertyMetadata(null));
        ...
        /// </summary>
        public DataTemplate AppointmentToolTip
        {
            get { return (DataTemplate)GetValue(AppointmentToolTipProperty); }
            set { SetValue(AppointmentToolTipProperty, value); }
        }
        /// <summary>
        ///  Using a DependencyProperty as the backing store for AppointmentToolTip.  This
        /// enables animation, styling, binding, etc...
        /// </summary>
        public static readonly DependencyProperty AppointmentToolTipProperty = DependencyProperty.Register("AppointmentToolTip",
            typeof(DataTemplate), typeof(ScheduleDaysAppointmentLayoutItemsControl), new PropertyMetadata(OnToolTipChanged));

        private static void OnToolTipChanged(DependencyObject dpo, DependencyPropertyChangedEventArgs args)
        {
            var schedule = dpo as ScheduleDaysAppointmentLayoutItemsControl;
