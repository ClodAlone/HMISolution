...
namespace Syncfusion.Silverlight.Client.Olap.Resources
{
    sealed class SR
    {
        ...
        private SR()
        {
            ...
            {
                this.resources = Syncfusion.Silverlight.Client.Olap.Resources.Syncfusion_OlapClient_Silverlight.ResourceManager;
            }
            else
            {
        ...
        public static string GetString(CultureInfo culture, string name)
        {
            ...
            {
                value = Syncfusion.Silverlight.Client.Olap.Resources.Syncfusion_OlapClient_Silverlight.ResourceManager.GetString(name);
            }
            return value;
        }
