...
using Syncfusion.Tools.Controls;
using Syncfusion.Tools.Primitives;

[assembly: ProvideMetadata(typeof(Syncfusion.SfShared.Silverlight.VisualStudio.Design.Metadata))]

namespace Syncfusion.SfShared.Silverlight.VisualStudio.Design
{
    internal class Metadata : IProvideAttributeTable
    {
        ...
        public AttributeTable AttributeTable
        {
            get
            {
                ...
                builder.AddCallback(typeof(Syncfusion.Tools.Primitives.HeaderedContentControl), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(false)));
                builder.AddCallback(typeof(Syncfusion.Tools.Primitives.HeaderedItemsControl), b => b.AddCustomAttributes(new ToolboxBrowsableAttribute(false)));
