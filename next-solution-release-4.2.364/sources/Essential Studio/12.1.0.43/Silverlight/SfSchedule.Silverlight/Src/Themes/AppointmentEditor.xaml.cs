...
namespace Syncfusion.UI.Xaml.Schedule
{
    ...
    public partial class AppointmentEditor
    {
...
#else
            Reminder.ItemsSource = GetLocalizedArrayValues(EnumHelper.GetValues(typeof(ReminderTimeType)));
#endif
        ...
        public static readonly DependencyProperty StartTimeZoneProperty =
            DependencyProperty.Register("StartTimeZone", typeof(TimeZone), typeof(AppointmentEditor), new PropertyMetadata(null));
        ...
        #region IsDeleteClicked
        /// <summary>
        /// Gets or sets a value indicating whether the Delete button has been clicked or not.
        /// </summary>
        public bool IsDeleteClicked
        {
            get { return (bool)GetValue(IsDeleteClickedClickedProperty); }
            set { SetValue(IsDeleteClickedClickedProperty, value); }
        }

        /// <summary>
        /// Using a DependencyProperty as the backing store for IsDeleteClicked.  This enables animation, styling, binding, etc...
        /// </summary>
        public static readonly DependencyProperty IsDeleteClickedClickedProperty =
            DependencyProperty.Register("IsDeleteClicked", typeof(bool), typeof(AppointmentEditor), new PropertyMetadata(false));
        #endregion
        ...
        {
            isNew = true;
            Dispatcher.BeginInvoke(() => { Subject.Focus(); });
        ...
        private void EditRec_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (EditedAppointment.RecurrenceProperites == null && !IsRecursive)
            {
                ...
                //EditedAppointment.RecurrenceProperites = recurrenceProperties;
                RecurrenceDaily = true;
