...
namespace Syncfusion.Layouting
{
  ...
  public class LCLeaf : LayoutContext
  {
    ...
    public override LayoutedWidget Layout( RectangleF rect )
    {
      ...
      bool clippedV = ( LayoutInfo.IsClippedVertical && m_layoutArea.Height != 0 );
      bool clippedH = ( LayoutInfo.IsClippedHorizontal && m_layoutArea.Width != 0 );
      
      if( m_layoutArea.TryFit( size, clippedV, clippedH ) )
      {
