...
using WPageSetup = Syncfusion.DocIO.DLS.WPageSetup;
...
{
  /// <summary>
  /// Represents a DLS viewer that can be used to view DLS Documents.
  /// </summary>
  ...
  public class DLSViewer : ScrollableControl
  {
    ...
    /// <summary>
    /// Gets the reusable object that sends output to a printer 
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="DLSViewer"/> class.
    /// </summary>
    public DLSViewer()
    {
    ...
    private void DrawPageBounds( Graphics graphics, WPageSetup setup )
    {
