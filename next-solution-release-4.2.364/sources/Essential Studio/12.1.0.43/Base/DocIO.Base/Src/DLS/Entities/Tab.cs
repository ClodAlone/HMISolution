...
//#if !SILVERLIGHT
        ...
        protected override void ReadXmlAttributes(IXDLSAttributeReader reader)
        {
            ...
            {
                m_tabPosition = reader.ReadFloat(XDLSConstants.TabPositionAttr);
            }
            ...
            {
                m_tlc = (TabLeader)reader.ReadEnum(XDLSConstants.TabLeaderAttr, typeof(TabLeader));
            }
            if (reader.HasAttribute(XDLSConstants.TabDeleteAttr))
            {
                m_tabDeletePosition = reader.ReadFloat(XDLSConstants.TabDeleteAttr);
            }
        }
//#endif
        #endregion

        #region IDocIOCloneable Members
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
