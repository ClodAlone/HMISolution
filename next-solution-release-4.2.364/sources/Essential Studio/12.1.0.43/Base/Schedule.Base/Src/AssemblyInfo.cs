...
#endif
[assembly: AssemblyTitle("Syncfusion.Schedule.Base")]
#if DEBUG
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class ScheduleBaseAssembly
    {
        /// <summary>
        ...
        /// <summary>
        /// A reference to the <see cref="System.Reflection.Assembly"/> for the Schedule assembly.
        /// </summary>
        ...
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Schedule";
        static ScheduleBaseAssembly()
        {
            Assembly = typeof(ScheduleBaseAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (e.Name.StartsWith(assemblies[n].GetName().Name))
                        return assemblies[n];
                }
            }
            return null;
...
namespace Syncfusion
{
    internal class AssemblyInfo : Syncfusion.ScheduleBaseAssembly
    {
    }
}
