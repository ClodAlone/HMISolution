...
namespace Syncfusion.JavaScript.Mobile
{
   public class DialogRenderModePropertiesBuilder
    {
         #region Fields
        private MobileDialogProperties MobileDialogModel { get; set; }
        #endregion

        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="MobileDialogWindowsPropertiesBuilder"/> class.
        /// </summary>
        /// <param name="mobileDialogModel">The mDialog model.</param>
