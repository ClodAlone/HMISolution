...
{
    [DataContract]
    public enum MobileHeaderPosition
    {
    ...
    public class Header : Control
    {
        ...
        /// <summary>
        /// Gets or sets the m Header model.
        /// </summary>
        /// <value>
        /// The m Header model.
        /// </value>
        public MobileHeaderProperties MobileHeaderModel
        {
            get;
            set;
        }
        ...
        {
            get { return this.MobileHeaderModel; }
        }
        #endregion

        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="MHeader"/> class.
        /// </summary>
        /// <param name="id">The identifier.</param>
        /// <param name="propModel">The property model.</param>
        public Header(String id, MobileHeaderProperties propModel)
        {
            this.ID = id;
            this.MobileHeaderModel = propModel;
        }
        #endregion
