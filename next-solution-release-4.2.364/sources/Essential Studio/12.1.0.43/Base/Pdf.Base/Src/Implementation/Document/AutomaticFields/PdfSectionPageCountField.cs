...
namespace Syncfusion.Pdf
{
    ...
    /// // Creates section page count field
    ...
    /// }
    /// doc.Save("SectionpageCountField.pdf");
    /// </code>
    /// <code lang="VB">
    /// ' Creates a new document
    ...
    /// ' Creates section page count field
    /// Dim sectionPageCount As PdfSectionPageCountField = New PdfSectionPageCountField(font)
    /// sectionPageCount.NumberStyle = PdfNumberStyle.UpperLatin
    ...
    public class PdfSectionPageCountField : PdfMultipleNumberValueField
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="PdfSectionPageCountField"/> class.
        /// </summary>
            ...
            else if (graphics.Page is PdfLoadedPage)
            {
                ...
                for (int i = 0; i < kids.Count; i++)
                {
                    ...
                    if (name == "/Pages")
                    {
                        ...
                        {
                            PdfReferenceHolder currentReference = temp[loop] as PdfReferenceHolder;
                            PdfDictionary pageDic = page.CrossTable.GetObject(currentReference) as PdfDictionary;
                            if (pageDic.Equals(page.Dictionary))
                            {
