...
namespace Syncfusion.Pdf.Native
{
    ...
    internal sealed class GdiApi
    {
        ...
        /// <returns></returns>
        [DllImport("gdi32.dll")]
        internal static extern bool SetWindowExtEx(IntPtr hdc, int nXExtent,
            int nYExtent, ref SIZE lpSize);
        /// <summary>
        ...
        internal static extern bool SetViewportExtEx(IntPtr hdc, int nXExtent, int nYExtent,
            ref SIZE lpSize);
        /// <summary>
        /// The GetViewportExtEx function retrieves the horizontal extent and vertical extent 
        /// of the current viewport for the specified device context.
        /// </summary>
        /// <param name="hdc">Handle to the device context. </param>        
        /// <param name="lpSize">Pointer to a size structure that
        /// receives the previous viewport extents in device units.</param>
        ...
        /// <param name="iMode">The modififcation mode.</param>
        ...
        /// <returns>The return value specifies the handle to the font added</returns>
        [DllImport("gdi32.dll")]
