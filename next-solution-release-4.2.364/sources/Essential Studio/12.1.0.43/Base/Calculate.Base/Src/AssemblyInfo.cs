...
//
[assembly: AssemblyTitle("Syncfusion.Calculate.Base")]
#if DEBUG
...
namespace Syncfusion
{
	...
	public class CalculateBaseAssembly
	{
		...
		static CalculateBaseAssembly()
		{
			Assembly = typeof(CalculateBaseAssembly).Assembly;
		...
		/// </summary>
		public static readonly string RootNamespace = "Syncfusion.Calculate";
...
namespace Syncfusion.Calculate
{
	...
	internal class AssemblyInfo : Syncfusion.CalculateBaseAssembly
	{
	}
	...
	/// </summary>
	[
	ToolboxBitmap(typeof(CalculateConfig), "ToolBoxIcons.Calculate.bmp")
	]
    [Description("A configuration component for the Calculate Support")]
	public class CalculateConfig : Component 
	{
		public CalculateConfig()
		{
			try
			{
			   ...
			   new Syncfusion.Core.Licensing.LicensedComponent(typeof(CalcEngine));
			}
			finally
			{
			AppDomain.CurrentDomain.AssemblyResolve -= new ResolveEventHandler(AssemblyInfo.AssemblyResolver);
