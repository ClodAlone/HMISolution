...
namespace Syncfusion.Styles
{
    ...
    /// the <see cref="MergeStyle"/> operation will show common settings in the property grid as bold.
    /// <para/>
    ...
    public abstract class StyleInfoBase : ShouldSerializeBasedPersisterType, IDisposable, IStyleInfo, ISupportInitialize, IFormattable, IConvertible, IXmlSerializable
    {
        ...
        Hashtable baseStyleValuesCache;
#else
        ...
        public virtual void InheritStyle(IStyleInfo istyle, StyleModifyType mt)
        {
            if (istyle == null)
                throw new ArgumentNullException("style");
            _store.InheritStyle(istyle.Store, mt);
        }
        ...
        internal object _GetExpandableObjectProperty(StyleInfoProperty sip)
        {
            ...
            if (subObject == null)
            {
                ...
                if (Switches.Styles.TraceVerbose)
                    ...
                    TraceUtil.TraceCurrentMethodInfo(sip.PropertyName);
#endif
            ...
            else
            {
                ...
                else if (CacheValues)
                {
                    ...
                    if (!baseStyleValuesCache.ContainsKey(sip.PropertyKey))
                    {
                        ...
                        value = baseStyleValuesCache[sip.PropertyKey];
#else
                    object value;
    ...
    public sealed class SerializePropertyAttribute : Attribute
    {
        ...
        {
            return this.Equals(SerializePropertyAttribute.Default);
        }
    ...
    public sealed class CloneablePropertyAttribute : Attribute
    {
        ...
        public override bool IsDefaultAttribute()
        {
            return this.Equals(CloneablePropertyAttribute.Default);
        }
    ...
    public sealed class DisposeablePropertyAttribute : Attribute
    {
        ...
        public override bool IsDefaultAttribute()
        {
            return this.Equals(DisposeablePropertyAttribute.Default);
        }
