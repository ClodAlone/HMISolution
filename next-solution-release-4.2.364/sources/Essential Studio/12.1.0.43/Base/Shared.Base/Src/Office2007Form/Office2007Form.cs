...
namespace Syncfusion.Windows.Forms
{
	public class Office2007Form: Form
	{
		...
		#region Constructors
		static Office2007Form()
		{
			Bitmap systemButtons = new Bitmap( typeof( Office2007Form ).Assembly.GetManifestResourceStream( "Syncfusion.Windows.Forms.Office2007Form.SystemButtons.bmp" ) );
			...
			m_bmpHelpButton = new Bitmap( typeof( Office2007Form ).Assembly.GetManifestResourceStream( "Syncfusion.Windows.Forms.Office2007Form.HelpButton.bmp" ) );
		...
		public virtual bool DisableOffice2007Style
		{
			get
			{
		...
		/// 
		/// </summary>
		[TypeConverter( typeof( Office2007Form.ColorSchemeTypeConverter ) )]
		...
		public bool ColorSchemeIsManaged
		{
			get
			{
		...
		[DefaultValue( false )]
		[Category( "Appearance" )]
		public bool UseOffice2007SchemeBackColor
		{
			get
			{
		...
		{
			if( m_bUseOffice2007ThemeBackground && ! m_bDisableOffice2007Style )
			{
		...
		private bool OnWmNcCalcSize( ref Message m )
		{
			...
			using( CaptionManager cm = new CaptionManager( this, false ) )
			{
				base.WndProc( ref m );
			}
		...
		{
			#region Constructors
			public FrameLayoutInfo( Office2007Form form )
			{
				m_form = form;
			}
			#endregion
		...
		class CaptionManager: IDisposable
		{
			...
			/// </summary>
			/// <param name="c"></param>
			public CaptionManager( Office2007Form f, bool bHideCaption )
			{
				if( f != null && f.IsHandleCreated )
				{
			...
			private Office2007Form m_form = null;
