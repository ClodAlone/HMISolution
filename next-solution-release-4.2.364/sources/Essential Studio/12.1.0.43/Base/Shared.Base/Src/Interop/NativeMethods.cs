...
namespace Syncfusion.Runtime.InteropServices
{
   ...
   , DocumentationExclude()]
	internal class NativeMethods
	{
		...
		[StructLayout(LayoutKind.Sequential), DocumentationExclude()]
		...
		{
			return (short)((n >> 16) & 0xffff /*=~0x0000*/ );
		}

		[DocumentationExclude()]
		internal static int LOWORD(int n)
		{
			return (short)(n & 0xffff /*=~0x0000*/ );
		}
		...
		internal const Int32 SM_CXBORDER = 5;
		internal const Int32 SM_CYBORDER = 6;
		...
		internal const int ESB_DISABLE_DOWN = 0x2;
		internal const int ESB_DISABLE_LEFT = 0x1;
		internal const int ESB_DISABLE_RIGHT = 0x2;
		internal const int ESB_DISABLE_UP = 0x1;

        internal const int LVM_FIRST = 0x1000;
        internal const int LVM_SCROLL = ( LVM_FIRST + 20 );

		[Flags]
		internal enum StateSystem
		{
			/// <summary>
		...
		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern int SetRectRgn(IntPtr hRgn,
        ...
        [DllImport("gdi32.dll", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Winapi)]
        internal static extern int GetOutlineTextMetrics(IntPtr hdc, int cbData, IntPtr lpOtm);
		...
		internal const int EM_GETRECT = 178;
		internal const int EM_CHARFROMPOS = 215;

		[DllImport("user32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool GetIconInfo(IntPtr hIcon, out ICONINFO piconinfo);

		[DllImport("comctl32.dll", SetLastError = true)]
		internal static extern bool ImageList_SetOverlayImage(IntPtr hImageList, int iImage, int iOverlay);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern IntPtr CreateRectRgn(int x1, int y1, int x2, int y2);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern IntPtr CreateRoundRectRgn(int nLeft, int nTop, int nRight, int nBottom, int nWidthEllipse, int nHeightEllipse);
		...
		internal static extern bool LPtoDP(IntPtr hDC, POINT lpPoint, int nCount);

		[DllImport("gdi32.dll", CallingConvention = CallingConvention.Winapi)]
		internal static extern bool LPtoDP(IntPtr hDC, int lpPoints, int nCount);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool LPtoDP(IntPtr hDC, SIZE lpSize, int nCount);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool LPtoDP(IntPtr hDC, ref RECT lpRect, int nCount);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool DPtoLP(IntPtr hDC, ref RECT lpRect, int nCount);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool SetWindowOrgEx(IntPtr hDC, int x, int y, POINT point);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool GetWindowExtEx(IntPtr hDC, out SIZE s);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern bool GetViewportExtEx(IntPtr hDC, out SIZE s);
		...
		[DllImport("user32")]
		internal static extern int EnableScrollBar(IntPtr hwnd, int wSBflags, int wArrows);
		...
		[DllImport("gdi32", CharSet = CharSet.Auto, ExactSpelling = true)]
		internal static extern IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel,
		...
		internal static extern int IntDeleteObject(IntPtr hObject);
		...
		[DllImport("shell32.dll", CharSet = CharSet.Auto, CallingConvention = CallingConvention.Winapi)]
		internal static extern IntPtr SHSimpleIDListFromPath(IntPtr pszPath);
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern int ClientToScreen(IntPtr hWnd, ref POINT pt);
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern int ScreenToClient(IntPtr hWnd, ref POINT pt);
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		internal extern static int InvalidateRect(IntPtr hWnd, IntPtr rect, bool bErase);
		...
		[Flags]
		internal enum DrawEdgeBorder: int
		{
			BDR_RAISEDOUTER = 1,
			BDR_SUNKENOUTER = 2,
			BDR_RAISEDINNER = 4,
			...
			BDR_RAISED = BDR_RAISEDINNER | BDR_RAISEDOUTER,
			BDR_SUNKEN = BDR_SUNKENINNER | BDR_SUNKENOUTER		
		}

		[Flags]
		internal enum DrawEdgeFlags: int
		{
			BF_LEFT = 1,
			BF_TOP = 2,
			BF_RIGHT = 4,
			BF_BOTTOM = 8,
			BF_ALL = BF_LEFT | BF_TOP | BF_RIGHT | BF_BOTTOM,
			BF_ADJUST = 0x2000,			
			BF_FLAT = 0x4000,
			BF_MIDDLE = 0x800
		}
		...
		public static extern bool DrawEdge( IntPtr hDC, ref NativeMethods.RECT rect, DrawEdgeBorder border, DrawEdgeFlags flags );
		...
		internal static extern ulong GetCurrentThemeName(
		  [MarshalAs(UnmanagedType.LPWStr)] string pszThemeFileName, Int32 cchMaxNameChars,
		 [MarshalAs(UnmanagedType.LPWStr)] string pszColorBuff, Int32 cchMaxColorChars,
		[MarshalAs(UnmanagedType.LPWStr)] string pszSizeBuff, Int32 cchMaxSizeChars);
		...
		internal interface IViewObject
		{
			...
			void Draw(int dwDrawAspect, int lindex, IntPtr pvAspect, tagDVTARGETDEVICE ptd, IntPtr hdcTargetDev, IntPtr hdcDraw, COMRECT lprcBounds, COMRECT lprcWBounds, IntPtr pfnContinue, int dwContinue);

			[PreserveSig]
			int GetColorSet(int dwDrawAspect, int lindex, IntPtr pvAspect, tagDVTARGETDEVICE ptd, IntPtr hicTargetDev, tagLOGPALETTE ppColorSet);
		...
		internal interface IViewObject2
		{
			...
			void GetExtent(int dwDrawAspect, int lindex, tagDVTARGETDEVICE ptd, tagSIZEL lpsizel);
		...
		internal interface IOleDataObject
		{
			...
			[PreserveSig]
			int OleGetData(FORMATETC pFormatetc, STGMEDIUM pMedium);

			[PreserveSig]
			int OleGetDataHere(FORMATETC pFormatetc, STGMEDIUM pMedium);

			[PreserveSig]
			int OleQueryGetData(FORMATETC pFormatetc);

			[PreserveSig]
			int OleGetCanonicalFormatEtc(FORMATETC pformatectIn, FORMATETC pformatetcOut);
			...
			[PreserveSig]
			int OleDAdvise(FORMATETC pFormatetc, int advf, object pAdvSink, int[] pdwConnection);
		...
		internal interface IPicture
		{
			...
			[PreserveSig]
			int SaveAsFile(IStream pstm, int fSaveMemCopy, out int pcbSize);
		...
		internal class Util
		{
			...
			private static int GetEmbededNullStringLengthAnsi(string s)
			{
				...
				return ((Util.GetPInvokeStringLength(s1) + Util.GetEmbededNullStringLengthAnsi(s2))
				  + 1);
			IL_002f:
				;
		...
		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern int GetClipBox(IntPtr hDC, ref RECT lpRect);
		...
		[DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
		internal static extern int ExtSelectClipRgn(IntPtr hdc, IntPtr hrgn, int fnMode);
		...
		{
			public static RECT[] CrackRegionData(IntPtr hRgn)
			{
				RECT[] nativeRects = new RECT[0];
				byte[] rgnData;
				int rgnSize;
				int cbHeader;
				int count;
			...
			private static RECT[] GetRects(byte[] buffer, int cbHeader, int nCount)
			{
				RECT[] nativeRects = new RECT[nCount];
				int left;
				int top;
				int right;
				int bottom;
				for (int n = 0; n < nCount; n++)
				{
					...
					nativeRects[n] = new RECT(left, top, right, bottom);
		...
		#region CMirroredDrawer class functions
		/// <summary>
        ...
        [DllImport("Gdi32.dll")]
        public static extern bool ModifyWorldTransform(IntPtr hdc, ref XFORM xform, int iMode);
		...
		#region DoubleBuffer Support
		//		[DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
		//		internal static extern IntPtr CreateCompatibleDC(IntPtr hDC);

		[DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
		internal static extern IntPtr CreateDIBSection(IntPtr hdc, ref BITMAPINFO_FLAT bmi, int iUsage, ref IntPtr ppvBits, IntPtr hSection, int dwOffset);

		//		[DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
		//		internal static extern IntPtr CreateCompatibleBitmap(IntPtr hDC, int width, int height);

		[DllImport("gdi32.dll")]
		internal static extern int GetDIBits(IntPtr hdc, IntPtr hbm, int arg1, int arg2, IntPtr arg3, ref BITMAPINFO_FLAT bmi, int arg5);
		...
		[DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
		internal static extern int GetObjectType(IntPtr hObject);

		//		[DllImport("gdi32.dll", CharSet = CharSet.Auto, SetLastError = true, ExactSpelling = true)]
		//		internal static extern bool DeleteDC(IntPtr hDC);

		[DllImport("gdi32.dll")]
		public static extern uint GetPaletteEntries(IntPtr hpal, int iStartIndex, int nEntries, byte[] lppe);
		...
		{
			internal int biSize = 0;
			internal int biWidth = 0;
			internal int biHeight = 0;
			internal short biPlanes = 0;
			internal short biBitCount = 0;
			internal int biCompression = 0;
			internal int biSizeImage = 0;
			internal int biXPelsPerMeter = 0;
			internal int biYPelsPerMeter = 0;
			internal int biClrUsed = 0;
			internal int biClrImportant = 0;
		}
