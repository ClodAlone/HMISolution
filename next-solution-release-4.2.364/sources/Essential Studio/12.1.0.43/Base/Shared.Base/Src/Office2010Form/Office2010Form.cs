...
namespace Syncfusion.Windows.Forms
{
    public class Office2010Form : Form
    {
        ...
        #region Constructors
        static Office2010Form()
        {
            Bitmap systemButtons = new Bitmap(typeof(Office2010Form).Assembly.GetManifestResourceStream("Syncfusion.Windows.Forms.Office2010Form.SystemButtons.bmp"));
            ...
            m_bmpHelpButton = new Bitmap(typeof(Office2010Form).Assembly.GetManifestResourceStream("Syncfusion.Windows.Forms.Office2010Form.HelpButton.bmp"));
        ...
        public virtual bool DisableOffice2010Style
        {
            get
            {
                return m_bDisableOffice2010Style || (m_bCompositionEnabled && this.applyAeroTheme);
            }
            set
            {
                if (m_bDisableOffice2010Style != value)
                {
                    m_bDisableOffice2010Style = value;
        ...
        [
        Browsable(false),
        Description("Gets/sets if to Force the Default OS Aero theme look and feel when Office2010Visual style is enabled. This will not work for XP and lower OS versions"),
        DefaultValue(true),
        Category("Behavior")
        ]
        public virtual bool ApplyAeroTheme
        {
            get
            {
        ...
        /// </summary>
        [Category("Misc"), Description("Gets or sets the Office2010 colorscheme.")]
        [TypeConverter(typeof(Office2010Form.ColorSchemeTypeConverter))]
        public Office2010Theme ColorScheme
        {
            get
            {
                return m_theme;
        ...
        protected Office2010Colors ColorTable
        {
            get
            {
                return Office2010Colors.GetColorTable(this.ColorScheme);
            }
        }
        /// <summary>
        ...
        /// </summary>
        [Description("Specifies whether current selected Office2010 scheme background color.")]
        [DefaultValue(false)]
        [Category("Appearance")]
        public bool UseOffice2010SchemeBackColor
        {
            get
            {
                return m_bUseOffice2010ThemeBackground;
            }
            set
            {
                if (value != m_bUseOffice2010ThemeBackground)
                {
                    m_bUseOffice2010ThemeBackground = value;
        ...
        {
            if (!m_bSuppressSizing || this.DisableOffice2010Style)
            {
        ...
        {
            if (m_bUseOffice2010ThemeBackground && !m_bDisableOffice2010Style)
            {
                Office2010Colors colorTable = this.ColorTable;
                Color clrFormBackground = colorTable.FormBackground;
                Graphics g = e.Graphics;
                Brush brush = new SolidBrush(clrFormBackground);
            ...
            if (this.IsHandleCreated)
            {
                ...
                if (this.FormBorderStyle != FormBorderStyle.None)
                {
                    ...
                    if (!this.IsMaximized || (this.IsMaximized && this.IsMdiChild))
                    {
                        ...
                        if (hRgn != IntPtr.Zero)
                        {
                            IntPtr hRoundRgn = NativeMethods.CreateRoundRectRgn(0, 0, rc.Width + 1, rc.Height + BORDER_WIDTH + 1, CURVE_WIDTH, CURVE_WIDTH);
        ...
        {
            Office2010Colors colorTbl = this.ColorTable;
            ...
            if (titleHeight > 0)
            {
                using (LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(0, rc.Top, 1, titleHeight), clBegin, clEnd, 90f))
                {
            ...
            using (Brush brush = new SolidBrush(this.IsActive ? colorTbl.ActiveFormBorderColor : colorTbl.InactiveFormBorderColor))
            {
                g.FillRectangle(brush, new Rectangle(x, rc.Top + titleHeight, width, rc.Height - titleHeight));
            }
        }
        /// <summary>
        /// 
        ...
        private void DrawFrameButtonBackgroundSelected(Graphics g, ref Rectangle rc)
        {
            ...
            DrawFrameButtonGradient(g, ref rc, colorTbl.SystemButtonSelectedGradientBegin, colorTbl.SystemButtonSelectedGradientEnd);

            DrawFrameButtonBorder(g, ref rc, colorTbl.SystemButtonBorderSelected);
        ...
        private void DrawFrameButtonBackgroundPressed(Graphics g, ref Rectangle rc)
        {
            ...
            DrawFrameButtonGradient(g, ref rc, colorTbl.SystemButtonPressedGradientBegin, colorTbl.SystemButtonPressedGradientEnd);

            DrawFrameButtonFlash(g, ref rc);

            DrawFrameButtonBorder(g, ref rc, colorTbl.SystemButtonBorderPressed);
            ...
            if (rc.Width > 0 && rc.Height > 0)
            {
                ...
                if (sText != string.Empty)
                {
                    ...
                    if (hFont != IntPtr.Zero)
                    {
                        ...
                        int format = DT_SINGLELINE | DT_END_ELLIPSIS | DT_VCENTER | DT_NOPREFIX;
        ...
        private void DrawFrameBorders(Graphics g, Rectangle rc)
        {
            ...
            {
                GraphicsPath path = GetFormPath(rc.Width - 1, rc.Height - 1);
                if (path != null)
                {
                    g.DrawPath(m_pBorder, path);
                    path.Dispose();
                }
            }
            ...
            if (this.Text != string.Empty || this.ControlBox)
            {
                g.DrawLine(m_pSeparatorDark, x1, y, x2, y);
                g.DrawLine(m_pSeparatorLight, x1, y + 1, x2, y + 1);
            }
        ...
        {
            if (this.UseOffice2010SchemeBackColor)
            {
                Invalidate();
            }
        }
        ...
        /// <summary>
        /// Occurs when <see cref="Office2010Form.ColorScheme"/> property is changed.
        /// </summary>
        ...
        /// 
        /// </summary>
        private Office2010Theme m_theme = Office2010Theme.Managed;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        private bool m_bUseOffice2010ThemeBackground = false;
        /// <summary>
        /// 
        /// </summary>
        private bool m_bDisableOffice2010Style = false;
        /// <summary>
        /// 
        /// </summary>
        private bool applyAeroTheme = true;
        /// <summary>
        /// 
        /// </summary>
        ...
        class FrameLayoutInfo
        {
            ...
            public FrameLayoutInfo(Office2010Form form)
            {
                m_form = form;
            }
            #endregion
            ...
            public void PerformLayout(int width, int height)
            {
                ...
                if (m_form.EnableTouchMode)
                    szIcon = new Size(szIcon.Width + 10, szIcon.Height + 10);
                ...
                if (!bIsFormBorderStyleNone)
                {
                    ...
                    {
                        m_titleHeight = Math.Max(captionPadding + contentHeight + SEPARATOR_WIDTH, this.SysCaptionHeight);
                    }
                    ...
                    m_rcText = new Rectangle(left + TEXT_MARGIN, sysBorderWidth, right - left - 2 * TEXT_MARGIN, m_titleHeight - sysBorderWidth);
        ...
        class CaptionManager : IDisposable
        {
            ...
            /// </summary>
            /// <param name="c"></param>
            public CaptionManager(Office2010Form f, bool bHideCaption)
            {
                if (f != null && f.IsHandleCreated)
                {
            ...
            private Office2010Form m_form = null;
