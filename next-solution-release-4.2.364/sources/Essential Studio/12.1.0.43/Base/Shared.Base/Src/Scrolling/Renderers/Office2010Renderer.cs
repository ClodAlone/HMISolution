...
namespace Syncfusion.Windows.Forms.Renderers
{
    ...
    public class Office2010Renderer :
        ClassicRenderer
    {
        #region Constants
        /// <summary>
        ...
        /// </summary>
        private ColorTableOffice2010 m_colorTable;
        /// <summary>
        ...
        private void DrawBackground(Graphics g, Rectangle rc)
        {
            ...
            {
                if (m_colorTable is ColorTableOffice2010Black)
                {
        ...
        private void DrawArrowBackground(Graphics g, Rectangle rc, ScrollButton type, ButtonState state)
        {
            ...
            switch (state)
            {
                ...
                case ButtonState.Checked:
                    ...
                    if (m_colorTable is ColorTableOffice2010Silver || m_colorTable is ColorTableOffice2010Black)
                    {
