...
namespace Syncfusion.Windows.Forms.Chart.SvgBase
{
    ...
    public sealed class LineElement : SuperElement
    {
        #region Properties
        /// <summary>
        ...
        /// <summary>
        /// Creates the <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.LineElement"/> from its coords.
        /// </summary>
        /// <param name="pt1">The first point.</param>
        /// <param name="pt2">The second point.</param>
        /// <returns>
        /// Created <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.LineElement"/>.
        /// </returns>
        ...
        /// <returns>Created <see cref="Syncfusion.Windows.Forms.Chart.SvgBase.LineElement"/>.</returns>
