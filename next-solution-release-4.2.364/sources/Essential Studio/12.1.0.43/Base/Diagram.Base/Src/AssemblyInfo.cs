...
//
[assembly: AssemblyTitle("Syncfusion.Diagram.Base")]
...
[assembly: DocumentationNamespaceExclude("Syncfusion.Runtime.InteropServices.WinAPI")]
...
namespace Syncfusion
{
	...
	public class DiagramBaseAssembly
	{
		...
		public static readonly string LegacyName = "Syncfusion.Diagram";
		...
		static DiagramBaseAssembly()
		{
			DiagramBaseAssembly.Assembly = typeof(DiagramBaseAssembly).Assembly;
			string fullName = Assembly.FullName;
			int len = fullName.IndexOf(",");
			DiagramBaseAssembly.Name = fullName.Substring(0, len);
		}
		...
		{
			if(e.Name.StartsWith(DiagramBaseAssembly.Name) || e.Name.StartsWith(DiagramBaseAssembly.LegacyName))
			{
			...
			public class Binder : SerializationBinder
		{
				...
				string assemblyName, string typeName)
			{
				...
				foreach (Assembly asm in new Assembly[] { Syncfusion.DiagramBaseAssembly.Assembly,
															Syncfusion.SharedBaseAssembly.Assembly
														})
				{
