...
namespace Syncfusion.SVG.IO
{
    ...
    /// </summary>
    public class PatternElement : SuperElement
    {
        #region Constants
        ...
        public TransformList PatternTransform
        {
            ...
            set
            {
                SetAttribute(SVG.ATTR_PATTERN_TRANSFORM, value, new TransformList(new Matrix()));
            }
        }
        ...
        public static PatternElement FormHatchBrush(HatchBrush brush)
        {
            ...
            switch (brush.HatchStyle)
            {
                ...
                case HatchStyle.DarkDownwardDiagonal:
                    elems = new Element[]
                          { 
                              LineElement.FromCoordinates( H4, 0, H8, H8 ),
                ...
                case HatchStyle.DarkHorizontal:
                    elems = new Element[]
                          { 
                              LineElement.FromCoordinates( 0, H2, H8, H6 ),
                ...
                case HatchStyle.DarkUpwardDiagonal:
                    elems = new Element[]
                          { 
                              LineElement.FromCoordinates( 0, H4, H4, 0 ),
                ...
                case HatchStyle.DashedHorizontal:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, H2, H4, H2 ),
                ...
                case HatchStyle.DashedUpwardDiagonal:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( H4, 0, 0, H4 ),
                ...
                case HatchStyle.DashedVertical:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( H2, 0, H2, H4 ),
                ...
                case HatchStyle.LargeCheckerBoard:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H3, H3 ),
                ...
                case HatchStyle.LargeConfetti:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H1, H1 ),
                ...
                case HatchStyle.NarrowHorizontal:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, H1, H8, H1 ),
                        LineElement.FromCoordinates( 0, H3, H8, H3 ),
                ...
                case HatchStyle.NarrowVertical:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( H1, 0, H1, H8 ),
                ...
                case HatchStyle.Plaid:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, 0, H8, 0 ),
                        LineElement.FromCoordinates( 0, H3, H8, H3 ),
                ...
                case HatchStyle.Shingle:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, H2, H2, 0 ),
                ...
                case HatchStyle.SmallConfetti:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, 0, H2, H2 ),
                ...
                case HatchStyle.SmallGrid:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, H2, H8, H2 ),
                        LineElement.FromCoordinates( 0, H6, H8, H6 ),
                        LineElement.FromCoordinates( H2, 0, H2, H8 ),
                        LineElement.FromCoordinates( H6, 0, H6, H8 )
                    };
                ...
                case HatchStyle.Wave:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, H4, H3, H2 ),
                ...
                case HatchStyle.Percent05:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, 0, H1, 0 ),
                ...
                case HatchStyle.Percent20:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, 0, H2, 0 ),
                ...
                case HatchStyle.Percent25:
                    elems = new Element[]
                    { 
                        LineElement.FromCoordinates( 0, 0, H3, 0 ),
                        LineElement.FromCoordinates( H4, H2, H6, H2 ),
                ...
                case HatchStyle.Percent30:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H3, H1 ),
                        LineElement.FromCoordinates( H4, H2, H6, H2 ),
                ...
                case HatchStyle.Percent60:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H4, H3 ),
                        RectElement.FromCoordinates( H4, H4, H4, H4 )
                    };
                    break;
                case HatchStyle.Percent70:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H4, H5 ),
                        RectElement.FromCoordinates( H4, H4, H4, H4 )
                    };
                    break;
                case HatchStyle.Percent75:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H7, H3 ),
                ...
                case HatchStyle.Percent80:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H7, H4 ),
                ...
                case HatchStyle.Percent90:
                    elems = new Element[]
                    { 
                        RectElement.FromCoordinates( 0, 0, H7, H5 ),
