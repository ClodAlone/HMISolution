...
namespace Syncfusion.Windows.Forms.Diagram
{
		...
		: RulerMarkupRenderer
	{
		...
		/// <summary>
		/// Creates instance of the <see cref="Syncfusion.Windows.Forms.Diagram.CentimetersMarkupRenderer"/>
		/// with given <see cref="Syncfusion.Windows.Forms.Diagram.Ruler"/> to render markup to.
		/// </summary>
