...
namespace Syncfusion.Runtime.InteropServices.WinAPI
{
    ...
    public class LocaleInfo
    {
        ...
        /// 
        /// </summary>
        public const uint LOCALE_USER_DEFAULT = 0x800;
        /// <summary>
        /// 
        /// </summary>
        public const uint LOCALE_IMEASURE = 0xd;
    ...
    /// <exclude/>
    [CLSCompliant(false)]
    public sealed class RichTextNativeMethods
    {
        ...
        /// </summary>
        [Flags]
        public enum RichEditFormat : uint
        {
            /// <summary>
            /// 
            /// </summary>
        ...
        /// </summary>
        [Flags]
        public enum RichEditEffects : uint
        {
            /// <summary>
            /// 
            /// </summary>
            ...
            /// 
            /// </summary>
            CFE_SMALLCAPS = RichEditFormat.CFM_SMALLCAPS,
            /// <summary>
            /// 
            /// </summary>
            CFE_ALLCAPS = RichEditFormat.CFM_ALLCAPS,
            /// <summary>
            /// 
            /// </summary>
            CFE_HIDDEN = RichEditFormat.CFM_HIDDEN,
            /// <summary>
            /// 
            /// </summary>
            CFE_OUTLINE = RichEditFormat.CFM_OUTLINE,
            /// <summary>
            /// 
            /// </summary>
            CFE_SHADOW = RichEditFormat.CFM_SHADOW,
            /// <summary>
            /// 
            /// </summary>
            CFE_EMBOSS = RichEditFormat.CFM_EMBOSS,
            /// <summary>
            /// 
            /// </summary>
            CFE_IMPRINT = RichEditFormat.CFM_IMPRINT,
            /// <summary>
            /// 
            /// </summary>
            CFE_DISABLED = RichEditFormat.CFM_DISABLED,
            /// <summary>
            /// 
            /// </summary>
            CFE_REVISED = RichEditFormat.CFM_REVISED,
        }
        #endregion

        #region Hidden or overrided APIs
        /// <summary>
        ...
        private static extern int SetWindowThemeInternal(IntPtr hWnd,
        ...
        public static int SetWindowTheme(IntPtr hWnd, string pszSubAppName, string pszSubIdList)
        {
            ...
            if (supportsThemes)
            {
                return SetWindowThemeInternal(hWnd, pszSubAppName, pszSubIdList);
            }
        ...
        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        public static extern int SendMessage(IntPtr hWnd, int msg, int wParam, ref CHARFORMAT2 lParam);

        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        public static extern int SendMessage(IntPtr hWnd, int msg, int wParam, ref PARAFORMAT2 lParam);

        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        public static extern int SendMessage(IntPtr hWnd, int msg, ref GETTEXTEX wParam, StringBuilder lParam);

        [DllImport("user32.dll", EntryPoint = "SendMessage", CharSet = CharSet.Auto)]
        public static extern int SendMessage(IntPtr hWnd, int msg, ref GETTEXTLENGTHEX wParam, int lParam);
    ...
    internal class Window
    {
        ...
        [DllImport("user32.dll")]
        internal static extern int EnumChildWindows(IntPtr hWndParent, CallBack lpEnumFunc, ref RECT lParam);
    ...
    internal class GDI
    {
        ...
        [DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = false, CallingConvention = CallingConvention.Winapi)]
        internal static extern IntPtr CreateEnhMetaFile(IntPtr hdcRef, string lpFilename, ref RECT lprect, string lpDescription);

        [DllImport("gdi32.dll", CharSet = CharSet.Auto, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        internal static extern IntPtr CloseEnhMetaFile(IntPtr hdc);
