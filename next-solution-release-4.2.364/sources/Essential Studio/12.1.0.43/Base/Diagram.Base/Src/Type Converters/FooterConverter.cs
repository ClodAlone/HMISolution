...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    public class FooterConverter : System.ComponentModel.ExpandableObjectConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                Footer footer = value as Footer;
                if (footer != null)
                {
                    System.Text.StringBuilder str = new StringBuilder();
                    if (footer.Left != null)
                    {
                        str.Append("Left=" + footer.Left);
                    }
                    if (footer.Center != null)
                    {
                        if (str.Length != 0)
                            str.Append(", ");
                        str.Append("Center=" + footer.Center);
                    }
                    if (footer.Right != null)
                    {
                        if (str.Length != 0)
                            str.Append(", ");
                        str.Append("Right=" + footer.Right);
                    }
