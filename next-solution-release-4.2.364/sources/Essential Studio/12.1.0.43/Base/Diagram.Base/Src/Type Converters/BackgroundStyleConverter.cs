...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    /// </summary>
    public class BackgroundStyleConverter : System.ComponentModel.TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                // BackgroundStyle backgroundStyle = value as BackgroundStyle;
                // if (backgroundStyle != null)
                // {
                //     return ("{" + backgroundStyle.Color + ", Type=" + backgroundStyle.Type + "}");
                // }
            }
