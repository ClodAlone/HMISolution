...
namespace Syncfusion.Windows.Forms.Diagram
{
	...
	/// </summary>
	public class LineStyleConverter : System.ComponentModel.ExpandableObjectConverter
	{
        /// <summary>
		...
		{  
			...
			{
				LineStyle lineStyle = value as LineStyle;
				if (lineStyle != null)
				{
					return ("{"+ "Width=" + lineStyle.LineWidth.ToString() + "," + lineStyle.LineColor.ToString() + "}");
				}
			}
