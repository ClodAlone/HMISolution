...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    /// </summary>
    public class ShadowStyleConverter : System.ComponentModel.TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                ShadowStyle shadowStyle = value as ShadowStyle;
                if (shadowStyle != null)
                {
                    return ("{" + shadowStyle.Visible.ToString() + ", " + shadowStyle.Color.ToString() + "}");
                }
            }
