...
namespace Syncfusion.Windows.Forms.Diagram
{
    ...
    /// </remarks>
    public class LabelNameEditor : UITypeEditor
    {
        private IWindowsFormsEditorService edSvc = null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LabelNameEditor"/> class.
        /// </summary>
        public LabelNameEditor()
        {
        }
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (this.edSvc != null)
            {
                ...
                // ILabelContainer lblContainer = context.Instance as ILabelContainer;
                //
                // if (lblContainer != null)
                // {
                //      foreach (Label curLabel in lblContainer.Labels)
                //      {
                //         string curItemValue = curLabel.Name;
