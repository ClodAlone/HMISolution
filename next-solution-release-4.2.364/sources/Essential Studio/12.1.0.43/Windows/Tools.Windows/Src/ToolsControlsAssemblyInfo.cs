...
//
[assembly: AssemblyTitle("Syncfusion.Tools.Controls")]
...
/// </summary>
	public class ToolsControlsAssembly
	{
		/// <summary>
		...
		static ToolsControlsAssembly()
		{
			Assembly = typeof(ToolsControlsAssembly).Assembly;
		...
		{
			if (e.Name.StartsWith(SharedAssembly.Name))
	...
	internal class AssemblyInfo : ToolsControlsAssembly
	{
	}
