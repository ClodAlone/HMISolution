...
namespace Syncfusion.Windows.Forms.Tools.Win32API
{
	...
	public class WindowsAPI
	{
		...
		public delegate IntPtr WindowProc(IntPtr hWnd, int nMsg, IntPtr wParam, IntPtr lParam);
		#endregion
		...
		[DllImport("gdi32.dll")]
		static public extern bool StretchBlt(IntPtr hDCDest,
		...
		[DllImport("gdi32.dll")]
		[CLSCompliant(false)]
		static public extern uint SetPixel(IntPtr hdc, int XPox, int YPos, int crColor);
		[DllImport("gdi32.dll")]
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool RedrawWindow(IntPtr hWnd, IntPtr rcUpdate, IntPtr hrgnUpdate, RedrawWindowFlags flags);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool RedrawWindow(IntPtr hWnd, ref RECT rcUpdate, IntPtr hrgnUpdate, RedrawWindowFlags flags);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool SetForegroundWindow(IntPtr hWnd);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int x, int y, int Width, int Height, SetWindowPosFlags flags);

		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool SetLayeredWindowAttributes(IntPtr hwnd, int crKey, int bAlpha, LayeredWindowFlags dwFlags);
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		[CLSCompliant(false)]
		public static extern IntPtr PostThreadMessage(uint idThread, int msg, int wParam, int lParam);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		...
		[DllImport("User32.dll", CharSet = CharSet.Auto)]
		public static extern bool UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDst, ref POINT pptDst, ref WIN32SIZE psize, IntPtr hdcSrc, ref POINT pprSrc, Int32 crKey, ref BLENDFUNCTION pblend, Int32 dwFlags);
		[DllImport("User32.dll", CharSet = CharSet.Auto)]
		...
		[DllImport("User32.dll", CharSet = CharSet.Auto)]
		public static extern int SetWindowLong(IntPtr hWnd, int nIndex, WindowProc wndProc);
		[DllImport("User32.dll", CharSet = CharSet.Auto)]
		public static extern System.Int32 GetWindowLong(IntPtr hWnd, int nIndex);
		[DllImport("User32.dll", CharSet = CharSet.Auto)]
		public static extern IntPtr GetDCEx(IntPtr hWnd, IntPtr hRegion, GetDCExFlags flags);
		[DllImport("User32.dll", CharSet = CharSet.Auto)]
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern int GetSystemMetrics(SystemMetricsCodes nIndex);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		[CLSCompliant(false)]
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern int AdjustWindowRectEx([In, Out]ref RECT lpRect, int dwStyle, bool bMenu, int dwExStyle);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool PtInRect(ref RECT rc, POINT pt);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern int DefWindowProc(IntPtr hWnd, int Msg, IntPtr wParam, IntPtr lParam);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern int DefWindowProc(IntPtr hWnd, Msg Msg, IntPtr wParam, ref RECT lParam);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool InflateRect(ref RECT lpRect, int dx, int dy);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		[CLSCompliant(false)]
		static public extern bool GetComboBoxInfo(IntPtr hWnd, ref COMBOBOXINFO cbi);
		#endregion
		...
		{
			return (Int16)(param.ToInt64() & 0xffff);
		}
		public static int HIGH_ORDER(IntPtr param)
		{
			return (Int16)(param.ToInt64() >> 16);
		}
		...
		static internal extern IntPtr SHAppBarMessage(int dwMessage, ref APPBARDATA pData );
      ...
      out String pbstr);
		...
		public static void SetRedraw(Control ctrl, bool bRedraw)
		{
			...
			{
				SendMessage(ctrl.Handle, Msg.WM_SETREDRAW, bRedraw ? 1 : 0, 0);
			}
		}
		...
		public static int GetStyle(Control ctrl)
		{
			...
			if (ctrl.IsHandleCreated)
			{
				nResult = GetWindowLong(ctrl.Handle, (int)SetWindowLongOffsets.GWL_STYLE);
			}
		...
		public static int GetExStyle(Control ctrl)
		{
			...
			if (ctrl.IsHandleCreated)
			{
				nResult = GetWindowLong(ctrl.Handle, (int)SetWindowLongOffsets.GWL_EXSTYLE);
			}
