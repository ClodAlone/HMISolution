...
#endif
[assembly: AssemblyTitle("Syncfusion.Tools.Windows")]
#if DEBUG
...
/// </summary>
	public class ToolsWindowsAssembly
	{
		/// <summary>
		...
		static ToolsWindowsAssembly()
		{
			Assembly = typeof(ToolsWindowsAssembly).Assembly;
		...
		public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
		{
			if (e.Name.StartsWith(SharedBaseAssembly.Name))
			...
			else if (e.Name.StartsWith(ToolsWindowsAssembly.Name))
				...
				return GridWindowsAssembly.Assembly;
			else if (e.Name.StartsWith("Syncfusion.Tools,"))
				return ToolsWindowsAssembly.Assembly;
			else if (e.Name == "Syncfusion.Shared")
				return SharedBaseAssembly.Assembly;
			else if (e.Name == "Syncfusion.Grid")
				return GridWindowsAssembly.Assembly;
			else if (e.Name == "Syncfusion.Tools")
				return ToolsWindowsAssembly.Assembly;
	...
	internal class AssemblyInfo : ToolsWindowsAssembly
	{
	}
	...
	internal class SharedResolver
	{
		...
		public static Assembly Resolve(object sender, System.ResolveEventArgs e)
		{
			...
			{
				rAssembly = GridWindowsAssembly.Assembly;
			}
