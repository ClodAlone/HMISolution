...
namespace Syncfusion.Windows.Forms.Tools.Design
{
  /// <summary></summary>
	public class TreeViewAdvDesigner : ControlDesigner
	{
		...
		/// 
		/// </summary>
		public TreeViewAdv Instance
		{
			get
			{
				return this.Control as TreeViewAdv;
			}
		}
		/// <summary></summary>
		...
		private void tree_NodesEditor( object sender, EventArgs e )
		{
			if( this.Instance != null )
			{
				...
				using( TreeViewAdvEditorForm form = new TreeViewAdvEditorForm( this.Instance, provider ) )
				{
					if( provider != null )
					{
		...
		public override DesignerActionListCollection ActionLists
		{
			get
			{
				if( null == actionLists )
				{
					...
					actionLists.Add(
						new TreeViewAdvActionList( this.Component ) );
				}
				return actionLists;
			}
		}
