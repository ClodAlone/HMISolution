...
#endif
[assembly: AssemblyTitle("Syncfusion.PivotAnalysis.Windows")]
#if DEBUG
...
[assembly: Guid("a665dd02-7de3-4bea-83b7-d29f63a7d2ad")]
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class PivotAnalysisWindowsAssembly
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Windows.Forms.PivotAnalysis";

        /// <summary>
        /// Initializes the <see cref="GridGroupingWindowsAssembly"/> class.
        /// </summary>
        static PivotAnalysisWindowsAssembly()
        {
            Assembly = typeof(PivotAnalysisWindowsAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else if (e.Name.StartsWith(PivotAnalysisWindowsAssembly.Name))
            {
                return PivotAnalysisWindowsAssembly.Assembly;
            }
            else if (e.Name.StartsWith(Syncfusion.ToolsWindowsAssembly.Name))
            {
                return ToolsWindowsAssembly.Assembly;
            }
            else
            {
...
namespace Syncfusion.Windows.Forms.PivotAnalysis
{
    ...
    /// </summary>
    internal class AssemblyInfo : Syncfusion.PivotAnalysisWindowsAssembly
    {
    }
}
