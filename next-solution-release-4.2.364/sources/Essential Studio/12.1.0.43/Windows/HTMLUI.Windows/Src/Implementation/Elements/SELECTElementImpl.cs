...
namespace Syncfusion.Windows.Forms.HTMLUI
{
      ...
      : UserControlHolderBase
    {
        ...
        /// </summary>
        private const string DEF_TAG_NAME = TagName.Select;
        ...
        private static void ReDefineReactions()
        {
            ...
            m_reactionType.Add(typeName, AttributeName.Size, ReactType.ReFormatMergElmAndReCalcDoc);

            m_reactionType.Add(typeName, AttributeName.Multiple, ReactType.ReFormatMergingElement);

            m_reactionType.Add(typeName, AttributeName.Selected, ReactType.ReFormatMergingElement);
        }

        /// <summary>
        /// Initializes static members of the SELECTElementImpl class 
        /// </summary>
        static SELECTElementImpl()
        {
            Type type = typeof(SELECTElementImpl);
        ...
        public SELECTElementImpl(IHTMLElement parent)
