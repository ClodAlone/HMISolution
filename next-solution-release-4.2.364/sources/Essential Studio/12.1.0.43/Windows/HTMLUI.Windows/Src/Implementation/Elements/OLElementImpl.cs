...
namespace Syncfusion.Windows.Forms.HTMLUI
{
    ...
    /// </summary>
    [ElementTag(TagName.Ol)]
    public class OLElementImpl : ListElement
    {
        #region Class constants
        /// <summary>
        /// Name of the tag this class indicates.
        /// </summary>
        private const string DEF_TAG_NAME = TagName.Ol;
        #endregion
        ...
        /// </summary>
        static OLElementImpl()
        {
            Type type = typeof(OLElementImpl);
