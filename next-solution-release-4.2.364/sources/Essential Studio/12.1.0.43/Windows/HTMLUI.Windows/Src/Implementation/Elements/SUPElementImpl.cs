...
namespace Syncfusion.Windows.Forms.HTMLUI
{
    ...
    /// </summary>
    [ElementTag(TagName.Sup)]
    public class SUPElementImpl : BaseElement
    {
        #region Class constants
        /// <summary>
        /// Name of the tag this class indicates.
        /// </summary>
        private const string DEF_TAG_NAME = TagName.Sup;
        ...
        /// </summary>
        static SUPElementImpl()
        {
            Type type = typeof(SUPElementImpl);
        ...
        protected override void CalculateFormatInternal()
        {
            ...
            format.FontSize *= DEF_FONT_SIZE_MULTIPLIER;
        }
        #endregion
    }
}