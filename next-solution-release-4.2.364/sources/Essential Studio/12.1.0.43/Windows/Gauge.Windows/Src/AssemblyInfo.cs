...
#endif
[assembly: AssemblyTitle("Syncfusion.Gauge.Windows")]
#if DEBUG
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class GaugeWindowsAssembly
    {
        /// <summary>
        ...
        /// <summary>
        /// A reference to the <see cref="System.Reflection.Assembly"/> for the Gauge assembly.
        /// </summary>
        ...
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Windows.Forms.Gauge";

        /// <summary>
        /// Initializes the <see cref="GaugeWindowsAssembly"/> class.
        /// </summary>
        static GaugeWindowsAssembly()
        {
            Assembly = typeof(GaugeWindowsAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            else if (e.Name.StartsWith(GaugeWindowsAssembly.Name))
            {
                return GaugeWindowsAssembly.Assembly;
            }
...
namespace Syncfusion.Windows.Forms.Gauge
{
    ...
    /// </summary>
    internal class AssemblyInfo : Syncfusion.GaugeWindowsAssembly
    {
    }
}
