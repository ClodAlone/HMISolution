...
{
    public partial class MetroTop10AutoFilter : MetroForm
    {
        ...
        public MetroTop10AutoFilter(List<double> numberList)
        {
            ...
            this.topComboBox1.SelectedIndex = 0;
            this.topComboBox1.MaxDropDownItems = 2;
            this.topComboBox1.DropDownStyle = ComboBoxStyle.DropDown;
            this.itemscomboBoxAdv1.MaxDropDownItems = 2;
            this.itemscomboBoxAdv1.DropDownStyle = ComboBoxStyle.DropDown;
            this.itemscomboBoxAdv1.DataSource = items;
            this.itemscomboBoxAdv1.SelectedIndex = 0;
