//-------------------------------------------------------------------------------------------------
// <copyright file="GridTextBoxControl.cs" company="syncfusion">
...
namespace Syncfusion.Windows.Forms.Grid
{
...
#endif
    {
        ...
        /// <override/>
        /// <summary>
        /// Gets or sets the selected text within the <see
        /// cref="RichTextBox" />.
        /// </summary>
        ...
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            if (this.inImeComposition)
            {
                this.raiseTextChangeWhenImeEnd = true;
                return;
            }
#endif
            if (this.suspendEvents <= 0)
        ...
        protected override void OnGotFocus(EventArgs e)
        {
            ...
            {
                TraceUtil.TraceCurrentMethodInfo("BEGIN", this.Text, Parent);
            }
#else
            ;
#endif
            ...
            if (Switches.GridFocus.TraceVerbose)
            {
                TraceUtil.TraceCurrentMethodInfo("END", this.Text, Parent);
            }
#else
            ;
#endif
            ...
            try
            {
                switch (msg.Msg)
                {
                    ...
                    case NativeMethods.WM_IME_ENDCOMPOSITION:
                        ...
                        if (/*firstTimeIME_ENDCOMPOSITION ||*/ this.raiseTextChangeWhenImeEnd)
                        {
                            BeginInvoke(new EventHandler(this.delayTextChange), new object[] { this, null });
                            this.raiseTextChangeWhenImeEnd = false;
                            ////firstTimeIME_ENDCOMPOSITION = false;
                        }

                        break;
                    case NativeMethods.WM_IME_STARTCOMPOSITION:
                        this.inImeComposition = true;
                        break;
#endif
        ...
        protected override bool ProcessKeyMessage(ref Message m)
        {
            ...
            switch (kc)
            {
                ...
                case Keys.V:
                    scrollInView = bCtl;
                    forwardParent = (bCtl && (this.SelectionLength == 0) && !(ParentCell is GridFormulaCellRenderer)) || bAlt;
                    callBase = false;
                    break;
...
#if !RICHTEXT
                case Keys.Back:
                    if (ParentCell.Grid.IsWindowless)
                        return true;
                    scrollInView = true;
        ...
        protected override void OnContentsResized(ContentsResizedEventArgs e)
        {
            ...
            if (this.parent != null)
            {
                this.textSize.Height = e.NewRectangle.Height; 
                this.textSize.Width = e.NewRectangle.Width;
#if DEBUG

                if (Switches.TextBoxCellEvents.TraceVerbose)
                {
                    TraceUtil.TraceCurrentMethodInfo(e.NewRectangle, this.textSize);
                }
#else
                ...
                if (!(Visible && Focused && this.Floatable))
                {
                    return;
                }

                Size size = this.parent.Grid.Model.AddBorders(this.textSize, this.parent.StyleInfo);
                ...
                else if (this.parent.StyleInfo.AutoSize && this.parent.Grid.AllowTextBoxAutoSize)
                {
                    this.parent.Grid.Model.GetSpannedRangeInfo(this.parent.RowIndex, this.parent.ColIndex, out rangeCell);
                    bool bChanged = false;
                    if (this.textSize.Height > ClientRectangle.Height)
                    {
                    ...
                    if (this.textSize.Width > ClientRectangle.Width)
                    {
        ...
        public bool FloatDone
        {
            get
            {
                ...
                // will be lost.
                return this.floatDone || this.inImeComposition;
#else
                return floatDone;
#endif
            }
