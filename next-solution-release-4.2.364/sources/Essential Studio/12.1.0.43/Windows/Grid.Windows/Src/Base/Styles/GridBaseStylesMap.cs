//-------------------------------------------------------------------------------------------------
// <copyright file="GridBaseStylesMap.cs" company="syncfusion">
...
namespace Syncfusion.Windows.Forms.Grid
{
    ...
    internal class GridBaseStyleIdentity : StyleInfoIdentityBase
    {
        ...
        {
#if DEBUG
            if (m_thisStyleInfo != null)
            {
                GridStyleInfo gridStyleInfo = (GridStyleInfo)m_thisStyleInfo;
                string baseStyleName = gridStyleInfo.HasBaseStyle ? gridStyleInfo.BaseStyle : string.Empty;
                return "Name = " + baseStyleName;
            }
#endif
            return string.Empty;
        }
    ...
    public class GridBaseStyle : NonFinalizeDisposable, ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="GridBaseStylesMap"/> this base style belongs to.
        /// </summary>
        [System.Xml.Serialization.XmlIgnore]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Browsable(false)]
        ...
        /// <summary>
        /// Gets or sets the <see cref="GridStyleInfo"/> with style settings for this base style.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets the <see cref="GridStyleInfoStore"/> with style settings for this base style.
        /// </summary>
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [System.Xml.Serialization.XmlIgnore]
    ...
    /// You can register custom base styles with the <see cref="GridBaseStylesMap"/> map that you can access with <see cref="GridModel.BaseStylesMap"/>.
    /// <para/>
    /// Use <see cref="GridBaseStylesMap.ShowGridBaseStylesMapDialog(object,string)"/> to let users customize base styles at run-time.
    /// </remarks>
    /// <example>
    /// The following example shows how to modify base styles and how to add a new custom base style:
    /// <code lang="C#">
    ...
    /// <seealso cref="GridStyleInfo"/>
    [Serializable,
    Editor(////"System.ComponentModel.Design.CollectionEditor, System.Design",
        typeof(Syncfusion.Windows.Forms.Grid.GridBaseStyleCollectionEditor), ////Syncfusion.Windows.Forms.Grid",
        typeof(System.Drawing.Design.UITypeEditor))] ////, System.Drawing"),        
    public class GridBaseStylesMap : NonFinalizeDisposable, ICloneable, ISerializable, ICollection
    {
        ...
        /// <summary>
        /// The <see cref="GridBaseStyle"/> for Standard style.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public GridBaseStyle Standard
        {
            get
            {
        ...
        /// <summary>
        /// The <see cref="GridBaseStyle"/> for Header style.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public GridBaseStyle Header
        {
            get
            {
                return this["Header"];
        ...
        /// <summary>
        /// The <see cref="GridBaseStyle"/> for column header style.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public GridBaseStyle ColumnHeader
        {
            get
            {
        ...
        /// <summary>
        /// The <see cref="GridBaseStyle"/> for row header style.
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public GridBaseStyle RowHeader
        {
            get
            {
        ...
        /// <summary>
        /// Gets an <see cref="ArrayList"/> will cell type names as strings.
        /// </summary>
        ...
        /// </summary>
        /// <param name="instance">The instance with a property that references a <see cref="GridBaseStylesMap"/>.</param>
        ...
        {
            return ShowGridBaseStylesMapDialog(instance, propertyName, null);
        }
        ...
        public static DialogResult ShowGridBaseStylesMapDialog(object instance, string propertyName, IServiceProvider provider)
        {
            ...
            object v = ce.IntEditValue(tdc, esc, ((ICloneable)oldValue).Clone());
            ...
            if (esc.DialogResult == DialogResult.OK)
            {
                ...
                if (changeService != null)
                {
                    ...
                    changeService.OnComponentChanged(instance, pd, oldValue, v);
                }
                else
                {
                    pd.SetValue(instance, v);
        ...
        public void RegisterStandardStyles()
        {
            ...
            standardStyle.StyleInfo.Interior = new BrushInfo(SystemColors.Window);
            standardStyle.BaseStylesMap = this;
            Add(standardStyle);

            // Header
            GridBaseStyle headerStyle = new GridBaseStyle("Header", true);
            headerStyle.StyleInfo.Font.Bold = true;
            headerStyle.StyleInfo.Borders.All = new GridBorder(GridBorderStyle.None, SystemColors.WindowFrame, GridBorderWeight.Thin);
            headerStyle.StyleInfo.Interior = new BrushInfo(SystemColors.Control);
            headerStyle.StyleInfo.VerticalAlignment = GridVerticalAlignment.Middle;
            ...
            colHeaderStyle.StyleInfo.BaseStyle = "Header";
            colHeaderStyle.StyleInfo.HorizontalAlignment = GridHorizontalAlignment.Center;
            colHeaderStyle.BaseStylesMap = this;
            Add(colHeaderStyle);

            // Row Header
            GridBaseStyle rowHeaderStyle = new GridBaseStyle("Row Header", true);
            rowHeaderStyle.StyleInfo.BaseStyle = "Header";
            rowHeaderStyle.StyleInfo.HorizontalAlignment = GridHorizontalAlignment.Left;
        ...
        public GridBaseStyle this[string name]
        {
            ...
            set
            {
                ...
                if (value.BaseStylesMap != this)
                {
                    ...
                    baseStyles[name] = currentStyle = new GridBaseStyle(value.Name, value.IsSystem, (GridStyleInfoStore)value.StyleInfoStore.Clone(), this);
        ...
        {
#if DEBUG
            Trace.WriteLineIf(Switches.Development.TraceVerbose, "Enter AddRange(GridBaseStyle[])");
#endif
            BeginUpdate();
            foreach (object o in value)
            {
                ...
                if (style == null)
                {
                    if (o != null && Switches.Development.TraceVerbose)
                    {
                        Trace.WriteLine(o.GetType().ToString() + ": " + o.ToString());
                    }
...
#if DEBUG
                Trace.WriteLineIf(Switches.Development.TraceVerbose, "Adding " + style.ToString());
#endif
            ...
            EndUpdate(true);
#if DEBUG
            Trace.WriteLineIf(Switches.Development.TraceVerbose, "Exit AddRange(GridBaseStyle[])");
#endif
        }

        /// <summary>
        /// Gets the number of base styles in the <see cref="GridBaseStylesMap"/>.
        /// </summary>
        [Browsable(false)]
        public int Count
        {
