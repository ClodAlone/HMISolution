...
#endif
[assembly: AssemblyTitle("Syncfusion.Grid.Grouping.Windows")]
#if DEBUG
...
[assembly: DocumentationNamespaceExclude("Syncfusion.Windows.Forms.Grid.Grouping.Design")]
...
namespace Syncfusion
{
    ...
    /// </summary>
    public class GridGroupingWindowsAssembly
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string RootNamespace = "Syncfusion.Windows.Forms.Grid.Grouping";

        /// <summary>
        /// Initializes the <see cref="GridGroupingWindowsAssembly"/> class.
        /// </summary>
        static GridGroupingWindowsAssembly()
        {
            Assembly = typeof(GridGroupingWindowsAssembly).Assembly;
        ...
        public static Assembly AssemblyResolver(object sender, System.ResolveEventArgs e)
        {
            ...
            if (e.Name.StartsWith(SharedWindowsAssembly.Name))
            {
                return SharedWindowsAssembly.Assembly;
            }
            else if (e.Name.StartsWith(Syncfusion.GridBaseAssembly.Name))
            {
                return GridBaseAssembly.Assembly;
            }
            else if (e.Name.StartsWith(Syncfusion.GridWindowsAssembly.Name))
            {
                return GridWindowsAssembly.Assembly;
            }
            else if (e.Name.StartsWith(Syncfusion.GroupingBaseAssembly.Name))
            {
                return Syncfusion.GroupingBaseAssembly.Assembly;
            }
            else if (e.Name.StartsWith(Syncfusion.GridGroupingBaseAssembly.Name))
            {
                return Syncfusion.GridGroupingBaseAssembly.Assembly;
            }
            else if (e.Name.StartsWith(GridGroupingWindowsAssembly.Name))
            {
                return GridGroupingWindowsAssembly.Assembly;
            }
            else
            {
...
namespace Syncfusion.Windows.Forms.Grid.Grouping
{
    ...
    /// </summary>
    internal class AssemblyInfo : Syncfusion.GridGroupingWindowsAssembly
    {
    }
}
