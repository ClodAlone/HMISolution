//-------------------------------------------------------------------------------------------------
// <copyright file="GridGroupOptionsEvents.cs" company="syncfusion">
...
#endif
{
    //// eva GridGroupOptionsChanged Syncfusion GridGroupOptionsStyleInfoIdentity identity GridGroupOptionsStyleInfo groupOptions StyleInfoProperty sip

    ////public delegate void GridGroupOptionsChangedEventHandler(object sender, GridGroupOptionsChangedEventArgs e);

    /// <summary>
    /// Provides event arguments for the <see cref="IGridGroupOptionsSource.RaiseGroupOptionsChanged"/>
    /// an <see cref="IGridGroupOptionsSource.RaiseGroupOptionsChanging"/> methods
    ...
    {
        GridGroupOptionsStyleInfoIdentity identity;
        GridGroupOptionsStyleInfo groupOptions;
        StyleInfoProperty sip;

        /// <summary>
        /// Initializes the object with GridGroupOptionsStyleInfoIdentity, GridGroupOptionsStyleInfo, and the StyleInfoProperty that was modified.
        /// </summary>
        ...
        /// </summary>
        [TraceProperty(true)]
        public GridGroupOptionsStyleInfoIdentity Identity
        {
            get
            {
                return identity;
