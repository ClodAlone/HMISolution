...
#endif
{
    ...
    public class SfAccordionItem : HeaderedContentControl, IUpdateVisualState
    {
        ...
        private ExpandableContentControl ExpandSite
        {
            ...
            set
            {
                if (_expandSite != null)
                {
                    ...
                    _expandSite.LayoutUpdated -= ExpandSite_LayoutUpdated;
                }               
                _expandSite = value;
                ...
                {
                    _expandSite.ContentSizeChanged += OnExpandSiteContentSizeChanged;
                    ExpandSite.LayoutUpdated += ExpandSite_LayoutUpdated;
                }
            }
        }
        ...
        internal static readonly DependencyProperty AccentBrushProperty =
            DependencyProperty.Register("AccentBrush", typeof(SolidColorBrush), typeof(SfAccordionItem), new PropertyMetadata(null));
        ...
        {
        SfAccordionItem ctrl = (SfAccordionItem) d;
            ...
            {
                SfAccordion parent = ctrl.ParentAccordion;
                if (parent != null)
                {
                    if (isSelected)
                    {
        ...
        public static readonly DependencyProperty AccordionButtonStyleProperty =
            DependencyProperty.Register(
                ...
                typeof(Style),
                typeof(SfAccordionItem),
                new PropertyMetadata(null,new PropertyChangedCallback(OnAccordionButtonStylePropertyChanged)));
        ...
        {
            SfAccordionItem source = (SfAccordionItem) d;
        ...
        public static readonly DependencyProperty ExpandableContentControlStyleProperty =
            DependencyProperty.Register(
                ...
                typeof(Style),
                typeof(SfAccordionItem),
                new PropertyMetadata(new PropertyChangedCallback(OnExpandableContentControlStylePropertyChanged)));
        ...
        public static readonly DependencyProperty ContentTargetSizeProperty =
            DependencyProperty.Register(
                ...
                typeof(Size),
                typeof(SfAccordionItem),
                new PropertyMetadata(new Size(double.NaN, double.NaN),new PropertyChangedCallback(OnContentTargetSizePropertyChanged)));
        ...
        /// AccordionItem.
        /// </summary>
        internal SfAccordion ParentAccordion { get; set; }
        ...
        public SfAccordionItem()
        {
            ...
            DefaultStyleKey = typeof(SfAccordionItem);
        ...
        private void Schedule(AccordionAction action)
        {
            ...
            if(DesignerProperties.GetIsInDesignMode(this) == true && ExpandSite != null)
#else
            if (DesignMode.DesignModeEnabled && ExpandSite != null)
#endif
            {
                switch (action)
                {
        ...
        private void OnStoryboardFinished(object sender, object e)
        {
...
#endif
        {
            ...
            if (VisualTreeHelper.GetChildrenCount(this) > 0)
            {
                ...
                if (root != null && VisualStateManager.GetVisualStateGroups(root) is IList<VisualStateGroup>)
                {
        ...
        void ExpandSite_LayoutUpdated(object sender, object e)
        {
            if (ExpandSite != null && IsSelected && !_isBusyWithAction)
            {
                ExpandSite.MeasureContent(ExpandSite.CalculateDesiredContentSize());
                ExpandSite.RecalculatePercentage(ExpandSite.TargetSize);
                Schedule(AccordionAction.Resize);
        ...
        protected override void OnKeyDown(KeyRoutedEventArgs e)
        {
            ...
            bool isSelected = IsSelected;
                    if ((isSelected && invariantKey == VirtualKey.Up) || (!isSelected && invariantKey == VirtualKey.Down))
                    {
                        IsSelected = !isSelected;
                    }
                    if (invariantKey == VirtualKey.Enter)
                    {
                        IsSelected = !isSelected;
                        e.Handled = true;
                    }
