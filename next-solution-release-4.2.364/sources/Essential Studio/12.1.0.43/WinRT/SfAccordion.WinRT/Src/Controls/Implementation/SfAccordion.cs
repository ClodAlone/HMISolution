...
#endif
{
    ...
    [StyleTypedProperty(Property = "ItemContainerStyle", StyleTargetType = typeof(SfAccordionItem))]
    ...
    public class SfAccordion : ItemsControl, IUpdateVisualState
    {
        /// <summary>
        ...
        private readonly List<SfAccordionItem> _scheduledActions;

        internal ObservableCollection<Object> internalItems = new ObservableCollection<object>();
        ...
        /// </summary>
        /// <remarks>An action can be expanding, resizing or collapsing.</remarks>
        private SfAccordionItem _currentActioningItem;
        ...
        public static readonly DependencyProperty AccentBrushProperty =
            DependencyProperty.Register("AccentBrush", typeof(SolidColorBrush), typeof(SfAccordion), new PropertyMetadata(null));

        /// <summary>
        /// Using a DependencyProperty as the backing store for HeaderTemplate.  This enables animation, styling, binding, etc...
        /// </summary>
        public static readonly DependencyProperty HeaderTemplateProperty =
            DependencyProperty.Register("HeaderTemplate", typeof (DataTemplate), typeof (SfAccordion), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty HeaderTemplateSelectorProperty =
            DependencyProperty.Register("HeaderTemplateSelector", typeof (DataTemplateSelector), typeof (SfAccordion), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ContentTemplateSelectorProperty =
           DependencyProperty.Register("ContentTemplateSelector", typeof (DataTemplateSelector), typeof (SfAccordion), new PropertyMetadata(null));
        ...
        {
            SfAccordion source = (SfAccordion)d;
            ...
            {
                SfAccordionItem item = source.Items[i] as SfAccordionItem;
                if(item == null)
                    item = source.ItemContainerGenerator.ContainerFromIndex(i) as SfAccordionItem;
                if (item != null)
                {
                    item.IsLocked = false;
                }
        ...
        private static void OnSelectedItemPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (source.DataContext == null && source.ItemsSource!=null && e.NewValue==null)
                source.SetValue(SelectedItemProperty, null);
        ...
        private static void OnSelectedIndexPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!source.IsValidIndexForSelection(newValue) && source._isloaded)
            {
        ...
        {
            SfAccordion accordion = (SfAccordion)d;
        ...
        public static readonly DependencyProperty ItemContainerStyleProperty =
            DependencyProperty.Register(
                ...
                typeof(Style),
                typeof(SfAccordion),
                new PropertyMetadata(null,new PropertyChangedCallback(OnItemContainerStylePropertyChanged)));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SfAccordion"/> class.
        /// </summary>
        public SfAccordion()
        {
            DefaultStyleKey = typeof(SfAccordion);
            ...
            _scheduledActions = new List<SfAccordionItem>();
            SizeChanged += OnAccordionSizeChanged;
            Loaded += SfAccordion_Loaded;
            Unloaded += SfAccordion_Unloaded;
            Interaction = new InteractionHelper(this);
        }

        void SfAccordion_Unloaded(object sender, RoutedEventArgs e)
        {
            _isloaded = false;
        }

        private void SfAccordion_Loaded(object sender, RoutedEventArgs e)
        {
            _isloaded = true;
            if (!IsValidIndexForSelection(SelectedIndex))
            {
                _selectedIndexNestedLevel++;
...
#endif
        {
            ...
            if (dispatcher != null)
            {
                if (dispatcher.HasThreadAccess)
                    ...
                    dispatcher.RunAsync(
                           CoreDispatcherPriority.Normal, new DispatchedHandler(LayoutChildren)).AsTask().Wait();
            }
            internalItems.CollectionChanged += internalItems_CollectionChanged;
#endif
            if (_isloaded && IsMinimumOneSelected && SelectedIndices.Count > 1)
        ...
        void internalItems_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            ChangeCollection(e);
        }

        private void ChangeCollection(NotifyCollectionChangedEventArgs e)
        {
        ...
        {
            return item is SfAccordionItem;
        }
        ...
        {
            SfAccordionItem accordionItem = element as SfAccordionItem;
            ...
            if (accordionItem != null)
            {
                ...
                SfAccordionItem.PreparePrepareHeaderedContentControlContainerForItemOverride(accordionItem, item, this, ItemContainerStyle);
               ...
               // if (accordionItem.HeaderTemplateSelector == null)
                {
                    if (accordionItem.HeaderTemplate == null)
                    {
                        if (HeaderTemplateSelector != null)
                        {
                            accordionItem.HeaderTemplate =
                                HeaderTemplateSelector.SelectTemplate(item, accordionItem) as DataTemplate;
                        }    
                    
                    }
                }

             //   if (accordionItem.ContentTemplateSelector == null)
                {
                    if (accordionItem.ContentTemplate == null)
                    {
                        if (ContentTemplateSelector != null)
                        {
                            accordionItem.ContentTemplate =
                                ContentTemplateSelector.SelectTemplate(item, accordionItem) as DataTemplate;
                        }
                ...
                {
                    accordionItem.SetBinding(
                        SfAccordionItem.AccordionButtonStyleProperty,
                        new Binding()
                        {
                            Source = AccordionButtonStyleName,
                            Mode = BindingMode.OneWay
                        });
                }

                if (accordionItem.AccentBrush == null)
                {
                    accordionItem.SetBinding(
                        SfAccordionItem.AccentBrushProperty,
                        new Binding()
                        {
                            Source =AccentBrush,
                            Mode = BindingMode.OneWay
        ...
        internal void OnAccordionItemUnselected(SfAccordionItem accordionItem)
        {
        ...
        private void UnselectItem(int index, object item)
        {
            ...
            SfAccordionItem container = index >= 0 && index < Items.Count ? Items[index] is SfAccordionItem ? Items[index] as SfAccordionItem :  ItemContainerGenerator.ContainerFromIndex(index) as SfAccordionItem : null;
        ...
        internal void OnAccordionItemSelected(SfAccordionItem accordionItem)
        {
        ...
        {
            SfAccordionItem oldAccordionItem = oldIndex >= 0 && oldIndex < Items.Count ? Items[oldIndex] is SfAccordionItem ?
                 Items[oldIndex] as SfAccordionItem : ItemContainerGenerator.ContainerFromIndex(oldIndex) as SfAccordionItem : null;
            SfAccordionItem newAccordionItem = newIndex >= 0 && newIndex < Items.Count ? Items[newIndex] is SfAccordionItem ?
                Items[newIndex] as SfAccordionItem : ItemContainerGenerator.ContainerFromIndex(newIndex) as SfAccordionItem : null;
        ...
        private int ProposeSelectedIndexCandidate(int nonCandidateIndex)
        {
            ...
            IEnumerable<int> validIndices = SelectedIndices.Where(i => i != nonCandidateIndex && ((i < Items.Count) && (item == null || !item.Equals(Items[i]))));
        ...
        private void UpdateAccordionItemsSelection(bool selectedValue)
        {
            ...
            {
                SfAccordionItem accordionItem = ItemContainerGenerator.ContainerFromItem(item) as SfAccordionItem;
        ...
        private void SetLockedProperties()
        {
            ...
            {
                SfAccordionItem item = null;
                item = Items[i] as SfAccordionItem;
                if(item == null)
                    item=ItemContainerGenerator.ContainerFromIndex(i) as SfAccordionItem;
                if (item != null)
                {
        ...
        internal void OnHeaderSizeChange(SfAccordionItem item)
        {
            LayoutChildren();
        }
        ...
        private void StartNextAction()
        {
            ...
            SfAccordionItem next = _scheduledActions.FirstOrDefault(item => item.ScheduledAction == AccordionAction.Collapse);
            if (next == null)
            {
        ...
        private void LayoutChildren()
        {
            ...
            {               
                ...
                foreach (object item in Items)
                {
                    ...
                    if(accordionItem == null)
                      accordionItem = ItemContainerGenerator.ContainerFromItem(item) as SfAccordionItem;
                    if (accordionItem != null)
                    {
