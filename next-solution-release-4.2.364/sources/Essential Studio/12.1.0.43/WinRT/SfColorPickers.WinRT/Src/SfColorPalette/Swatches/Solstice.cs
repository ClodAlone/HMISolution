...
{
    /// <summary>
    /// Represents a set of colors with Solstice theme
    /// </summary>
    public class Solstice : SwatchesBase
    {
#if!WINRT
        /// <summary>
        ...
        /// cref="Syncfusion.UI.Xaml.Controls.Media.Solstice"/> class.
        /// </summary>
        /// <seealso
        /// cref="N:Syncfusion.UI.Xaml.Controls.Media">Syncfusion.UI.Xaml.Controls.Media
        /// Namespace</seealso>
        ...
        public Solstice()
        {
            DefaultStyleKey = typeof(Solstice);
        }
    }
}
