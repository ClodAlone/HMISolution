...
{
    /// <summary>
    /// Represents a set of colors with Hardcover theme
    /// </summary>
    public class Hardcover : SwatchesBase
    {
#if!WINRT
        /// <summary>
        ...
        /// cref="Syncfusion.UI.Xaml.Controls.Media.Hardcover"/> class.
        /// </summary>
        /// <seealso
        /// cref="N:Syncfusion.UI.Xaml.Controls.Media">Syncfusion.UI.Xaml.Controls.Media
        /// Namespace</seealso>
        ...
        public Hardcover()
        {
            DefaultStyleKey = typeof(Hardcover);
        }
    }
}
