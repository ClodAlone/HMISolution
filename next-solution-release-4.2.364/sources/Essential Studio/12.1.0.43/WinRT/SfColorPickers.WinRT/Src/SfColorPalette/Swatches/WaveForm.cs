...
{
    /// <summary>
    /// Represents a set of colors with Waveform theme
    /// </summary>
    public class Waveform : SwatchesBase
    {
#if!WINRT
        /// <summary>
        ...
        /// cref="Syncfusion.UI.Xaml.Controls.Media.Waveform"/> class.
        /// </summary>
        /// <seealso
        /// cref="N:Syncfusion.UI.Xaml.Controls.Media">Syncfusion.UI.Xaml.Controls.Media
        /// Namespace</seealso>
        ...
        public Waveform()
        {
            DefaultStyleKey = typeof(Waveform);
        }
    }
}
