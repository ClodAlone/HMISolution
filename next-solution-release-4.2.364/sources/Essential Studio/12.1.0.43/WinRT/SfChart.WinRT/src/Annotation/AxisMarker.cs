...
namespace Syncfusion.UI.Xaml.Charts
{
    internal class AxisMarker : ShapeAnnotation
    {
        ...
        public override void UpdateAnnotation()
        {
            if (markerContent != null)
            {
                ...
                if (XAxis != null && YAxis != null)
                {
                    ...
                    RotatedRect = new Rect(textPosition.X,textPosition.Y ,
                                           markerContent.DesiredSize.Width,  markerContent.DesiredSize.Height);
                }
            }
        }
        private bool CheckPointRange(double point, ChartAxis axis)
        {
        ...
        {
            Binding binding = new Binding() { Path = new PropertyPath("AxisLabelTemplate"), Source = ParentAnnotation };
            markerContent.SetBinding(ContentControl.ContentTemplateProperty, binding);
        }
    }
}
