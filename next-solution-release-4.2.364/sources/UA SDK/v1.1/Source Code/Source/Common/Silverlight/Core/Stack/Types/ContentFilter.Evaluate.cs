...
namespace Opc.Ua
{
    ...
    public partial class ContentFilter
    {
        ...
        private object GetValue(FilterContext context, FilterOperand operand, IFilterTarget target)
        {
            ...
            SimpleAttributeOperand attribute = operand as SimpleAttributeOperand;
        ...
        private bool InView(FilterContext context, IFilterTarget target, ContentFilterElement element)
        {
            ...
            try
            {
                return target.IsInView(context, viewId);
            }
            catch
            {
                return false;
        ...
        {
            FilterOperand[] operands = GetOperands(element, 4);
            ...
            NodeId targetTypeId = GetValue(context, operands[1], target) as NodeId;
            ...
            int? hops = Cast(hopsValue, BuiltInType.Int32) as int?;
            ...
            try
            {
                bool relatedTo = target.IsRelatedTo(
                    context, 
                    sourceTypeId,
                    targetTypeId,
                    referenceTypeId,
