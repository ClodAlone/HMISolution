...
namespace Opc.Ua
{
    ...
    public class InstanceStateSnapshot : IFilterTarget
    {
        ...
        public bool IsInView(FilterContext context, NodeId viewId)
        {
        ...
        /// </summary>
        /// <param name="context">The context to use when evaluating the relationships.</param>
        /// <param name="sourceTypeId">The type of the source instance.</param>
        /// <param name="targetTypeId">The type of the target instance.</param>
        /// <param name="referenceTypeId">The type of the reference(s) to follow.</param>
        /// <param name="hops">The sub-set of an array value to return.</param>
        /// <returns>
        /// The attribute value. Returns null if the attribute does not exist.
        /// </returns>
        public bool IsRelatedTo(FilterContext context, NodeId sourceTypeId, NodeId targetTypeId, NodeId referenceTypeId, int hops)
        {
            return false;
        }
