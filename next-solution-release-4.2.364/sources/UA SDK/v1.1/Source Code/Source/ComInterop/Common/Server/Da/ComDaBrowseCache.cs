    ...
    public class ComDaBrowseCache
    {
            ...
            bool onlyEssentialProperties)
        {
            ...
            if (!onlyEssentialProperties)
            {
                ...
                if (childrenByName.TryGetValue(Opc.Ua.BrowseNames.TimeZone, out property))
                {
                    nodeToRead = new ReadValueId();
                    nodeToRead.NodeId = (NodeId)property.NodeId;
                    nodeToRead.AttributeId = Attributes.Value;
                    nodeToRead.Handle = Opc.Ua.BrowseNames.TimeZone;
                    nodesToRead.Add(nodeToRead);
                }
            }
            ...
            int first)
        {
            ...
            if (!onlyEssentialProperties)
            {
                ...
                if (element.ReferencesByName.ContainsKey(Opc.Ua.BrowseNames.TimeZone))
                {
