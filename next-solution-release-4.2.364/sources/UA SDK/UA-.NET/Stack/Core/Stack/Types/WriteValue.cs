    ...
    public partial class WriteValue
    {
        ...
        public static ServiceResult Validate(WriteValue value)
        {
            ...
            if (!String.IsNullOrEmpty(value.IndexRange))
            {
                ...
                /////////////////////////////////////////////////////////////////////////////////////////////
                // https://support.progea.com/Products/default.asp?22161
                if (array == null && 
                    (value.ParsedIndexRange.Dimensions == 1 || value.ParsedIndexRange.Dimensions == 2) && 
                    TypeInfo.IsNumericType(value.Value.WrappedValue.TypeInfo.BuiltInType))
                    return null;
                /////////////////////////////////////////////////////////////////////////////////////////////
