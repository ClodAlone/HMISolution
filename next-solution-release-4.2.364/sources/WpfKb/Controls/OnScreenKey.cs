...
namespace WpfKb.Controls
{
    ...
    public class OnScreenKey : Border
    {
        ...
        public static readonly DependencyProperty FontSizeProperty = DependencyProperty.Register("FontSize", typeof(int), typeof(OnScreenKey), new UIPropertyMetadata(20));
