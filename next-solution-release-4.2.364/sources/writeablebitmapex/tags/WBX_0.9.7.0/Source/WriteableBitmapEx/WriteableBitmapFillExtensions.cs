...
namespace System.Windows.Media.Imaging
{
   ...
   public static partial class WriteableBitmapExtensions
   {
      ...
      private static System.Collections.Generic.List<int> ComputeBezierPoints(int x1, int y1, int cx1, int cy1, int cx2, int cy2, int x2, int y2, int color, int[] pixels, int w, int h)
      {
      ...
      /// <param name="w">The width of the bitmap.</param>
      /// <param name="h">The height of the bitmap.</param> 
      private static System.Collections.Generic.List<int> ComputeSegmentPoints(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, float tension, int color, int[] pixels, int w, int h)
      {
         // Determine distances between controls points (bounding rect) to find the optimal stepsize
