namespace Unosquare.FFME.Rendering.Wave
{
    ...
    internal class WaveFormat
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return
                    channels == (obj as WaveFormat).channels &&
                    sampleRate == (obj as WaveFormat).sampleRate &&
                    averageBytesPerSecond == (obj as WaveFormat).averageBytesPerSecond &&
                    blockAlign == (obj as WaveFormat).blockAlign &&
                    bitsPerSample == (obj as WaveFormat).bitsPerSample;
            }
